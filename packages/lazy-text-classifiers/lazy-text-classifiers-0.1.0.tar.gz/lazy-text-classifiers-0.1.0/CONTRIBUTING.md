...
Ready to contribute? Here's how to set up `lazy-text-classifiers` for local development.

1. Fork the `lazy-text-classifiers` repo on GitHub.

2. Clone your fork locally:

    ```bash
    git clone git@github.com:{your_name_here}/lazy-text-classifiers.git
    ```
