...
# run tests
test:
	pytest --cov-report xml --cov-report html --cov=lazy_text_classifiers lazy_text_classifiers/tests
...
generate-docs:
	rm -f docs/lazy_text_classifiers*.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs lazy_text_classifiers **/tests
