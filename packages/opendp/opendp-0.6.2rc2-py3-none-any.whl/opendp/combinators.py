...
def make_basic_composition(
    ...
    [make_basic_composition in Rust documentation.](https://docs.rs/opendp/0.6.2-rc.2/opendp/combinators/fn.make_basic_composition.html)
...
def make_chain_mt(
    ...
    [make_chain_mt in Rust documentation.](https://docs.rs/opendp/0.6.2-rc.2/opendp/combinators/fn.make_chain_mt.html)
...
def make_chain_tm(
    ...
    [make_chain_tm in Rust documentation.](https://docs.rs/opendp/0.6.2-rc.2/opendp/combinators/fn.make_chain_tm.html)
...
def make_chain_tt(
    ...
    [make_chain_tt in Rust documentation.](https://docs.rs/opendp/0.6.2-rc.2/opendp/combinators/fn.make_chain_tt.html)
...
def make_default_user_measurement(
    ...
    * `ZeroConcentratedDivergence<_>`
    ...
    [make_default_user_measurement in Rust documentation.](https://docs.rs/opendp/0.6.2-rc.2/opendp/combinators/fn.make_default_user_measurement.html)
...
def make_default_user_postprocessor(
    ...
    * `AllDomain<_>`
    ...
    [make_default_user_postprocessor in Rust documentation.](https://docs.rs/opendp/0.6.2-rc.2/opendp/combinators/fn.make_default_user_postprocessor.html)
...
def make_default_user_transformation(
    ...
    * `L2Distance<_>`
    ...
    [make_default_user_transformation in Rust documentation.](https://docs.rs/opendp/0.6.2-rc.2/opendp/combinators/fn.make_default_user_transformation.html)
...
def make_fix_delta(
    ...
    [make_fix_delta in Rust documentation.](https://docs.rs/opendp/0.6.2-rc.2/opendp/combinators/fn.make_fix_delta.html)
...
def make_population_amplification(
    ...
    [make_population_amplification in Rust documentation.](https://docs.rs/opendp/0.6.2-rc.2/opendp/combinators/fn.make_population_amplification.html)
...
def make_pureDP_to_fixed_approxDP(
    ...
    [make_pureDP_to_fixed_approxDP in Rust documentation.](https://docs.rs/opendp/0.6.2-rc.2/opendp/combinators/fn.make_pureDP_to_fixed_approxDP.html)
...
def make_pureDP_to_zCDP(
    ...
    [make_pureDP_to_zCDP in Rust documentation.](https://docs.rs/opendp/0.6.2-rc.2/opendp/combinators/fn.make_pureDP_to_zCDP.html)
...
def make_zCDP_to_approxDP(
    ...
    [make_zCDP_to_approxDP in Rust documentation.](https://docs.rs/opendp/0.6.2-rc.2/opendp/combinators/fn.make_zCDP_to_approxDP.html)
