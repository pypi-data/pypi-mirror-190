...
class PimMemoTestCase(ModuleTestCase):
    ...
    def test_pimmemo_create_item_tree(self):
        ...
        self.assertRaisesRegex(UserError,
            "The note 'name 1: text 1' has subnotes and therefore can not be deleted.",
            PimMemo.delete,
            [m_lst[0]])
    ...
    def test_pimmemo_report_optimize_tags(self):
        ...
        txt = '<div align="left"><font face="normal"><b>Lorem</b> <u><i>ipsum</i> dolor</u> sit </font>'+\
            '<font face="sans" size="5">amet</font><font face="normal">, </font>'+\
            '<font face="serif">consectetur</font><font face="normal"> </font>'+\
            '<font face="monospace">adipisicing</font><font face="normal"> elit, </font>'+\
            '</div><div align="center"><font face="normal" size="6">sed</font>'+\
            '<font face="normal"> <font size="7">doeiusmod</font> <font size="3">tempor</font>'+\
            ' <font size="2">incididunt</font> ut labore </font></div><div>'+\
            '<font face="normal">et dolore magna aliqua.</font></div><div align="left">'+\
            '<font face="normal">Ut enimad <font color="#cc0000">minim</font> <b>'+\
            '<font color="#204a87">veniam</font></b>, quis nostrud exercitation ullamco '+\
            'laboris nisi utaliquip ex ea commodo consequat. </font></div>'
        ...
        self.assertEqual(result, '<div align="left"><span style="font-family:initial;"><b>Lorem</b> <u><i>ipsum</i> dolor</u> sit </span><span style="font-family:sans-serif;font-size:110%;">amet</span><span style="font-family:initial;">, </span><span style="font-family:serif;">consectetur</span><span style="font-family:initial;"> </span><span style="font-family:monospace;">adipisicing</span><span style="font-family:initial;"> elit, </span></div><div align="center"><span style="font-family:initial;font-size:120%;">sed</span><span style="font-family:initial;"> <span style="font-size:130%;">doeiusmod</span> <span style="font-size:90%;">tempor</span> <span style="font-size:80%;">incididunt</span> ut labore </span></div><div><span style="font-family:initial;">et dolore magna aliqua.</span></div><div align="left"><span style="font-family:initial;">Ut enimad <span style="color:#cc0000;">minim</span> <b><span style="color:#204a87;">veniam</span></b>, quis nostrud exercitation ullamco laboris nisi utaliquip ex ea commodo consequat. </span></div>')
