...
class BatchHandler:
    ...
    def forward_batch(self,
                      module: Module,
                      batch: List[Union[torch.Tensor, List[torch.Tensor]],
                                  Union[torch.Tensor, List[torch.Tensor]]]) -> ModuleOutput:
        """
        ...
        :type batch: List[Union[torch.Tensor, List[torch.Tensor]], Union[torch.Tensor, List[torch.Tensor]]]
    ...
    def loss_batch_eval(self,
                        module: Module,
                        batch: List[Union[torch.Tensor, List[torch.Tensor]],
                                    Union[torch.Tensor, List[torch.Tensor]]]) -> float:
        """
    ...
    def train_n_batches(self,
                        ...
                        n_batches: int,
                        loader: DataLoader,
                        freeze_pretrained: bool) -> List[List, float, float]:
        """
    ...
    def lrrt(self,
             loader: DataLoader,
             freeze_pretrained: bool = False) -> List[float, float]:
        """
...
class Debugger(BatchHandler):
    ...
    def overfit_batch(self,
                      module: Module,
                      batch_debug: List[Union[torch.Tensor, List[torch.Tensor]],
                                        Union[torch.Tensor, List[torch.Tensor]]],
                      n_iters: int,
                      lrrt_loader: DataLoader = None,
                      lr: float = 1e-5,
                      freeze_pretrained: bool = False) -> List[Module, List[float]]:
        """
        ...
        :type batch_debug: List[Union[torch.Tensor, List[torch.Tensor]], Union[torch.Tensor, List[torch.Tensor]]]
...
class Visualizer:
    ...
    def lines_multiplot(lines: List[List[float]],
                        title: str,
                        multiplot_labels: List[List[str]],
                        y_label: str,
                        x_label: str,
                        file_name: str):
        """
...
class Trainer(BatchHandler):
    ...
    def losses_epoch_eval(self, module: Module) -> List[float, float]:
        """
    ...
    def train(self,
              max_epochs: int,
              freeze_pretrained: bool = False) -> List[Module, List[float], List[float], List[float]]:
        """
        training procedure
    ...
    def train_overkill_epoch(self, lr_initial: float, freeze_pretrained: bool) -> List[List[float], float, int]:
        """
