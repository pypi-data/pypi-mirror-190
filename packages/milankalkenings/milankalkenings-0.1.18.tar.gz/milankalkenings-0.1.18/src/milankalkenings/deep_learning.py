...
class BatchHandler:
    ...
    def forward_batch(self,
                      module: Module,
                      batch: List[Union[torch.Tensor, List[torch.Tensor]]]) -> ModuleOutput:
        """
        ...
        :type batch: List[Union[torch.Tensor, List[torch.Tensor]]]
    ...
    def loss_batch_eval(self,
                        module: Module,
                        batch: List[Union[torch.Tensor, List[torch.Tensor]]]) -> float:
        """
...
class Debugger(BatchHandler):
    ...
    def overfit_batch(self,
        ...
        :type batch_debug: List[Union[torch.Tensor, List[torch.Tensor]]]
