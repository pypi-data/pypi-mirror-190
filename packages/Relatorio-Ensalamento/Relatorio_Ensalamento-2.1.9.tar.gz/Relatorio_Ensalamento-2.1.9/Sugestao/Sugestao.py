...
def insert_excel(nome_arquivo, dict_retorna_sugestao, dict_retorna_sugestao_list, dict_retorna_sugestao_subutilizada):
    ...
    df_capacidade['Overbooking negociado com o coordenador'] = df_capacidade.apply(lambda x: transforma_porcentagem(x['Overbooking negociado com o coordenador']), axis=1)
