...
class Config:
    ...
    def __init__(self):
        ...
        self.force_cpu = True # may be useful if your GPU does not have enough memory to run the training
        self.truncate_dataset_to_size = 10000 # may be useful if your GPU does not have enough memory to run the training
