...
from mmap_ninja_dataframe.base import _create_mmap_for_key, load_dir_as_dict
...
class SparseDataFrameMmap:
    ...
    def __init__(
        ...
        self._data = load_dir_as_dict(self._out_dir, self._wrapper_fn_dict)
