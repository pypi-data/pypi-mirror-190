...
class Dates:
    ...
    def offset(self, date_string: str | None = None, date_format:str = '%d.%m.%Y', seconds: int | None = None, minutes: int | None = None, hours: int | None = None, days: int | None = None, months: int | None = None, years: int | None = None, output_format: str = '%d.%m.%Y') -> str:
        """_summary_
