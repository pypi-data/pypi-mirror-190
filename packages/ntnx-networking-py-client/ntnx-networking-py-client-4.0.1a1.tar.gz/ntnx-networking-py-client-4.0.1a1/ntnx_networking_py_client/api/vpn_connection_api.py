...
class VpnConnectionApi(object):
    ...
    def create_vpn_connection(self, body, **kwargs):  # noqa: E501
        ...
        :param networking.v4.config.VpnConnection body: Create VPN connection request body (required)
    ...
    def create_vpn_connection_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/vpn-connections', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_vpn_connection(self, extId, **kwargs):  # noqa: E501
        ...
        :param str extId: VPN connection UUID (required)
        :param bool async_req:
        :return: networking.v4.config.TaskReferenceApiResponse
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_vpn_connection_with_http_info(extId, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_vpn_connection_with_http_info(extId, **kwargs)  # noqa: E501
            return data

    def delete_vpn_connection_with_http_info(self, extId, **kwargs):  # noqa: E501
        """Delete VPN connection
        Delete VPN connection request body
        ...
        >>> thread = api.delete_vpn_connection_with_http_info(extId, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/vpn-connections/{extId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_vpn_connection(self, extId, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_vpn_connection_with_http_info(extId, **kwargs)  # noqa: E501
        else:
            (data) = self.get_vpn_connection_with_http_info(extId, **kwargs)  # noqa: E501
            return data

    def get_vpn_connection_with_http_info(self, extId, **kwargs):  # noqa: E501
        """Get VPN connection
        Get VPN connection for a specified ExtId.
        ...
        >>> thread = api.get_vpn_connection_with_http_info(extId, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_vpn_connection" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'extId' is set
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/vpn-connections/{extId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_vpn_connections(self, **kwargs):  # noqa: E501
        ...
        - localNetworkGatewayReference
        - name
        - remoteNetworkGatewayReference
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_vpn_connections_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_vpn_connections_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_vpn_connections_with_http_info(self, **kwargs):  # noqa: E501
        """List the VPN connections
        List the VPN connections
        ...
        >>> thread = api.list_vpn_connections_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_vpn_connections" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/vpn-connections', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_vpn_connection(self, body, extId, **kwargs):  # noqa: E501
        """Update VPN connection
        Update VPN connection

        >>> response = api.update_vpn_connection(body, extId)

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_vpn_connection(body, extId, async_req=True)
        >>> result = thread.get()

        :param networking.v4.config.VpnConnection body: Update VPN connection request body (required)
        :param str extId: VPN connection UUID (required)
        :param bool async_req:
        :return: networking.v4.config.TaskReferenceApiResponse
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_vpn_connection_with_http_info(body, extId, **kwargs)  # noqa: E501
        else:
            (data) = self.update_vpn_connection_with_http_info(body, extId, **kwargs)  # noqa: E501
            return data

    def update_vpn_connection_with_http_info(self, body, extId, **kwargs):  # noqa: E501
        """Update VPN connection
        Update VPN connection
        ...
        >>> thread = api.update_vpn_connection_with_http_info(body, extId, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_vpn_connection" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/vpn-connections/{extId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
