...
class VpcNsStatsApi(object):
    ...
    def get_vpc_ns_stats(self, vpcUuid, extSubnetUuid, **kwargs):  # noqa: E501
        """Get VPC North-South statistics.
        Get VPC North-South statistics

        >>> response = api.get_vpc_ns_stats(vpcUuid, extSubnetUuid, (optional) _startTime, (optional) _endTime, (optional) _samplingInterval, (optional) _statType, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_vpc_ns_stats(vpcUuid, extSubnetUuid, async_req=True)
        >>> result = thread.get()

        :param str vpcUuid: The UUID of the VPC. (required)
        :param str extSubnetUuid: The UUID of the VPC. (required)
...
- tenantId
        ...
        if kwargs.get('async_req'):
            return self.get_vpc_ns_stats_with_http_info(vpcUuid, extSubnetUuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_vpc_ns_stats_with_http_info(vpcUuid, extSubnetUuid, **kwargs)  # noqa: E501
            return data

    def get_vpc_ns_stats_with_http_info(self, vpcUuid, extSubnetUuid, **kwargs):  # noqa: E501
        """Get VPC North-South statistics.
        Get VPC North-South statistics
        ...
        >>> thread = api.get_vpc_ns_stats_with_http_info(vpcUuid, extSubnetUuid, async_req=True)
        >>> result = thread.get()
...
- tenantId
        ...
        all_params = ['vpcUuid', 'extSubnetUuid', '_startTime', '_endTime', '_samplingInterval', '_statType', '_select']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_vpc_ns_stats" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'vpcUuid' is set
        if ('vpcUuid' not in params or
                params['vpcUuid'] is None):
            raise ValueError("Missing the required parameter `vpcUuid` when calling `get_vpc_ns_stats`")  # noqa: E501
        # verify the required parameter 'extSubnetUuid' is set
        if ('extSubnetUuid' not in params or
                params['extSubnetUuid'] is None):
            raise ValueError("Missing the required parameter `extSubnetUuid` when calling `get_vpc_ns_stats`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'vpcUuid' in params:
            path_params['vpcUuid'] = params['vpcUuid']  # noqa: E501
        if 'extSubnetUuid' in params:
            path_params['extSubnetUuid'] = params['extSubnetUuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/stats/vpc/{vpcUuid}/external-subnets/{extSubnetUuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
