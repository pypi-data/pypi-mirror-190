...
class RoutingPolicyApi(object):
    ...
    def create_routing_policy(self, body, **kwargs):  # noqa: E501
        ...
        :param networking.v4.config.RoutingPolicy body: Schema to configure a routing policy. (required)
        ...
        if kwargs.get('async_req'):
            return self.create_routing_policy_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_routing_policy_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_routing_policy_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create a Routing Policy.
        Create a routing policy.
        ...
        >>> thread = api.create_routing_policy_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_routing_policy" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/routing-policies', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_routing_policy(self, extId, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_routing_policy_with_http_info(extId, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_routing_policy_with_http_info(extId, **kwargs)  # noqa: E501
            return data

    def delete_routing_policy_with_http_info(self, extId, **kwargs):  # noqa: E501
        """Delete the Routing Policy corresponding to the extId.
        Delete the routing policy corresponding to the extId.
        ...
        >>> thread = api.delete_routing_policy_with_http_info(extId, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_routing_policy" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/routing-policies/{extId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_routing_policy(self, extId, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_routing_policy_with_http_info(extId, **kwargs)  # noqa: E501
        else:
            (data) = self.get_routing_policy_with_http_info(extId, **kwargs)  # noqa: E501
            return data

    def get_routing_policy_with_http_info(self, extId, **kwargs):  # noqa: E501
        """Get a single Routing Policy corresponding to the extId.
        Get a single routing policy corresponding to the extId.
        ...
        >>> thread = api.get_routing_policy_with_http_info(extId, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_routing_policy" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'extId' is set
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/routing-policies/{extId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_routing_policies(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_routing_policies_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_routing_policies_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_routing_policies_with_http_info(self, **kwargs):  # noqa: E501
        """Get a list of Routing Policies.
        Get a list of routing policies.
        ...
        >>> thread = api.list_routing_policies_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_routing_policies" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/routing-policies', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def put_routing_policy(self, body, extId, **kwargs):  # noqa: E501
        """Update the Routing Policy corresponding to the extId.
        Update the Routing Policy corresponding to the extId.

        >>> response = api.put_routing_policy(body, extId)

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_routing_policy(body, extId, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_routing_policy_with_http_info(body, extId, **kwargs)  # noqa: E501
        else:
            (data) = self.put_routing_policy_with_http_info(body, extId, **kwargs)  # noqa: E501
            return data

    def put_routing_policy_with_http_info(self, body, extId, **kwargs):  # noqa: E501
        """Update the Routing Policy corresponding to the extId.
        Update the Routing Policy corresponding to the extId.
        ...
        >>> thread = api.put_routing_policy_with_http_info(body, extId, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_routing_policy" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/routing-policies/{extId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
