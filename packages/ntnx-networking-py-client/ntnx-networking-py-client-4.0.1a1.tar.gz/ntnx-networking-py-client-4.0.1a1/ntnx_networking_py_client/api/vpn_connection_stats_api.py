...
class VpnConnectionStatsApi(object):
    ...
    def get_vpn_connection_stats(self, extId, **kwargs):  # noqa: E501
        """Get VPN connection statistics
        Get VPN connection statistics

        >>> response = api.get_vpn_connection_stats(extId, (optional) _startTime, (optional) _endTime, (optional) _samplingInterval, (optional) _statType, (optional) _select)
...
- throughputTxKbps
        ...
        if kwargs.get('async_req'):
            return self.get_vpn_connection_stats_with_http_info(extId, **kwargs)  # noqa: E501
        else:
            (data) = self.get_vpn_connection_stats_with_http_info(extId, **kwargs)  # noqa: E501
            return data

    def get_vpn_connection_stats_with_http_info(self, extId, **kwargs):  # noqa: E501
        """Get VPN connection statistics
        Get VPN connection statistics
        ...
        >>> thread = api.get_vpn_connection_stats_with_http_info(extId, async_req=True)
        >>> result = thread.get()
...
- throughputTxKbps
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_vpn_connection_stats" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/stats/vpn-connections/{extId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
