...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.FloatingIpApiResponsedata import FloatingIpApiResponsedata  # noqa: F401,E501
...
class FloatingIpApiResponse(object):
    """FloatingIpApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.FloatingIpApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.FloatingIp | networking.v4.error.ErrorResponse }`
