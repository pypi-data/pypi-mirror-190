...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.Layer2StretchListApiResponsedata import Layer2StretchListApiResponsedata  # noqa: F401,E501
...
class Layer2StretchListApiResponse(object):
    """Layer2StretchListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.Layer2StretchListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.Layer2Stretch] | networking.v4.error.ErrorResponse }`
