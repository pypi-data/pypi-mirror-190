...
class NodeSchedulableStatus(object):
    """NodeSchedulableStatus - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    attribute_map = {
        'ext_id': 'extId',
        'never_schedulable': 'neverSchedulable',
        '_reserved': '$reserved',
    ...
    def __init__(self, ext_id=None, never_schedulable=None, *args, **kwargs):  # noqa: E501
        """NodeSchedulableStatus - a model defined in Swagger
            \nArray of node UUIDs and boolean pairs, indicating whether the nodes are storage-only
        """
        self.__ext_id = None
        self.__never_schedulable = None
        self.discriminator = None
        self.__ext_id = ext_id
        self.__never_schedulable = never_schedulable
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.NodeSchedulableStatus'
    ...
    @property
    def never_schedulable(self):
        """`{ bool }`
            \nThe boolean value to indicate whether or not node is a storage only node
        """ # noqa: E501
        return self.__never_schedulable

    @never_schedulable.setter
    def never_schedulable(self, never_schedulable):
        if never_schedulable is None:
            raise ValueError("Invalid value for `never_schedulable`, must not be `None`")  # noqa: E501
