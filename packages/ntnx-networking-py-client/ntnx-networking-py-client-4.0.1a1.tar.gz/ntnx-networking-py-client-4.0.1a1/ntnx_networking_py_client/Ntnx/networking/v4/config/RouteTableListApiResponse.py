...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.RouteTableListApiResponsedata import RouteTableListApiResponsedata  # noqa: F401,E501
...
class RouteTableListApiResponse(object):
    """RouteTableListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.RouteTableListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.RouteTable] | networking.v4.error.ErrorResponse }`
