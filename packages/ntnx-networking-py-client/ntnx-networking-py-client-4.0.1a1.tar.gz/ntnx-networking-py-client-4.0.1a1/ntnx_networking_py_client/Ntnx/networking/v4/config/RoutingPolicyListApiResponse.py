...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.RoutingPolicyListApiResponsedata import RoutingPolicyListApiResponsedata  # noqa: F401,E501
...
class RoutingPolicyListApiResponse(object):
    """RoutingPolicyListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.RoutingPolicyListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.RoutingPolicy] | networking.v4.error.ErrorResponse }`
