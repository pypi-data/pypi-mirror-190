...
from ntnx_networking_py_client.Ntnx.networking.v4.config.AzureConfig import AzureConfig  # noqa: F401,E501
...
class NetworkCloudConfig(NetworkingBaseModel):
    """NetworkCloudConfig - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.NetworkCloudConfig'


    @property
    def azure_config(self):
        """`{ networking.v4.config.AzureConfig }`
