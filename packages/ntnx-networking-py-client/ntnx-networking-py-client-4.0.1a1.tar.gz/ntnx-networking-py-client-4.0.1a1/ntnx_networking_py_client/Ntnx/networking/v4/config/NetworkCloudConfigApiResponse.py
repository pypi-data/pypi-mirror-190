...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.NetworkCloudConfigApiResponsedata import NetworkCloudConfigApiResponsedata  # noqa: F401,E501
...
class NetworkCloudConfigApiResponse(object):
    """NetworkCloudConfigApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.NetworkCloudConfigApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.NetworkCloudConfig | networking.v4.error.ErrorResponse }`
