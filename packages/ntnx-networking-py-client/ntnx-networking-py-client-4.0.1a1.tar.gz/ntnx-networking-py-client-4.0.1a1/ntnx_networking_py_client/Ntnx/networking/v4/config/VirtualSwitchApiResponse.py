...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.VirtualSwitchApiResponsedata import VirtualSwitchApiResponsedata  # noqa: F401,E501
...
class VirtualSwitchApiResponse(object):
    """VirtualSwitchApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.VirtualSwitchApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.VirtualSwitch | networking.v4.error.ErrorResponse }`
