...
class IPSubnetObject(object):
    """IPSubnetObject - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def __init__(self, ip_subnet=None, *args, **kwargs):  # noqa: E501
        """IPSubnetObject - a model defined in Swagger
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.IPSubnetObject'

    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.IPSubnetObject'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(IPSubnetObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IPSubnetObject):
            return False
