...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.NodeSchedulableStatusApiResponsedata import NodeSchedulableStatusApiResponsedata  # noqa: F401,E501
...
class NodeSchedulableStatusApiResponse(object):
    """NodeSchedulableStatusApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.NodeSchedulableStatusApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.NodeSchedulableStatus] | networking.v4.error.ErrorResponse }`
