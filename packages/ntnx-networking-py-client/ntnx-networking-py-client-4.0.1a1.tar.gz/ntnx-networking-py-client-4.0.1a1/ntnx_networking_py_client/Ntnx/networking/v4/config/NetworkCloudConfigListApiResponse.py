...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.NetworkCloudConfigListApiResponsedata import NetworkCloudConfigListApiResponsedata  # noqa: F401,E501
...
class NetworkCloudConfigListApiResponse(object):
    """NetworkCloudConfigListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.NetworkCloudConfigListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.NetworkCloudConfig] | networking.v4.error.ErrorResponse }`
