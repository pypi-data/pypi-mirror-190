...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.NetworkControllerListApiResponsedata import NetworkControllerListApiResponsedata  # noqa: F401,E501
...
class NetworkControllerListApiResponse(object):
    """NetworkControllerListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.NetworkControllerListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.NetworkController] | networking.v4.error.ErrorResponse }`
