...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.IPFIXExporterApiResponsedata import IPFIXExporterApiResponsedata  # noqa: F401,E501
...
class IPFIXExporterApiResponse(object):
    """IPFIXExporterApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.IPFIXExporterApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.IPFIXExporter | networking.v4.error.ErrorResponse }`
