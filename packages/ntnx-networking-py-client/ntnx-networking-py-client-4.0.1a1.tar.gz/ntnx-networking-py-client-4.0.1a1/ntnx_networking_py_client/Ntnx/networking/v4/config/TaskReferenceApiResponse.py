...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.TaskReferenceApiResponsedata import TaskReferenceApiResponsedata  # noqa: F401,E501
...
class TaskReferenceApiResponse(object):
    """TaskReferenceApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.TaskReferenceApiResponse'
    ...
    @property
    def data(self):
        """`{ prism.v4.config.TaskReference | networking.v4.error.ErrorResponse }`
