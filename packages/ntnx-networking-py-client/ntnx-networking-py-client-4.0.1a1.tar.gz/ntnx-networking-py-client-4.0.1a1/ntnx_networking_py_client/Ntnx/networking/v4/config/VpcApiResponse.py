...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.VpcApiResponsedata import VpcApiResponsedata  # noqa: F401,E501
...
class VpcApiResponse(object):
    """VpcApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.VpcApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.Vpc | networking.v4.error.ErrorResponse }`
