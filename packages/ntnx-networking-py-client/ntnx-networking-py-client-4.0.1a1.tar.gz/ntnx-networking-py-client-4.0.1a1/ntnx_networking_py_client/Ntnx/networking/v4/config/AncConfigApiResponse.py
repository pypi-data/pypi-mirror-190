...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.AncConfigApiResponsedata import AncConfigApiResponsedata  # noqa: F401,E501
...
class AncConfigApiResponse(object):
    """AncConfigApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.AncConfigApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.AncConfig | networking.v4.error.ErrorResponse }`
