...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.ClusterFlowStatusApiResponsedata import ClusterFlowStatusApiResponsedata  # noqa: F401,E501
...
class ClusterFlowStatusApiResponse(object):
    """ClusterFlowStatusApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.ClusterFlowStatusApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.ClusterFlowStatus | networking.v4.error.ErrorResponse }`
