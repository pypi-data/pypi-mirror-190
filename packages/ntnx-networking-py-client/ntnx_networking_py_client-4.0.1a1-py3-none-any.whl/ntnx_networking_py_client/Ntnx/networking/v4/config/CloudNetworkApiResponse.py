...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.CloudNetworkApiResponsedata import CloudNetworkApiResponsedata  # noqa: F401,E501
...
class CloudNetworkApiResponse(object):
    """CloudNetworkApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.CloudNetworkApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.CloudNetwork | networking.v4.error.ErrorResponse }`
