...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.BgpSessionApiResponsedata import BgpSessionApiResponsedata  # noqa: F401,E501
...
class BgpSessionApiResponse(object):
    """BgpSessionApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.BgpSessionApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.BgpSession | networking.v4.error.ErrorResponse }`
