...
import six
from ntnx_networking_py_client.Ntnx.networking.v4.config.ClusterStatus import ClusterStatus  # noqa: F401,E501
...
class ClusterFlowStatus(object):
    """ClusterFlowStatus - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.ClusterFlowStatus'
    ...
    def cluster_status_list(self):
        """`{ list[networking.v4.config.ClusterStatus] }`
