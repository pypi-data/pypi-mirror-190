...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.Layer2StretchApiResponsedata import Layer2StretchApiResponsedata  # noqa: F401,E501
...
class Layer2StretchApiResponse(object):
    """Layer2StretchApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.Layer2StretchApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.Layer2Stretch | networking.v4.error.ErrorResponse }`
