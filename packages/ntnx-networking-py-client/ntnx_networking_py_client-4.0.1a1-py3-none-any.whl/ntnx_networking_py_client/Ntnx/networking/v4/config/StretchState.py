...
class StretchState(object):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """StretchState - a model defined in Swagger
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.StretchState'

    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.StretchState'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(StretchState, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StretchState):
            return False
