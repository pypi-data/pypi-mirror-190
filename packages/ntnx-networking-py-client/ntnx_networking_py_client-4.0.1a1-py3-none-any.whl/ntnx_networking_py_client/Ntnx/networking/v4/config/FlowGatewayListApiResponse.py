...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.FlowGatewayListApiResponsedata import FlowGatewayListApiResponsedata  # noqa: F401,E501
...
class FlowGatewayListApiResponse(object):
    """FlowGatewayListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.FlowGatewayListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.FlowGateway] | networking.v4.error.ErrorResponse }`
