...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.VpnConnectionListApiResponsedata import VpnConnectionListApiResponsedata  # noqa: F401,E501
...
class VpnConnectionListApiResponse(object):
    """VpnConnectionListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.VpnConnectionListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.VpnConnection] | networking.v4.error.ErrorResponse }`
