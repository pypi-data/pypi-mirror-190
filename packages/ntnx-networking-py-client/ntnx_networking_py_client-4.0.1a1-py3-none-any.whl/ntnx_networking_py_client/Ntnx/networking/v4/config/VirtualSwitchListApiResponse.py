...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.VirtualSwitchListApiResponsedata import VirtualSwitchListApiResponsedata  # noqa: F401,E501
...
class VirtualSwitchListApiResponse(object):
    """VirtualSwitchListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.VirtualSwitchListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.VirtualSwitch] | networking.v4.error.ErrorResponse | list[networking.v4.config.VirtualSwitchProjection] }`
