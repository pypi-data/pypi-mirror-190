...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.BgpSessionListApiResponsedata import BgpSessionListApiResponsedata  # noqa: F401,E501
...
class BgpSessionListApiResponse(object):
    """BgpSessionListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.BgpSessionListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.BgpSession] | networking.v4.error.ErrorResponse }`
