...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.FloatingIpListApiResponsedata import FloatingIpListApiResponsedata  # noqa: F401,E501
...
class FloatingIpListApiResponse(object):
    """FloatingIpListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.FloatingIpListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.FloatingIp] | networking.v4.error.ErrorResponse }`
