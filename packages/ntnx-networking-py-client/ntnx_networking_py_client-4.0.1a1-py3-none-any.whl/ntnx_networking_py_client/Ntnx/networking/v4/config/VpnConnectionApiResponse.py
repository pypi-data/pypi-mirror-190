...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.VpnConnectionApiResponsedata import VpnConnectionApiResponsedata  # noqa: F401,E501
...
class VpnConnectionApiResponse(object):
    """VpnConnectionApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.VpnConnectionApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.VpnConnection | networking.v4.error.ErrorResponse }`
