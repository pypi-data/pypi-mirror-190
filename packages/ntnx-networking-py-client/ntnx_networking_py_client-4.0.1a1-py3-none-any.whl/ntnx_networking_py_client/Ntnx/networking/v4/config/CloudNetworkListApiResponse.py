...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.CloudNetworkListApiResponsedata import CloudNetworkListApiResponsedata  # noqa: F401,E501
...
class CloudNetworkListApiResponse(object):
    """CloudNetworkListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.CloudNetworkListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.CloudNetwork] | networking.v4.error.ErrorResponse }`
