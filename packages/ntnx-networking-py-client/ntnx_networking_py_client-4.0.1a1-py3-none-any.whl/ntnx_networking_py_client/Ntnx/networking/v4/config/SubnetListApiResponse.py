...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.SubnetListApiResponsedata import SubnetListApiResponsedata  # noqa: F401,E501
...
class SubnetListApiResponse(object):
    """SubnetListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.SubnetListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.Subnet] | networking.v4.error.ErrorResponse }`
