...
class IpReserveOutput(object):
    """IpReserveOutput - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.IpReserveOutput'

    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.IpReserveOutput'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(IpReserveOutput, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IpReserveOutput):
            return False
