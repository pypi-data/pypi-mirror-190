...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.NetworkControllerApiResponsedata import NetworkControllerApiResponsedata  # noqa: F401,E501
...
class NetworkControllerApiResponse(object):
    """NetworkControllerApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.NetworkControllerApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.NetworkController | networking.v4.error.ErrorResponse }`
