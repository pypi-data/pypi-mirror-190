...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.SubnetApiResponsedata import SubnetApiResponsedata  # noqa: F401,E501
...
class SubnetApiResponse(object):
    """SubnetApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.SubnetApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.Subnet | networking.v4.error.ErrorResponse }`
