...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.RouteTableApiResponsedata import RouteTableApiResponsedata  # noqa: F401,E501
...
class RouteTableApiResponse(object):
    """RouteTableApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.RouteTableApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.RouteTable | networking.v4.error.ErrorResponse }`
