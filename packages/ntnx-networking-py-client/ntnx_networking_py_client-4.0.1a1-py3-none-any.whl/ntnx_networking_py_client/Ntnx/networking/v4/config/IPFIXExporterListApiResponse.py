...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.IPFIXExporterListApiResponsedata import IPFIXExporterListApiResponsedata  # noqa: F401,E501
...
class IPFIXExporterListApiResponse(object):
    """IPFIXExporterListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.IPFIXExporterListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.IPFIXExporter] | networking.v4.error.ErrorResponse }`
