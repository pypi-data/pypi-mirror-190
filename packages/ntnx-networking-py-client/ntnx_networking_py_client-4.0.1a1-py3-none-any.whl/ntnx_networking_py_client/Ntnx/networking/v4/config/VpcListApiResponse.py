...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.VpcListApiResponsedata import VpcListApiResponsedata  # noqa: F401,E501
...
class VpcListApiResponse(object):
    """VpcListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.VpcListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[networking.v4.config.Vpc] | networking.v4.error.ErrorResponse }`
