...
class SubnetMigrationItem(object):
    """SubnetMigrationItem - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_object_type(self):
        return 'networking.v4.config.SubnetMigrationItem'

    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.SubnetMigrationItem'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SubnetMigrationItem, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubnetMigrationItem):
            return False
