...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.RoutingPolicyApiResponsedata import RoutingPolicyApiResponsedata  # noqa: F401,E501
...
class RoutingPolicyApiResponse(object):
    """RoutingPolicyApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.RoutingPolicyApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.RoutingPolicy | networking.v4.error.ErrorResponse }`
