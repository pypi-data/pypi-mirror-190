...
from ntnx_networking_py_client.Ntnx.OneOfnetworking.v4.config.FlowGatewayApiResponsedata import FlowGatewayApiResponsedata  # noqa: F401,E501
...
class FlowGatewayApiResponse(object):
    """FlowGatewayApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'networking.v4.r0.a1.config.FlowGatewayApiResponse'
    ...
    @property
    def data(self):
        """`{ networking.v4.config.FlowGateway | networking.v4.error.ErrorResponse }`
