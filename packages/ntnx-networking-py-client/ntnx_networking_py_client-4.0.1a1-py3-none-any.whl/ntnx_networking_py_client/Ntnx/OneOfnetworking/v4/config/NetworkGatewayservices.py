...
class NetworkGatewayservices(object):
    """NetworkGatewayservices - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.config.NetworkGatewayservices'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in NetworkGatewayservices.discriminator_value_class_map.values():
            return list(NetworkGatewayservices.discriminator_value_class_map.keys())[list(NetworkGatewayservices.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NetworkGatewayservices, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkGatewayservices):
            return False
