...
class SubnetApi(object):
    ...
    def create_subnet(self, body, **kwargs):  # noqa: E501
        ...
        :param networking.v4.config.Subnet body: Request schema to create the subnet. (required)
    ...
    def create_subnet_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/subnets', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_subnet(self, extId, **kwargs):  # noqa: E501
        ...
        :param str extId: The UUID of the subnet. (required)
        :param bool async_req:
        :return: networking.v4.config.TaskReferenceApiResponse
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_subnet_with_http_info(extId, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_subnet_with_http_info(extId, **kwargs)  # noqa: E501
            return data

    def delete_subnet_with_http_info(self, extId, **kwargs):  # noqa: E501
        """Delete the specified subnet.
        Delete the specified subnet.
        ...
        >>> thread = api.delete_subnet_with_http_info(extId, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/subnets/{extId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_subnet(self, extId, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_subnet_with_http_info(extId, **kwargs)  # noqa: E501
        else:
            (data) = self.get_subnet_with_http_info(extId, **kwargs)  # noqa: E501
            return data

    def get_subnet_with_http_info(self, extId, **kwargs):  # noqa: E501
        """Get the subnet with the specified UUID.
        Get a subnet with the specified UUID.
        ...
        >>> thread = api.get_subnet_with_http_info(extId, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/subnets/{extId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_subnets(self, **kwargs):  # noqa: E501
        ...
        >>> response = api.list_subnets((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby)
    ...
    def list_subnets_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/subnets', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_subnet(self, body, extId, **kwargs):  # noqa: E501
        """Update the specified subnet.
        Update the specified subnet.

        >>> response = api.update_subnet(body, extId)

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_subnet(body, extId, async_req=True)
        >>> result = thread.get()

        :param networking.v4.config.Subnet body: Request schema to update the specified subnet. (required)
        :param str extId: The UUID of the subnet. (required)
        :param bool async_req:
        :return: networking.v4.config.TaskReferenceApiResponse
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_subnet_with_http_info(body, extId, **kwargs)  # noqa: E501
        else:
            (data) = self.update_subnet_with_http_info(body, extId, **kwargs)  # noqa: E501
            return data

    def update_subnet_with_http_info(self, body, extId, **kwargs):  # noqa: E501
        """Update the specified subnet.
        Update the specified subnet.
        ...
        >>> thread = api.update_subnet_with_http_info(body, extId, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/networking/v4.0.a1/config/subnets/{extId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
