        ...
        try:
            ...
            if self._tracking and self._pipeline_json and self._model_json:
                ...
                if self._error_message:
                    ...
                    self._pass(f'Pipeline {status} with id {self._pipeline_id}')    
...
# -------------------------------------------------------------------------------
    ...
    def _run_pipeline_steps(self, model):
        ...
        try:
            ...
            self._error_message = f'Error! Failed to finish model pipeline. Error occurred when running {current_step}.\n{traceback.format_exc()}'
            if self._tracking:
