...
class Callbacks(models.Model):
    tenant = models.UUIDField(default=None, null=True, editable=False)
    businessid = models.UUIDField(default=None, null=True, editable=False)
    ...
    def __repr__(self):
        return f'Callbacks(tenant="{self.tenant}",businessid="{self.businessid}",reference="{self.reference}",callback="{self.callback}", request={self.request}, response={self.response})'
...
class IPN(models.Model):
    ...
    def __repr__(self):
        return f'IPN(tenant="{self.tenant}",businessid="{self.businessid}",client_id="{self.client_id}", bank_id="{self.bank_id}", country_code="{self.country_code}", account_number="{self.account_number}", ipn_type={self.ipn_type}, status={self.status})'
