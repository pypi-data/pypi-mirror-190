...
if __name__ == '__main__':
    ...
    detector = SCRFD(model_file='/home/hoangleminh/work_ceberus/face_reg/weights/scrfd_2.5g_kps.onnx')
    detector.prepare(-1)
    img_paths = ['/home/hoangleminh/work_ceberus/face_reg/images/test.jpg']
