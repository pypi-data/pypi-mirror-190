...
from lupin_grognard.core.format.clang_format import ClangFormater
...
def format(
    ...
    You can set GROG_CLANG_FORMAT env var in order to use the executable from your PATH"""
    formater = ClangFormater(name=clang_format)
