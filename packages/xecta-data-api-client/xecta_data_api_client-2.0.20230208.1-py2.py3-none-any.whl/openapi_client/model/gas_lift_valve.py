...
class GasLiftValve(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, xid, tubing_xid, source_id, source_mandrel_id, run_date, pull_date, glv_station, install_md, test_rack_open_pressure, surface_open_pressure, surface_close_pressure, port_size, *args, **kwargs):  # noqa: E501
