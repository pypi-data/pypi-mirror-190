...
def lazy_import():
    ...
    globals()['WellTimezone'] = WellTimezone
...
class Well(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'lat': (float,),  # noqa: E501
            'lon': (float,),  # noqa: E501
            'timezone': (WellTimezone,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, xid, source_id, uwi, name, lat, lon, timezone, *args, **kwargs):  # noqa: E501
