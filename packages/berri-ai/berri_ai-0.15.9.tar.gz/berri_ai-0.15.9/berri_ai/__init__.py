...
def docQAPipeline(user_email: str, open_ai_key: str, input_url_or_list: Union[str, List[str]], language: Optional[str] = None):
  ...
  try:
    ...
    print("debug output - type of input_url_or_list: ", input_url_or_list)
    if isinstance(input_url_or_list, str):
      ...
      for item in input_url_or_list:
        ...
        if language == None:
          ...
          DocStore([documentData], language)
