...
dictionary_extractors.append(
    DictionaryExtractor('../../data/nga/ressources/leaveType', 'LeaveType', case_sensitive=False))
...
dictionary_extractors.append(
    DictionaryExtractor('../../data/corpora/gazetteers/Job_Functions.txt', 'JobFunction', case_sensitive=False))
dictionary_extractors.append(
    DictionaryExtractor('../../data/nga/ressources/allowances', 'Allowance', case_sensitive=False))
dictionary_extractors.append(DictionaryExtractor('../../data/nga/ressources/changerequests', entity_type=None))
dictionary_extractors.append(
    DictionaryExtractor('../../data/nga/ressources/payelements', 'PayElement', case_sensitive=False))
dictionary_extractors.append(DictionaryExtractor('../../data/nga/ressources/payforms', 'payForm', case_sensitive=False))
dictionary_extractors.append(
    DictionaryExtractor('../../data/nga/ressources/ReportNames', 'ReportName', case_sensitive=False))
