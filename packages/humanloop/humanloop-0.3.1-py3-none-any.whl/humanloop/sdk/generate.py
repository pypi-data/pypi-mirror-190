...
def generate_canonical():
    """Creates a generation with a project's active deployment.

    Mention app - can change in app

    All 3 generates should share same.
    """


def generate_with_model_config():
    """Creates a generation with a specific model config.

    ID or parameters"""


def generate_with_experiment(experiment_id: str):
    """Creates a generation with a specific experiment."""
