...
setup(
    ...
    install_requires=['collibra_core==2.0.0.post7', 'collibra_importer==2.0.0.post6', 'cryptography==38.0.1', 'luluigi==3.2.0igi', 'python-dotenv==0.20.0', 'toml==0.10.2', 'requests==2.27.1', 'apache_beam==2.42.0']
)
