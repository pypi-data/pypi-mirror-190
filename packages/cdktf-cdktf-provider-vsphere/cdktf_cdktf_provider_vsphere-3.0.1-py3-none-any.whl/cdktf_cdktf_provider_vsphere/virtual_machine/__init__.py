...
class VirtualMachine(
    ...
    def __init__(
        ...
        *,
        ...
        :param extra_config_reboot_required: Allow the virtual machine to be rebooted when a change to ``extra_config`` occurs. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#extra_config_reboot_required VirtualMachine#extra_config_reboot_required}
...
class VirtualMachineNetworkInterface:
    def __init__(
        ...
        *,
        ...
        :param adapter_type: The controller type. Can be one of e1000, e1000e, vmxnet3, or vrdma. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/vsphere/r/virtual_machine#adapter_type VirtualMachine#adapter_type}
