...
def instance_configure(
    ...
    if creating and upgrading_from is None and base.enabled(instance, settings):
        ...
        revert_init(ctx, service, settings, instance.datadir)
    ...
    if upgrading_from is not None:
        ...
        init(ctx, service, settings, instance.datadir)
...
def backup(
    ...
    *,
    ...
    return ctx.run(cmd, check=True, env=env)
...
def expire_command(
    ...
    """
    return base.make_cmd(service.stanza, settings, "expire")
