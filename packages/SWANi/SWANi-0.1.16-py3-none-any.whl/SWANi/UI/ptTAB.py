...
class ptTAB(QTabWidget):
    ...
    def wfExecTabUI(self):
        ...
        self.ptConfigButton = QPushButton(APPLABELS.PTCONFIGBUTTONTEXT)
    ...
    def onWfTypeChanged(self,index):
        self.ptConfig['WF_OPTION']['wfType']=str(index)
        self.ptConfig.save()
        self.reset_wf()
    ...
    def genWF(self):
        ...
        self.wf.add_input_folders(self.SWANiGlobalConfig,self.ptConfig,self.check_input,self.mainWindow.freesurfer)
    ...
    def SWANiSlicer_thread(self):
        ...
        slicerThread=SWANiSlicer(self.SWANiGlobalConfig['MAIN']['slicerPath'],self.ptFolder,self.SWANiGlobalConfig['MAIN']['slicerSceneExt'],parent=self)
    ...
    def loadPt(self):
        ...
        self.ptConfig=SWANiConfig(self.ptFolder)
        ...
        for inputName in self.inputReport:
            ...
            self.DirectoryWatcher.addPath(os.path.join(self.ptFolder,self.SWANiGlobalConfig['DEFAULTFOLDERS']['default_'+inputName+'_folder']))
