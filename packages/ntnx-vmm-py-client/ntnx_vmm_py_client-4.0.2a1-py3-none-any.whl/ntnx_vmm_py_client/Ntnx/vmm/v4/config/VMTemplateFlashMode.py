...
class VMTemplateFlashMode(object):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """VMTemplateFlashMode - a model defined in Swagger
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.config.VMTemplateFlashMode'

    def _initialize_fq_object_type(self):
        return 'vmm.v4.r0.a1.config.VMTemplateFlashMode'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VMTemplateFlashMode, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VMTemplateFlashMode):
            return False
