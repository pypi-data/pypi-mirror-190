...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        'vmm.v4.config.GpuMode' : 'ConfigGpuMode',
        'vmm.v4.config.PowerState' : 'ConfigPowerState',
        'vmm.v4.images.CategoryReference' : 'ImagesCategoryReference',
        'vmm.v4.ahv.config.NetworkFunctionNicType' : 'AhvConfigNetworkFunctionNicType',
        ...
        'vmm.v4.config.Sysprep' : 'ConfigSysprep',
        'vmm.v4.ahv.config.MachineType' : 'AhvConfigMachineType',
        'vmm.v4.ahv.config.GpuVendor' : 'AhvConfigGpuVendor',
        'vmm.v4.ahv.config.NicType' : 'AhvConfigNicType',
        'vmm.v4.config.NetworkFunctionNicType' : 'ConfigNetworkFunctionNicType',
        'vmm.v4.ahv.config.GpuMode' : 'AhvConfigGpuMode',
        'vmm.v4.ahv.config.ImageReference' : 'AhvConfigImageReference',
        'vmm.v4.ahv.config.CloudInit' : 'AhvConfigCloudInit',
        'vmm.v4.ahv.config.EnforcementMode' : 'AhvConfigEnforcementMode',
        'vmm.v4.config.VlanMode' : 'ConfigVlanMode',
        'vmm.v4.config.CloudInit' : 'ConfigCloudInit',
        'vmm.v4.config.MachineType' : 'ConfigMachineType',
        'vmm.v4.images.ClusterReference' : 'ImagesClusterReference',
        'vmm.v4.config.GpuVendor' : 'ConfigGpuVendor',
        'vmm.v4.images.EnforcementMode' : 'ImagesEnforcementMode',
        'vmm.v4.ahv.config.PowerState' : 'AhvConfigPowerState',
        'vmm.v4.config.NicType' : 'ConfigNicType',
        'vmm.v4.ahv.config.Sysprep' : 'AhvConfigSysprep',
        'vmm.v4.ahv.config.VlanMode' : 'AhvConfigVlanMode'
    }
    ...
    def __get_request_timeout(self, request_timeout):
        ...
        :param request_timeout: A list [connect, read] for the request timeouts in milliseconds for an operation
        """
    ...
    def call_api(self, resource_path, method,
        ...
        :param _request_timeout: timeout setting for this request. It needs to be a pair (list) of
                                 ...
                                 the timeouts will be derived from the configuration.
        :return:
