...
def init_args():
    ...
    parser.add_argument(
        "--det_model_dir", type=str, default=os.path.join(root_path, "ch_PP-OCRv3_det_infer/")
    )
    ...
    parser.add_argument(
        "--rec_model_dir", type=str, default=os.path.join(root_path, "ch_PP-OCRv3_rec_infer/")
    )
