...
def init_args():
    ...
    parser.add_argument(
        "--det_model_dir", type=str, default="./deprem_ocr/ch_PP-OCRv3_det_infer/"
    )
    ...
    parser.add_argument(
        "--rec_model_dir", type=str, default="./deprem_ocr/ch_PP-OCRv3_rec_infer/"
    )
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default="./deprem_ocr/ppocr/ppocr_keys_v1.txt",
    )
