...
class DepremOCR:
    ...
    def __download_models(self):
        ...
        det_model_path = os.path.join(PROJECT_ROOT, "ch_PP-OCRv3_det_infer.tar")
        ...
        rec_model_path = os.path.join(PROJECT_ROOT, "ch_PP-OCRv3_rec_infer.tar")
