...
def init_args():
    PROJECT_ROOT = os.path.join(expanduser("~"), ".cache")
    ...
    parser.add_argument(
        "--det_model_dir", type=str, default=os.path.join(PROJECT_ROOT, "ch_PP-OCRv3_det_infer/")
    )
    ...
    parser.add_argument(
        "--rec_model_dir", type=str, default=os.path.join(PROJECT_ROOT, "ch_PP-OCRv3_rec_infer/")
    )
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default=os.path.join(PROJECT_ROOT, "ppocr/ppocr_keys_v1.txt"),
    )
