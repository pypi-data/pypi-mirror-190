...
#   to be called by the prjDataReadyFcnP() in order to set 
#   ambient boundary conditions for steady-state initialization.
# NOTE: No parameters in order to utilize as argument to cxLib 
#   constructor.
#
...
def main():
    ...
    myPrj = cxLib(0, True, setWthCtmInit)
    ...
    #----------------------------------------------------------------
    myPrj.setupSimulation(prjPath, 1)
