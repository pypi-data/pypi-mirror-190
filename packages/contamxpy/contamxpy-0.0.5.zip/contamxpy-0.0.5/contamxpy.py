...
#========================================================== class cxLib  =====#
class cxLib:
    """cxLib provides a wrapper around ``contamx-lib``.
    ...
    wthFunc : (function name), optional
    ...
    """
    def __init__( self, wp: int = 0, cb: bool = False, wthFunc = None):
        ...
        self.wthInitFunction = wthFunc
        """Weather and contaminant boundary condition initialization function.

        Used to set ambient conditions prior to running steady-state initialization.
        """
...
def prjDataReadyFcnP(state, handle):
    ...
    ----------
    state
        The *ContamXState* obtained from ``contamx-lib`` upon instantiation of an :py:class:`cxLib` object.
    handle
