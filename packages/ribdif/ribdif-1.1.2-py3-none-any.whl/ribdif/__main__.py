...
def arg_handling_evaluate(args, workingDir):
...
def evaluate():
    ...
    #Argument handeling
    genus, primer_file, outdir, rerun = arg_handling_evaluate(args, workingDir)
...
def correct():
    ...
    args = correcting.parse_args()
    
    genus, primer_file, outdir, rerun = correcting.arg_handling(args, workingDir)
