...
class discrete():
    ...
    #Exports Wiggles type signal to SciLab Syntax
    def to_scilab(self):
    ...
    #Exports Wiggles type signal to Matlab Syntax
    def to_matlab(self):
        x_scilab_string = self.ylabel+'=['
        t_scilab_string = self.xlabel+'=['
        for item in self.x:
    ...
    #Exports Wiggles type signal to C Syntax
    def to_c(self):
    ...
    #Exports Wiggles type signal to cpp Syntax
    def to_cpp(self):
    ...
    #Exports Wiggles type signal to Java Syntax
    def to_java(self):
    ...
    def fft(self):
        change = copy.deepcopy(self)
        change.x = np.fft.fft(change.x)
        change.t = np.fft.fftfreq(len(change.x), d=(change.t[1]-change.t[0]))
        change.xlabel = "Frequency"
        change.ylabel = "Amplitude"
        return change
