...
NAME = 'hai-gui-framework'
DESCRIPTION = 'HaiGF is the Hakutaku Artificial Intelligence (HAI) GUI Framework, which provides a set of APIs for building GUI applications in HAI Platform.'
URL = 'https://github.com/zhangzhengde0225/hai-gui-framework'
EMAIL = 'drivener@163.com'
AUTHOR = 'Zhengde Zhang'
REQUIRES_PYTHON = '>=3.6.0'

with open(f'HaiGF/version.py') as f:
    data = f.readlines()
    for line in data:
...
setup(
    ...
    data_files=[
        ('HaiGF/gui_framework', ['config/default_config.yaml', 'icons/*'])
        ],
