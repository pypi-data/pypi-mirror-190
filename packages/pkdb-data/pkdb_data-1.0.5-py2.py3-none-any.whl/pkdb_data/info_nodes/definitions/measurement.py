...
MEASUREMENT_NODES.extend(
    [
        ...
        MeasurementType(
            ...
            label="Total peripheral resistance (TPR)",
            description="Total peripheral resistance (TPR).",
            parents=["cardiovascular measurement"],
            dtype=DType.NUMERIC,
            units=[DIMENSIONLESS],  # FIXME: units unclear
            annotations=[],
            synonyms=["TPR", "Peripheral vascular resistance", "PVR"],
        ),
        MeasurementType(
            sid="pcwp",
            ...
            synonyms=["PCWP", "Pulmonary artery wedge pressure"],
        ),
        MeasurementType(
            sid="pap",
            name="pulmonary artery pressure (PAP)",
            label="Pulmonary artery pressure (PAP). Blood pressure in the pulmonary "
        ...
        MeasurementType(
            ...
            synonyms=["resting heart rate", "HR"],
        ),
        MeasurementType(
            sid="ehr",
            name="EHR",
