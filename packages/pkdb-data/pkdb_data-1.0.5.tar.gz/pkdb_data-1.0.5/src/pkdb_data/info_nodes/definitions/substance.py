...
SUBSTANCE_NODES: List[InfoNode] = [
    ...
    Substance(
        sid="ramiprilat-diketopiperazine",
        name="ramiprilat diketopiperazine",
        description="Ramiprilat Diketopiperazine.",
        annotations=[
            (BQB.IS, "pubchem.compound/46782857"),
            (BQB.IS, "inchikey/DZRWPCCIYKIPJW-RFZHGLQHSA-N"),
        ],
        synonyms=["ramipril DKP"],
    ),
    Substance(
        ...
        synonyms=["ramipril DKP acid"],
    ),
    # Substance(
    #     sid="px/caf",
    #     label="ramipril",
    #     description="Ramipril secondary metabolites. All metabolites beside ramipril.",
    #     parents=["px", "caf"],
    #     synonyms=["17X/137X"],
    # ),
    Substance(
    ...
    Substance(
        ...
        annotations=[
            ...
            (BQB.IS_VERSION_OF, "pubmed/P00797"),
        ],
    ),
    # ----------------------
    # bicarbonate
