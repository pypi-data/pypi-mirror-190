...
- sidebarContent (a list of or a singular dash component, string or number; optional):
    ...
    _type = 'EALayout'
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, className=Component.UNDEFINED, drawerContent=Component.UNDEFINED, headerContent=Component.UNDEFINED, sidebarContent=Component.UNDEFINED, open=Component.UNDEFINED, showLeftHandNav=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'drawerContent', 'headerContent', 'open', 'showLeftHandNav', 'sidebarContent']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'drawerContent', 'headerContent', 'open', 'showLeftHandNav', 'sidebarContent']
