...
class ProQuo:
    ...
    def __init__(self, reference_model: Model, reference_vectorizer: ReferenceVectorizer,
                 relation_model: TFPreTrainedModel, relation_vectorizer: RelationVectorizerBert, open_quote: str,
                 close_quote: str):
        """
    ...
    def __search_single_word(self, quote: Quote, source_text: str, search_space_start: int, search_space_end: int,
