...
class NioConanFile(ConanFile):
    ...
    def disk_image(self, images_output="disk.img"):
        ...
        output = {
            ...
            'uboot': os.path.join(sel4_sysroot, 'platform', self.platform, 'uboot-' + self.platform + '.bin'),
            'initrd': os.path.join(sel4_sysroot, 'platform', self.platform, 'images/proc-image-arm-s32g2'),
            'dtb': os.path.join(sel4_sysroot, 'platform', self.platform, 'images/kernel.dtb'),
        }
