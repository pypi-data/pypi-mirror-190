...
class QuickBoot(Uboot):
    ...
    def config_net(self):
        ...
        # self.command("env print ipaddr", True)
        # self.command("env print netmask", True)
        # self.command("env print serverip", True)
...
def main():
    root = {
        ...
        'kernel_dtb': '/Users/zhiguo.zhu/.conan/data/sel4-osf/develop/_/_/package/a5ad5696abf650a25eea8f377806b3d5fe234e6e/platform/rdb2/kernel.dtb',
    }
