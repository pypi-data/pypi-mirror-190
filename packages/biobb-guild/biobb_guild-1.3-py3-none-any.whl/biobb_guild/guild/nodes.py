...
class Nodes(BiobbObject):
    ...
    def __init__(self, input_file_path1, input_file_path2, input_file_dataset, output_sif_path,
...
def nodes(input_file_path1: str, input_file_path2: str, input_file_dataset: str, output_sif_path: str, properties: dict = None, **kwargs) -> int:
    ...
    return Nodes(input_file_path1=input_file_path1,
...
def main():
    ...
    nodes(input_file_path1=args.input_interactome,
