    ...
    with tempfile.NamedTemporaryFile(suffix=".png") as fp:
        try:
            if valid_url(image_b_url):
                ...
                # image_2 = Image.open(fp.name)
        except:
            pass
    print("{} {}".format(image_a_md5, image_a_url))
    print("{} {}".format(image_b_md5, image_b_url))
...
if __name__ == '__main__':
    ...
    a = "https://goodiegoodie.co.nz/wp-content/uploads/2023/02/placeholder_v1-127.png"
    b = "https://images.megabit.co.nz/images/megaplus/logo/placeholder_v1.png"
    a = "https://goodie.megaplus.co.nz/static/upload/imgs/8d272fa4de1e47e3b5df8c593612ed9e.jpg"
    b = "https://goodiegoodie.co.nz/wp-content/uploads/2023/02/8d272fa4de1e47e3b5df8c593612ed9e-1.jpg"
