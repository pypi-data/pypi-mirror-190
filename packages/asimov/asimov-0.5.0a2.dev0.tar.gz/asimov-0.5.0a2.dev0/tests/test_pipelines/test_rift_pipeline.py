...
class RiftTests(unittest.TestCase):
    ...
    #     with contextlib.redirect_stdout(f):
    #         apply_page(
    #             file=f"https://git.ligo.org/asimov/data/-/raw/main/defaults/production-pe.yaml",
    #             event=None,
    #             ledger=self.ledger,
    #         )
    #         apply_page(
    ...
    #         pipeline = "rift"
    #         apply_page(
    #             file=f"https://git.ligo.org/asimov/data/-/raw/main/tests/{event}.yaml",
    #             event=None,
    #             ledger=self.ledger,
    #         )
    #         apply_page(
    #             file=f"{self.cwd}/tests/test_data/test_{pipeline}.yaml",
    #             event=event,
    #             ledger=self.ledger,
    #         )
