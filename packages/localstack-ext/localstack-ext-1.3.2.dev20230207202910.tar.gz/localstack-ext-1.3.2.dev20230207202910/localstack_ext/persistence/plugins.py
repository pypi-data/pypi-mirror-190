...
def register_restricted_pods_api():from localstack.services.edge import ROUTER as A;from localstack_ext.persistence.pods_api import CloudPodsRestrictedApi as B;A.add(B())
@hooks.on_infra_start()
def register_public_pods_api():from localstack.services.edge import ROUTER as A;from localstack_ext.bootstrap.pods.server_api import CloudPodsPublicApi as B;A.add(B())
@hooks.on_infra_start(should_load=api_key_configured)
