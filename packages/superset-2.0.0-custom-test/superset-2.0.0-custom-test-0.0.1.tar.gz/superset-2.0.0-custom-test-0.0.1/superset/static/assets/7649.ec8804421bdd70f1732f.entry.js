"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[7649,5296],{50948:(t,e,a)=>{a.d(e,{Z:()=>h});var i=a(51995),o=a(11965),s=a(61988),n=a(94184),r=a.n(n),l=a(13423),c=a(67294),d=a(70163),u=a(1927);const m=i.iK.div`
  display: flex;
...
`;function h({toast:t,onCloseToast:e}){const a=(0,c.useRef)(),[i,n]=(0,c.useState)(!1),h=()=>{n(!0)},_=(0,c.useCallback)((()=>{a.current&&clearTimeout(a.current),n((()=>(setTimeout((()=>{e(t.id)}),150),!1)))}),[e,t.id]);(0,c.useEffect)((()=>(setTimeout(h),t.duration>0&&(a.current=setTimeout(_,t.duration)),()=>{a.current&&clearTimeout(a.current)})),[_,t.duration]);let b="toast--success",f=(0,o.tZ)(d.Z.CircleCheckSolid,{css:t=>p(t)});return t.toastType===u.p.WARNING?(f=(0,o.tZ)(d.Z.WarningSolid,{css:p}),b="toast--warning"):t.toastType===u.p.DANGER?(f=(0,o.tZ)(d.Z.ErrorSolid,{css:p}),b="toast--danger"):t.toastType===u.p.INFO&&(f=(0,o.tZ)(d.Z.InfoSolid,{css:p}),b="toast--info"),(0,o.tZ)(m,{className:r()("alert","toast",i&&"toast--visible",b),role:"alert"},f,(0,o.tZ)(l.ZP,{content:t.text}),(0,o.tZ)("i",{className:"fa fa-close pull-right pointer",role:"button",tabIndex:0,onClick:_,"aria-label":(0,s.t)("Close")}))}},5667:(t,e,a)=>{a.d(e,{Z:()=>r});var i=a(14890),o=a(37703),s=a(37355),n=a(72570);const r=(0,o.$j)((({messageToasts:t})=>({toasts:t})),(t=>(0,i.DE)({removeToast:n.RS},t)))(s.Z)},37355:(t,e,a)=>{a.d(e,{Z:()=>l});var i=a(67294),o=a(51995),s=a(50948),n=a(11965);const r=o.iK.div`
  max-width: 600px;
  position: fixed;
