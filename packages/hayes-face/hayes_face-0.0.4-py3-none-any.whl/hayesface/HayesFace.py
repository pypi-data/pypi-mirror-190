...
from hayesface.model import retinaface_model
from hayesface.commons import preprocess, postprocess
...
def extract_faces(img, threshold=0.9, model = None, align = True, allow_upscaling = True):
