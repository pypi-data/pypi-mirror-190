...
KUBERNETES_USE_LOCAL_SERVICE_HEADERS = from_conf(
    "KUBERNETES_USE_LOCAL_SERVICE_HEADERS", True
)
KUBERNETES_SECRETS_FOR_ARGO_WORKFLOWS = from_conf(
    "KUBERNETES_SECRETS_FOR_ARGO_WORKFLOWS", ""
)
