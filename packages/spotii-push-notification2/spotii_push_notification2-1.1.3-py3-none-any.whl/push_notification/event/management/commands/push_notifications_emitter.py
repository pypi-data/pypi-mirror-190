...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        print("push notifications emitter started", end='\r')
        ...
        while True:
            ...
            try:
                with transaction.atomic():
                    ...
                    print(
                        "proccessing {} events".format(events_len), end='\r'
                    )
    ...
    async def emit(self, session: aiohttp.ClientSession, event: PushNotificationEvent):
        print(
            "emit event {}".format(event.event_id), end='\r')
        ...
        try:
            ...
            print(
                "event {} has been delivered to {}".format(
                    event.event_id, res.url), end='\r'
            )
        except Exception as e:
            print(
                "error while delivering the event {}, retry {}: {}".format(
                    event.event_id, event.retry, str(e)), end='\r'
            )
        finally:
