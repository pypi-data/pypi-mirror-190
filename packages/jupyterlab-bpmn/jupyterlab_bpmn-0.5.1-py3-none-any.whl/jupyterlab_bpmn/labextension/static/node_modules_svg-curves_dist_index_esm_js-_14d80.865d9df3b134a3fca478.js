"use strict";
(self["webpackChunkjupyterlab_bpmn"] = self["webpackChunkjupyterlab_bpmn"] || []).push([["node_modules_svg-curves_dist_index_esm_js-_14d80"],{

/***/ "./node_modules/svg-curves/dist/index.esm.js":
/*!***************************************************!*\
  !*** ./node_modules/svg-curves/dist/index.esm.js ***!
  \***************************************************/
...
function createCurve(points, attrs = {}) {
  var path = (0,tiny_svg__WEBPACK_IMPORTED_MODULE_0__.create)('path');

  var data = getData(points);

  (0,tiny_svg__WEBPACK_IMPORTED_MODULE_0__.attr)(path, (0,min_dash__WEBPACK_IMPORTED_MODULE_1__.assign)({}, DEFAULT_ATTRS, attrs, {
    d: data
  }));
...
function getData(points) {
  ...
  ].concat((0,min_dash__WEBPACK_IMPORTED_MODULE_1__.map)(segments, function(segment) {
...
//# sourceMappingURL=node_modules_svg-curves_dist_index_esm_js-_14d80.865d9df3b134a3fca478.js.map