...
model = pkg_resources.resource_stream(__name__, '/tmp/nn4.small2.v1.t7')
...
def get_faces(record):
    ...
    # Load the cascade
    face_model = pkg_resources.resource_stream(__name__, '/tmp/haarcascade_frontalface_default.xml')
