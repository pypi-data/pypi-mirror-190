...
class Tiles(Element2D):
    ...
    def lon_lat_to_easting_northing(longitude, latitude):
        ...
        See docstring for holoviews_samap.util.transform.lon_lat_to_easting_northing
    ...
    def easting_northing_to_lon_lat(easting, northing):
        ...
        See docstring for holoviews_samap.util.transform.easting_northing_to_lon_lat
        for more information
        """
