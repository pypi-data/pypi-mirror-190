...
from holoviews_samap.plotting.plotly import PlotlyRenderer, DynamicMap
from holoviews_samap.plotting.plotly.util import clean_internal_figure_properties
from holoviews_samap.core.decollate import (
    initialize_dynamic, to_expr_extract_streams, expr_to_fn_of_stream_contents
)
from holoviews_samap.streams import Derived, History
from holoviews_samap.plotting.plotly.callbacks import (
...
def to_function_spec(hvobj):
    ...
    This borrows the low-level holoviews_samap decollate logic, but instead of returning
