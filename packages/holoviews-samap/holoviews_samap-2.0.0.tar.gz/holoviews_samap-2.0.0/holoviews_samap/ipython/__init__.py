...
class notebook_extension(extension):
    ...
    def __call__(self, *args, **params):
        ...
        try:
            ...
            try:
                ...
                holoviews_samap.archive = notebook_archive
        ...
        if 'matplotlib' in Store.renderers and not notebook_extension._loaded:
            ...
            holoviews_samap.archive.exporters = [svg_exporter] + holoviews_samap.archive.exporters
        ...
        for r in [r for r in resources if r != 'holoviews_samap']:
    ...
    def _get_resources(self, args, params):
        ...
        resources = []
        disabled = []
        for resource in ['holoviews_samap'] + list(Store.renderers.keys()):
            if resource in args:
        ...
        if ('holoviews_samap' not in disabled) and ('holoviews_samap' not in resources):
            resources = ['holoviews_samap'] + resources
        return resources
