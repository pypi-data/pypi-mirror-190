...
try:
    from holoviews_samap.plotting import mpl # noqa Register backend
except:
    raise SkipTest('Matplotlib backend not available.')

from holoviews_samap import Overlay, Curve, Image, HoloMap
from holoviews_samap.core.options import Store, StoreOptions
