...
from holoviews_samap.core import HoloMap, NdOverlay, Overlay, GridSpace, DynamicMap
from holoviews_samap.element import Points
from holoviews_samap.element.comparison import ComparisonTestCase
from holoviews_samap.streams import Stream, PlotSize, RangeXY

try:
    from holoviews_samap.operation.datashader import spread, datashade
except:
...
class TestDecollation(ComparisonTestCase):
    def setUp(self):
        from holoviews_samap.tests.test_streams import Sum, Val
    ...
    def test_traverse_derived_streams(self):
        from holoviews_samap.tests.test_streams import Val
