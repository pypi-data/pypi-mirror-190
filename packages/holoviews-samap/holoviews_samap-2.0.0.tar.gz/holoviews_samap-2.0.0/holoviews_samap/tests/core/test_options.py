...
from holoviews_samap import Store, Histogram, Image, Curve, Points, DynamicMap, opts
from holoviews_samap.core.options import (
...
from holoviews_samap import plotting              # noqa Register backends

Options.skip_invalid = False

try:
    # Needed a backend to register backend and options
    from holoviews_samap.plotting import mpl # noqa
except:
    pass

try:
    # Needed to register backend  and options
    from holoviews_samap.plotting import bokeh # noqa
except:
    pass

try:
    # Needed to register backend  and options
    from holoviews_samap.plotting import plotly # noqa
except:
    pass
...
class TestLookupOptions(ComparisonTestCase):
    ...
    def test_lookup_options_honors_backend(self):
        ...
        try:
            import holoviews_samap.plotting.matplotlib # noqa
        except:
            pass
        ...
        try:
            import holoviews_samap.plotting.plotly # noqa
        except:
            pass
