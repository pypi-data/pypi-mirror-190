...
from holoviews_samap import NdOverlay, Overlay, Dimension
from holoviews_samap.core.spaces import DynamicMap, HoloMap
from holoviews_samap.core.options import Store, Cycle
from holoviews_samap.element.comparison import ComparisonTestCase
from holoviews_samap.element import (Image, Scatter, Curve, Points,
                               Area, VectorField, HLine, Path)
from holoviews_samap.operation import operation
from holoviews_samap.plotting.util import (
...
from holoviews_samap.streams import PointerX

try:
    from holoviews_samap.plotting.bokeh import util
...
class TestMPLColormapUtils(ComparisonTestCase):
    ...
    def setUp(self):
        try:
            ...
            import holoviews_samap.plotting.mpl # noqa
        except:
...
class TestBokehPaletteUtils(ComparisonTestCase):
    ...
    def setUp(self):
        try:
            ...
            import holoviews_samap.plotting.bokeh # noqa
        except:
