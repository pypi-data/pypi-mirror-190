...
from holoviews_samap.element import Table
from holoviews_samap.element.comparison import ComparisonTestCase
from holoviews_samap.streams import CDSStream, Stream
...
try:
    ...
    from holoviews_samap.plotting.bokeh.callbacks import CDSCallback
