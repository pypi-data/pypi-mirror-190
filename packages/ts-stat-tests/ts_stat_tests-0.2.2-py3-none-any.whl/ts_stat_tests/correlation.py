...
def acf(
    ...
    r"""
    !!! summary "Summary"
        Calculate the autocorrelation function.<br>
        Full name: Auto-Correlation Function.<br>
    ...
    Args:
        ...
        adjusted (bool, optional):
            ...
            Defaults to `False`.
        nlags (int, optional):
            Number of lags to return autocorrelation for. If not provided, uses $min(10 \times np.log10(nobs), nobs - 1)$. The returned value includes $lag 0$ (ie., $1$) so size of the acf vector is $(nlags + 1,)$.<br>
            Defaults to `None`.
        qstat (bool, optional):
    ...
    ??? tip "See Also"
        ...
        - [`ts_stat_tests.correlation.ccf`][src.ts_stat_tests.correlation.ccf]: The cross-correlation function.
    """
    return st_acf(
        x=x,
        adjusted=adjusted,
...
def pacf(
    ...
    r"""
    !!! summary "Summary"
        Partial autocorrelation estimate.<br>
        Full name: Partial Auto-Correlation Function.<br>
    ...
    Args:
        ...
        nlags (int, optional):
            Number of lags to return autocorrelation for. If not provided, uses $min(10 \times np.log10(nobs), nobs // 2 - 1)$. The returned value includes lag `0` (ie., `1`) so size of the pacf vector is $(nlags + 1,)$.<br>
            Defaults to `None`.
        method (str, optional):
...
def ccf(
    ...
    """
    !!! summary "Summary"
        The cross-correlation function.<br>
        Full name: Cross-Correlation function.<br>
...
def alb(
    ...
    r"""
    !!! summary "Summary"
        Ljung-Box test of autocorrelation in residuals.<br>
        Full name: Ljung-Box test for autocorrelation in residuals.<br>
    ...
    Args:
        x (array_like, optional):
            The data series. The data is demeaned before the test statistic is computed.<br>
            Defaults to `array_like`.
        lags (Union[int, array_like], optional):
            If lags is an integer (`int`) then this is taken to be the largest lag that is included, the test result is reported for all smaller lag length. If lags is a list or array, then all lags are included up to the largest lag in the list, however only the tests for the lags in the list are reported. If lags is `None`, then the default maxlag is currently $min((nobs // 2 - 2), 40)$. After $0.12$ this will change to $min(10, nobs // 5)$. The default number of `lags` changes if `period` is set.<br>
            Defaults to `None`.
        ...
        model_df (int, optional):
            ...
            Defaults to `0`.
        period (int, optional):
            The period of a Seasonal time series. Used to compute the max lag for seasonal data which uses $min(2*period, nobs // 5)$ if set. If `None`, then the default rule is used to set the number of lags. When set, must be $>= 2$.<br>
            Defaults to `None`.
        return_df (bool, optional):
            Flag indicating whether to return the result as a single DataFrame with columns `lb_stat`, `lb_pvalue`, and optionally `bp_stat` and `bp_pvalue`. After $0.12$, this will become the only return method. Set to `True` to return the DataFrame or `False` to continue returning the $2 - 4$ output. If `None` (the default), a warning is raised.<br>
            Defaults to `True`.
    ...
    Returns:
        ...
        pvalue (Union[float, np.ndarray]):
            The p-value based on chi-square distribution. The p-value is computed as $1.0 - chi2.cdf(lbvalue, dof)$ where $dof$ is $lag - model\_df$. If $lag - model\_df <= 0$, then `NaN` is returned for the `pvalue`.
    ...
    ??? tip "See Also"
        ...
        - [`ts_stat_tests.correlation.alb`][src.ts_stat_tests.correlation.alb]: Ljung-Box test of autocorrelation in residuals.
        - [`ts_stat_tests.correlation.alm`][src.ts_stat_tests.correlation.alm]: Lagrange Multiplier tests for autocorrelation.
        - [`ts_stat_tests.correlation.abg`][src.ts_stat_tests.correlation.abg]: Breusch-Godfrey Lagrange Multiplier tests for residual autocorrelation.
    """
...
def alm(
    ...
    *,
    ...
    """
    !!! summary "Summary"
        Lagrange Multiplier tests for autocorrelation.<br>
        Full name: Lagrange Multiplier tests for autocorrelation.<br>
    ...
    Args:
        ...
        store (bool, optional):
            ...
            Defaults to `False`.
        period (int, optional):
            The period of a Seasonal time series. Used to compute the max lag for seasonal data which uses $min(2 \\times period, nobs // 5)$ if set. If `None`, then the default rule is used to set the number of lags. When set, must be $>=$ `2`.<br>
            Defaults to `None`.
        ddof (int, optional):
...
def abg(
    ...
    """
    !!! summary "Summary"
        Breusch-Godfrey Lagrange Multiplier tests for residual autocorrelation.<br>
