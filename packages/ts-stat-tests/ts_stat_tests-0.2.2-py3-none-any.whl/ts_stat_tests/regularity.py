...
def approx_entropy(x: array_like, order: int = 2, metric: str = "chebyshev") -> float:
    ...
    ??? Tip "See Also"
        - [`sample_entropy()`][src.ts_stat_tests.regularity.sample_entropy]
        - [`spectral_entropy()`][src.ts_stat_tests.regularity.spectral_entropy]
    """
...
def sample_entropy(x: array_like, order: int = 2, metric: str = "chebyshev") -> float:
    ...
    ??? Tip "See Also"
        - [`approx_entropy()`][src.ts_stat_tests.regularity.approx_entropy]
        - [`spectral_entropy()`][src.ts_stat_tests.regularity.spectral_entropy]
    """
...
def entropy(
    ...
    ???+ Info "Details"
        ...
        - [`approx_entropy()`][src.ts_stat_tests.regularity.approx_entropy]<br>
        - [`sample_entropy()`][src.ts_stat_tests.regularity.sample_entropy]<br>
        - [`spectral_entropy()`][src.ts_stat_tests.regularity.spectral_entropy]
    ...
    ??? Tip "See Also"
        - [`regularity()`][src.ts_stat_tests.regularity.regularity]
        - [`approx_entropy()`][src.ts_stat_tests.regularity.approx_entropy]
        - [`sample_entropy()`][src.ts_stat_tests.regularity.sample_entropy]
        - [`spectral_entropy()`][src.ts_stat_tests.regularity.spectral_entropy]
    """
...
def regularity(
    ...
    ???+ Info "Details"
        This is a pass-through, convenience wrapper around the [`entropy()`][src.ts_stat_tests.regularity.entropy] function.
    ...
    ??? Tip "See Also"
        - [`entropy()`][src.ts_stat_tests.regularity.entropy]
        - [`approx_entropy()`][src.ts_stat_tests.regularity.approx_entropy]
        - [`sample_entropy()`][src.ts_stat_tests.regularity.sample_entropy]
        - [`spectral_entropy()`][src.ts_stat_tests.regularity.spectral_entropy]
    """
