from powerml import PrestoFilter
import json
...
def testPrestoFilter(data, data_filename):
    ...
    print(metrics)
    data_filename = f'{data_filename}_presto_filtered'
...
if __name__ == "__main__":
    ...
    num_test = len(data)
    testPrestoFilter(data[:num_test], data_filename)
