...
def _check_refresh_token_exists(ctx: typer.Context) -> bool:
...
def ensure_login(method: callable) -> callable:
    def check_access_token(*args, **kwargs) -> typing.Any:  # noqa: ANN401
        ctx = args[0]
