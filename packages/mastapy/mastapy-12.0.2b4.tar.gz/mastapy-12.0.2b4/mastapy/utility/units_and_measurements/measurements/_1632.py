...
class LengthShort(_1570.MeasurementBase):
    """LengthShort
    ...
    @property
    def micrometres(self) -> '_1575.Unit':
    ...
    @property
    def millimetres(self) -> '_1575.Unit':
    ...
    @property
    def thousandths_of_an_inch(self) -> '_1575.Unit':
