...
from mastapy.utility.report import _1735, _1738
...
TItem = TypeVar('TItem', bound='_1738.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1735.CustomReportMultiPropertyItemBase, Generic[TItem]):
    """CustomReportMultiPropertyItem
