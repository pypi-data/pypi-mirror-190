...
from mastapy.utility.report import _1731, _1732
...
T = TypeVar('T', bound='_1732.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1731.CustomReportItemContainerCollectionBase, Generic[T]):
    """CustomReportItemContainerCollection
