...
from mastapy.utility.databases import _1792, _1794, _1793
...
TValue = TypeVar('TValue', bound='_1792.NamedDatabaseItem')


class NamedDatabase(_1794.SQLDatabase['_1793.NamedKey', 'TValue'], Generic[TValue]):
    """NamedDatabase
    ...
    def duplicate(self, new_name: 'str', item: '_1792.NamedDatabaseItem') -> '_1792.NamedDatabaseItem':
    ...
    def rename(self, item: '_1792.NamedDatabaseItem', new_name: 'str') -> 'bool':
