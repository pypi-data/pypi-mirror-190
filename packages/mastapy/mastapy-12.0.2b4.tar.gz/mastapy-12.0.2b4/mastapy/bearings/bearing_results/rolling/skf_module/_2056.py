...
from mastapy.bearings.bearing_results.rolling.skf_module import _2048, _2052
...
class Viscosities(_2052.SKFCalculationResult):
    """Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_2048.OperatingViscosity':
