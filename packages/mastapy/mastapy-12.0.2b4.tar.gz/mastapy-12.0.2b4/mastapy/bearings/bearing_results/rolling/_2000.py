...
from mastapy.bearings.bearing_results.rolling import _1999, _1986
...
class LoadedSphericalRollerThrustBearingRow(_1986.LoadedRollerBearingRow):
    """LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1999.LoadedSphericalRollerThrustBearingResults':
