...
from mastapy.bearings.bearing_results.rolling import _2020, _1980
...
class LoadedCylindricalRollerBearingResults(_1980.LoadedNonBarrelRollerBearingResults):
    """LoadedCylindricalRollerBearingResults
    ...
    @property
    def permissible_continuous_axial_load(self) -> '_2020.PermissibleContinuousAxialLoadResults':
