...
from mastapy.bearings.bearing_results.rolling.skf_module import _2049, _2052
...
class DynamicAxialLoadCarryingCapacity(_2052.SKFCalculationResult):
    """DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self) -> '_2049.PermissibleAxialLoad':
