...
from mastapy.bearings.bearing_results.rolling import _1961, _1986
...
class LoadedCrossedRollerBearingRow(_1986.LoadedRollerBearingRow):
    """LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1961.LoadedCrossedRollerBearingResults':
