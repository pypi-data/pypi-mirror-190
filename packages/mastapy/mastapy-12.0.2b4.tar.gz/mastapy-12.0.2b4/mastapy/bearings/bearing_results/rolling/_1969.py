...
from mastapy.bearings.bearing_results.rolling import _1968, _1959
...
class LoadedDeepGrooveBallBearingRow(_1959.LoadedBallBearingRow):
    """LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1968.LoadedDeepGrooveBallBearingResults':
