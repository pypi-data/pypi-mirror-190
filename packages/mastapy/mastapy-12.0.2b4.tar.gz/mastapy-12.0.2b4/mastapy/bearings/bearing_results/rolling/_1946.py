...
from mastapy.bearings.bearing_results.rolling import _1945, _1986
...
class LoadedAsymmetricSphericalRollerBearingRow(_1986.LoadedRollerBearingRow):
    """LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1945.LoadedAsymmetricSphericalRollerBearingResults':
