...
from mastapy.bearings.bearing_results.rolling import _2023, _1970
...
class LoadedRollerBearingElement(_1970.LoadedElement):
    """LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_2023.ResultsAtRollerOffset]':
