...
from mastapy.bearings.bearing_results.rolling import _1953, _1951
...
class LoadedAxialThrustNeedleRollerBearingRow(_1951.LoadedAxialThrustCylindricalRollerBearingRow):
    """LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1953.LoadedAxialThrustNeedleRollerBearingResults':
