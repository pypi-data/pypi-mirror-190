...
from mastapy.bearings.bearing_results.rolling import _1996, _1986
...
class LoadedSphericalRollerRadialBearingRow(_1986.LoadedRollerBearingRow):
    """LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1996.LoadedSphericalRollerRadialBearingResults':
