...
from mastapy.bearings.bearing_designs.rolling.xml_import import _2132, _2131
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_2132.BearingImportFile]':
    ...
    @property
    def variables(self) -> 'List[_2131.AbstractXmlVariableAssignment]':
