...
from mastapy.bearings.tolerances import _1882, _1877, _1869
...
class SupportDetail(_1869.InterferenceDetail):
    """SupportDetail
    ...
    @property
    def material_source(self) -> '_1882.SupportMaterialSource':
        ...
        return constructor.new_from_mastapy_type(_1882.SupportMaterialSource)(value) if value is not None else None
    ...
    @property
    def radial_specification_method(self) -> '_1877.RadialSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1877.RadialSpecificationMethod)(value) if value is not None else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1877.RadialSpecificationMethod'):
