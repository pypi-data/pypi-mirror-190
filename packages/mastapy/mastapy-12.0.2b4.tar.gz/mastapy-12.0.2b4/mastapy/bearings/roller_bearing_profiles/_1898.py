...
class RollerBearingUserSpecifiedProfile(_1897.RollerBearingProfile):
    """RollerBearingUserSpecifiedProfile
    ...
    @property
    def data_to_use(self) -> '_1888.ProfileDataToUse':
        ...
        return constructor.new_from_mastapy_type(_1888.ProfileDataToUse)(value) if value is not None else None

    @data_to_use.setter
    def data_to_use(self, value: '_1888.ProfileDataToUse'):
    ...
    @property
    def profile_to_fit(self) -> '_1890.ProfileToFit':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1890.ProfileToFit)(value) if value is not None else None

    @profile_to_fit.setter
    def profile_to_fit(self, value: '_1890.ProfileToFit'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ProfileToFit = value

    @property
    def points(self) -> 'List[_1900.UserSpecifiedProfilePoint]':
