...
class ParetoOptimistaionVariable(_1517.ParetoOptimisationVariableBase):
    """ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1519.PropertyTargetForDominantCandidateSearch':
    ...
    def property_target_for_dominant_candidate_search(self, value: '_1519.PropertyTargetForDominantCandidateSearch'):
