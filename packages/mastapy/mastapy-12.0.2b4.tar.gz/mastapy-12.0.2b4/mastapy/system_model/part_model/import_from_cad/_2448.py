...
from mastapy.system_model.part_model.import_from_cad import _2454, _2455
...
class ConnectorFromCAD(_2455.MountableComponentFromCAD):
    """ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_2454.HousedOrMounted':
        ...
        return constructor.new_from_mastapy_type(_2454.HousedOrMounted)(value) if value is not None else None

    @mounting.setter
    def mounting(self, value: '_2454.HousedOrMounted'):
