...
from mastapy.system_model.part_model.part_groups import _2442
...
class RootAssembly(_2386.Assembly):
    """RootAssembly
    ...
    @property
    def parallel_part_groups(self) -> 'List[_2442.ParallelPartGroup]':
    ...
    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2437.SpecifiedParallelPartGroupDrawingOrder]':
