...
from mastapy.system_model.part_model.couplings import _2531, _2534
...
class Clutch(_2534.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2531.ClutchType':
        ...
        return constructor.new_from_mastapy_type(_2531.ClutchType)(value) if value is not None else None

    @clutch_type.setter
    def clutch_type(self, value: '_2531.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_5339.ClutchSpringType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5339.ClutchSpringType)(value) if value is not None else None

    @spring_type.setter
    def spring_type(self, value: '_5339.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_2294.ClutchConnection':
