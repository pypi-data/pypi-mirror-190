...
from mastapy.system_model.part_model.couplings import _2559, _2561, _2534
...
class TorqueConverter(_2534.Coupling):
    """TorqueConverter
    ...
    @property
    def pump(self) -> '_2559.TorqueConverterPump':
    ...
    @property
    def turbine(self) -> '_2561.TorqueConverterTurbine':
