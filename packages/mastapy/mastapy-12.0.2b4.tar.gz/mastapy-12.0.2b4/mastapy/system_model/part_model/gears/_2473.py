...
from mastapy.system_model.part_model.gears import _2472, _2483
...
class ConceptGearSet(_2483.GearSet):
    """ConceptGearSet
    ...
    @property
    def concept_gears(self) -> 'List[_2472.ConceptGear]':
    ...
    @property
    def concept_meshes(self) -> 'List[_2257.ConceptGearMesh]':
