...
from mastapy.system_model.part_model.gears import _2494, _2471
...
class SpiralBevelGearSet(_2471.BevelGearSet):
    """SpiralBevelGearSet
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_2494.SpiralBevelGear]':
    ...
    @property
    def spiral_bevel_meshes(self) -> 'List[_2275.SpiralBevelGearMesh]':
