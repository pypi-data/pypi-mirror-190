...
from mastapy.system_model.part_model.gears import _2476, _2478, _2477
...
class PlanetaryGearSet(_2477.CylindricalGearSet):
    """PlanetaryGearSet
    ...
    @property
    def annuluses(self) -> 'List[_2476.CylindricalGear]':
    ...
    @property
    def planets(self) -> 'List[_2478.CylindricalPlanetGear]':
    ...
    @property
    def suns(self) -> 'List[_2476.CylindricalGear]':
    ...
    def add_annulus(self) -> '_2476.CylindricalGear':
    ...
    def add_planet(self) -> '_2476.CylindricalGear':
    ...
    def add_sun(self) -> '_2476.CylindricalGear':
