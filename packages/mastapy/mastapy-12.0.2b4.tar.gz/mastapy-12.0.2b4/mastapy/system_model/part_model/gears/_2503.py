...
from mastapy.system_model.part_model.gears import _2502, _2483
...
class WormGearSet(_2483.GearSet):
    """WormGearSet
    ...
    @property
    def worm_gears(self) -> 'List[_2502.WormGear]':
    ...
    @property
    def worm_meshes(self) -> 'List[_2281.WormGearMesh]':
