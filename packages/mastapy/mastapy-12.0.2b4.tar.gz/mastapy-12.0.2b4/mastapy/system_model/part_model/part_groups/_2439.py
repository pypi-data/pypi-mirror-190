...
from mastapy.system_model.part_model.part_groups import _2440, _2438
...
class ConcentricPartGroup(_2438.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2440.ConcentricPartGroupParallelToThis]':
