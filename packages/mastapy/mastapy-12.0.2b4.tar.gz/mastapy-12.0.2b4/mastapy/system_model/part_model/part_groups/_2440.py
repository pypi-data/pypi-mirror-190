...
from mastapy.system_model.part_model.part_groups import _2438, _2439, _2442
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2438.ConcentricOrParallelPartGroup':
        ...
        if _2438.ConcentricOrParallelPartGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2439.ConcentricPartGroup':
        ...
        if _2439.ConcentricPartGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2442.ParallelPartGroup':
        ...
        if _2442.ParallelPartGroup.TYPE not in temp.__class__.__mro__:
