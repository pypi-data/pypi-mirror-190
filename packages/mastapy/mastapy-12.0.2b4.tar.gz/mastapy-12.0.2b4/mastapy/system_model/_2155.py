...
from mastapy.utility import _1547, _1548, _1546
...
class Design(_0.APIBase):
    ...
    @property
    def file_save_details_all(self) -> '_1547.FileHistory':
    ...
    @property
    def file_save_details_most_recent(self) -> '_1548.FileHistoryItem':
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1546.ExternalFullFEFileOption'] = _1546.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
