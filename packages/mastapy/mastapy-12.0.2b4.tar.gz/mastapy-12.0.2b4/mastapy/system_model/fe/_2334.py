...
from mastapy.system_model.fe import (
    _2308, _2314, _2362, _2339,
    _2310, _2335, _2346, _2332,
    _2347, _2336, _2360, _2342,
    _2343, _2344, _2345
)
from mastapy._internal.implicit import list_with_selected_item, overridable, enum_with_selected_value
from mastapy.system_model.part_model import _2396, _2400, _2405
...
class FESubstructure(_66.FEStiffness):
    ...
    @property
    def alignment_method(self) -> '_2308.AlignmentMethod':
        ...
        return constructor.new_from_mastapy_type(_2308.AlignmentMethod)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2308.AlignmentMethod'):
    ...
    @property
    def bearing_node_alignment(self) -> '_2314.BearingNodeAlignmentOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2314.BearingNodeAlignmentOption)(value) if value is not None else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2314.BearingNodeAlignmentOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def alignment_using_axial_node_positions(self) -> '_2310.AlignmentUsingAxialNodePositions':
    ...
    @property
    def alignment_to_component(self) -> '_2175.RelativeComponentAlignment[_2396.Component]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2396.Component](temp) if temp is not None else None
    ...
    @property
    def export(self) -> '_2335.FESubstructureExportOptions':
    ...
    @property
    def gear_meshing_options(self) -> 'List[_2346.GearMeshingOptions]':
    ...
    @property
    def geometries(self) -> 'List[_2332.FEStiffnessGeometry]':
    ...
    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2347.IndependentMastaCreatedCondensationNode]':
    ...
    @property
    def links(self) -> 'List[_2369.FELink]':
    ...
    @property
    def replaced_shafts(self) -> 'List[_2434.Shaft]':
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2360.ReplacedShaftSelectionHelper]':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2342.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2343.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2344.FESubstructureWithSelectionForModalAnalysis':
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2345.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_165.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7483.TaskProgress'] = None):
    ...
    def import_node_positions(self, file_name: 'str', distance_unit: '_1575.Unit'):
    ...
    def import_reduced_stiffness(self, file_name: 'str', distance_unit: '_1575.Unit', force_unit: '_1575.Unit'):
    ...
    def links_for(self, node: '_2336.FESubstructureNode') -> 'List[_2369.FELink]':
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7483.TaskProgress'):
        """ 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def load_stl_geometry(self, length_unit: '_1575.Unit', file_name: 'str'):
