...
class FESubstructureWithSelection(_2312.BaseFEWithSelection):
    """FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self) -> '_2334.FESubstructure':
    ...
    @property
    def element_face_groups(self) -> 'List[_2327.ElementFaceGroupWithSelection]':
    ...
    @property
    def node_groups(self) -> 'List[_2352.NodeGroupWithSelection]':
