...
from mastapy.system_model.fe import _2309, _2316
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2309.AlignmentMethodForRaceBearing':
        ...
        return constructor.new_from_mastapy_type(_2309.AlignmentMethodForRaceBearing)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2309.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2316.BearingRaceNodeLink]':
