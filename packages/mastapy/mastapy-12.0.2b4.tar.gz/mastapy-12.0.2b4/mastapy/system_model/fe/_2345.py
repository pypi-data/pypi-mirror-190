...
from mastapy.system_model.fe import _2351, _2341
...
class FESubstructureWithSelectionForStaticAnalysis(_2341.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @property
    def boundary_conditions_all_nodes(self) -> 'List[_2351.NodeBoundaryConditionStaticAnalysis]':
    ...
    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_2351.NodeBoundaryConditionStaticAnalysis]':
