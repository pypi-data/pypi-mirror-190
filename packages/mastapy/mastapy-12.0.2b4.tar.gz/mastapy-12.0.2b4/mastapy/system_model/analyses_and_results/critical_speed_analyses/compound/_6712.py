...
class StraightBevelPlanetGearCompoundCriticalSpeedAnalysis(_6706.StraightBevelDiffGearCompoundCriticalSpeedAnalysis):
    """StraightBevelPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6583.StraightBevelPlanetGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6583.StraightBevelPlanetGearCriticalSpeedAnalysis]':
