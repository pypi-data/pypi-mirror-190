...
class CouplingHalfCompoundCriticalSpeedAnalysis(_6678.MountableComponentCompoundCriticalSpeedAnalysis):
    """CouplingHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6509.CouplingHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6509.CouplingHalfCriticalSpeedAnalysis]':
