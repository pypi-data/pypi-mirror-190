...
class PlanetCarrierCompoundCriticalSpeedAnalysis(_6678.MountableComponentCompoundCriticalSpeedAnalysis):
    """PlanetCarrierCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6557.PlanetCarrierCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6557.PlanetCarrierCriticalSpeedAnalysis]':
