...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6630, _6631, _6661
...
class ConceptGearSetCompoundCriticalSpeedAnalysis(_6661.GearSetCompoundCriticalSpeedAnalysis):
    """ConceptGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6501.ConceptGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def concept_gears_compound_critical_speed_analysis(self) -> 'List[_6630.ConceptGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def concept_meshes_compound_critical_speed_analysis(self) -> 'List[_6631.ConceptGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6501.ConceptGearSetCriticalSpeedAnalysis]':
