...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6525, _6526, _6532
...
class FaceGearSetCriticalSpeedAnalysis(_6532.GearSetCriticalSpeedAnalysis):
    """FaceGearSetCriticalSpeedAnalysis
    ...
    @property
    def face_gears_critical_speed_analysis(self) -> 'List[_6525.FaceGearCriticalSpeedAnalysis]':
    ...
    @property
    def face_meshes_critical_speed_analysis(self) -> 'List[_6526.FaceGearMeshCriticalSpeedAnalysis]':
