...
class AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis(_6634.ConicalGearMeshCompoundCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6475.AGMAGleasonConicalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6475.AGMAGleasonConicalGearMeshCriticalSpeedAnalysis]':
