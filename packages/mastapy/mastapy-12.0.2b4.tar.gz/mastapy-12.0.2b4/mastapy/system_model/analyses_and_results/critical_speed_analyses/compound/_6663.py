...
class HypoidGearCompoundCriticalSpeedAnalysis(_6605.AGMAGleasonConicalGearCompoundCriticalSpeedAnalysis):
    """HypoidGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6534.HypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6534.HypoidGearCriticalSpeedAnalysis]':
