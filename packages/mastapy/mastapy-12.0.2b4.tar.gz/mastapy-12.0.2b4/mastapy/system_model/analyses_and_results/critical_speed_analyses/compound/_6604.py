...
class AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis(_6636.ConnectionCompoundCriticalSpeedAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6473.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6473.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis]':
