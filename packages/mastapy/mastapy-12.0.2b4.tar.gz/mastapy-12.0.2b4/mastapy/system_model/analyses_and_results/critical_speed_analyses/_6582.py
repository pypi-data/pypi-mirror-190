...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6580, _6581, _6488
...
class StraightBevelGearSetCriticalSpeedAnalysis(_6488.BevelGearSetCriticalSpeedAnalysis):
    """StraightBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_gears_critical_speed_analysis(self) -> 'List[_6580.StraightBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_meshes_critical_speed_analysis(self) -> 'List[_6581.StraightBevelGearMeshCriticalSpeedAnalysis]':
