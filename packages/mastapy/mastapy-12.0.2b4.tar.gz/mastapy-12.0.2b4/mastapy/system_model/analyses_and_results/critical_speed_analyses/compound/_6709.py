...
class StraightBevelGearCompoundCriticalSpeedAnalysis(_6617.BevelGearCompoundCriticalSpeedAnalysis):
    """StraightBevelGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6580.StraightBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6580.StraightBevelGearCriticalSpeedAnalysis]':
