...
class TorqueConverterConnectionCompoundCriticalSpeedAnalysis(_6639.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """TorqueConverterConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6589.TorqueConverterConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6589.TorqueConverterConnectionCriticalSpeedAnalysis]':
