...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6654, _6655, _6661
...
class FaceGearSetCompoundCriticalSpeedAnalysis(_6661.GearSetCompoundCriticalSpeedAnalysis):
    """FaceGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6527.FaceGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def face_gears_compound_critical_speed_analysis(self) -> 'List[_6654.FaceGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def face_meshes_compound_critical_speed_analysis(self) -> 'List[_6655.FaceGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6527.FaceGearSetCriticalSpeedAnalysis]':
