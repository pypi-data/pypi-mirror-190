...
class PartToPartShearCouplingCompoundCriticalSpeedAnalysis(_6638.CouplingCompoundCriticalSpeedAnalysis):
    """PartToPartShearCouplingCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6553.PartToPartShearCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6553.PartToPartShearCouplingCriticalSpeedAnalysis]':
