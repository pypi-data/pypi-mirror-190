...
class ZerolBevelGearMeshCompoundCriticalSpeedAnalysis(_6618.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """ZerolBevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6599.ZerolBevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6599.ZerolBevelGearMeshCriticalSpeedAnalysis]':
