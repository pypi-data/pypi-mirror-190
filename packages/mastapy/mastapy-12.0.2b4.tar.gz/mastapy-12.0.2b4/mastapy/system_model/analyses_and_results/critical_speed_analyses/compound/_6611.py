...
class BeltDriveCompoundCriticalSpeedAnalysis(_6699.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """BeltDriveCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6480.BeltDriveCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6480.BeltDriveCriticalSpeedAnalysis]':
