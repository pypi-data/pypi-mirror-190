...
class CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis(_6625.CoaxialConnectionCompoundCriticalSpeedAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6516.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6516.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
