...
class DatumCompoundCriticalSpeedAnalysis(_6626.ComponentCompoundCriticalSpeedAnalysis):
    """DatumCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6523.DatumCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6523.DatumCriticalSpeedAnalysis]':
