...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import (
    _6478, _6480, _6483, _6490,
    _6489, _6513, _6492, _6497,
    _6501, _6515, _6517, _6521,
    _6528, _6527, _6529, _6536,
    _6543, _6546, _6547, _6548,
    _6550, _6553, _6557, _6558,
    _6559, _6561, _6563, _6568,
    _6567, _6573, _6575, _6579,
    _6582, _6585, _6590, _6593,
    _6597, _6600, _6470
)
...
class AssemblyCriticalSpeedAnalysis(_6470.AbstractAssemblyCriticalSpeedAnalysis):
    """AssemblyCriticalSpeedAnalysis
    ...
    @property
    def bearings(self) -> 'List[_6478.BearingCriticalSpeedAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6480.BeltDriveCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6483.BevelDifferentialGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6490.BoltedJointCriticalSpeedAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6489.BoltCriticalSpeedAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6513.CVTCriticalSpeedAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6492.ClutchCriticalSpeedAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6497.ConceptCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6501.ConceptGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6515.CycloidalAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6517.CycloidalDiscCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6521.CylindricalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6528.FEPartCriticalSpeedAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6527.FaceGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6529.FlexiblePinAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6536.HypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6543.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6546.KlingelnbergCycloPalloidSpiralBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6547.MassDiscCriticalSpeedAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6548.MeasurementComponentCriticalSpeedAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6550.OilSealCriticalSpeedAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6553.PartToPartShearCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6557.PlanetCarrierCriticalSpeedAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6558.PointLoadCriticalSpeedAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6559.PowerLoadCriticalSpeedAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6561.RingPinsCriticalSpeedAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6563.RollingRingAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6568.ShaftHubConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6567.ShaftCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6573.SpiralBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6575.SpringDamperCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6579.StraightBevelDiffGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6582.StraightBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6585.SynchroniserCriticalSpeedAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6590.TorqueConverterCriticalSpeedAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6593.UnbalancedMassCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6597.WormGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6600.ZerolBevelGearSetCriticalSpeedAnalysis]':
