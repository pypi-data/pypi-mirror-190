...
class WormGearMeshCompoundCriticalSpeedAnalysis(_6660.GearMeshCompoundCriticalSpeedAnalysis):
    """WormGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6596.WormGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6596.WormGearMeshCriticalSpeedAnalysis]':
