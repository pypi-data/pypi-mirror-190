...
class SpiralBevelGearMeshCompoundCriticalSpeedAnalysis(_6618.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """SpiralBevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6572.SpiralBevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6572.SpiralBevelGearMeshCriticalSpeedAnalysis]':
