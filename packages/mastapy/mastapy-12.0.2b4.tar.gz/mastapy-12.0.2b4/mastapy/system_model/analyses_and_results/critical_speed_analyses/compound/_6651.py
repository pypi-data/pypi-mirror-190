...
class CylindricalPlanetGearCompoundCriticalSpeedAnalysis(_6648.CylindricalGearCompoundCriticalSpeedAnalysis):
    """CylindricalPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6522.CylindricalPlanetGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6522.CylindricalPlanetGearCriticalSpeedAnalysis]':
