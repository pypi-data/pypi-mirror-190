...
class RingPinsCompoundCriticalSpeedAnalysis(_6678.MountableComponentCompoundCriticalSpeedAnalysis):
    """RingPinsCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6561.RingPinsCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6561.RingPinsCriticalSpeedAnalysis]':
