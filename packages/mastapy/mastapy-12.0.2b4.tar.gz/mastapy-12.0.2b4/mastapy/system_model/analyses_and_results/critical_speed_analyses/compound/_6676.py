...
class MassDiscCompoundCriticalSpeedAnalysis(_6723.VirtualComponentCompoundCriticalSpeedAnalysis):
    """MassDiscCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6547.MassDiscCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6547.MassDiscCriticalSpeedAnalysis]':
