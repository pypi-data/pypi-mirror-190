...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6577, _6578, _6488
...
class StraightBevelDiffGearSetCriticalSpeedAnalysis(_6488.BevelGearSetCriticalSpeedAnalysis):
    """StraightBevelDiffGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_diff_gears_critical_speed_analysis(self) -> 'List[_6577.StraightBevelDiffGearCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_critical_speed_analysis(self) -> 'List[_6578.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
