...
class PartSteadyStateSynchronousResponseOnAShaft(_7472.PartStaticLoadAnalysisCase):
    """PartSteadyStateSynchronousResponseOnAShaft
    ...
    def create_viewable(self) -> '_2210.SteadyStateSynchronousResponseViewable':
