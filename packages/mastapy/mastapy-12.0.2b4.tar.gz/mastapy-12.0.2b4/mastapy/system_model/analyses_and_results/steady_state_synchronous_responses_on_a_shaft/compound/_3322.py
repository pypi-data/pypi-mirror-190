...
class AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft(_3323.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseOnAShaft):
    """AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3193.AbstractShaftSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3193.AbstractShaftSteadyStateSynchronousResponseOnAShaft]':
