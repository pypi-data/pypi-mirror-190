...
class BearingCompoundSteadyStateSynchronousResponseOnAShaft(_3357.ConnectorCompoundSteadyStateSynchronousResponseOnAShaft):
    """BearingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3199.BearingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3199.BearingSteadyStateSynchronousResponseOnAShaft]':
