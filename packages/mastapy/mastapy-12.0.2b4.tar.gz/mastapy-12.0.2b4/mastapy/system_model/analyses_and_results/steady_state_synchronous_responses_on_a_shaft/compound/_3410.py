...
class RingPinsCompoundSteadyStateSynchronousResponseOnAShaft(_3398.MountableComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """RingPinsCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3280.RingPinsSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3280.RingPinsSteadyStateSynchronousResponseOnAShaft]':
