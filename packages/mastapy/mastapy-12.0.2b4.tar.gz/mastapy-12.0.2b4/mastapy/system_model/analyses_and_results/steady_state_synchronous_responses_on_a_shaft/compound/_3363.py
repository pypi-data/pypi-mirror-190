...
class CVTPulleyCompoundSteadyStateSynchronousResponseOnAShaft(_3409.PulleyCompoundSteadyStateSynchronousResponseOnAShaft):
    """CVTPulleyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3232.CVTPulleySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3232.CVTPulleySteadyStateSynchronousResponseOnAShaft]':
