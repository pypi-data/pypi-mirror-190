...
class WormGearCompoundSteadyStateSynchronousResponseOnAShaft(_3379.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """WormGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3317.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3317.WormGearSteadyStateSynchronousResponseOnAShaft]':
