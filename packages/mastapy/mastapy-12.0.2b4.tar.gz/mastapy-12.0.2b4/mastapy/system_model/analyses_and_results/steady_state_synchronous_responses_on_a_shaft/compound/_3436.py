...
class SynchroniserPartCompoundSteadyStateSynchronousResponseOnAShaft(_3360.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    """SynchroniserPartCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3306.SynchroniserPartSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3306.SynchroniserPartSteadyStateSynchronousResponseOnAShaft]':
