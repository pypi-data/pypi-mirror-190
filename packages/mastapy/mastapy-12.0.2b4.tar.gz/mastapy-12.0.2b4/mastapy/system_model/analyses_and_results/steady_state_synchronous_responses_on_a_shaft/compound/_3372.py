...
class DatumCompoundSteadyStateSynchronousResponseOnAShaft(_3346.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """DatumCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3242.DatumSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3242.DatumSteadyStateSynchronousResponseOnAShaft]':
