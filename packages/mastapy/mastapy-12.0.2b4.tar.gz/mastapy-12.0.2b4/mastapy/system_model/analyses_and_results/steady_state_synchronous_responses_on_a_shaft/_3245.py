...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3246, _3244, _3250
...
class FaceGearSetSteadyStateSynchronousResponseOnAShaft(_3250.GearSetSteadyStateSynchronousResponseOnAShaft):
    """FaceGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def face_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3246.FaceGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def face_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3244.FaceGearMeshSteadyStateSynchronousResponseOnAShaft]':
