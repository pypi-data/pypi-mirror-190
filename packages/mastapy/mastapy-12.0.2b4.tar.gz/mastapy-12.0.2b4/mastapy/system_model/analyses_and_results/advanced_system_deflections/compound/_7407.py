...
class MountableComponentCompoundAdvancedSystemDeflection(_7355.ComponentCompoundAdvancedSystemDeflection):
    """MountableComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7277.MountableComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7277.MountableComponentAdvancedSystemDeflection]':
