...
class PartToPartShearCouplingHalfAdvancedSystemDeflection(_7237.CouplingHalfAdvancedSystemDeflection):
    """PartToPartShearCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2733.PartToPartShearCouplingHalfSystemDeflection]':
