...
class ConceptCouplingAdvancedSystemDeflection(_7235.CouplingAdvancedSystemDeflection):
    """ConceptCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2665.ConceptCouplingSystemDeflection]':
