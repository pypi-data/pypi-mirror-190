...
class ShaftCompoundAdvancedSystemDeflection(_7331.AbstractShaftCompoundAdvancedSystemDeflection):
    """ShaftCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7295.ShaftAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7295.ShaftAdvancedSystemDeflection]':
