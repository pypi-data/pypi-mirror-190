...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7321, _7323
...
class PowerLoadAdvancedSystemDeflection(_7323.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6865.PowerLoadLoadCase':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2738.PowerLoadSystemDeflection]':
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_7321.TransmissionErrorToOtherPowerLoad]':
