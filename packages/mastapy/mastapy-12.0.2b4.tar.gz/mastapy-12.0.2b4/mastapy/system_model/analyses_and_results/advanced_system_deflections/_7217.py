...
class BoltedJointAdvancedSystemDeflection(_7298.SpecialisedAssemblyAdvancedSystemDeflection):
    """BoltedJointAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2655.BoltedJointSystemDeflection]':
