...
class PartToPartShearCouplingCompoundAdvancedSystemDeflection(_7367.CouplingCompoundAdvancedSystemDeflection):
    """PartToPartShearCouplingCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7280.PartToPartShearCouplingAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7280.PartToPartShearCouplingAdvancedSystemDeflection]':
