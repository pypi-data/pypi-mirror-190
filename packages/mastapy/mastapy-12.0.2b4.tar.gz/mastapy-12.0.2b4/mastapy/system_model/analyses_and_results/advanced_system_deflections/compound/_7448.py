...
class TorqueConverterConnectionCompoundAdvancedSystemDeflection(_7368.CouplingConnectionCompoundAdvancedSystemDeflection):
    """TorqueConverterConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7318.TorqueConverterConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7318.TorqueConverterConnectionAdvancedSystemDeflection]':
