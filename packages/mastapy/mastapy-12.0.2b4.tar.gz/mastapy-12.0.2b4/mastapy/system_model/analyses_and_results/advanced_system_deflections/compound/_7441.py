...
class StraightBevelPlanetGearCompoundAdvancedSystemDeflection(_7435.StraightBevelDiffGearCompoundAdvancedSystemDeflection):
    """StraightBevelPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7311.StraightBevelPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7311.StraightBevelPlanetGearAdvancedSystemDeflection]':
