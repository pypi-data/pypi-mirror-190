...
class FEPartAdvancedSystemDeflection(_7196.AbstractShaftOrHousingAdvancedSystemDeflection):
    """FEPartAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2703.FEPartSystemDeflection]':
