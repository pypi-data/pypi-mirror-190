...
class RootAssemblyCompoundAdvancedSystemDeflection(_7337.AssemblyCompoundAdvancedSystemDeflection):
    """RootAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7294.RootAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7294.RootAssemblyAdvancedSystemDeflection]':
