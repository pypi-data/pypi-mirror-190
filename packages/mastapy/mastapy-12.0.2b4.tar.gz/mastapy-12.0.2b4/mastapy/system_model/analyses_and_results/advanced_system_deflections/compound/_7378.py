...
class CylindricalGearMeshCompoundAdvancedSystemDeflection(_7389.GearMeshCompoundAdvancedSystemDeflection):
    """CylindricalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7246.CylindricalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7246.CylindricalGearMeshAdvancedSystemDeflection]':
