...
class FaceGearMeshCompoundAdvancedSystemDeflection(_7389.GearMeshCompoundAdvancedSystemDeflection):
    """FaceGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7253.FaceGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7253.FaceGearMeshAdvancedSystemDeflection]':
