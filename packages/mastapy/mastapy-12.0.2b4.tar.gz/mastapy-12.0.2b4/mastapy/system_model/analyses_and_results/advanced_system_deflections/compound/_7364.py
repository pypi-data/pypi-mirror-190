...
class ConicalGearSetCompoundAdvancedSystemDeflection(_7390.GearSetCompoundAdvancedSystemDeflection):
    """ConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7231.ConicalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7231.ConicalGearSetAdvancedSystemDeflection]':
