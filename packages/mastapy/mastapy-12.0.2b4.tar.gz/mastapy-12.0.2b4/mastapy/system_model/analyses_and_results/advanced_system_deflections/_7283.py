...
class PlanetaryConnectionAdvancedSystemDeflection(_7297.ShaftToMountableComponentConnectionAdvancedSystemDeflection):
    """PlanetaryConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2735.PlanetaryConnectionSystemDeflection]':
