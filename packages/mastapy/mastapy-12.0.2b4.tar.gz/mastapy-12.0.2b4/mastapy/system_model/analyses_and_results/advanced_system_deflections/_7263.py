...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7261, _7262, _7203
...
class HypoidGearSetAdvancedSystemDeflection(_7203.AGMAGleasonConicalGearSetAdvancedSystemDeflection):
    """HypoidGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2710.HypoidGearSetSystemDeflection]':
    ...
    @property
    def hypoid_gears_advanced_system_deflection(self) -> 'List[_7261.HypoidGearAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_meshes_advanced_system_deflection(self) -> 'List[_7262.HypoidGearMeshAdvancedSystemDeflection]':
