...
class FaceGearAdvancedSystemDeflection(_7257.GearAdvancedSystemDeflection):
    """FaceGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2702.FaceGearSystemDeflection]':
