...
class RingPinsAdvancedSystemDeflection(_7277.MountableComponentAdvancedSystemDeflection):
    """RingPinsAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2740.RingPinsSystemDeflection]':
