...
class CylindricalPlanetGearCompoundAdvancedSystemDeflection(_7377.CylindricalGearCompoundAdvancedSystemDeflection):
    """CylindricalPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7249.CylindricalPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7249.CylindricalPlanetGearAdvancedSystemDeflection]':
