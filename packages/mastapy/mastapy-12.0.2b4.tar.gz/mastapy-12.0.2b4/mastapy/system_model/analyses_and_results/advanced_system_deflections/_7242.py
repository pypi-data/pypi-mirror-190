...
class CycloidalDiscAdvancedSystemDeflection(_7195.AbstractShaftAdvancedSystemDeflection):
    """CycloidalDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2684.CycloidalDiscSystemDeflection]':
