...
class SpiralBevelGearMeshAdvancedSystemDeflection(_7214.BevelGearMeshAdvancedSystemDeflection):
    """SpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2753.SpiralBevelGearMeshSystemDeflection]':
