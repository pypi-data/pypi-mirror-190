...
class StraightBevelDiffGearCompoundAdvancedSystemDeflection(_7346.BevelGearCompoundAdvancedSystemDeflection):
    """StraightBevelDiffGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7305.StraightBevelDiffGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7305.StraightBevelDiffGearAdvancedSystemDeflection]':
