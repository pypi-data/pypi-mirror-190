...
class PointLoadCompoundAdvancedSystemDeflection(_7452.VirtualComponentCompoundAdvancedSystemDeflection):
    """PointLoadCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7286.PointLoadAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7286.PointLoadAdvancedSystemDeflection]':
