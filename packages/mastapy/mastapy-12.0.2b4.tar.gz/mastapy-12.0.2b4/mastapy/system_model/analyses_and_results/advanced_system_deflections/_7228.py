...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7226, _7227, _7259
...
class ConceptGearSetAdvancedSystemDeflection(_7259.GearSetAdvancedSystemDeflection):
    """ConceptGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2667.ConceptGearSetSystemDeflection]':
    ...
    @property
    def concept_gears_advanced_system_deflection(self) -> 'List[_7226.ConceptGearAdvancedSystemDeflection]':
    ...
    @property
    def concept_meshes_advanced_system_deflection(self) -> 'List[_7227.ConceptGearMeshAdvancedSystemDeflection]':
