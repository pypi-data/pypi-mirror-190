...
class BevelGearMeshCompoundAdvancedSystemDeflection(_7335.AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection):
    """BevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7214.BevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7214.BevelGearMeshAdvancedSystemDeflection]':
