...
class OilSealAdvancedSystemDeflection(_7233.ConnectorAdvancedSystemDeflection):
    """OilSealAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2730.OilSealSystemDeflection]':
