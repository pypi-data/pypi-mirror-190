...
class ConceptCouplingConnectionCompoundAdvancedSystemDeflection(_7368.CouplingConnectionCompoundAdvancedSystemDeflection):
    """ConceptCouplingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7224.ConceptCouplingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7224.ConceptCouplingConnectionAdvancedSystemDeflection]':
