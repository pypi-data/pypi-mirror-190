...
class OilSealCompoundAdvancedSystemDeflection(_7366.ConnectorCompoundAdvancedSystemDeflection):
    """OilSealCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7278.OilSealAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7278.OilSealAdvancedSystemDeflection]':
