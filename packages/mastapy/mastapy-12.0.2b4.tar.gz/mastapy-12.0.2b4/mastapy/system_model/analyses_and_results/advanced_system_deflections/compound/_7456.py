...
class ZerolBevelGearCompoundAdvancedSystemDeflection(_7346.BevelGearCompoundAdvancedSystemDeflection):
    """ZerolBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7327.ZerolBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7327.ZerolBevelGearAdvancedSystemDeflection]':
