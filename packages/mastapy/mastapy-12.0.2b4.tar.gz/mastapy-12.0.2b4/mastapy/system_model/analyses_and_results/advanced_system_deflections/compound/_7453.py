...
class WormGearCompoundAdvancedSystemDeflection(_7388.GearCompoundAdvancedSystemDeflection):
    """WormGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7324.WormGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7324.WormGearAdvancedSystemDeflection]':
