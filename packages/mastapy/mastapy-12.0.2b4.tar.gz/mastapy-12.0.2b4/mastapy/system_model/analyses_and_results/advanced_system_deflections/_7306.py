...
class StraightBevelDiffGearMeshAdvancedSystemDeflection(_7214.BevelGearMeshAdvancedSystemDeflection):
    """StraightBevelDiffGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2759.StraightBevelDiffGearMeshSystemDeflection]':
