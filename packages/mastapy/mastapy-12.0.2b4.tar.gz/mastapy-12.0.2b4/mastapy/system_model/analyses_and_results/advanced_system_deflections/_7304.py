...
class SpringDamperHalfAdvancedSystemDeflection(_7237.CouplingHalfAdvancedSystemDeflection):
    """SpringDamperHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2757.SpringDamperHalfSystemDeflection]':
