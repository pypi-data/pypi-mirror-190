...
class BevelDifferentialSunGearCompoundAdvancedSystemDeflection(_7341.BevelDifferentialGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialSunGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7212.BevelDifferentialSunGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7212.BevelDifferentialSunGearAdvancedSystemDeflection]':
