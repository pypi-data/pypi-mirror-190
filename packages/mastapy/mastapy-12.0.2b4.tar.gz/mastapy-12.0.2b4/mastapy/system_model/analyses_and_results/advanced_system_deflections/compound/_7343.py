...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7341, _7342, _7348
...
class BevelDifferentialGearSetCompoundAdvancedSystemDeflection(_7348.BevelGearSetCompoundAdvancedSystemDeflection):
    """BevelDifferentialGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7210.BevelDifferentialGearSetAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gears_compound_advanced_system_deflection(self) -> 'List[_7341.BevelDifferentialGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_compound_advanced_system_deflection(self) -> 'List[_7342.BevelDifferentialGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7210.BevelDifferentialGearSetAdvancedSystemDeflection]':
