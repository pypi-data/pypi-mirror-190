...
class WormGearAdvancedSystemDeflection(_7257.GearAdvancedSystemDeflection):
    """WormGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2784.WormGearSystemDeflection]':
