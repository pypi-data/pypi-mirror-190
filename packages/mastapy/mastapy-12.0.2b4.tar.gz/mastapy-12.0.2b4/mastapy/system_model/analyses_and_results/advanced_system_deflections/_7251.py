...
class ExternalCADModelAdvancedSystemDeflection(_7222.ComponentAdvancedSystemDeflection):
    """ExternalCADModelAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2698.ExternalCADModelSystemDeflection]':
