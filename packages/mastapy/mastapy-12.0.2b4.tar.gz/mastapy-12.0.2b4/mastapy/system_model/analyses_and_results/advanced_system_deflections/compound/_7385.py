...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7383, _7384, _7390
...
class FaceGearSetCompoundAdvancedSystemDeflection(_7390.GearSetCompoundAdvancedSystemDeflection):
    """FaceGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7254.FaceGearSetAdvancedSystemDeflection]':
    ...
    @property
    def face_gears_compound_advanced_system_deflection(self) -> 'List[_7383.FaceGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def face_meshes_compound_advanced_system_deflection(self) -> 'List[_7384.FaceGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7254.FaceGearSetAdvancedSystemDeflection]':
