...
class CVTBeltConnectionCompoundAdvancedSystemDeflection(_7339.BeltConnectionCompoundAdvancedSystemDeflection):
    """CVTBeltConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7239.CVTBeltConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7239.CVTBeltConnectionAdvancedSystemDeflection]':
