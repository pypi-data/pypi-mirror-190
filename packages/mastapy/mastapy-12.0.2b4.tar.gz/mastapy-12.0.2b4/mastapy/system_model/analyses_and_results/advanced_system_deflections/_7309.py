...
class StraightBevelGearMeshAdvancedSystemDeflection(_7214.BevelGearMeshAdvancedSystemDeflection):
    """StraightBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2762.StraightBevelGearMeshSystemDeflection]':
