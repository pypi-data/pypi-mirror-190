...
class SynchroniserSleeveAdvancedSystemDeflection(_7315.SynchroniserPartAdvancedSystemDeflection):
    """SynchroniserSleeveAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2769.SynchroniserSleeveSystemDeflection]':
