...
class TorqueConverterTurbineAdvancedSystemDeflection(_7237.CouplingHalfAdvancedSystemDeflection):
    """TorqueConverterTurbineAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2777.TorqueConverterTurbineSystemDeflection]':
