...
class PulleyCompoundAdvancedSystemDeflection(_7369.CouplingHalfCompoundAdvancedSystemDeflection):
    """PulleyCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7288.PulleyAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7288.PulleyAdvancedSystemDeflection]':
