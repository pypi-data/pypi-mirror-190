...
class HypoidGearCompoundAdvancedSystemDeflection(_7334.AGMAGleasonConicalGearCompoundAdvancedSystemDeflection):
    """HypoidGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7261.HypoidGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7261.HypoidGearAdvancedSystemDeflection]':
