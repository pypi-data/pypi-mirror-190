...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7252, _7253, _7259
...
class FaceGearSetAdvancedSystemDeflection(_7259.GearSetAdvancedSystemDeflection):
    """FaceGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2701.FaceGearSetSystemDeflection]':
    ...
    @property
    def face_gears_advanced_system_deflection(self) -> 'List[_7252.FaceGearAdvancedSystemDeflection]':
    ...
    @property
    def face_meshes_advanced_system_deflection(self) -> 'List[_7253.FaceGearMeshAdvancedSystemDeflection]':
