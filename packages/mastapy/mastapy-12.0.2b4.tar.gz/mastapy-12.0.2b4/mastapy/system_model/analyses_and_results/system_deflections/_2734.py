...
from mastapy.system_model.analyses_and_results.system_deflections import _2732, _2677
...
class PartToPartShearCouplingSystemDeflection(_2677.CouplingSystemDeflection):
    """PartToPartShearCouplingSystemDeflection
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_2732.PartToPartShearCouplingConnectionSystemDeflection':
    ...
    @property
    def power_flow_results(self) -> '_4059.PartToPartShearCouplingPowerFlow':
