...
class VirtualComponentCompoundSystemDeflection(_2875.MountableComponentCompoundSystemDeflection):
    """VirtualComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2781.VirtualComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2781.VirtualComponentSystemDeflection]':
