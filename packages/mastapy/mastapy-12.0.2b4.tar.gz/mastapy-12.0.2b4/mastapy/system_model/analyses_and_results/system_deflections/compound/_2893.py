...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2894, _2798
...
class ShaftCompoundSystemDeflection(_2798.AbstractShaftCompoundSystemDeflection):
    """ShaftCompoundSystemDeflection
    ...
    @property
    def shaft_duty_cycle_damage_results(self) -> '_2894.ShaftDutyCycleSystemDeflection':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2750.ShaftSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2750.ShaftSystemDeflection]':
