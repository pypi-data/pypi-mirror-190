...
class ShaftToMountableComponentConnectionCompoundSystemDeflection(_2800.AbstractShaftToMountableComponentConnectionCompoundSystemDeflection):
    """ShaftToMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2751.ShaftToMountableComponentConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2751.ShaftToMountableComponentConnectionSystemDeflection]':
