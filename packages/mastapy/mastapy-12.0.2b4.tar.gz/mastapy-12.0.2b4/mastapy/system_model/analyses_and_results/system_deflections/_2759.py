...
class StraightBevelDiffGearMeshSystemDeflection(_2652.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4084.StraightBevelDiffGearMeshPowerFlow':
