...
class StraightBevelPlanetGearCompoundSystemDeflection(_2904.StraightBevelDiffGearCompoundSystemDeflection):
    """StraightBevelPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2765.StraightBevelPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2765.StraightBevelPlanetGearSystemDeflection]':
