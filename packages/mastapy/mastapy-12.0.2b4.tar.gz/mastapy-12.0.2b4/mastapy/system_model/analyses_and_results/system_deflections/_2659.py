...
from mastapy.system_model.analyses_and_results.system_deflections import _2657, _2677
...
class ClutchSystemDeflection(_2677.CouplingSystemDeflection):
    """ClutchSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3999.ClutchPowerFlow':
