...
from mastapy.system_model.analyses_and_results.system_deflections import _2784, _2782, _2706
...
class WormGearSetSystemDeflection(_2706.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4105.WormGearSetPowerFlow':
    ...
    @property
    def worm_gears_system_deflection(self) -> 'List[_2784.WormGearSystemDeflection]':
    ...
    @property
    def worm_meshes_system_deflection(self) -> 'List[_2782.WormGearMeshSystemDeflection]':
