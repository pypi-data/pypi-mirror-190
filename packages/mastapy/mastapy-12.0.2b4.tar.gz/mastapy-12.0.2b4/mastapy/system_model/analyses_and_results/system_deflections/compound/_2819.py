...
class ClutchConnectionCompoundSystemDeflection(_2835.CouplingConnectionCompoundSystemDeflection):
    """ClutchConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2657.ClutchConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2657.ClutchConnectionSystemDeflection]':
