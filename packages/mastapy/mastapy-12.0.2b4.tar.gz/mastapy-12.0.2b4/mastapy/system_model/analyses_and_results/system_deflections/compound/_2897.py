...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2797
...
class SpecialisedAssemblyCompoundSystemDeflection(_2797.AbstractAssemblyCompoundSystemDeflection):
    """SpecialisedAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2752.SpecialisedAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2752.SpecialisedAssemblySystemDeflection]':
