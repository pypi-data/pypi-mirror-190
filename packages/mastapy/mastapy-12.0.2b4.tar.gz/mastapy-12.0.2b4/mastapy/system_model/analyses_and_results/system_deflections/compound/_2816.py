...
class BoltCompoundSystemDeflection(_2822.ComponentCompoundSystemDeflection):
    """BoltCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2656.BoltSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2656.BoltSystemDeflection]':
