...
class ConceptCouplingHalfCompoundSystemDeflection(_2836.CouplingHalfCompoundSystemDeflection):
    """ConceptCouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2664.ConceptCouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2664.ConceptCouplingHalfSystemDeflection]':
