...
class AbstractShaftCompoundSystemDeflection(_2799.AbstractShaftOrHousingCompoundSystemDeflection):
    """AbstractShaftCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2638.AbstractShaftSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2638.AbstractShaftSystemDeflection]':
