...
class CycloidalDiscPlanetaryBearingConnectionSystemDeflection(_2639.AbstractShaftToMountableComponentConnectionSystemDeflection):
    """CycloidalDiscPlanetaryBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4021.CycloidalDiscPlanetaryBearingConnectionPowerFlow':
