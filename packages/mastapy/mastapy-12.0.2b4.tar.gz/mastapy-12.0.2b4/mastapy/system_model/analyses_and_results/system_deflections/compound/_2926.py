...
class ZerolBevelGearMeshCompoundSystemDeflection(_2814.BevelGearMeshCompoundSystemDeflection):
    """ZerolBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2785.ZerolBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2785.ZerolBevelGearMeshSystemDeflection]':
