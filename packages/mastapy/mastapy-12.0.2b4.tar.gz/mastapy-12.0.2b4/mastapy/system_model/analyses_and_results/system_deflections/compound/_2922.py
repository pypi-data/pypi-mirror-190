...
class WormGearCompoundSystemDeflection(_2856.GearCompoundSystemDeflection):
    """WormGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2784.WormGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2784.WormGearSystemDeflection]':
