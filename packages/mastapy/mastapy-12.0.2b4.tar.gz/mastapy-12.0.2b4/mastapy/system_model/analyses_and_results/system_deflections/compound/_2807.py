...
class BeltDriveCompoundSystemDeflection(_2897.SpecialisedAssemblyCompoundSystemDeflection):
    """BeltDriveCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2646.BeltDriveSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2646.BeltDriveSystemDeflection]':
