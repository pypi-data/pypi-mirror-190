...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2907, _2908, _2815
...
class StraightBevelGearSetCompoundSystemDeflection(_2815.BevelGearSetCompoundSystemDeflection):
    """StraightBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2763.StraightBevelGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_compound_system_deflection(self) -> 'List[_2907.StraightBevelGearCompoundSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_compound_system_deflection(self) -> 'List[_2908.StraightBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2763.StraightBevelGearSetSystemDeflection]':
