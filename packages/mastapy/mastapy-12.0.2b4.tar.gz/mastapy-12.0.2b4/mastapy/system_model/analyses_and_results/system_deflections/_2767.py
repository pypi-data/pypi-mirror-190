...
from mastapy.system_model.analyses_and_results.system_deflections import _2657, _2768
...
class SynchroniserHalfSystemDeflection(_2768.SynchroniserPartSystemDeflection):
    """SynchroniserHalfSystemDeflection
    ...
    @property
    def clutch_connection(self) -> '_2657.ClutchConnectionSystemDeflection':
    ...
    @property
    def power_flow_results(self) -> '_4092.SynchroniserHalfPowerFlow':
