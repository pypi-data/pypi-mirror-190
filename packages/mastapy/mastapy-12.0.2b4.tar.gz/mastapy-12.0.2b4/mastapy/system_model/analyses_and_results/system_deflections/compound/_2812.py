...
class BevelDifferentialSunGearCompoundSystemDeflection(_2808.BevelDifferentialGearCompoundSystemDeflection):
    """BevelDifferentialSunGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2651.BevelDifferentialSunGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2651.BevelDifferentialSunGearSystemDeflection]':
