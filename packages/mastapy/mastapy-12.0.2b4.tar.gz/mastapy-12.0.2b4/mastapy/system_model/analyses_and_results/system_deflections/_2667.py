...
from mastapy.system_model.analyses_and_results.system_deflections import _2668, _2666, _2706
...
class ConceptGearSetSystemDeflection(_2706.GearSetSystemDeflection):
    """ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4007.ConceptGearSetPowerFlow':
    ...
    @property
    def concept_gears_system_deflection(self) -> 'List[_2668.ConceptGearSystemDeflection]':
    ...
    @property
    def concept_meshes_system_deflection(self) -> 'List[_2666.ConceptGearMeshSystemDeflection]':
