...
class WormGearMeshCompoundSystemDeflection(_2857.GearMeshCompoundSystemDeflection):
    """WormGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2782.WormGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2782.WormGearMeshSystemDeflection]':
