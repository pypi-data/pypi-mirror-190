...
class AbstractShaftOrHousingSystemDeflection(_2661.ComponentSystemDeflection):
    """AbstractShaftOrHousingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3977.AbstractShaftOrHousingPowerFlow':
