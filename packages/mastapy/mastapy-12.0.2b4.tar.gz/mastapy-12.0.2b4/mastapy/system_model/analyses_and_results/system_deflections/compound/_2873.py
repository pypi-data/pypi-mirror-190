...
class MassDiscCompoundSystemDeflection(_2921.VirtualComponentCompoundSystemDeflection):
    """MassDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2725.MassDiscSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2725.MassDiscSystemDeflection]':
