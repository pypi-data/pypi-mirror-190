...
class PartToPartShearCouplingCompoundSystemDeflection(_2834.CouplingCompoundSystemDeflection):
    """PartToPartShearCouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2734.PartToPartShearCouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2734.PartToPartShearCouplingSystemDeflection]':
