...
class CVTCompoundSystemDeflection(_2807.BeltDriveCompoundSystemDeflection):
    """CVTCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2680.CVTSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2680.CVTSystemDeflection]':
