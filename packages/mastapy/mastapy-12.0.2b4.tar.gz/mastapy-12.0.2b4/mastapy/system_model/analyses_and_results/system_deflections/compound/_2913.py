...
class SynchroniserHalfCompoundSystemDeflection(_2914.SynchroniserPartCompoundSystemDeflection):
    """SynchroniserHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2767.SynchroniserHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2767.SynchroniserHalfSystemDeflection]':
