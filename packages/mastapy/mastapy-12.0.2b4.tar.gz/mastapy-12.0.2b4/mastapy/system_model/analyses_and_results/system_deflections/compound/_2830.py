...
class ConicalGearMeshCompoundSystemDeflection(_2857.GearMeshCompoundSystemDeflection):
    """ConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2670.ConicalGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2670.ConicalGearMeshSystemDeflection]':
