...
class SpringDamperConnectionCompoundSystemDeflection(_2835.CouplingConnectionCompoundSystemDeflection):
    """SpringDamperConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2756.SpringDamperConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2756.SpringDamperConnectionSystemDeflection]':
