...
class OilSealCompoundSystemDeflection(_2833.ConnectorCompoundSystemDeflection):
    """OilSealCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2730.OilSealSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2730.OilSealSystemDeflection]':
