...
class RingPinsToDiscConnectionCompoundSystemDeflection(_2863.InterMountableComponentConnectionCompoundSystemDeflection):
    """RingPinsToDiscConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2741.RingPinsToDiscConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2741.RingPinsToDiscConnectionSystemDeflection]':
