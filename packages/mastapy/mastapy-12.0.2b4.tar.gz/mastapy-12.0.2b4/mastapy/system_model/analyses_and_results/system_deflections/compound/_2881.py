...
class PlanetaryConnectionCompoundSystemDeflection(_2896.ShaftToMountableComponentConnectionCompoundSystemDeflection):
    """PlanetaryConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2735.PlanetaryConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2735.PlanetaryConnectionSystemDeflection]':
