...
class ClutchCompoundSystemDeflection(_2834.CouplingCompoundSystemDeflection):
    """ClutchCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2659.ClutchSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2659.ClutchSystemDeflection]':
