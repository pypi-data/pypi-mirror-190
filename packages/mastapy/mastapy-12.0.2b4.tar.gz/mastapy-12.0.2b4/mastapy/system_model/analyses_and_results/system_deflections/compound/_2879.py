...
class PartToPartShearCouplingConnectionCompoundSystemDeflection(_2835.CouplingConnectionCompoundSystemDeflection):
    """PartToPartShearCouplingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2732.PartToPartShearCouplingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2732.PartToPartShearCouplingConnectionSystemDeflection]':
