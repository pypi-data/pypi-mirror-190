...
class BeltConnectionCompoundSystemDeflection(_2863.InterMountableComponentConnectionCompoundSystemDeflection):
    """BeltConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2645.BeltConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2645.BeltConnectionSystemDeflection]':
