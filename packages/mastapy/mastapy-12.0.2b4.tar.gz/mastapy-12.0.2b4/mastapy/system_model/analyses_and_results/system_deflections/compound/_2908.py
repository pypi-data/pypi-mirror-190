...
class StraightBevelGearMeshCompoundSystemDeflection(_2814.BevelGearMeshCompoundSystemDeflection):
    """StraightBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2762.StraightBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2762.StraightBevelGearMeshSystemDeflection]':
