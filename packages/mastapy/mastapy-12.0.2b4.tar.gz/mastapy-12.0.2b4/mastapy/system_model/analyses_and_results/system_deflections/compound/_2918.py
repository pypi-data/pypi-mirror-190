...
class TorqueConverterPumpCompoundSystemDeflection(_2836.CouplingHalfCompoundSystemDeflection):
    """TorqueConverterPumpCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2775.TorqueConverterPumpSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2775.TorqueConverterPumpSystemDeflection]':
