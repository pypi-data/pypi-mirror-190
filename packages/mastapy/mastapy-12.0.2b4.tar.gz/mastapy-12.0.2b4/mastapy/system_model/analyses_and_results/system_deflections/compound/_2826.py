...
class ConceptGearCompoundSystemDeflection(_2856.GearCompoundSystemDeflection):
    """ConceptGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2668.ConceptGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2668.ConceptGearSystemDeflection]':
