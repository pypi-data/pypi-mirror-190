...
class PointLoadCompoundSystemDeflection(_2921.VirtualComponentCompoundSystemDeflection):
    """PointLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2737.PointLoadSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2737.PointLoadSystemDeflection]':
