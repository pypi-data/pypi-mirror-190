...
class MeasurementComponentCompoundSystemDeflection(_2921.VirtualComponentCompoundSystemDeflection):
    """MeasurementComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2726.MeasurementComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2726.MeasurementComponentSystemDeflection]':
