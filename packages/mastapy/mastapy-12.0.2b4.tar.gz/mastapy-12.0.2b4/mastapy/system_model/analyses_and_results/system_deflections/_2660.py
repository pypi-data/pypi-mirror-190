...
from mastapy.system_model.analyses_and_results.power_flows import _4000, _4020
...
class CoaxialConnectionSystemDeflection(_2751.ShaftToMountableComponentConnectionSystemDeflection):
    """CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4000.CoaxialConnectionPowerFlow':
        ...
        if _4000.CoaxialConnectionPowerFlow.TYPE not in temp.__class__.__mro__:
