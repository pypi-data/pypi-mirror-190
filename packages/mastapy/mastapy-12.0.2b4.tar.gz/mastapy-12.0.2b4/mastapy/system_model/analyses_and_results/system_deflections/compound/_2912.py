...
class SynchroniserCompoundSystemDeflection(_2897.SpecialisedAssemblyCompoundSystemDeflection):
    """SynchroniserCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2770.SynchroniserSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2770.SynchroniserSystemDeflection]':
