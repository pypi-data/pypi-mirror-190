...
from mastapy.system_model.analyses_and_results.power_flows import _3985, _4016
...
class BeltConnectionSystemDeflection(_2713.InterMountableComponentConnectionSystemDeflection):
    """BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3985.BeltConnectionPowerFlow':
        ...
        if _3985.BeltConnectionPowerFlow.TYPE not in temp.__class__.__mro__:
