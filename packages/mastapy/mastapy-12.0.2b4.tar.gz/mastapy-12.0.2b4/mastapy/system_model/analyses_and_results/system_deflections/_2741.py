...
from mastapy.system_model.analyses_and_results.system_deflections import _2742, _2713
...
class RingPinsToDiscConnectionSystemDeflection(_2713.InterMountableComponentConnectionSystemDeflection):
    """RingPinsToDiscConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4069.RingPinsToDiscConnectionPowerFlow':
    ...
    @property
    def ring_pin_to_disc_contacts(self) -> 'List[_2742.RingPinToDiscContactReporting]':
