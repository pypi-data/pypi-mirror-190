...
class ConicalGearCompoundSystemDeflection(_2856.GearCompoundSystemDeflection):
    """ConicalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2672.ConicalGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2672.ConicalGearSystemDeflection]':
