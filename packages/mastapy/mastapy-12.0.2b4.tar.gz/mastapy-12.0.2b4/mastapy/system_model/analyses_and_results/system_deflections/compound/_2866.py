...
class KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection(_2831.ConicalGearSetCompoundSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2715.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2715.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
