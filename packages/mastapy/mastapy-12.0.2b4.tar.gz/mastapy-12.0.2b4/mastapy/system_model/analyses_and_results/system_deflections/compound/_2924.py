...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2922, _2923, _2858
...
class WormGearSetCompoundSystemDeflection(_2858.GearSetCompoundSystemDeflection):
    """WormGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2783.WormGearSetSystemDeflection]':
    ...
    @property
    def worm_gears_compound_system_deflection(self) -> 'List[_2922.WormGearCompoundSystemDeflection]':
    ...
    @property
    def worm_meshes_compound_system_deflection(self) -> 'List[_2923.WormGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2783.WormGearSetSystemDeflection]':
