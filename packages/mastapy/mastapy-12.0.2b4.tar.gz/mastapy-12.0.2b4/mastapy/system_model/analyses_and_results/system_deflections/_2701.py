...
from mastapy.system_model.analyses_and_results.system_deflections import _2702, _2700, _2706
...
class FaceGearSetSystemDeflection(_2706.GearSetSystemDeflection):
    """FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4032.FaceGearSetPowerFlow':
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2702.FaceGearSystemDeflection]':
    ...
    @property
    def face_meshes_system_deflection(self) -> 'List[_2700.FaceGearMeshSystemDeflection]':
