...
class TorqueConverterTurbineCompoundSystemDeflection(_2836.CouplingHalfCompoundSystemDeflection):
    """TorqueConverterTurbineCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2777.TorqueConverterTurbineSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2777.TorqueConverterTurbineSystemDeflection]':
