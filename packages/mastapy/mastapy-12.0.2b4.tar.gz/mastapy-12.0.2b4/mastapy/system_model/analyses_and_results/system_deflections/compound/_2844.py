...
class CylindricalGearCompoundSystemDeflection(_2856.GearCompoundSystemDeflection):
    """CylindricalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2693.CylindricalGearSystemDeflectionWithLTCAResults]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2693.CylindricalGearSystemDeflectionWithLTCAResults]':
