...
class StraightBevelGearCompoundSystemDeflection(_2813.BevelGearCompoundSystemDeflection):
    """StraightBevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2764.StraightBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2764.StraightBevelGearSystemDeflection]':
