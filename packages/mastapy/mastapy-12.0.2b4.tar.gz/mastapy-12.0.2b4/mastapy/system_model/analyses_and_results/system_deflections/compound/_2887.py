...
class RingPinsCompoundSystemDeflection(_2875.MountableComponentCompoundSystemDeflection):
    """RingPinsCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2740.RingPinsSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2740.RingPinsSystemDeflection]':
