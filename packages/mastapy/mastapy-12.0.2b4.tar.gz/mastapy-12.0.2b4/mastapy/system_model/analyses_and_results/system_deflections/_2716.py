...
class KlingelnbergCycloPalloidConicalGearSystemDeflection(_2672.ConicalGearSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4044.KlingelnbergCycloPalloidConicalGearPowerFlow':
