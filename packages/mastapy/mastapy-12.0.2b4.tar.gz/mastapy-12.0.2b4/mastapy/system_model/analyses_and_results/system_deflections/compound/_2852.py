...
class FaceGearMeshCompoundSystemDeflection(_2857.GearMeshCompoundSystemDeflection):
    """FaceGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2700.FaceGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2700.FaceGearMeshSystemDeflection]':
