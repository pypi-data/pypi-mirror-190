...
class AGMAGleasonConicalGearSetSystemDeflection(_2671.ConicalGearSetSystemDeflection):
    """AGMAGleasonConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3982.AGMAGleasonConicalGearSetPowerFlow':
