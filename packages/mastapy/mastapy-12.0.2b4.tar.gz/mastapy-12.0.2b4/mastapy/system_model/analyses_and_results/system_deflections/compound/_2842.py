...
class CycloidalDiscCompoundSystemDeflection(_2798.AbstractShaftCompoundSystemDeflection):
    """CycloidalDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2684.CycloidalDiscSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2684.CycloidalDiscSystemDeflection]':
