...
class CycloidalDiscCentralBearingConnectionCompoundSystemDeflection(_2821.CoaxialConnectionCompoundSystemDeflection):
    """CycloidalDiscCentralBearingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2682.CycloidalDiscCentralBearingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2682.CycloidalDiscCentralBearingConnectionSystemDeflection]':
