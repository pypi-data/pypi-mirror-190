...
class ConceptGearCompoundHarmonicAnalysisOfSingleExcitation(_6125.GearCompoundHarmonicAnalysisOfSingleExcitation):
    """ConceptGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5966.ConceptGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5966.ConceptGearHarmonicAnalysisOfSingleExcitation]':
