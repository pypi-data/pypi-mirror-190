...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5984, _5985, _5997
...
class CylindricalGearSetHarmonicAnalysisOfSingleExcitation(_5997.GearSetHarmonicAnalysisOfSingleExcitation):
    """CylindricalGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def cylindrical_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5984.CylindricalGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cylindrical_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5985.CylindricalGearMeshHarmonicAnalysisOfSingleExcitation]':
