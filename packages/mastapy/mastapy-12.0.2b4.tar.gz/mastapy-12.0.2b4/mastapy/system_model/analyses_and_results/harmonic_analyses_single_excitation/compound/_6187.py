...
class TorqueConverterTurbineCompoundHarmonicAnalysisOfSingleExcitation(_6106.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    """TorqueConverterTurbineCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6058.TorqueConverterTurbineHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6058.TorqueConverterTurbineHarmonicAnalysisOfSingleExcitation]':
