...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import (
    _5945, _5947, _5950, _5956,
    _5957, _5978, _5960, _5965,
    _5968, _5980, _5982, _5986,
    _5993, _5992, _5994, _6002,
    _6009, _6012, _6013, _6014,
    _6016, _6020, _6023, _6024,
    _6025, _6027, _6029, _6034,
    _6033, _6039, _6042, _6045,
    _6048, _6052, _6056, _6059,
    _6063, _6066, _5937
)
...
class AssemblyHarmonicAnalysisOfSingleExcitation(_5937.AbstractAssemblyHarmonicAnalysisOfSingleExcitation):
    """AssemblyHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def bearings(self) -> 'List[_5945.BearingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def belt_drives(self) -> 'List[_5947.BeltDriveHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5950.BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5956.BoltedJointHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bolts(self) -> 'List[_5957.BoltHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cv_ts(self) -> 'List[_5978.CVTHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def clutches(self) -> 'List[_5960.ClutchHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5965.ConceptCouplingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5968.ConceptGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5980.CycloidalAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5982.CycloidalDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5986.CylindricalGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def fe_parts(self) -> 'List[_5993.FEPartHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5992.FaceGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5994.FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6002.HypoidGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6009.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6012.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def mass_discs(self) -> 'List[_6013.MassDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def measurement_components(self) -> 'List[_6014.MeasurementComponentHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def oil_seals(self) -> 'List[_6016.OilSealHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6020.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6023.PlanetCarrierHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def point_loads(self) -> 'List[_6024.PointLoadHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def power_loads(self) -> 'List[_6025.PowerLoadHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def ring_pins(self) -> 'List[_6027.RingPinsHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6029.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6034.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def shafts(self) -> 'List[_6033.ShaftHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6039.SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6042.SpringDamperHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6045.StraightBevelDiffGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6048.StraightBevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def synchronisers(self) -> 'List[_6052.SynchroniserHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def torque_converters(self) -> 'List[_6056.TorqueConverterHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6059.UnbalancedMassHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6063.WormGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6066.ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation]':
