...
class ShaftCompoundHarmonicAnalysisOfSingleExcitation(_6068.AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation):
    """ShaftCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6033.ShaftHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6033.ShaftHarmonicAnalysisOfSingleExcitation]':
