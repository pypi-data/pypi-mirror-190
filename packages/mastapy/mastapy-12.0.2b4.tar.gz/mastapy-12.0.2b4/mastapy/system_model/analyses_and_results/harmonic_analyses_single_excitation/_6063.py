...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6061, _6062, _5997
...
class WormGearSetHarmonicAnalysisOfSingleExcitation(_5997.GearSetHarmonicAnalysisOfSingleExcitation):
    """WormGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def worm_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6061.WormGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6062.WormGearMeshHarmonicAnalysisOfSingleExcitation]':
