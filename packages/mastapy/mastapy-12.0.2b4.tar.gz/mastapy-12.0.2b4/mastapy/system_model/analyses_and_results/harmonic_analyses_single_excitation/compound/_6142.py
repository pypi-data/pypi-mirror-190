...
class MassDiscCompoundHarmonicAnalysisOfSingleExcitation(_6189.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """MassDiscCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6013.MassDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6013.MassDiscHarmonicAnalysisOfSingleExcitation]':
