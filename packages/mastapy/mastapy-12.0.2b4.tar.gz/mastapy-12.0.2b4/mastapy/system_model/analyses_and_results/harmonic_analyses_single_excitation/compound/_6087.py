...
class BoltedJointCompoundHarmonicAnalysisOfSingleExcitation(_6165.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """BoltedJointCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5956.BoltedJointHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5956.BoltedJointHarmonicAnalysisOfSingleExcitation]':
