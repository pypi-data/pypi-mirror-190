...
class ConceptGearCompoundModalAnalysisAtAStiffness(_4984.GearCompoundModalAnalysisAtAStiffness):
    """ConceptGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4826.ConceptGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4826.ConceptGearModalAnalysisAtAStiffness]':
