...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4903, _4902, _4814
...
class StraightBevelDiffGearSetModalAnalysisAtAStiffness(_4814.BevelGearSetModalAnalysisAtAStiffness):
    """StraightBevelDiffGearSetModalAnalysisAtAStiffness
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4903.StraightBevelDiffGearModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4902.StraightBevelDiffGearMeshModalAnalysisAtAStiffness]':
