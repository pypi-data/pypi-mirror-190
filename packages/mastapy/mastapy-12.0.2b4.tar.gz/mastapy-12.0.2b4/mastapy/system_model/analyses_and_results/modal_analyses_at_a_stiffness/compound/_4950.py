...
class CoaxialConnectionCompoundModalAnalysisAtAStiffness(_5023.ShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """CoaxialConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4820.CoaxialConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4820.CoaxialConnectionModalAnalysisAtAStiffness]':
