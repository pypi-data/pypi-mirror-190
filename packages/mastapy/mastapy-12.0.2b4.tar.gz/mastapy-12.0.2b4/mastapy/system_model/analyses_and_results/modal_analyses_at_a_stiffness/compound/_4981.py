...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4979, _4980, _4986
...
class FaceGearSetCompoundModalAnalysisAtAStiffness(_4986.GearSetCompoundModalAnalysisAtAStiffness):
    """FaceGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4852.FaceGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def face_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4979.FaceGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def face_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4980.FaceGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4852.FaceGearSetModalAnalysisAtAStiffness]':
