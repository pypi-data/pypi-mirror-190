...
class CouplingHalfCompoundModalAnalysisAtAStiffness(_5003.MountableComponentCompoundModalAnalysisAtAStiffness):
    """CouplingHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4834.CouplingHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4834.CouplingHalfModalAnalysisAtAStiffness]':
