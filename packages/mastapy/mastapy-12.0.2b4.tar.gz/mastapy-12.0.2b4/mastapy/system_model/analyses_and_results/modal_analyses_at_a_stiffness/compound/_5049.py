...
class WormGearCompoundModalAnalysisAtAStiffness(_4984.GearCompoundModalAnalysisAtAStiffness):
    """WormGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4921.WormGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4921.WormGearModalAnalysisAtAStiffness]':
