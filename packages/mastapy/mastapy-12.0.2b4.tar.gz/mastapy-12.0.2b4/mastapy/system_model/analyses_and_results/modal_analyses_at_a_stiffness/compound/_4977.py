...
class DatumCompoundModalAnalysisAtAStiffness(_4951.ComponentCompoundModalAnalysisAtAStiffness):
    """DatumCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4847.DatumModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4847.DatumModalAnalysisAtAStiffness]':
