...
class CylindricalPlanetGearCompoundModalAnalysisAtAStiffness(_4973.CylindricalGearCompoundModalAnalysisAtAStiffness):
    """CylindricalPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4846.CylindricalPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4846.CylindricalPlanetGearModalAnalysisAtAStiffness]':
