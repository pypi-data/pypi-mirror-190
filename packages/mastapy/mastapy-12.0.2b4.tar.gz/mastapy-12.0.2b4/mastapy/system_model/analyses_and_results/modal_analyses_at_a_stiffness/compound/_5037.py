...
class StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness(_5031.StraightBevelDiffGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4908.StraightBevelPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4908.StraightBevelPlanetGearModalAnalysisAtAStiffness]':
