...
class CouplingCompoundModalAnalysisAtAStiffness(_5024.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """CouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4835.CouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4835.CouplingModalAnalysisAtAStiffness]':
