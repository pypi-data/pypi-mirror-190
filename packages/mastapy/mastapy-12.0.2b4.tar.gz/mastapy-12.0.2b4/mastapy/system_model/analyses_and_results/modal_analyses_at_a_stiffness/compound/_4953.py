...
class ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness(_4964.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4822.ConceptCouplingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4822.ConceptCouplingConnectionModalAnalysisAtAStiffness]':
