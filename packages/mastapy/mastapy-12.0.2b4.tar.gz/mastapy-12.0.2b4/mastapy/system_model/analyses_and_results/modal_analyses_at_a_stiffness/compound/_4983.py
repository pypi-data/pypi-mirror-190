...
class FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness(_5024.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4854.FlexiblePinAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4854.FlexiblePinAssemblyModalAnalysisAtAStiffness]':
