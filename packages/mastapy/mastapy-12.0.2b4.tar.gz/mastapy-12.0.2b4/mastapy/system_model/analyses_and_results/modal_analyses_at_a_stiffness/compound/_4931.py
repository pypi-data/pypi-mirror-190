...
class AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness(_4959.ConicalGearMeshCompoundModalAnalysisAtAStiffness):
    """AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4800.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4800.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness]':
