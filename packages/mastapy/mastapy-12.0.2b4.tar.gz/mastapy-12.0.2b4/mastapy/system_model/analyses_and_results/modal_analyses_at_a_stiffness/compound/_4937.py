...
class BevelDifferentialGearCompoundModalAnalysisAtAStiffness(_4942.BevelGearCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4808.BevelDifferentialGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4808.BevelDifferentialGearModalAnalysisAtAStiffness]':
