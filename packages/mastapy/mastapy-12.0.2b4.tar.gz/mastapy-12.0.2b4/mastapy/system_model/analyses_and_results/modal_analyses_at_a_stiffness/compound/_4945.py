...
class BoltCompoundModalAnalysisAtAStiffness(_4951.ComponentCompoundModalAnalysisAtAStiffness):
    """BoltCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4816.BoltModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4816.BoltModalAnalysisAtAStiffness]':
