...
class AbstractAssemblyCompoundModalAnalysisAtAStiffness(_5005.PartCompoundModalAnalysisAtAStiffness):
    """AbstractAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4796.AbstractAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4796.AbstractAssemblyModalAnalysisAtAStiffness]':
