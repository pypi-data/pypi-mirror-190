...
class ComponentCompoundModalAnalysisAtAStiffness(_5005.PartCompoundModalAnalysisAtAStiffness):
    """ComponentCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4821.ComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4821.ComponentModalAnalysisAtAStiffness]':
