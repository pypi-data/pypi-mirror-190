...
class SpecialisedAssemblyCompoundModalAnalysisAtAStiffness(_4926.AbstractAssemblyCompoundModalAnalysisAtAStiffness):
    """SpecialisedAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4895.SpecialisedAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4895.SpecialisedAssemblyModalAnalysisAtAStiffness]':
