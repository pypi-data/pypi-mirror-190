...
class ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness(_4943.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4923.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4923.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
