...
class ConicalGearCompoundModalAnalysisAtAStiffness(_4984.GearCompoundModalAnalysisAtAStiffness):
    """ConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4829.ConicalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4829.ConicalGearModalAnalysisAtAStiffness]':
