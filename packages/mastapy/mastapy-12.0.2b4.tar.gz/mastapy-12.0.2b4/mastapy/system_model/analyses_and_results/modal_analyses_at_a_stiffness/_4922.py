...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4921, _4920, _4857
...
class WormGearSetModalAnalysisAtAStiffness(_4857.GearSetModalAnalysisAtAStiffness):
    """WormGearSetModalAnalysisAtAStiffness
    ...
    @property
    def worm_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4921.WormGearModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4920.WormGearMeshModalAnalysisAtAStiffness]':
