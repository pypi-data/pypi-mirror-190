...
class PlanetaryConnectionCompoundSteadyStateSynchronousResponse(_3159.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """PlanetaryConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3013.PlanetaryConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3013.PlanetaryConnectionSteadyStateSynchronousResponse]':
