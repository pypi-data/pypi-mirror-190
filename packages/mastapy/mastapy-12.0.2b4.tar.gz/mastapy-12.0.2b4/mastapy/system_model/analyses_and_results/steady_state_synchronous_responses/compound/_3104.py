...
class CVTPulleyCompoundSteadyStateSynchronousResponse(_3150.PulleyCompoundSteadyStateSynchronousResponse):
    """CVTPulleyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2970.CVTPulleySteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2970.CVTPulleySteadyStateSynchronousResponse]':
