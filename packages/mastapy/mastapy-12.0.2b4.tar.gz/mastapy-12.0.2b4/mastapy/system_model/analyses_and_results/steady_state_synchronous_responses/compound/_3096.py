...
class ConicalGearSetCompoundSteadyStateSynchronousResponse(_3122.GearSetCompoundSteadyStateSynchronousResponse):
    """ConicalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2962.ConicalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2962.ConicalGearSetSteadyStateSynchronousResponse]':
