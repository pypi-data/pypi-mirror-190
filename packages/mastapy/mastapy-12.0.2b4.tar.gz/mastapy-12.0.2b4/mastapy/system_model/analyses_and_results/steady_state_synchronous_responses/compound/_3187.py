...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3185, _3186, _3122
...
class WormGearSetCompoundSteadyStateSynchronousResponse(_3122.GearSetCompoundSteadyStateSynchronousResponse):
    """WormGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3057.WormGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_gears_compound_steady_state_synchronous_response(self) -> 'List[_3185.WormGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3186.WormGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3057.WormGearSetSteadyStateSynchronousResponse]':
