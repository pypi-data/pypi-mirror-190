...
class RingPinsCompoundSteadyStateSynchronousResponse(_3139.MountableComponentCompoundSteadyStateSynchronousResponse):
    """RingPinsCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3019.RingPinsSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3019.RingPinsSteadyStateSynchronousResponse]':
