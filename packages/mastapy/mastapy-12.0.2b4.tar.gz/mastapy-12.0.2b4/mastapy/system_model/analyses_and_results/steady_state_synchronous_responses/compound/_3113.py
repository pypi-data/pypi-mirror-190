...
class DatumCompoundSteadyStateSynchronousResponse(_3087.ComponentCompoundSteadyStateSynchronousResponse):
    """DatumCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2980.DatumSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2980.DatumSteadyStateSynchronousResponse]':
