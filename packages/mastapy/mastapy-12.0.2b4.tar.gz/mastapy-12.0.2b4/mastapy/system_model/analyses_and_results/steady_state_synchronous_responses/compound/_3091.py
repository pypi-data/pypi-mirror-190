...
class ConceptGearCompoundSteadyStateSynchronousResponse(_3120.GearCompoundSteadyStateSynchronousResponse):
    """ConceptGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2960.ConceptGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2960.ConceptGearSteadyStateSynchronousResponse]':
