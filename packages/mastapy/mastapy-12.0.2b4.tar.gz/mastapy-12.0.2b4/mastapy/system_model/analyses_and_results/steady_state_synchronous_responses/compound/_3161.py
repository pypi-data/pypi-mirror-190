...
class SpiralBevelGearCompoundSteadyStateSynchronousResponse(_3078.BevelGearCompoundSteadyStateSynchronousResponse):
    """SpiralBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3031.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3031.SpiralBevelGearSteadyStateSynchronousResponse]':
