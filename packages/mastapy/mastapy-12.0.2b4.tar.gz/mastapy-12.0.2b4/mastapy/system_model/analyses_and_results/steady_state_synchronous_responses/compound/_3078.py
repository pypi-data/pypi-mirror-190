...
class BevelGearCompoundSteadyStateSynchronousResponse(_3066.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse):
    """BevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2947.BevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2947.BevelGearSteadyStateSynchronousResponse]':
