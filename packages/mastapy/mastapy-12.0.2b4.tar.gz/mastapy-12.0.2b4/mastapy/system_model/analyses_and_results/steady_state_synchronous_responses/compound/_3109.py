...
class CylindricalGearCompoundSteadyStateSynchronousResponse(_3120.GearCompoundSteadyStateSynchronousResponse):
    """CylindricalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2978.CylindricalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2978.CylindricalGearSteadyStateSynchronousResponse]':
