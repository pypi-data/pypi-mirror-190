...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3061, _3059, _2946
...
class ZerolBevelGearSetSteadyStateSynchronousResponse(_2946.BevelGearSetSteadyStateSynchronousResponse):
    """ZerolBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def zerol_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3061.ZerolBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3059.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
