...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2994, _2992, _2934
...
class HypoidGearSetSteadyStateSynchronousResponse(_2934.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse):
    """HypoidGearSetSteadyStateSynchronousResponse
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response(self) -> 'List[_2994.HypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_meshes_steady_state_synchronous_response(self) -> 'List[_2992.HypoidGearMeshSteadyStateSynchronousResponse]':
