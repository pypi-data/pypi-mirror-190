...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2942, _2940, _2946
...
class BevelDifferentialGearSetSteadyStateSynchronousResponse(_2946.BevelGearSetSteadyStateSynchronousResponse):
    """BevelDifferentialGearSetSteadyStateSynchronousResponse
    ...
    @property
    def bevel_differential_gears_steady_state_synchronous_response(self) -> 'List[_2942.BevelDifferentialGearSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_meshes_steady_state_synchronous_response(self) -> 'List[_2940.BevelDifferentialGearMeshSteadyStateSynchronousResponse]':
