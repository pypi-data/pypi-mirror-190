...
class RollingRingConnectionCompoundSteadyStateSynchronousResponse(_3127.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """RollingRingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3022.RollingRingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3022.RollingRingConnectionSteadyStateSynchronousResponse]':
