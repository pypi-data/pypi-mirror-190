...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3031, _3029, _2946
...
class SpiralBevelGearSetSteadyStateSynchronousResponse(_2946.BevelGearSetSteadyStateSynchronousResponse):
    """SpiralBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def spiral_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3031.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3029.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
