...
class BoltedJointCompoundSteadyStateSynchronousResponse(_3160.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """BoltedJointCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2948.BoltedJointSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2948.BoltedJointSteadyStateSynchronousResponse]':
