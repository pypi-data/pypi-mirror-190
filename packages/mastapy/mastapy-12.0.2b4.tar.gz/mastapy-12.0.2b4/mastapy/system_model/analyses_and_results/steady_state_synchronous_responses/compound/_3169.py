...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3167, _3168, _3080
...
class StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse(_3080.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3039.StraightBevelDiffGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_gears_compound_steady_state_synchronous_response(self) -> 'List[_3167.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3168.StraightBevelDiffGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3039.StraightBevelDiffGearSetSteadyStateSynchronousResponse]':
