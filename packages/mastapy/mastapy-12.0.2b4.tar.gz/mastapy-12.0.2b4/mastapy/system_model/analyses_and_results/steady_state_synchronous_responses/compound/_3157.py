...
class ShaftCompoundSteadyStateSynchronousResponse(_3063.AbstractShaftCompoundSteadyStateSynchronousResponse):
    """ShaftCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3026.ShaftSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3026.ShaftSteadyStateSynchronousResponse]':
