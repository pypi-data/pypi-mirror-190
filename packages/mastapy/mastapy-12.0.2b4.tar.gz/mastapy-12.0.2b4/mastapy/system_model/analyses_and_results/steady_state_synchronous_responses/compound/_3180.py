...
class TorqueConverterConnectionCompoundSteadyStateSynchronousResponse(_3100.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """TorqueConverterConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3050.TorqueConverterConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3050.TorqueConverterConnectionSteadyStateSynchronousResponse]':
