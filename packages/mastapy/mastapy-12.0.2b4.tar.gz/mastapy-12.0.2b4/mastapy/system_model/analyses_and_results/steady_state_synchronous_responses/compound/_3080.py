...
class BevelGearSetCompoundSteadyStateSynchronousResponse(_3068.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse):
    """BevelGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2946.BevelGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2946.BevelGearSetSteadyStateSynchronousResponse]':
