...
class PartToPartShearCouplingCompoundSteadyStateSynchronousResponse(_3099.CouplingCompoundSteadyStateSynchronousResponse):
    """PartToPartShearCouplingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3012.PartToPartShearCouplingSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3012.PartToPartShearCouplingSteadyStateSynchronousResponse]':
