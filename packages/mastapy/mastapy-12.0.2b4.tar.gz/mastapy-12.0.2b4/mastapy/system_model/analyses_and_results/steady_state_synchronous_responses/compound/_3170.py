...
class StraightBevelGearCompoundSteadyStateSynchronousResponse(_3078.BevelGearCompoundSteadyStateSynchronousResponse):
    """StraightBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3043.StraightBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3043.StraightBevelGearSteadyStateSynchronousResponse]':
