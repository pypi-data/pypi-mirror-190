...
class RootAssemblyCompoundSteadyStateSynchronousResponse(_3069.AssemblyCompoundSteadyStateSynchronousResponse):
    """RootAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3024.RootAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3024.RootAssemblySteadyStateSynchronousResponse]':
