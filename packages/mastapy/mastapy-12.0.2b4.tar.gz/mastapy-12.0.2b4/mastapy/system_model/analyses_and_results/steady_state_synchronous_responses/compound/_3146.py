...
class PlanetaryGearSetCompoundSteadyStateSynchronousResponse(_3111.CylindricalGearSetCompoundSteadyStateSynchronousResponse):
    """PlanetaryGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3014.PlanetaryGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3014.PlanetaryGearSetSteadyStateSynchronousResponse]':
