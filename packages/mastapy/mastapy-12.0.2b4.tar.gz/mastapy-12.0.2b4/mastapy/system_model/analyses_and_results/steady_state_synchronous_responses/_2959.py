...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2960, _2958, _2989
...
class ConceptGearSetSteadyStateSynchronousResponse(_2989.GearSetSteadyStateSynchronousResponse):
    """ConceptGearSetSteadyStateSynchronousResponse
    ...
    @property
    def concept_gears_steady_state_synchronous_response(self) -> 'List[_2960.ConceptGearSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response(self) -> 'List[_2958.ConceptGearMeshSteadyStateSynchronousResponse]':
