...
class PointLoadCompoundSteadyStateSynchronousResponse(_3184.VirtualComponentCompoundSteadyStateSynchronousResponse):
    """PointLoadCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3016.PointLoadSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3016.PointLoadSteadyStateSynchronousResponse]':
