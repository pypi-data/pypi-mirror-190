...
class CoaxialConnectionCompoundSteadyStateSynchronousResponse(_3159.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """CoaxialConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2953.CoaxialConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2953.CoaxialConnectionSteadyStateSynchronousResponse]':
