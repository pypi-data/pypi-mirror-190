...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3115, _3116, _3122
...
class FaceGearSetCompoundSteadyStateSynchronousResponse(_3122.GearSetCompoundSteadyStateSynchronousResponse):
    """FaceGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2984.FaceGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def face_gears_compound_steady_state_synchronous_response(self) -> 'List[_3115.FaceGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def face_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3116.FaceGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2984.FaceGearSetSteadyStateSynchronousResponse]':
