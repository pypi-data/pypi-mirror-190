...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3073, _3074, _3080
...
class BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse(_3080.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2941.BevelDifferentialGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_gears_compound_steady_state_synchronous_response(self) -> 'List[_3073.BevelDifferentialGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3074.BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2941.BevelDifferentialGearSetSteadyStateSynchronousResponse]':
