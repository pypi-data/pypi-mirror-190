...
class PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse(_3100.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3010.PartToPartShearCouplingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3010.PartToPartShearCouplingConnectionSteadyStateSynchronousResponse]':
