...
class BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed(_3678.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3460.BeltDriveSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3460.BeltDriveSteadyStateSynchronousResponseAtASpeed]':
