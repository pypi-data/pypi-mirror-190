...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3499, _3497, _3509
...
class CylindricalGearSetSteadyStateSynchronousResponseAtASpeed(_3509.GearSetSteadyStateSynchronousResponseAtASpeed):
    """CylindricalGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3499.CylindricalGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3497.CylindricalGearMeshSteadyStateSynchronousResponseAtASpeed]':
