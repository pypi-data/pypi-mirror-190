...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3514, _3512, _3455
...
class HypoidGearSetSteadyStateSynchronousResponseAtASpeed(_3455.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseAtASpeed):
    """HypoidGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3514.HypoidGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def hypoid_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3512.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed]':
