...
class BoltCompoundSteadyStateSynchronousResponseAtASpeed(_3605.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """BoltCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3470.BoltSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3470.BoltSteadyStateSynchronousResponseAtASpeed]':
