...
class CVTCompoundSteadyStateSynchronousResponseAtASpeed(_3590.BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed):
    """CVTCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3492.CVTSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3492.CVTSteadyStateSynchronousResponseAtASpeed]':
