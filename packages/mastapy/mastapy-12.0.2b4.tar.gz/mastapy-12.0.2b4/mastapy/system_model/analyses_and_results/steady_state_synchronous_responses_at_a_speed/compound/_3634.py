...
class FaceGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_3639.GearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    """FaceGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3503.FaceGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3503.FaceGearMeshSteadyStateSynchronousResponseAtASpeed]':
