...
class ExternalCADModelCompoundSteadyStateSynchronousResponseAtASpeed(_3605.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """ExternalCADModelCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3502.ExternalCADModelSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3502.ExternalCADModelSteadyStateSynchronousResponseAtASpeed]':
