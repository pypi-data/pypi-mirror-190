...
class CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed(_3581.AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed):
    """CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3496.CycloidalDiscSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3496.CycloidalDiscSteadyStateSynchronousResponseAtASpeed]':
