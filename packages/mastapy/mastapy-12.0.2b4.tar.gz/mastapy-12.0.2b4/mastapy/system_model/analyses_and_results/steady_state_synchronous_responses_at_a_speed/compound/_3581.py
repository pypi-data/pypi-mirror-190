...
class AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed(_3582.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed):
    """AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3452.AbstractShaftSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3452.AbstractShaftSteadyStateSynchronousResponseAtASpeed]':
