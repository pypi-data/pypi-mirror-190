...
class MassDiscCompoundSteadyStateSynchronousResponseAtASpeed(_3702.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """MassDiscCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3525.MassDiscSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3525.MassDiscSteadyStateSynchronousResponseAtASpeed]':
