...
class VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3657.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3573.VirtualComponentSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3573.VirtualComponentSteadyStateSynchronousResponseAtASpeed]':
