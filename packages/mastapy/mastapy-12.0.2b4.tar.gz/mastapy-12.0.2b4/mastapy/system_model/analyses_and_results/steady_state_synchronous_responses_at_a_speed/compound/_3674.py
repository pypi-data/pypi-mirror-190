...
class RootAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3587.AssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """RootAssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3544.RootAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3544.RootAssemblySteadyStateSynchronousResponseAtASpeed]':
