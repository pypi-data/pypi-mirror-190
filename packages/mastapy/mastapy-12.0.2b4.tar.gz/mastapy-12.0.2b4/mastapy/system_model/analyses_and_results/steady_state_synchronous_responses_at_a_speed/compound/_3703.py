...
class WormGearCompoundSteadyStateSynchronousResponseAtASpeed(_3638.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """WormGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3576.WormGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3576.WormGearSteadyStateSynchronousResponseAtASpeed]':
