...
class ConicalGearCompoundSteadyStateSynchronousResponseAtASpeed(_3638.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConicalGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3484.ConicalGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3484.ConicalGearSteadyStateSynchronousResponseAtASpeed]':
