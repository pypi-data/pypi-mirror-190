...
class DatumCompoundSteadyStateSynchronousResponseAtASpeed(_3605.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """DatumCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3501.DatumSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3501.DatumSteadyStateSynchronousResponseAtASpeed]':
