...
from mastapy.system_model.analyses_and_results.static_loads import _6732, _6744
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results import _2626, _2570
...
class TimeSeriesLoadCaseGroup(_5595.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    def load_cases(self) -> 'List[_6732.TimeSeriesLoadCase]':
    ...
    @property
    def compound_multibody_dynamics_analysis(self) -> '_2626.CompoundMultibodyDynamicsAnalysis':
