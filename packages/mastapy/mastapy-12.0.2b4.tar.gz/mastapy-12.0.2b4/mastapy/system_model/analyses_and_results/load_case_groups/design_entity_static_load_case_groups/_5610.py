...
TConnection = TypeVar('TConnection', bound='_2224.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6775.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5611.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    """ConnectionStaticLoadCaseGroup
