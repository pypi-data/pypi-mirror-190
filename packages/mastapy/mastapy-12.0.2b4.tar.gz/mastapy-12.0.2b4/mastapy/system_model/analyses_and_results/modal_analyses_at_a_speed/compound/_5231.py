...
class CylindricalGearCompoundModalAnalysisAtASpeed(_5242.GearCompoundModalAnalysisAtASpeed):
    """CylindricalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5103.CylindricalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5103.CylindricalGearModalAnalysisAtASpeed]':
