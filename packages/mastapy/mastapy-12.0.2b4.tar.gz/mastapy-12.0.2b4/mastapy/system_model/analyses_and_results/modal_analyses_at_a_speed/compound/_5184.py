...
class AbstractAssemblyCompoundModalAnalysisAtASpeed(_5263.PartCompoundModalAnalysisAtASpeed):
    """AbstractAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5055.AbstractAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5055.AbstractAssemblyModalAnalysisAtASpeed]':
