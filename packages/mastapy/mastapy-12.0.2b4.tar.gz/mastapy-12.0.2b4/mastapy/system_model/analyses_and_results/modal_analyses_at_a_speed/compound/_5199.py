...
class BevelDifferentialSunGearCompoundModalAnalysisAtASpeed(_5195.BevelDifferentialGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialSunGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5070.BevelDifferentialSunGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5070.BevelDifferentialSunGearModalAnalysisAtASpeed]':
