...
class SpringDamperCompoundModalAnalysisAtASpeed(_5221.CouplingCompoundModalAnalysisAtASpeed):
    """SpringDamperCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5159.SpringDamperModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5159.SpringDamperModalAnalysisAtASpeed]':
