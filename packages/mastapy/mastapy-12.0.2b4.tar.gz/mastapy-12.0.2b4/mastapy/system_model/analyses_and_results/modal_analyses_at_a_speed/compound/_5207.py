...
class ClutchHalfCompoundModalAnalysisAtASpeed(_5223.CouplingHalfCompoundModalAnalysisAtASpeed):
    """ClutchHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5077.ClutchHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5077.ClutchHalfModalAnalysisAtASpeed]':
