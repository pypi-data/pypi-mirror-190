...
class BevelDifferentialGearCompoundModalAnalysisAtASpeed(_5200.BevelGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5067.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5067.BevelDifferentialGearModalAnalysisAtASpeed]':
