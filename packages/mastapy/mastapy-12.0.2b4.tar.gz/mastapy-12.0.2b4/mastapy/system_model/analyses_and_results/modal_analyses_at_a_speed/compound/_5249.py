...
class InterMountableComponentConnectionCompoundModalAnalysisAtASpeed(_5219.ConnectionCompoundModalAnalysisAtASpeed):
    """InterMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5120.InterMountableComponentConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5120.InterMountableComponentConnectionModalAnalysisAtASpeed]':
