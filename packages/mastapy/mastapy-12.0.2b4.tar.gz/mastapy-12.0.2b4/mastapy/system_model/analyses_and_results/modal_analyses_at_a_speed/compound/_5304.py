...
class TorqueConverterTurbineCompoundModalAnalysisAtASpeed(_5223.CouplingHalfCompoundModalAnalysisAtASpeed):
    """TorqueConverterTurbineCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5175.TorqueConverterTurbineModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5175.TorqueConverterTurbineModalAnalysisAtASpeed]':
