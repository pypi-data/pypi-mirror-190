...
class StraightBevelDiffGearCompoundModalAnalysisAtASpeed(_5200.BevelGearCompoundModalAnalysisAtASpeed):
    """StraightBevelDiffGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5161.StraightBevelDiffGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5161.StraightBevelDiffGearModalAnalysisAtASpeed]':
