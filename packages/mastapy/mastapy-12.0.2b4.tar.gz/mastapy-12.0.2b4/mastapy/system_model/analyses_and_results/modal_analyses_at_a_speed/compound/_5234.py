...
class CylindricalPlanetGearCompoundModalAnalysisAtASpeed(_5231.CylindricalGearCompoundModalAnalysisAtASpeed):
    """CylindricalPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5105.CylindricalPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5105.CylindricalPlanetGearModalAnalysisAtASpeed]':
