...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5307, _5308, _5244
...
class WormGearSetCompoundModalAnalysisAtASpeed(_5244.GearSetCompoundModalAnalysisAtASpeed):
    """WormGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5180.WormGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5307.WormGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def worm_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5308.WormGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5180.WormGearSetModalAnalysisAtASpeed]':
