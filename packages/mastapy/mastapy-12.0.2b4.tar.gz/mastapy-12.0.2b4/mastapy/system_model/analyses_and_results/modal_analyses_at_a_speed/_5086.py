...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5085, _5084, _5115
...
class ConceptGearSetModalAnalysisAtASpeed(_5115.GearSetModalAnalysisAtASpeed):
    """ConceptGearSetModalAnalysisAtASpeed
    ...
    @property
    def concept_gears_modal_analysis_at_a_speed(self) -> 'List[_5085.ConceptGearModalAnalysisAtASpeed]':
    ...
    @property
    def concept_meshes_modal_analysis_at_a_speed(self) -> 'List[_5084.ConceptGearMeshModalAnalysisAtASpeed]':
