...
class ConceptGearMeshCompoundModalAnalysisAtASpeed(_5243.GearMeshCompoundModalAnalysisAtASpeed):
    """ConceptGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5084.ConceptGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5084.ConceptGearMeshModalAnalysisAtASpeed]':
