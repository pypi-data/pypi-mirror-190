...
class SpecialisedAssemblyCompoundModalAnalysisAtASpeed(_5184.AbstractAssemblyCompoundModalAnalysisAtASpeed):
    """SpecialisedAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5153.SpecialisedAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5153.SpecialisedAssemblyModalAnalysisAtASpeed]':
