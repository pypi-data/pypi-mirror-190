...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5283, _5284, _5202
...
class SpiralBevelGearSetCompoundModalAnalysisAtASpeed(_5202.BevelGearSetCompoundModalAnalysisAtASpeed):
    """SpiralBevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5156.SpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5283.SpiralBevelGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5284.SpiralBevelGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5156.SpiralBevelGearSetModalAnalysisAtASpeed]':
