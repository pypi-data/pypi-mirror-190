...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5067, _5066, _5073
...
class BevelDifferentialGearSetModalAnalysisAtASpeed(_5073.BevelGearSetModalAnalysisAtASpeed):
    """BevelDifferentialGearSetModalAnalysisAtASpeed
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_speed(self) -> 'List[_5067.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis_at_a_speed(self) -> 'List[_5066.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
