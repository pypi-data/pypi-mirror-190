...
class BoltedJointCompoundModalAnalysisAtASpeed(_5282.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """BoltedJointCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5074.BoltedJointModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5074.BoltedJointModalAnalysisAtASpeed]':
