...
class RollingRingAssemblyCompoundModalAnalysisAtASpeed(_5282.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """RollingRingAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5146.RollingRingAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5146.RollingRingAssemblyModalAnalysisAtASpeed]':
