...
class ConceptCouplingHalfCompoundHarmonicAnalysis(_5847.CouplingHalfCompoundHarmonicAnalysis):
    """ConceptCouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5643.ConceptCouplingHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5643.ConceptCouplingHalfHarmonicAnalysis]':
