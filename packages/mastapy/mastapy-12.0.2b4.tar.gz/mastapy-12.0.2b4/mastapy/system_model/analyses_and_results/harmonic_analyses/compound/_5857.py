...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5855, _5856, _5868
...
class CylindricalGearSetCompoundHarmonicAnalysis(_5868.GearSetCompoundHarmonicAnalysis):
    """CylindricalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5665.CylindricalGearSetHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_harmonic_analysis(self) -> 'List[_5855.CylindricalGearCompoundHarmonicAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_harmonic_analysis(self) -> 'List[_5856.CylindricalGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5665.CylindricalGearSetHarmonicAnalysis]':
