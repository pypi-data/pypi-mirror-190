...
class SpringDamperConnectionCompoundHarmonicAnalysis(_5846.CouplingConnectionCompoundHarmonicAnalysis):
    """SpringDamperConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5745.SpringDamperConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5745.SpringDamperConnectionHarmonicAnalysis]':
