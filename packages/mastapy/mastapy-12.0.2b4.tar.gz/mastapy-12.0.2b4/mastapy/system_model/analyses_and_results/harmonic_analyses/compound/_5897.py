...
class RingPinsCompoundHarmonicAnalysis(_5885.MountableComponentCompoundHarmonicAnalysis):
    """RingPinsCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5730.RingPinsHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5730.RingPinsHarmonicAnalysis]':
