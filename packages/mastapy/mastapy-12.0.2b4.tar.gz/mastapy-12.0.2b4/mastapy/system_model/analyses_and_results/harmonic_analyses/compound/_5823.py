...
class BevelDifferentialSunGearCompoundHarmonicAnalysis(_5819.BevelDifferentialGearCompoundHarmonicAnalysis):
    """BevelDifferentialSunGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5630.BevelDifferentialSunGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5630.BevelDifferentialSunGearHarmonicAnalysis]':
