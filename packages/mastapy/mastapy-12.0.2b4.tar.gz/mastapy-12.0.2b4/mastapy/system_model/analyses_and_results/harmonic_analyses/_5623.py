...
class BearingHarmonicAnalysis(_5652.ConnectorHarmonicAnalysis):
    """BearingHarmonicAnalysis
    ...
    @property
    def rolling_bearing_speed_results(self) -> '_2027.RollingBearingSpeedResults':
    ...
    @property
    def system_deflection_results(self) -> '_2644.BearingSystemDeflection':
