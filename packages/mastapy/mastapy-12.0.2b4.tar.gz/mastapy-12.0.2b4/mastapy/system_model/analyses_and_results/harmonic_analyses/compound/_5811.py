...
class AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis(_5843.ConnectionCompoundHarmonicAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5618.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5618.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
