...
class GearCompoundHarmonicAnalysis(_5885.MountableComponentCompoundHarmonicAnalysis):
    """GearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5687.GearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5687.GearHarmonicAnalysis]':
