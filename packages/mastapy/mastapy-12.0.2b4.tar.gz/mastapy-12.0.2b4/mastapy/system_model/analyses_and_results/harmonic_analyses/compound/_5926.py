...
class TorqueConverterConnectionCompoundHarmonicAnalysis(_5846.CouplingConnectionCompoundHarmonicAnalysis):
    """TorqueConverterConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5760.TorqueConverterConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5760.TorqueConverterConnectionHarmonicAnalysis]':
