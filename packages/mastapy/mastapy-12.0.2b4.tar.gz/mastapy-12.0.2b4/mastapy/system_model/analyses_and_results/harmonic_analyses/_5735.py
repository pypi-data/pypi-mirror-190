...
class RootAssemblyHarmonicAnalysis(_5622.AssemblyHarmonicAnalysis):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self) -> '_5699.HarmonicAnalysisRootAssemblyExportOptions':
    ...
    @property
    def harmonic_analysis_inputs(self) -> '_2583.HarmonicAnalysis':
        ...
        if _2583.HarmonicAnalysis.TYPE not in temp.__class__.__mro__:
