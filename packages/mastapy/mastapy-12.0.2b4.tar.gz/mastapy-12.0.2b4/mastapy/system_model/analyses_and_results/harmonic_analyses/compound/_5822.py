...
class BevelDifferentialPlanetGearCompoundHarmonicAnalysis(_5819.BevelDifferentialGearCompoundHarmonicAnalysis):
    """BevelDifferentialPlanetGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5629.BevelDifferentialPlanetGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5629.BevelDifferentialPlanetGearHarmonicAnalysis]':
