...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5801, _5807
...
class FEPartSingleWhineAnalysisResultsPropertyAccessor(_5807.SingleWhineAnalysisResultsPropertyAccessor):
    """FEPartSingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5801.ResultsForOrderIncludingSurfaces]':
