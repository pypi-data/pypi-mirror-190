...
class CycloidalDiscCentralBearingConnectionCompoundHarmonicAnalysis(_5832.CoaxialConnectionCompoundHarmonicAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5660.CycloidalDiscCentralBearingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5660.CycloidalDiscCentralBearingConnectionHarmonicAnalysis]':
