...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5793, _5800
...
class ResultsForOrderIncludingSurfaces(_5800.ResultsForOrderIncludingNodes):
    """ResultsForOrderIncludingSurfaces
    ...
    @property
    def fe_surfaces(self) -> 'List[_5793.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]':
