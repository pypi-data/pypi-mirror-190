...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5626, _5627, _5633
...
class BevelDifferentialGearSetHarmonicAnalysis(_5633.BevelGearSetHarmonicAnalysis):
    """BevelDifferentialGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5626.BevelDifferentialGearHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gears_harmonic_analysis(self) -> 'List[_5626.BevelDifferentialGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5627.BevelDifferentialGearMeshHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_harmonic_analysis(self) -> 'List[_5627.BevelDifferentialGearMeshHarmonicAnalysis]':
