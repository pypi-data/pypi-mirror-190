...
class AbstractAssemblyCompoundHarmonicAnalysis(_5887.PartCompoundHarmonicAnalysis):
    """AbstractAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5614.AbstractAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5614.AbstractAssemblyHarmonicAnalysis]':
