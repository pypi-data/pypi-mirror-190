...
class CVTBeltConnectionCompoundHarmonicAnalysis(_5817.BeltConnectionCompoundHarmonicAnalysis):
    """CVTBeltConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5656.CVTBeltConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5656.CVTBeltConnectionHarmonicAnalysis]':
