...
class PointLoadCompoundHarmonicAnalysis(_5930.VirtualComponentCompoundHarmonicAnalysis):
    """PointLoadCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5726.PointLoadHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5726.PointLoadHarmonicAnalysis]':
