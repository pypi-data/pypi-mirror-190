...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5837, _5838, _5868
...
class ConceptGearSetCompoundHarmonicAnalysis(_5868.GearSetCompoundHarmonicAnalysis):
    """ConceptGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5647.ConceptGearSetHarmonicAnalysis]':
    ...
    @property
    def concept_gears_compound_harmonic_analysis(self) -> 'List[_5837.ConceptGearCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_meshes_compound_harmonic_analysis(self) -> 'List[_5838.ConceptGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5647.ConceptGearSetHarmonicAnalysis]':
