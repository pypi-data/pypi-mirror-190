...
class SynchroniserSleeveCompoundHarmonicAnalysis(_5923.SynchroniserPartCompoundHarmonicAnalysis):
    """SynchroniserSleeveCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5759.SynchroniserSleeveHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5759.SynchroniserSleeveHarmonicAnalysis]':
