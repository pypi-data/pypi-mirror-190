...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5790, _5795
...
class ResultsForMultipleOrdersForGroups(_5795.ResultsForMultipleOrders):
    """ResultsForMultipleOrdersForGroups
    ...
    @property
    def groups(self) -> 'List[_5790.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic]':
