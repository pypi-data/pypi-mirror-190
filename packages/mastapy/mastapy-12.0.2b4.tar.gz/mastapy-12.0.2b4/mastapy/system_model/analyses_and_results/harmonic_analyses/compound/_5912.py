...
class SpringDamperHalfCompoundHarmonicAnalysis(_5847.CouplingHalfCompoundHarmonicAnalysis):
    """SpringDamperHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5746.SpringDamperHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5746.SpringDamperHalfHarmonicAnalysis]':
