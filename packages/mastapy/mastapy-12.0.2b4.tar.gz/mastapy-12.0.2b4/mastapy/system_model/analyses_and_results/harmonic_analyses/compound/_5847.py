...
class CouplingHalfCompoundHarmonicAnalysis(_5885.MountableComponentCompoundHarmonicAnalysis):
    """CouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5654.CouplingHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5654.CouplingHalfHarmonicAnalysis]':
