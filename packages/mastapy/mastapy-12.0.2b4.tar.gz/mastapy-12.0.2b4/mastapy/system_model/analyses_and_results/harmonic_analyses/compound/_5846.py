...
class CouplingConnectionCompoundHarmonicAnalysis(_5873.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    """CouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5653.CouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5653.CouplingConnectionHarmonicAnalysis]':
