...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5645, _5646, _5692
...
class ConceptGearSetHarmonicAnalysis(_5692.GearSetHarmonicAnalysis):
    """ConceptGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5645.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def concept_gears_harmonic_analysis(self) -> 'List[_5645.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5646.ConceptGearMeshHarmonicAnalysis]':
    ...
    @property
    def concept_meshes_harmonic_analysis(self) -> 'List[_5646.ConceptGearMeshHarmonicAnalysis]':
