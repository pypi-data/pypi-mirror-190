...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5708, _5709, _5707
...
class KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis(_5707.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis
    ...
    @property
    def assembly_load_case(self) -> '_6843.KlingelnbergCycloPalloidHypoidGearSetLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2718.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection':
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5708.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_harmonic_analysis(self) -> 'List[_5708.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5709.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_harmonic_analysis(self) -> 'List[_5709.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
