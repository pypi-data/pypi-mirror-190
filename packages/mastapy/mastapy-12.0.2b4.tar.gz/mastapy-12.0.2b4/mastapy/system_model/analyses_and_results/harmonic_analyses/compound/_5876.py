...
class KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis(_5842.ConicalGearSetCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5707.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5707.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
