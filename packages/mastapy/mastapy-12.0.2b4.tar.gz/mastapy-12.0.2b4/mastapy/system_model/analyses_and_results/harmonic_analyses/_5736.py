...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5700, _5616
...
class ShaftHarmonicAnalysis(_5616.AbstractShaftHarmonicAnalysis):
    """ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4618.ShaftModalAnalysis':
    ...
    @property
    def export(self) -> '_5700.HarmonicAnalysisShaftExportOptions':
    ...
    @property
    def system_deflection_results(self) -> '_2750.ShaftSystemDeflection':
