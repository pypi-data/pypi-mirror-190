...
class PartToPartShearCouplingCompoundHarmonicAnalysis(_5845.CouplingCompoundHarmonicAnalysis):
    """PartToPartShearCouplingCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5721.PartToPartShearCouplingHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5721.PartToPartShearCouplingHarmonicAnalysis]':
