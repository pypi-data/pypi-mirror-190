...
class PartToPartShearCouplingConnectionCompoundHarmonicAnalysis(_5846.CouplingConnectionCompoundHarmonicAnalysis):
    """PartToPartShearCouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5719.PartToPartShearCouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5719.PartToPartShearCouplingConnectionHarmonicAnalysis]':
