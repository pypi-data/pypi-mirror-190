...
class StraightBevelDiffGearCompoundHarmonicAnalysis(_5824.BevelGearCompoundHarmonicAnalysis):
    """StraightBevelDiffGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5748.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5748.StraightBevelDiffGearHarmonicAnalysis]':
