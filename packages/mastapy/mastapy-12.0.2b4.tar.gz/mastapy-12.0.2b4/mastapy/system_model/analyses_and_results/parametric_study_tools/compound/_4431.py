...
class CycloidalDiscPlanetaryBearingConnectionCompoundParametricStudyTool(_4388.AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """CycloidalDiscPlanetaryBearingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4284.CycloidalDiscPlanetaryBearingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4284.CycloidalDiscPlanetaryBearingConnectionParametricStudyTool]':
