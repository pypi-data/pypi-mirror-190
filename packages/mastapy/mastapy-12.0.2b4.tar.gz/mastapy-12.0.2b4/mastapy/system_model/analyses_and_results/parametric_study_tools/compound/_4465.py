...
class PartToPartShearCouplingCompoundParametricStudyTool(_4422.CouplingCompoundParametricStudyTool):
    """PartToPartShearCouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4338.PartToPartShearCouplingParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4338.PartToPartShearCouplingParametricStudyTool]':
