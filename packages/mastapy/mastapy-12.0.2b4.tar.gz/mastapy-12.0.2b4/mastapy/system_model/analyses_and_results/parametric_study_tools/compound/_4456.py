...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4454, _4455, _4453
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool(_4453.KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4316.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_parametric_study_tool(self) -> 'List[_4454.KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_parametric_study_tool(self) -> 'List[_4455.KlingelnbergCycloPalloidHypoidGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4316.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]':
