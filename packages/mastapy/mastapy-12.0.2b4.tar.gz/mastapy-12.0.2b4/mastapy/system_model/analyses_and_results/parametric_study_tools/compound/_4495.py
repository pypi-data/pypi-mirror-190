...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4493, _4494, _4403
...
class StraightBevelGearSetCompoundParametricStudyTool(_4403.BevelGearSetCompoundParametricStudyTool):
    """StraightBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4366.StraightBevelGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4493.StraightBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4494.StraightBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4366.StraightBevelGearSetParametricStudyTool]':
