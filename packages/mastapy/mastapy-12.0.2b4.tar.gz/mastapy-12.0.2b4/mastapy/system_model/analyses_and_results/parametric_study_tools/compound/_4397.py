...
class BevelDifferentialGearMeshCompoundParametricStudyTool(_4402.BevelGearMeshCompoundParametricStudyTool):
    """BevelDifferentialGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4249.BevelDifferentialGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4249.BevelDifferentialGearMeshParametricStudyTool]':
