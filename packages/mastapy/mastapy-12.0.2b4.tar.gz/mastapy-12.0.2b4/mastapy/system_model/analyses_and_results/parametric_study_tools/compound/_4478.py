...
class RollingRingConnectionCompoundParametricStudyTool(_4450.InterMountableComponentConnectionCompoundParametricStudyTool):
    """RollingRingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4348.RollingRingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4348.RollingRingConnectionParametricStudyTool]':
