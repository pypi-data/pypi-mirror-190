...
class SpiralBevelGearCompoundParametricStudyTool(_4401.BevelGearCompoundParametricStudyTool):
    """SpiralBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4356.SpiralBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4356.SpiralBevelGearParametricStudyTool]':
