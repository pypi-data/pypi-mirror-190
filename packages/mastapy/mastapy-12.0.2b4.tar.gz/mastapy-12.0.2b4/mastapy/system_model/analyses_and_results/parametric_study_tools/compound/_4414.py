...
class ConceptGearCompoundParametricStudyTool(_4443.GearCompoundParametricStudyTool):
    """ConceptGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4268.ConceptGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4268.ConceptGearParametricStudyTool]':
