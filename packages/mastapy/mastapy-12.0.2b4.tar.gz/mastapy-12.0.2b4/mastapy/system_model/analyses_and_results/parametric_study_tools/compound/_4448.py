...
class HypoidGearMeshCompoundParametricStudyTool(_4390.AGMAGleasonConicalGearMeshCompoundParametricStudyTool):
    """HypoidGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4307.HypoidGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4307.HypoidGearMeshParametricStudyTool]':
