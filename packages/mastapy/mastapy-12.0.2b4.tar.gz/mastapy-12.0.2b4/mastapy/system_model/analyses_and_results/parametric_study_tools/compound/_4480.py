...
class ShaftCompoundParametricStudyTool(_4386.AbstractShaftCompoundParametricStudyTool):
    """ShaftCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4352.ShaftParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4352.ShaftParametricStudyTool]':
