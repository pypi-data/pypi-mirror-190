...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4414, _4415, _4445
...
class ConceptGearSetCompoundParametricStudyTool(_4445.GearSetCompoundParametricStudyTool):
    """ConceptGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4269.ConceptGearSetParametricStudyTool]':
    ...
    @property
    def concept_gears_compound_parametric_study_tool(self) -> 'List[_4414.ConceptGearCompoundParametricStudyTool]':
    ...
    @property
    def concept_meshes_compound_parametric_study_tool(self) -> 'List[_4415.ConceptGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4269.ConceptGearSetParametricStudyTool]':
