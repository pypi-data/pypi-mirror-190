...
class SpringDamperCompoundParametricStudyTool(_4422.CouplingCompoundParametricStudyTool):
    """SpringDamperCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4360.SpringDamperParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4360.SpringDamperParametricStudyTool]':
