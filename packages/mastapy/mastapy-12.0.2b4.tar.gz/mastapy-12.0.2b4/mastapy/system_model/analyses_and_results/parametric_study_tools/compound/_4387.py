...
class AbstractShaftOrHousingCompoundParametricStudyTool(_4410.ComponentCompoundParametricStudyTool):
    """AbstractShaftOrHousingCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4239.AbstractShaftOrHousingParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4239.AbstractShaftOrHousingParametricStudyTool]':
