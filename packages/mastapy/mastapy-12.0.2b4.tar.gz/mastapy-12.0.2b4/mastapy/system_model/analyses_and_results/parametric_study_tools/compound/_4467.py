...
class PartToPartShearCouplingHalfCompoundParametricStudyTool(_4424.CouplingHalfCompoundParametricStudyTool):
    """PartToPartShearCouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4337.PartToPartShearCouplingHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4337.PartToPartShearCouplingHalfParametricStudyTool]':
