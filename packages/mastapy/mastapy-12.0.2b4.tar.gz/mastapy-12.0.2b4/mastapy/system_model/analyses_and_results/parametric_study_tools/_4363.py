...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4362, _4361, _4256
...
class StraightBevelDiffGearSetParametricStudyTool(_4256.BevelGearSetParametricStudyTool):
    """StraightBevelDiffGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_diff_gears_parametric_study_tool(self) -> 'List[_4362.StraightBevelDiffGearParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_meshes_parametric_study_tool(self) -> 'List[_4361.StraightBevelDiffGearMeshParametricStudyTool]':
