...
class MassDiscCompoundParametricStudyTool(_4507.VirtualComponentCompoundParametricStudyTool):
    """MassDiscCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4320.MassDiscParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4320.MassDiscParametricStudyTool]':
