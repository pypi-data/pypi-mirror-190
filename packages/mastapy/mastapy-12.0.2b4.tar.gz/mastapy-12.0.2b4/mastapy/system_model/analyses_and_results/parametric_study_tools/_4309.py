...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4308, _4307, _4244
...
class HypoidGearSetParametricStudyTool(_4244.AGMAGleasonConicalGearSetParametricStudyTool):
    """HypoidGearSetParametricStudyTool
    ...
    @property
    def hypoid_gears_parametric_study_tool(self) -> 'List[_4308.HypoidGearParametricStudyTool]':
    ...
    @property
    def hypoid_meshes_parametric_study_tool(self) -> 'List[_4307.HypoidGearMeshParametricStudyTool]':
