...
class SpecialisedAssemblyCompoundParametricStudyTool(_4385.AbstractAssemblyCompoundParametricStudyTool):
    """SpecialisedAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4354.SpecialisedAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4354.SpecialisedAssemblyParametricStudyTool]':
