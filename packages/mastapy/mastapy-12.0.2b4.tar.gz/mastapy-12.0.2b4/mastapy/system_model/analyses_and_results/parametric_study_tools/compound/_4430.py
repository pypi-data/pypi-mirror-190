...
class CycloidalDiscCompoundParametricStudyTool(_4386.AbstractShaftCompoundParametricStudyTool):
    """CycloidalDiscCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4283.CycloidalDiscParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4283.CycloidalDiscParametricStudyTool]':
