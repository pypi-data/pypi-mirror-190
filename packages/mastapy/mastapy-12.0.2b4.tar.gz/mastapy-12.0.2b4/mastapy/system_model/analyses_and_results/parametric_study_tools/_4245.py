...
from mastapy.system_model.analyses_and_results.parametric_study_tools import (
    _4292, _4246, _4248, _4251,
    _4257, _4258, _4279, _4261,
    _4266, _4269, _4281, _4283,
    _4287, _4301, _4300, _4302,
    _4309, _4316, _4319, _4320,
    _4321, _4324, _4338, _4341,
    _4342, _4343, _4345, _4347,
    _4351, _4352, _4357, _4360,
    _4363, _4366, _4370, _4374,
    _4377, _4381, _4384, _4238
)
...
class AssemblyParametricStudyTool(_4238.AbstractAssemblyParametricStudyTool):
    """AssemblyParametricStudyTool
    ...
    @property
    def all_duty_cycle_results(self) -> 'List[_4292.DutyCycleResultsForAllComponents]':
    ...
    @property
    def bearings(self) -> 'List[_4246.BearingParametricStudyTool]':
    ...
    @property
    def belt_drives(self) -> 'List[_4248.BeltDriveParametricStudyTool]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4251.BevelDifferentialGearSetParametricStudyTool]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4257.BoltedJointParametricStudyTool]':
    ...
    @property
    def bolts(self) -> 'List[_4258.BoltParametricStudyTool]':
    ...
    @property
    def cv_ts(self) -> 'List[_4279.CVTParametricStudyTool]':
    ...
    @property
    def clutches(self) -> 'List[_4261.ClutchParametricStudyTool]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4266.ConceptCouplingParametricStudyTool]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4269.ConceptGearSetParametricStudyTool]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4281.CycloidalAssemblyParametricStudyTool]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4283.CycloidalDiscParametricStudyTool]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4287.CylindricalGearSetParametricStudyTool]':
    ...
    @property
    def fe_parts(self) -> 'List[_4301.FEPartParametricStudyTool]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4300.FaceGearSetParametricStudyTool]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4302.FlexiblePinAssemblyParametricStudyTool]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4309.HypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4316.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4319.KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def mass_discs(self) -> 'List[_4320.MassDiscParametricStudyTool]':
    ...
    @property
    def measurement_components(self) -> 'List[_4321.MeasurementComponentParametricStudyTool]':
    ...
    @property
    def oil_seals(self) -> 'List[_4324.OilSealParametricStudyTool]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4338.PartToPartShearCouplingParametricStudyTool]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4341.PlanetCarrierParametricStudyTool]':
    ...
    @property
    def point_loads(self) -> 'List[_4342.PointLoadParametricStudyTool]':
    ...
    @property
    def power_loads(self) -> 'List[_4343.PowerLoadParametricStudyTool]':
    ...
    @property
    def ring_pins(self) -> 'List[_4345.RingPinsParametricStudyTool]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4347.RollingRingAssemblyParametricStudyTool]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4351.ShaftHubConnectionParametricStudyTool]':
    ...
    @property
    def shafts(self) -> 'List[_4352.ShaftParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4357.SpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4360.SpringDamperParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4363.StraightBevelDiffGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4366.StraightBevelGearSetParametricStudyTool]':
    ...
    @property
    def synchronisers(self) -> 'List[_4370.SynchroniserParametricStudyTool]':
    ...
    @property
    def torque_converters(self) -> 'List[_4374.TorqueConverterParametricStudyTool]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4377.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4381.WormGearSetParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4384.ZerolBevelGearSetParametricStudyTool]':
