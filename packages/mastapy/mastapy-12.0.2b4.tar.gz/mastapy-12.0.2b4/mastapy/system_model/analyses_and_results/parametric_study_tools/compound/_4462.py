...
class MountableComponentCompoundParametricStudyTool(_4410.ComponentCompoundParametricStudyTool):
    """MountableComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4323.MountableComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4323.MountableComponentParametricStudyTool]':
