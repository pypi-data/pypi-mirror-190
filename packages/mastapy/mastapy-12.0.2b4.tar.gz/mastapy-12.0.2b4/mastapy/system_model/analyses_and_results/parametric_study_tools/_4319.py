...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4318, _4317, _4313
...
class KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool(_4313.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool):
    """KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_parametric_study_tool(self) -> 'List[_4318.KlingelnbergCycloPalloidSpiralBevelGearParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_parametric_study_tool(self) -> 'List[_4317.KlingelnbergCycloPalloidSpiralBevelGearMeshParametricStudyTool]':
