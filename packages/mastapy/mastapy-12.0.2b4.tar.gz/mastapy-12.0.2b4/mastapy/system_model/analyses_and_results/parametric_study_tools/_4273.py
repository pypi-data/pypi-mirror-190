...
class ConnectionParametricStudyTool(_7462.ConnectionAnalysisCase):
    """ConnectionParametricStudyTool
    ...
    @property
    def data_logger(self) -> '_1812.DataLoggerWithCharts':
    ...
    @property
    def parametric_study_tool(self) -> '_4330.ParametricStudyTool':
