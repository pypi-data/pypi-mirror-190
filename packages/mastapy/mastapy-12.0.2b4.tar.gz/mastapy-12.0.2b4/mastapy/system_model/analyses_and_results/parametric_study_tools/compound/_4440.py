...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4438, _4439, _4445
...
class FaceGearSetCompoundParametricStudyTool(_4445.GearSetCompoundParametricStudyTool):
    """FaceGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4300.FaceGearSetParametricStudyTool]':
    ...
    @property
    def face_gears_compound_parametric_study_tool(self) -> 'List[_4438.FaceGearCompoundParametricStudyTool]':
    ...
    @property
    def face_meshes_compound_parametric_study_tool(self) -> 'List[_4439.FaceGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4300.FaceGearSetParametricStudyTool]':
