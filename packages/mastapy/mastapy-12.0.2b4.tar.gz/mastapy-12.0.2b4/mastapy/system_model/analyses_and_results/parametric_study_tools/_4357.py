...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4356, _4355, _4256
...
class SpiralBevelGearSetParametricStudyTool(_4256.BevelGearSetParametricStudyTool):
    """SpiralBevelGearSetParametricStudyTool
    ...
    @property
    def spiral_bevel_gears_parametric_study_tool(self) -> 'List[_4356.SpiralBevelGearParametricStudyTool]':
    ...
    @property
    def spiral_bevel_meshes_parametric_study_tool(self) -> 'List[_4355.SpiralBevelGearMeshParametricStudyTool]':
