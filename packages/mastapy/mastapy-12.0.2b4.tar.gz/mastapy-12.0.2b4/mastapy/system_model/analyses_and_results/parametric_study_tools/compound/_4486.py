...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4484, _4485, _4403
...
class SpiralBevelGearSetCompoundParametricStudyTool(_4403.BevelGearSetCompoundParametricStudyTool):
    """SpiralBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4357.SpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4484.SpiralBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def spiral_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4485.SpiralBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4357.SpiralBevelGearSetParametricStudyTool]':
