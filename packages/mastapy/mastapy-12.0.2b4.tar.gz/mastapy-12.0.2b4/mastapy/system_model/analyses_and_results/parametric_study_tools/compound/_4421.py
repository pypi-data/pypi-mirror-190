...
class ConnectorCompoundParametricStudyTool(_4462.MountableComponentCompoundParametricStudyTool):
    """ConnectorCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4274.ConnectorParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4274.ConnectorParametricStudyTool]':
