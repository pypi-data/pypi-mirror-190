...
class CouplingConnectionCompoundParametricStudyTool(_4450.InterMountableComponentConnectionCompoundParametricStudyTool):
    """CouplingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4275.CouplingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4275.CouplingConnectionParametricStudyTool]':
