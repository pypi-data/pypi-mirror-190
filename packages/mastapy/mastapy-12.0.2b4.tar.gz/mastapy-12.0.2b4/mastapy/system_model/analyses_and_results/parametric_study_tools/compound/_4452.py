...
class KlingelnbergCycloPalloidConicalGearMeshCompoundParametricStudyTool(_4418.ConicalGearMeshCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4311.KlingelnbergCycloPalloidConicalGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4311.KlingelnbergCycloPalloidConicalGearMeshParametricStudyTool]':
