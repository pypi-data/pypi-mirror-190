...
class CylindricalGearParametricStudyTool(_4304.GearParametricStudyTool):
    """CylindricalGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2691.CylindricalGearSystemDeflection]':
