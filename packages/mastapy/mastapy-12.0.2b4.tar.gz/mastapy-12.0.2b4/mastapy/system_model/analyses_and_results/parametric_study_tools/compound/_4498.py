...
class SynchroniserCompoundParametricStudyTool(_4483.SpecialisedAssemblyCompoundParametricStudyTool):
    """SynchroniserCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4370.SynchroniserParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4370.SynchroniserParametricStudyTool]':
