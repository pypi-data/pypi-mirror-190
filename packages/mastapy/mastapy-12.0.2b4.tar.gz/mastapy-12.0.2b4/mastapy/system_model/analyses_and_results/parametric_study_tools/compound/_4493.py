...
class StraightBevelGearCompoundParametricStudyTool(_4401.BevelGearCompoundParametricStudyTool):
    """StraightBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4365.StraightBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4365.StraightBevelGearParametricStudyTool]':
