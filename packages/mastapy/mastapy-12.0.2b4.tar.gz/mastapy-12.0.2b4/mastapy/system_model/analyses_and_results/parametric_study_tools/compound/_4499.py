...
class SynchroniserHalfCompoundParametricStudyTool(_4500.SynchroniserPartCompoundParametricStudyTool):
    """SynchroniserHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4369.SynchroniserHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4369.SynchroniserHalfParametricStudyTool]':
