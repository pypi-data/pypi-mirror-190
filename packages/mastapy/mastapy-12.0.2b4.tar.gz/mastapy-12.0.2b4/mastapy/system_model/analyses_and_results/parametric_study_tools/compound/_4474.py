...
class RingPinsCompoundParametricStudyTool(_4462.MountableComponentCompoundParametricStudyTool):
    """RingPinsCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4345.RingPinsParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4345.RingPinsParametricStudyTool]':
