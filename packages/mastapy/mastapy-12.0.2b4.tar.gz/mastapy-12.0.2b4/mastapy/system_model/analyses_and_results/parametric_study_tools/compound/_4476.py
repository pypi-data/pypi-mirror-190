...
class RollingRingAssemblyCompoundParametricStudyTool(_4483.SpecialisedAssemblyCompoundParametricStudyTool):
    """RollingRingAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4347.RollingRingAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4347.RollingRingAssemblyParametricStudyTool]':
