...
class PowerLoadCompoundParametricStudyTool(_4507.VirtualComponentCompoundParametricStudyTool):
    """PowerLoadCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4343.PowerLoadParametricStudyTool]':
    ...
    @property
    def load_cases(self) -> 'List[_6865.PowerLoadLoadCase]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4343.PowerLoadParametricStudyTool]':
