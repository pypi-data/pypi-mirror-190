...
class CylindricalGearMeshParametricStudyTool(_4303.GearMeshParametricStudyTool):
    """CylindricalGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2685.CylindricalGearMeshSystemDeflection]':
