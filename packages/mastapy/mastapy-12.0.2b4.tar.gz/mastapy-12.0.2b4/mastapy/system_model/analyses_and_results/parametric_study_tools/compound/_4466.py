...
class PartToPartShearCouplingConnectionCompoundParametricStudyTool(_4423.CouplingConnectionCompoundParametricStudyTool):
    """PartToPartShearCouplingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4336.PartToPartShearCouplingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4336.PartToPartShearCouplingConnectionParametricStudyTool]':
