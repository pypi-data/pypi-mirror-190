...
class BevelGearCompoundPowerFlow(_4113.AGMAGleasonConicalGearCompoundPowerFlow):
    """BevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3993.BevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3993.BevelGearPowerFlow]':
