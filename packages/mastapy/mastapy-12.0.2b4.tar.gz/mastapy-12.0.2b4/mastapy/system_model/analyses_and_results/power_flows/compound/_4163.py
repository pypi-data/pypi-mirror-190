...
class FaceGearMeshCompoundPowerFlow(_4168.GearMeshCompoundPowerFlow):
    """FaceGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4030.FaceGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4030.FaceGearMeshPowerFlow]':
