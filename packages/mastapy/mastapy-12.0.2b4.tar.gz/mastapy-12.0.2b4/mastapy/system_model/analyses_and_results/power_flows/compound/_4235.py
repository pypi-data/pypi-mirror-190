...
class ZerolBevelGearCompoundPowerFlow(_4125.BevelGearCompoundPowerFlow):
    """ZerolBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4107.ZerolBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4107.ZerolBevelGearPowerFlow]':
