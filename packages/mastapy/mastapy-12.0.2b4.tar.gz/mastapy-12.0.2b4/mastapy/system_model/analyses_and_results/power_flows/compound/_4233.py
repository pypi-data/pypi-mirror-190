...
class WormGearMeshCompoundPowerFlow(_4168.GearMeshCompoundPowerFlow):
    """WormGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4103.WormGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4103.WormGearMeshPowerFlow]':
