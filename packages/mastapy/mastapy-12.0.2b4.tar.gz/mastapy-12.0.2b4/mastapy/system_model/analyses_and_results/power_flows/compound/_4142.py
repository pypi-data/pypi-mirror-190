...
class ConicalGearMeshCompoundPowerFlow(_4168.GearMeshCompoundPowerFlow):
    """ConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4008.ConicalGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4008.ConicalGearMeshPowerFlow]':
