...
from mastapy.system_model.analyses_and_results.power_flows import _4107, _4106, _3994
...
class ZerolBevelGearSetPowerFlow(_3994.BevelGearSetPowerFlow):
    """ZerolBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4107.ZerolBevelGearPowerFlow]':
    ...
    @property
    def zerol_bevel_gears_power_flow(self) -> 'List[_4107.ZerolBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4106.ZerolBevelGearMeshPowerFlow]':
    ...
    @property
    def zerol_bevel_meshes_power_flow(self) -> 'List[_4106.ZerolBevelGearMeshPowerFlow]':
