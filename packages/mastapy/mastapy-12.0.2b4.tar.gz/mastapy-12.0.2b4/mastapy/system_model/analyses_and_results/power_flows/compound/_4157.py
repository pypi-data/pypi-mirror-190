...
class CylindricalGearMeshCompoundPowerFlow(_4168.GearMeshCompoundPowerFlow):
    """CylindricalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4024.CylindricalGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4024.CylindricalGearMeshPowerFlow]':
