...
class CoaxialConnectionCompoundPowerFlow(_4206.ShaftToMountableComponentConnectionCompoundPowerFlow):
    """CoaxialConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4000.CoaxialConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4000.CoaxialConnectionPowerFlow]':
