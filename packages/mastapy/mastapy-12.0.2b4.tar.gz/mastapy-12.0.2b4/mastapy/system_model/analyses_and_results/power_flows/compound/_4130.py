...
class ClutchCompoundPowerFlow(_4146.CouplingCompoundPowerFlow):
    """ClutchCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3999.ClutchPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3999.ClutchPowerFlow]':
