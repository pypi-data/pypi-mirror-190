...
class SynchroniserCompoundPowerFlow(_4207.SpecialisedAssemblyCompoundPowerFlow):
    """SynchroniserCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4094.SynchroniserPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4094.SynchroniserPowerFlow]':
