...
class PulleyCompoundPowerFlow(_4148.CouplingHalfCompoundPowerFlow):
    """PulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4067.PulleyPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4067.PulleyPowerFlow]':
