...
class PartToPartShearCouplingConnectionCompoundPowerFlow(_4147.CouplingConnectionCompoundPowerFlow):
    """PartToPartShearCouplingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4057.PartToPartShearCouplingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4057.PartToPartShearCouplingConnectionPowerFlow]':
