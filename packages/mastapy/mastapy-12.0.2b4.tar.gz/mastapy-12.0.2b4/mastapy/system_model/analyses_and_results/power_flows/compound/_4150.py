...
class CVTCompoundPowerFlow(_4119.BeltDriveCompoundPowerFlow):
    """CVTCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4017.CVTPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4017.CVTPowerFlow]':
