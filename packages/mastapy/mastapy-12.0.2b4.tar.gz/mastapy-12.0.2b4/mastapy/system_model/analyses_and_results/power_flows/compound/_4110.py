...
class AbstractShaftCompoundPowerFlow(_4111.AbstractShaftOrHousingCompoundPowerFlow):
    """AbstractShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3978.AbstractShaftPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3978.AbstractShaftPowerFlow]':
