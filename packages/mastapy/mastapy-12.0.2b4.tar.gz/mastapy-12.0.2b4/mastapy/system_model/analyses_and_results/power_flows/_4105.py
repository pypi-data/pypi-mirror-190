...
from mastapy.system_model.analyses_and_results.power_flows import _4104, _4103, _4037
...
class WormGearSetPowerFlow(_4037.GearSetPowerFlow):
    """WormGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4104.WormGearPowerFlow]':
    ...
    @property
    def worm_gears_power_flow(self) -> 'List[_4104.WormGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4103.WormGearMeshPowerFlow]':
    ...
    @property
    def worm_meshes_power_flow(self) -> 'List[_4103.WormGearMeshPowerFlow]':
