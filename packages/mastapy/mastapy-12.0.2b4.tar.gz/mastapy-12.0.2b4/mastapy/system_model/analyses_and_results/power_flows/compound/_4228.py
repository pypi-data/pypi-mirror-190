...
class TorqueConverterPumpCompoundPowerFlow(_4148.CouplingHalfCompoundPowerFlow):
    """TorqueConverterPumpCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4099.TorqueConverterPumpPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4099.TorqueConverterPumpPowerFlow]':
