...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4120, _4121, _4127
...
class BevelDifferentialGearSetCompoundPowerFlow(_4127.BevelGearSetCompoundPowerFlow):
    """BevelDifferentialGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3989.BevelDifferentialGearSetPowerFlow]':
    ...
    @property
    def bevel_differential_gears_compound_power_flow(self) -> 'List[_4120.BevelDifferentialGearCompoundPowerFlow]':
    ...
    @property
    def bevel_differential_meshes_compound_power_flow(self) -> 'List[_4121.BevelDifferentialGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3989.BevelDifferentialGearSetPowerFlow]':
