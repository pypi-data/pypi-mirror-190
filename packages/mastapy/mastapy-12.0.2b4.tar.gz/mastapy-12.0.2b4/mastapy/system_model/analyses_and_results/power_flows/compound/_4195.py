...
class PointLoadCompoundPowerFlow(_4231.VirtualComponentCompoundPowerFlow):
    """PointLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4063.PointLoadPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4063.PointLoadPowerFlow]':
