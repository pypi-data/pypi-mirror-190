...
from mastapy.system_model.analyses_and_results.power_flows import _4050, _4049, _4045
...
class KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow(_4045.KlingelnbergCycloPalloidConicalGearSetPowerFlow):
    """KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4050.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_power_flow(self) -> 'List[_4050.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4049.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_power_flow(self) -> 'List[_4049.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow]':
