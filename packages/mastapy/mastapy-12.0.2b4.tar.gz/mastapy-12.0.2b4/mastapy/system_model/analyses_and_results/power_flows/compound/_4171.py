...
class HypoidGearCompoundPowerFlow(_4113.AGMAGleasonConicalGearCompoundPowerFlow):
    """HypoidGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4040.HypoidGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4040.HypoidGearPowerFlow]':
