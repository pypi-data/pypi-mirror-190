...
class BevelDifferentialPlanetGearCompoundPowerFlow(_4120.BevelDifferentialGearCompoundPowerFlow):
    """BevelDifferentialPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3990.BevelDifferentialPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3990.BevelDifferentialPlanetGearPowerFlow]':
