...
class GearCompoundPowerFlow(_4186.MountableComponentCompoundPowerFlow):
    """GearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4036.GearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4036.GearPowerFlow]':
