...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4162, _4163, _4169
...
class FaceGearSetCompoundPowerFlow(_4169.GearSetCompoundPowerFlow):
    """FaceGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4032.FaceGearSetPowerFlow]':
    ...
    @property
    def face_gears_compound_power_flow(self) -> 'List[_4162.FaceGearCompoundPowerFlow]':
    ...
    @property
    def face_meshes_compound_power_flow(self) -> 'List[_4163.FaceGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4032.FaceGearSetPowerFlow]':
