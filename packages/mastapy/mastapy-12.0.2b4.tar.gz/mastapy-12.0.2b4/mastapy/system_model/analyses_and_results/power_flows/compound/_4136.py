...
class ConceptCouplingConnectionCompoundPowerFlow(_4147.CouplingConnectionCompoundPowerFlow):
    """ConceptCouplingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4002.ConceptCouplingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4002.ConceptCouplingConnectionPowerFlow]':
