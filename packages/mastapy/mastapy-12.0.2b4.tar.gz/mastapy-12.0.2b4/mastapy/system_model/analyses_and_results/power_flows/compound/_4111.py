...
class AbstractShaftOrHousingCompoundPowerFlow(_4134.ComponentCompoundPowerFlow):
    """AbstractShaftOrHousingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3977.AbstractShaftOrHousingPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3977.AbstractShaftOrHousingPowerFlow]':
