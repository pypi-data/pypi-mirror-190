...
class StraightBevelPlanetGearCompoundPowerFlow(_4214.StraightBevelDiffGearCompoundPowerFlow):
    """StraightBevelPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4090.StraightBevelPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4090.StraightBevelPlanetGearPowerFlow]':
