...
class PlanetCarrierCompoundPowerFlow(_4186.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4062.PlanetCarrierPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4062.PlanetCarrierPowerFlow]':
