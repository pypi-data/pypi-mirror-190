...
class BevelDifferentialGearMeshCompoundPowerFlow(_4126.BevelGearMeshCompoundPowerFlow):
    """BevelDifferentialGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3987.BevelDifferentialGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3987.BevelDifferentialGearMeshPowerFlow]':
