...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4181, _4182, _4177
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow(_4177.KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4051.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_power_flow(self) -> 'List[_4181.KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_power_flow(self) -> 'List[_4182.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4051.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
