...
class PartCompoundPowerFlow(_7470.PartCompoundAnalysis):
    """PartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4056.PartPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4056.PartPowerFlow]':
