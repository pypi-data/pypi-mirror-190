...
from mastapy.system_model.analyses_and_results.power_flows.compound import (
    _4117, _4119, _4122, _4129,
    _4128, _4150, _4130, _4135,
    _4140, _4152, _4154, _4158,
    _4165, _4164, _4166, _4173,
    _4180, _4183, _4184, _4185,
    _4187, _4189, _4194, _4195,
    _4196, _4198, _4200, _4205,
    _4204, _4210, _4211, _4216,
    _4219, _4222, _4226, _4230,
    _4234, _4237, _4109
)
...
class AssemblyCompoundPowerFlow(_4109.AbstractAssemblyCompoundPowerFlow):
    """AssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3983.AssemblyPowerFlow]':
    ...
    @property
    def bearings(self) -> 'List[_4117.BearingCompoundPowerFlow]':
    ...
    @property
    def belt_drives(self) -> 'List[_4119.BeltDriveCompoundPowerFlow]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4122.BevelDifferentialGearSetCompoundPowerFlow]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4129.BoltedJointCompoundPowerFlow]':
    ...
    @property
    def bolts(self) -> 'List[_4128.BoltCompoundPowerFlow]':
    ...
    @property
    def cv_ts(self) -> 'List[_4150.CVTCompoundPowerFlow]':
    ...
    @property
    def clutches(self) -> 'List[_4130.ClutchCompoundPowerFlow]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4135.ConceptCouplingCompoundPowerFlow]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4140.ConceptGearSetCompoundPowerFlow]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4152.CycloidalAssemblyCompoundPowerFlow]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4154.CycloidalDiscCompoundPowerFlow]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4158.CylindricalGearSetCompoundPowerFlow]':
    ...
    @property
    def fe_parts(self) -> 'List[_4165.FEPartCompoundPowerFlow]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4164.FaceGearSetCompoundPowerFlow]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4166.FlexiblePinAssemblyCompoundPowerFlow]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4173.HypoidGearSetCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4180.KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4183.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def mass_discs(self) -> 'List[_4184.MassDiscCompoundPowerFlow]':
    ...
    @property
    def measurement_components(self) -> 'List[_4185.MeasurementComponentCompoundPowerFlow]':
    ...
    @property
    def oil_seals(self) -> 'List[_4187.OilSealCompoundPowerFlow]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4189.PartToPartShearCouplingCompoundPowerFlow]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4194.PlanetCarrierCompoundPowerFlow]':
    ...
    @property
    def point_loads(self) -> 'List[_4195.PointLoadCompoundPowerFlow]':
    ...
    @property
    def power_loads(self) -> 'List[_4196.PowerLoadCompoundPowerFlow]':
    ...
    @property
    def ring_pins(self) -> 'List[_4198.RingPinsCompoundPowerFlow]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4200.RollingRingAssemblyCompoundPowerFlow]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4205.ShaftHubConnectionCompoundPowerFlow]':
    ...
    @property
    def shafts(self) -> 'List[_4204.ShaftCompoundPowerFlow]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4210.SpiralBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4211.SpringDamperCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4216.StraightBevelDiffGearSetCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4219.StraightBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def synchronisers(self) -> 'List[_4222.SynchroniserCompoundPowerFlow]':
    ...
    @property
    def torque_converters(self) -> 'List[_4226.TorqueConverterCompoundPowerFlow]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4230.UnbalancedMassCompoundPowerFlow]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4234.WormGearSetCompoundPowerFlow]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4237.ZerolBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3983.AssemblyPowerFlow]':
