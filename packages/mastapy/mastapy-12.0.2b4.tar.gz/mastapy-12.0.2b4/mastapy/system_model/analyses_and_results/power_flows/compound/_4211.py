...
class SpringDamperCompoundPowerFlow(_4146.CouplingCompoundPowerFlow):
    """SpringDamperCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4083.SpringDamperPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4083.SpringDamperPowerFlow]':
