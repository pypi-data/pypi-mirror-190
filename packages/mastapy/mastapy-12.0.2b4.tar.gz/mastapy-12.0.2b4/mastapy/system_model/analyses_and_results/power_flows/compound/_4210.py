...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4208, _4209, _4127
...
class SpiralBevelGearSetCompoundPowerFlow(_4127.BevelGearSetCompoundPowerFlow):
    """SpiralBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4080.SpiralBevelGearSetPowerFlow]':
    ...
    @property
    def spiral_bevel_gears_compound_power_flow(self) -> 'List[_4208.SpiralBevelGearCompoundPowerFlow]':
    ...
    @property
    def spiral_bevel_meshes_compound_power_flow(self) -> 'List[_4209.SpiralBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4080.SpiralBevelGearSetPowerFlow]':
