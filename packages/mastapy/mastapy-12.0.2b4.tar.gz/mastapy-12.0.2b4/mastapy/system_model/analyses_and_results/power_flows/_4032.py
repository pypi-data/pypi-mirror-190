...
from mastapy.system_model.analyses_and_results.power_flows import _4031, _4030, _4037
...
class FaceGearSetPowerFlow(_4037.GearSetPowerFlow):
    """FaceGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4031.FaceGearPowerFlow]':
    ...
    @property
    def face_gears_power_flow(self) -> 'List[_4031.FaceGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4030.FaceGearMeshPowerFlow]':
    ...
    @property
    def face_meshes_power_flow(self) -> 'List[_4030.FaceGearMeshPowerFlow]':
