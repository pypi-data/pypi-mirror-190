...
class ConnectionCompoundPowerFlow(_7463.ConnectionCompoundAnalysis):
    """ConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4011.ConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4011.ConnectionPowerFlow]':
