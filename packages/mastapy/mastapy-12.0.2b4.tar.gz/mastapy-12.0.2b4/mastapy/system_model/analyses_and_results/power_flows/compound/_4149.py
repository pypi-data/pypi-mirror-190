...
class CVTBeltConnectionCompoundPowerFlow(_4118.BeltConnectionCompoundPowerFlow):
    """CVTBeltConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4016.CVTBeltConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4016.CVTBeltConnectionPowerFlow]':
