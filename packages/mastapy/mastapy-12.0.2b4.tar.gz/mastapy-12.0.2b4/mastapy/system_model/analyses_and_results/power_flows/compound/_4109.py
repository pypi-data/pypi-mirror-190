...
class AbstractAssemblyCompoundPowerFlow(_4188.PartCompoundPowerFlow):
    """AbstractAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3976.AbstractAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3976.AbstractAssemblyPowerFlow]':
