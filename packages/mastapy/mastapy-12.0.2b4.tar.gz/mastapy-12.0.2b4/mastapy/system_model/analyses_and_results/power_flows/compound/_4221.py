...
class StraightBevelSunGearCompoundPowerFlow(_4214.StraightBevelDiffGearCompoundPowerFlow):
    """StraightBevelSunGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4091.StraightBevelSunGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4091.StraightBevelSunGearPowerFlow]':
