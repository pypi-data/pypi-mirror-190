...
class ZerolBevelGearMeshCompoundPowerFlow(_4126.BevelGearMeshCompoundPowerFlow):
    """ZerolBevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4106.ZerolBevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4106.ZerolBevelGearMeshPowerFlow]':
