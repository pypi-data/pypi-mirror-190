...
class CylindricalPlanetGearCompoundPowerFlow(_4156.CylindricalGearCompoundPowerFlow):
    """CylindricalPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4027.CylindricalPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4027.CylindricalPlanetGearPowerFlow]':
