...
class TorqueConverterCompoundPowerFlow(_4146.CouplingCompoundPowerFlow):
    """TorqueConverterCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4098.TorqueConverterPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4098.TorqueConverterPowerFlow]':
