...
from mastapy.system_model.analyses_and_results.power_flows import _4006, _4005, _4037
...
class ConceptGearSetPowerFlow(_4037.GearSetPowerFlow):
    """ConceptGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4006.ConceptGearPowerFlow]':
    ...
    @property
    def concept_gears_power_flow(self) -> 'List[_4006.ConceptGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4005.ConceptGearMeshPowerFlow]':
    ...
    @property
    def concept_meshes_power_flow(self) -> 'List[_4005.ConceptGearMeshPowerFlow]':
