...
class BearingCompoundPowerFlow(_4145.ConnectorCompoundPowerFlow):
    """BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3984.BearingPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3984.BearingPowerFlow]':
