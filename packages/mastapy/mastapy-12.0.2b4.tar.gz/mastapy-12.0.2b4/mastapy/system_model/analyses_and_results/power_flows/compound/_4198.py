...
class RingPinsCompoundPowerFlow(_4186.MountableComponentCompoundPowerFlow):
    """RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4068.RingPinsPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4068.RingPinsPowerFlow]':
