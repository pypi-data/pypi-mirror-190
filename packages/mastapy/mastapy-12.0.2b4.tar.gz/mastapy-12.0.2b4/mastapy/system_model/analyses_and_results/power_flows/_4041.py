...
from mastapy.system_model.analyses_and_results.power_flows import _4040, _4039, _3982
...
class HypoidGearSetPowerFlow(_3982.AGMAGleasonConicalGearSetPowerFlow):
    """HypoidGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4040.HypoidGearPowerFlow]':
    ...
    @property
    def hypoid_gears_power_flow(self) -> 'List[_4040.HypoidGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4039.HypoidGearMeshPowerFlow]':
    ...
    @property
    def hypoid_meshes_power_flow(self) -> 'List[_4039.HypoidGearMeshPowerFlow]':
