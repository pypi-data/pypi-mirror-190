...
class WormGearAdvancedTimeSteppingAnalysisForModulation(_6993.GearAdvancedTimeSteppingAnalysisForModulation):
    """WormGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2784.WormGearSystemDeflection':
