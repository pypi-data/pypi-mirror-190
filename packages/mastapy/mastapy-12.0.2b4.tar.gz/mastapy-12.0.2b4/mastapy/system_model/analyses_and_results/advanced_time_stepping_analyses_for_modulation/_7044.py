...
class StraightBevelGearAdvancedTimeSteppingAnalysisForModulation(_6951.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6888.StraightBevelGearLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2764.StraightBevelGearSystemDeflection':
