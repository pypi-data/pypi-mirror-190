...
class RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation(_7034.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2743.RollingRingAssemblySystemDeflection':
