...
class RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation(_7001.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6872.RollingRingConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2744.RollingRingConnectionSystemDeflection':
