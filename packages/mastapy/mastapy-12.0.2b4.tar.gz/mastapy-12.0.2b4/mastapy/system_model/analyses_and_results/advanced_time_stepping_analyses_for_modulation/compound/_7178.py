...
class SynchroniserCompoundAdvancedTimeSteppingAnalysisForModulation(_7163.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2553.Synchroniser':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7049.SynchroniserAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7049.SynchroniserAdvancedTimeSteppingAnalysisForModulation]':
