...
class HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7069.AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2485.HypoidGear':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6998.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6998.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
