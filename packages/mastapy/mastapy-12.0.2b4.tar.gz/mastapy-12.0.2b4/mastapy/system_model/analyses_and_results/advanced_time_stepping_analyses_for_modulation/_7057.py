...
class UnbalancedMassAdvancedTimeSteppingAnalysisForModulation(_7058.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """UnbalancedMassAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2780.UnbalancedMassSystemDeflection':
