...
class PlanetCarrierAdvancedTimeSteppingAnalysisForModulation(_7013.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    """PlanetCarrierAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6861.PlanetCarrierLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2736.PlanetCarrierSystemDeflection':
