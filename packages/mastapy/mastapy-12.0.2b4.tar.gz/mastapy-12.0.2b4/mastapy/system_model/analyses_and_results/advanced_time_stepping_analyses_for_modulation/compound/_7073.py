...
class BearingCompoundAdvancedTimeSteppingAnalysisForModulation(_7101.ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BearingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6943.BearingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6943.BearingAdvancedTimeSteppingAnalysisForModulation]':
