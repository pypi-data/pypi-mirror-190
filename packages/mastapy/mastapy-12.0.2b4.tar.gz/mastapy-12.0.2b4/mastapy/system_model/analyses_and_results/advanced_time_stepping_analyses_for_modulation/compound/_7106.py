...
class CVTCompoundAdvancedTimeSteppingAnalysisForModulation(_7075.BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CVTCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6975.CVTAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6975.CVTAdvancedTimeSteppingAnalysisForModulation]':
