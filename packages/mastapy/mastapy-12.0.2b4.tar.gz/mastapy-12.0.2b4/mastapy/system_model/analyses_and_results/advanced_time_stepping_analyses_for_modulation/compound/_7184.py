...
class TorqueConverterPumpCompoundAdvancedTimeSteppingAnalysisForModulation(_7104.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterPumpCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2559.TorqueConverterPump':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7055.TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7055.TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation]':
