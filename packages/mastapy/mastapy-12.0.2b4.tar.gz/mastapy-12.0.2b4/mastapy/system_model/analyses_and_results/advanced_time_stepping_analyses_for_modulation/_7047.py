...
class StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation(_7041.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2500.StraightBevelPlanetGear':
    ...
    @property
    def system_deflection_results(self) -> '_2765.StraightBevelPlanetGearSystemDeflection':
