...
class HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7070.AGMAGleasonConicalGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2267.HypoidGearMesh':
    ...
    @property
    def connection_design(self) -> '_2267.HypoidGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6999.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6999.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
