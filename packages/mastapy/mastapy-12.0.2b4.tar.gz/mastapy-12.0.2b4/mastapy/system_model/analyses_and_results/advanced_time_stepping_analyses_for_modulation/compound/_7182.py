...
class TorqueConverterCompoundAdvancedTimeSteppingAnalysisForModulation(_7102.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2558.TorqueConverter':
    ...
    @property
    def assembly_design(self) -> '_2558.TorqueConverter':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7053.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7053.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]':
