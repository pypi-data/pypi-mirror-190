...
class PointLoadCompoundAdvancedTimeSteppingAnalysisForModulation(_7187.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PointLoadCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7022.PointLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7022.PointLoadAdvancedTimeSteppingAnalysisForModulation]':
