...
class RingPinsCompoundAdvancedTimeSteppingAnalysisForModulation(_7142.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2521.RingPins':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7025.RingPinsAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7025.RingPinsAdvancedTimeSteppingAnalysisForModulation]':
