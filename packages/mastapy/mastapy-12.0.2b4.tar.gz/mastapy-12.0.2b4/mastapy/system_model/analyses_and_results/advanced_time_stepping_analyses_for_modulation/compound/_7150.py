...
class PlanetCarrierCompoundAdvancedTimeSteppingAnalysisForModulation(_7142.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PlanetCarrierCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2421.PlanetCarrier':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7021.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7021.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]':
