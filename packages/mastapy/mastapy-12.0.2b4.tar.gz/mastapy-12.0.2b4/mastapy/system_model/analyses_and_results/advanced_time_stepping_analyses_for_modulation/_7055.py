...
class TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation(_6974.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6900.TorqueConverterPumpLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2775.TorqueConverterPumpSystemDeflection':
