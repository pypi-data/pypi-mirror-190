...
class PointLoadAdvancedTimeSteppingAnalysisForModulation(_7058.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """PointLoadAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2737.PointLoadSystemDeflection':
