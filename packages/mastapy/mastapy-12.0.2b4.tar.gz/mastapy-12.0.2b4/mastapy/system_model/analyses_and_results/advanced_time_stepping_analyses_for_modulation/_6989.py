...
class FaceGearMeshAdvancedTimeSteppingAnalysisForModulation(_6994.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6811.FaceGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2700.FaceGearMeshSystemDeflection':
