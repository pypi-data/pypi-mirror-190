...
class ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation(_6973.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6764.ConceptCouplingConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2663.ConceptCouplingConnectionSystemDeflection':
