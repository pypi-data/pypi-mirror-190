...
class GearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7130.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """GearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6994.GearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6994.GearMeshAdvancedTimeSteppingAnalysisForModulation]':
