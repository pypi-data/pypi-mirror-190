...
class RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7130.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2244.RollingRingConnection':
    ...
    @property
    def connection_design(self) -> '_2244.RollingRingConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7029.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7029.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
