...
class FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7124.GearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2263.FaceGearMesh':
    ...
    @property
    def connection_design(self) -> '_2263.FaceGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6989.FaceGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6989.FaceGearMeshAdvancedTimeSteppingAnalysisForModulation]':
