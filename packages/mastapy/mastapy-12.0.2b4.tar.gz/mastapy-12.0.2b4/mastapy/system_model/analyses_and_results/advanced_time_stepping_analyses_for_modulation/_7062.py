...
class ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation(_6951.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2787.ZerolBevelGearSystemDeflection':
