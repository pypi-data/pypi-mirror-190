...
class UnbalancedMassCompoundAdvancedTimeSteppingAnalysisForModulation(_7187.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """UnbalancedMassCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7057.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7057.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]':
