...
class SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation(_7051.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2769.SynchroniserSleeveSystemDeflection':
