...
from mastapy.system_model.analyses_and_results.system_deflections import _2638, _2684, _2750
...
class AbstractShaftAdvancedTimeSteppingAnalysisForModulation(_6933.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2638.AbstractShaftSystemDeflection':
