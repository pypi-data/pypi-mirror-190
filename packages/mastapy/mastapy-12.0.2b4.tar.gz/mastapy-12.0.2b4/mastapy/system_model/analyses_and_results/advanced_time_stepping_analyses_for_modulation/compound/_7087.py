...
class ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7103.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2294.ClutchConnection':
    ...
    @property
    def connection_design(self) -> '_2294.ClutchConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6957.ClutchConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6957.ClutchConnectionAdvancedTimeSteppingAnalysisForModulation]':
