...
class PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation(_6972.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2734.PartToPartShearCouplingSystemDeflection':
