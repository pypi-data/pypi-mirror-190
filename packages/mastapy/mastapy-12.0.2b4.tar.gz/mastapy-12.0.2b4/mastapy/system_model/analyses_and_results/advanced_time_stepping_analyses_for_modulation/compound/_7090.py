...
class ComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7144.PartCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6960.ComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6960.ComponentAdvancedTimeSteppingAnalysisForModulation]':
