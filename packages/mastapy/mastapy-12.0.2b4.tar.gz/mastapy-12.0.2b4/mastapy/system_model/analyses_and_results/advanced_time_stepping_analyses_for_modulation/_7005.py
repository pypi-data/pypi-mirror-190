...
class KlingelnbergCycloPalloidHypoidGearAdvancedTimeSteppingAnalysisForModulation(_7002.KlingelnbergCycloPalloidConicalGearAdvancedTimeSteppingAnalysisForModulation):
    """KlingelnbergCycloPalloidHypoidGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6841.KlingelnbergCycloPalloidHypoidGearLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2719.KlingelnbergCycloPalloidHypoidGearSystemDeflection':
