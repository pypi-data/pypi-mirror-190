...
class RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation(_7104.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2547.RollingRing':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7027.RollingRingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7027.RollingRingAdvancedTimeSteppingAnalysisForModulation]':
