...
class StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6952.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6889.StraightBevelGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2762.StraightBevelGearMeshSystemDeflection':
