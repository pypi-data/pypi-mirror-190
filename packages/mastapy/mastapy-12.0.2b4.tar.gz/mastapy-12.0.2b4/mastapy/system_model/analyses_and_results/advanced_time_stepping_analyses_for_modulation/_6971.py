...
class ConnectorAdvancedTimeSteppingAnalysisForModulation(_7013.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    """ConnectorAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2674.ConnectorSystemDeflection':
