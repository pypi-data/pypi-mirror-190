...
class PowerLoadAdvancedTimeSteppingAnalysisForModulation(_7058.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """PowerLoadAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2738.PowerLoadSystemDeflection':
