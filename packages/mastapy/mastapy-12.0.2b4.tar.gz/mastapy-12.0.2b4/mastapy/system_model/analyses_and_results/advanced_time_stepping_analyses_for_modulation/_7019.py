...
class PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation(_7033.ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6858.PlanetaryConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2735.PlanetaryConnectionSystemDeflection':
