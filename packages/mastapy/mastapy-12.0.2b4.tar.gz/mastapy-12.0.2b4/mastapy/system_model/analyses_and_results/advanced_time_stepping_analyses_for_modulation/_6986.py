...
class DatumAdvancedTimeSteppingAnalysisForModulation(_6960.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """DatumAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6795.DatumLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2697.DatumSystemDeflection':
