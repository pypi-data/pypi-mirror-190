...
class OilSealAdvancedTimeSteppingAnalysisForModulation(_6971.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    """OilSealAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2730.OilSealSystemDeflection':
