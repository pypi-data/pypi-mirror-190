...
class ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation(_7142.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6971.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6971.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
