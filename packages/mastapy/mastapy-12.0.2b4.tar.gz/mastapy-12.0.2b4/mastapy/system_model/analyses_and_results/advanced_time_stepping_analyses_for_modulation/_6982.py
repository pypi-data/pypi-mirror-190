...
class CylindricalGearAdvancedTimeSteppingAnalysisForModulation(_6993.GearAdvancedTimeSteppingAnalysisForModulation):
    """CylindricalGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2691.CylindricalGearSystemDeflection':
