...
class PlanetaryConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7162.ShaftToMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PlanetaryConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2239.PlanetaryConnection':
    ...
    @property
    def connection_design(self) -> '_2239.PlanetaryConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7019.PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7019.PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation]':
