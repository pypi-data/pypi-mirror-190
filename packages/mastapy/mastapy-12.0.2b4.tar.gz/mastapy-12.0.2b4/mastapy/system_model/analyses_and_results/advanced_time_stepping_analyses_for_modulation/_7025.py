...
class RingPinsAdvancedTimeSteppingAnalysisForModulation(_7013.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6869.RingPinsLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2740.RingPinsSystemDeflection':
