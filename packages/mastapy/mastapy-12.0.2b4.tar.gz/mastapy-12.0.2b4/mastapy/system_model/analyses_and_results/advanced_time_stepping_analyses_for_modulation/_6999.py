...
class HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation(_6939.AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6832.HypoidGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2709.HypoidGearMeshSystemDeflection':
