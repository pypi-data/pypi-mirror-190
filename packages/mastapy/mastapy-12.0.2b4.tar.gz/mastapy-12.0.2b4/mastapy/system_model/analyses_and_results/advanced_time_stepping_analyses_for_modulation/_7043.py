...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7041, _7042, _6953
...
class StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation(_6953.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2760.StraightBevelDiffGearSetSystemDeflection':
    ...
    @property
    def straight_bevel_diff_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7041.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_diff_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7042.StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation]':
