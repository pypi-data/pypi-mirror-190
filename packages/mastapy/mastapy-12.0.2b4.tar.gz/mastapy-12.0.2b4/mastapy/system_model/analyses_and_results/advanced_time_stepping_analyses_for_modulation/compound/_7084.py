...
class BoltCompoundAdvancedTimeSteppingAnalysisForModulation(_7090.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BoltCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6954.BoltAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6954.BoltAdvancedTimeSteppingAnalysisForModulation]':
