...
class DatumCompoundAdvancedTimeSteppingAnalysisForModulation(_7090.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """DatumCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6986.DatumAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6986.DatumAdvancedTimeSteppingAnalysisForModulation]':
