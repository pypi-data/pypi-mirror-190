...
class BevelDifferentialSunGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7076.BevelDifferentialGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialSunGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6950.BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6950.BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation]':
