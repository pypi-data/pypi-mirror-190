...
class CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation(_6944.BeltConnectionAdvancedTimeSteppingAnalysisForModulation):
    """CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2678.CVTBeltConnectionSystemDeflection':
