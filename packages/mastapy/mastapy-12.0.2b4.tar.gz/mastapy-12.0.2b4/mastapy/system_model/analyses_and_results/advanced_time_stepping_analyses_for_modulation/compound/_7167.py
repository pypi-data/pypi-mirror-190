...
class SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation(_7102.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2551.SpringDamper':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7038.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7038.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
