...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6196
...
class WindTurbineCertificationReport(_6196.CombinationAnalysis):
    """WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2426.RootAssembly':
    ...
    @property
    def extreme_load_case_static_analysis(self) -> '_2746.RootAssemblySystemDeflection':
    ...
    @property
    def ldd_static_analysis(self) -> '_2892.RootAssemblyCompoundSystemDeflection':
    ...
    @property
    def nominal_load_case_static_analysis(self) -> '_2746.RootAssemblySystemDeflection':
