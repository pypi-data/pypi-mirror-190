...
class FlexiblePinAnalysisStopStartAnalysis(_6197.FlexiblePinAnalysis):
    """FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_extreme_load_case(self) -> '_2750.ShaftSystemDeflection':
    ...
    @property
    def shaft_nominal_load_case(self) -> '_2750.ShaftSystemDeflection':
