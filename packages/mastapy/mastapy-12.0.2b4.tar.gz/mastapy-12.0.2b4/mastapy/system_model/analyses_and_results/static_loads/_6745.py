...
from mastapy.system_model.analyses_and_results.static_loads import (
    ...
    _6758, _6781, _6759, _6761,
    _6766, _6769, _6783, _6785,
    _6791, _6813, _6812, _6814,
    _6818, _6833, _6843, _6846,
    _6847, _6848, _6852, _6857,
    _6861, _6864, _6865, _6869,
    _6870, _6871, _6875, _6876,
    _6735, _6881, _6884, _6887,
    _6890, _6894, _6899, _6906,
    _6910, _6913, _6733
)
...
class AssemblyLoadCase(_6733.AbstractAssemblyLoadCase):
    """AssemblyLoadCase
    ...
    @property
    def bearings(self) -> 'List[_6746.BearingLoadCase]':
    ...
    @property
    def belt_drives(self) -> 'List[_6748.BeltDriveLoadCase]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6751.BevelDifferentialGearSetLoadCase]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6757.BoltedJointLoadCase]':
    ...
    @property
    def bolts(self) -> 'List[_6758.BoltLoadCase]':
    ...
    @property
    def cv_ts(self) -> 'List[_6781.CVTLoadCase]':
    ...
    @property
    def clutch_connections(self) -> 'List[_6759.ClutchConnectionLoadCase]':
    ...
    @property
    def clutches(self) -> 'List[_6761.ClutchLoadCase]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6766.ConceptCouplingLoadCase]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6769.ConceptGearSetLoadCase]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6783.CycloidalAssemblyLoadCase]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6785.CycloidalDiscLoadCase]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6791.CylindricalGearSetLoadCase]':
    ...
    @property
    def fe_parts(self) -> 'List[_6813.FEPartLoadCase]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6812.FaceGearSetLoadCase]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6814.FlexiblePinAssemblyLoadCase]':
    ...
    @property
    def gear_meshes(self) -> 'List[_6818.GearMeshLoadCase]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6833.HypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6843.KlingelnbergCycloPalloidHypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6846.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase]':
    ...
    @property
    def mass_discs(self) -> 'List[_6847.MassDiscLoadCase]':
    ...
    @property
    def measurement_components(self) -> 'List[_6848.MeasurementComponentLoadCase]':
    ...
    @property
    def oil_seals(self) -> 'List[_6852.OilSealLoadCase]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6857.PartToPartShearCouplingLoadCase]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6861.PlanetCarrierLoadCase]':
    ...
    @property
    def point_loads(self) -> 'List[_6864.PointLoadLoadCase]':
    ...
    @property
    def ring_pins(self) -> 'List[_6869.RingPinsLoadCase]':
    ...
    @property
    def ring_pins_to_cycloidal_disc_connections(self) -> 'List[_6870.RingPinsToDiscConnectionLoadCase]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6871.RollingRingAssemblyLoadCase]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6875.ShaftHubConnectionLoadCase]':
    ...
    @property
    def shafts(self) -> 'List[_6876.ShaftLoadCase]':
    ...
    @property
    def shafts_and_housings(self) -> 'List[_6735.AbstractShaftOrHousingLoadCase]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6881.SpiralBevelGearSetLoadCase]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6884.SpringDamperLoadCase]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6887.StraightBevelDiffGearSetLoadCase]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6890.StraightBevelGearSetLoadCase]':
    ...
    @property
    def synchronisers(self) -> 'List[_6894.SynchroniserLoadCase]':
    ...
    @property
    def torque_converters(self) -> 'List[_6899.TorqueConverterLoadCase]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6906.UnbalancedMassLoadCase]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6910.WormGearSetLoadCase]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6913.ZerolBevelGearSetLoadCase]':
