...
from mastapy.system_model.analyses_and_results.static_loads import _6885, _6886, _6756
...
class StraightBevelDiffGearSetLoadCase(_6756.BevelGearSetLoadCase):
    """StraightBevelDiffGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6885.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6885.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6886.StraightBevelDiffGearMeshLoadCase]':
