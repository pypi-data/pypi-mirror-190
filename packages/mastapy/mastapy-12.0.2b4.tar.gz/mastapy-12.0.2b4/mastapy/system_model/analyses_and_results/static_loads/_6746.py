...
class BearingLoadCase(_6776.ConnectorLoadCase):
    ...
    @property
    def include_fitting_effects(self) -> '_1554.LoadCaseOverrideOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1554.LoadCaseOverrideOption)(value) if value is not None else None

    @include_fitting_effects.setter
    def include_fitting_effects(self, value: '_1554.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def include_ring_ovality(self) -> '_1554.LoadCaseOverrideOption':
    ...
    def include_ring_ovality(self, value: '_1554.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeRingOvality = value

    @property
    def include_thermal_expansion_effects(self) -> '_1554.LoadCaseOverrideOption':
    ...
    def include_thermal_expansion_effects(self, value: '_1554.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
