...
class FlexiblePinAssemblyLoadCase(_6878.SpecialisedAssemblyLoadCase):
    ...
    @property
    def include_inner_race_distortion_for_flexible_pin_spindle(self) -> '_1554.LoadCaseOverrideOption':
    ...
    def include_inner_race_distortion_for_flexible_pin_spindle(self, value: '_1554.LoadCaseOverrideOption'):
