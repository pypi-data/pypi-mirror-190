...
from mastapy.system_model.analyses_and_results.static_loads import _6731, _6738, _6732
...
class ConnectionLoadCase(_2600.ConnectionAnalysis):
    """ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_6731.StaticLoadCase':
    ...
    @property
    def time_series_load_case(self) -> '_6732.TimeSeriesLoadCase':
