...
from mastapy.system_model.analyses_and_results.static_loads import _6773, _6821
...
class ConicalGearSetLoadCase(_6821.GearSetLoadCase):
    """ConicalGearSetLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6773.ConicalGearSetHarmonicLoadData':
