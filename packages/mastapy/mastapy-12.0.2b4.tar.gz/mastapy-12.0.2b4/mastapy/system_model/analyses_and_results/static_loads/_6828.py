...
from mastapy.system_model.analyses_and_results.static_loads import _6827, _6806
...
class HarmonicLoadDataImportFromMotorPackages(_6827.HarmonicLoadDataImportBase['T'], Generic[T]):
    """HarmonicLoadDataImportFromMotorPackages
