...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4736, _4737, _4735
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis(_4735.KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4589.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_modal_analysis(self) -> 'List[_4736.KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_modal_analysis(self) -> 'List[_4737.KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4589.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
