...
from mastapy.system_model.analyses_and_results.modal_analyses import _4544, _4543, _4578
...
class ConceptGearSetModalAnalysis(_4578.GearSetModalAnalysis):
    """ConceptGearSetModalAnalysis
    ...
    @property
    def concept_gears_modal_analysis(self) -> 'List[_4544.ConceptGearModalAnalysis]':
    ...
    @property
    def concept_meshes_modal_analysis(self) -> 'List[_4543.ConceptGearMeshModalAnalysis]':
