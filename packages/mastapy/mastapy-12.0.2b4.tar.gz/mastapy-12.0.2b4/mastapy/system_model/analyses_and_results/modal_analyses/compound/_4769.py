...
class SpringDamperCompoundModalAnalysis(_4704.CouplingCompoundModalAnalysis):
    """SpringDamperCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4627.SpringDamperModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4627.SpringDamperModalAnalysis]':
