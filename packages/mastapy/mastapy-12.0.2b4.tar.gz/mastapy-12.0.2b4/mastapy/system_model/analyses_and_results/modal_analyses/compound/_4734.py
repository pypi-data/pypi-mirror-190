...
class KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis(_4700.ConicalGearMeshCompoundModalAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4584.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4584.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis]':
