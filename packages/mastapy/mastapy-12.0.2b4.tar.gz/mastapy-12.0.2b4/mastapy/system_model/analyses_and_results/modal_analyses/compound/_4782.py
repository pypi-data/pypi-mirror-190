...
class SynchroniserPartCompoundModalAnalysis(_4706.CouplingHalfCompoundModalAnalysis):
    """SynchroniserPartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4638.SynchroniserPartModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4638.SynchroniserPartModalAnalysis]':
