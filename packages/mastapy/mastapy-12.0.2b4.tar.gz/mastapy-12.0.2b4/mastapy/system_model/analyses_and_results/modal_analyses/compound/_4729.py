...
class HypoidGearCompoundModalAnalysis(_4671.AGMAGleasonConicalGearCompoundModalAnalysis):
    """HypoidGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4581.HypoidGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4581.HypoidGearModalAnalysis]':
