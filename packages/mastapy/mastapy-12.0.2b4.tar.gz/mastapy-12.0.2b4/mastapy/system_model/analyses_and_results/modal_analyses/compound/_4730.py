...
class HypoidGearMeshCompoundModalAnalysis(_4672.AGMAGleasonConicalGearMeshCompoundModalAnalysis):
    """HypoidGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4580.HypoidGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4580.HypoidGearMeshModalAnalysis]':
