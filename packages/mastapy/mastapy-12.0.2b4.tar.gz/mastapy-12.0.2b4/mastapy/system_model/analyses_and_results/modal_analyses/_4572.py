...
from mastapy.system_model.analyses_and_results.modal_analyses import _4571, _4570, _4578
...
class FaceGearSetModalAnalysis(_4578.GearSetModalAnalysis):
    """FaceGearSetModalAnalysis
    ...
    @property
    def face_gears_modal_analysis(self) -> 'List[_4571.FaceGearModalAnalysis]':
    ...
    @property
    def face_meshes_modal_analysis(self) -> 'List[_4570.FaceGearMeshModalAnalysis]':
