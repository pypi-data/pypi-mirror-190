...
from mastapy.utility.modal_analysis import _1761
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2603.DesignEntityGroupAnalysis):
    """RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1761.DesignEntityExcitationDescription]':
