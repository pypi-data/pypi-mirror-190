...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4729, _4730, _4673
...
class HypoidGearSetCompoundModalAnalysis(_4673.AGMAGleasonConicalGearSetCompoundModalAnalysis):
    """HypoidGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4582.HypoidGearSetModalAnalysis]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis(self) -> 'List[_4729.HypoidGearCompoundModalAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis(self) -> 'List[_4730.HypoidGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4582.HypoidGearSetModalAnalysis]':
