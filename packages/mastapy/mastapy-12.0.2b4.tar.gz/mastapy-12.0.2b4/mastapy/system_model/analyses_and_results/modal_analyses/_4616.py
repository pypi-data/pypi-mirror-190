...
from mastapy.system_model.analyses_and_results.modal_analyses import _2586, _4521
...
class RootAssemblyModalAnalysis(_4521.AssemblyModalAnalysis):
    """RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_2586.ModalAnalysis':
