...
class ConicalGearMeshCompoundModalAnalysis(_4726.GearMeshCompoundModalAnalysis):
    """ConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4546.ConicalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4546.ConicalGearMeshModalAnalysis]':
