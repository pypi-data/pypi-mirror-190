...
class AGMAGleasonConicalGearSetCompoundModalAnalysis(_4701.ConicalGearSetCompoundModalAnalysis):
    """AGMAGleasonConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4520.AGMAGleasonConicalGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4520.AGMAGleasonConicalGearSetModalAnalysis]':
