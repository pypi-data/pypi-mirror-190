...
class FaceGearMeshCompoundModalAnalysis(_4726.GearMeshCompoundModalAnalysis):
    """FaceGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4570.FaceGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4570.FaceGearMeshModalAnalysis]':
