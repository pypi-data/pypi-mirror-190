...
class ConceptCouplingCompoundModalAnalysis(_4704.CouplingCompoundModalAnalysis):
    """ConceptCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4542.ConceptCouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4542.ConceptCouplingModalAnalysis]':
