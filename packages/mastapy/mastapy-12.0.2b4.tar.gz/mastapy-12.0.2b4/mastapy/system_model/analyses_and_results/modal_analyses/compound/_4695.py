...
class ConceptCouplingHalfCompoundModalAnalysis(_4706.CouplingHalfCompoundModalAnalysis):
    """ConceptCouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4541.ConceptCouplingHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4541.ConceptCouplingHalfModalAnalysis]':
