...
class MassDiscCompoundModalAnalysis(_4789.VirtualComponentCompoundModalAnalysis):
    """MassDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4593.MassDiscModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4593.MassDiscModalAnalysis]':
