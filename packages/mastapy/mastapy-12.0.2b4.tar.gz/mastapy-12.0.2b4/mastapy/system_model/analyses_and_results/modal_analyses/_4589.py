...
from mastapy.system_model.analyses_and_results.modal_analyses import _4588, _4587, _4586
...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysis(_4586.KlingelnbergCycloPalloidConicalGearSetModalAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetModalAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_modal_analysis(self) -> 'List[_4588.KlingelnbergCycloPalloidHypoidGearModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_modal_analysis(self) -> 'List[_4587.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]':
