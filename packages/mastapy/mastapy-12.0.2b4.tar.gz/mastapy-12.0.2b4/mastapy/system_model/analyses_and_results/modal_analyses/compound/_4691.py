...
class CoaxialConnectionCompoundModalAnalysis(_4764.ShaftToMountableComponentConnectionCompoundModalAnalysis):
    """CoaxialConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4538.CoaxialConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4538.CoaxialConnectionModalAnalysis]':
