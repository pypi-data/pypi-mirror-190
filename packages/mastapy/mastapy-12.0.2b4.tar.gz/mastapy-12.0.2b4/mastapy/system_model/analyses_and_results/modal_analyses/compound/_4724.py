...
class FlexiblePinAssemblyCompoundModalAnalysis(_4765.SpecialisedAssemblyCompoundModalAnalysis):
    """FlexiblePinAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4574.FlexiblePinAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4574.FlexiblePinAssemblyModalAnalysis]':
