...
class PulleyCompoundModalAnalysis(_4706.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4610.PulleyModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4610.PulleyModalAnalysis]':
