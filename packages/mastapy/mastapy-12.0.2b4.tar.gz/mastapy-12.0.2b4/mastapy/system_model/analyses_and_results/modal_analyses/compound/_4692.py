...
class ComponentCompoundModalAnalysis(_4746.PartCompoundModalAnalysis):
    """ComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4539.ComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4539.ComponentModalAnalysis]':
