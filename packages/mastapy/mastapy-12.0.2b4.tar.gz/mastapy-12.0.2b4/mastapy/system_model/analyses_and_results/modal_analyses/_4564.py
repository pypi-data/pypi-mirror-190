...
from mastapy.system_model.analyses_and_results.modal_analyses import _4563, _4562, _4578
...
class CylindricalGearSetModalAnalysis(_4578.GearSetModalAnalysis):
    """CylindricalGearSetModalAnalysis
    ...
    @property
    def cylindrical_gears_modal_analysis(self) -> 'List[_4563.CylindricalGearModalAnalysis]':
    ...
    @property
    def cylindrical_meshes_modal_analysis(self) -> 'List[_4562.CylindricalGearMeshModalAnalysis]':
