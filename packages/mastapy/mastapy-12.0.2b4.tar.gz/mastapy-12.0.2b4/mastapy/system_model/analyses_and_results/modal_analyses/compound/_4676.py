...
class BeltConnectionCompoundModalAnalysis(_4732.InterMountableComponentConnectionCompoundModalAnalysis):
    """BeltConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4523.BeltConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4523.BeltConnectionModalAnalysis]':
