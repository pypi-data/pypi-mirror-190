...
class ExternalCADModelCompoundModalAnalysis(_4692.ComponentCompoundModalAnalysis):
    """ExternalCADModelCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4569.ExternalCADModelModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4569.ExternalCADModelModalAnalysis]':
