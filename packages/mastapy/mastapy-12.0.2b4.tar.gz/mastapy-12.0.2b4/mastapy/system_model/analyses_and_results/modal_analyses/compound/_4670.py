...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysis(_4702.ConnectionCompoundModalAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4517.AbstractShaftToMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4517.AbstractShaftToMountableComponentConnectionModalAnalysis]':
