...
class BevelDifferentialGearCompoundModalAnalysis(_4683.BevelGearCompoundModalAnalysis):
    """BevelDifferentialGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4526.BevelDifferentialGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4526.BevelDifferentialGearModalAnalysis]':
