...
class ShaftToMountableComponentConnectionCompoundModalAnalysis(_4670.AbstractShaftToMountableComponentConnectionCompoundModalAnalysis):
    """ShaftToMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4620.ShaftToMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4620.ShaftToMountableComponentConnectionModalAnalysis]':
