...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4790, _4791, _4727
...
class WormGearSetCompoundModalAnalysis(_4727.GearSetCompoundModalAnalysis):
    """WormGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4651.WormGearSetModalAnalysis]':
    ...
    @property
    def worm_gears_compound_modal_analysis(self) -> 'List[_4790.WormGearCompoundModalAnalysis]':
    ...
    @property
    def worm_meshes_compound_modal_analysis(self) -> 'List[_4791.WormGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4651.WormGearSetModalAnalysis]':
