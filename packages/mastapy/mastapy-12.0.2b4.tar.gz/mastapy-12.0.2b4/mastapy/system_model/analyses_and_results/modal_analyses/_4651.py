...
from mastapy.system_model.analyses_and_results.modal_analyses import _4650, _4649, _4578
...
class WormGearSetModalAnalysis(_4578.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self) -> 'List[_4650.WormGearModalAnalysis]':
    ...
    @property
    def worm_meshes_modal_analysis(self) -> 'List[_4649.WormGearMeshModalAnalysis]':
