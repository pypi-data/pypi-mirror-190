...
class FaceGearCompoundModalAnalysis(_4725.GearCompoundModalAnalysis):
    """FaceGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4571.FaceGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4571.FaceGearModalAnalysis]':
