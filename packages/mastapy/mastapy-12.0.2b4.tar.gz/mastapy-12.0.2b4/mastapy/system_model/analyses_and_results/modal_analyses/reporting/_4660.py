...
class PerModeResultsReport(_1721.CustomReportChart):
    """PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1783.TableAndChartOptions':
    ...
    def display_option(self, value: '_1783.TableAndChartOptions'):
