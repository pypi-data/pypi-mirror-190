...
class AbstractShaftOrHousingCompoundModalAnalysis(_4692.ComponentCompoundModalAnalysis):
    """AbstractShaftOrHousingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4516.AbstractShaftOrHousingModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4516.AbstractShaftOrHousingModalAnalysis]':
