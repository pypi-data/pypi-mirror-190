...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4696, _4697, _4727
...
class ConceptGearSetCompoundModalAnalysis(_4727.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4545.ConceptGearSetModalAnalysis]':
    ...
    @property
    def concept_gears_compound_modal_analysis(self) -> 'List[_4696.ConceptGearCompoundModalAnalysis]':
    ...
    @property
    def concept_meshes_compound_modal_analysis(self) -> 'List[_4697.ConceptGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4545.ConceptGearSetModalAnalysis]':
