...
class SpringDamperHalfCompoundModalAnalysis(_4706.CouplingHalfCompoundModalAnalysis):
    """SpringDamperHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4626.SpringDamperHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4626.SpringDamperHalfModalAnalysis]':
