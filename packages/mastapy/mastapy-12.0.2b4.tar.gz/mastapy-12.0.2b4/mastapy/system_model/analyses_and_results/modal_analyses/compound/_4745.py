...
class OilSealCompoundModalAnalysis(_4703.ConnectorCompoundModalAnalysis):
    """OilSealCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4599.OilSealModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4599.OilSealModalAnalysis]':
