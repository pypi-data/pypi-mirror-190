...
class DatumCompoundModalAnalysis(_4692.ComponentCompoundModalAnalysis):
    """DatumCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4566.DatumModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4566.DatumModalAnalysis]':
