...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6466, _6469, _6468
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self) -> '_6466.ExcelFileDetails':
    ...
    @property
    def masta_file_details(self) -> '_6469.MASTAFileDetails':
    ...
    @property
    def working_folder(self) -> '_1564.SelectableFolder':
    ...
    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6468.ExcelSheetDesignStateSelector]':
