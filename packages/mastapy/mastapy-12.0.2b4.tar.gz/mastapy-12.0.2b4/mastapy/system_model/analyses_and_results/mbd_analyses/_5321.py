...
from mastapy.system_model.analyses_and_results.mbd_analyses import (
    _5322, _5325, _5328, _5334,
    _5335, _5357, _5338, _5344,
    _5347, _5386, _5359, _5361,
    _5365, _5372, _5371, _5373,
    _5377, _5381, _5392, _5395,
    _5396, _5400, _5402, _5406,
    _5409, _5410, _5411, _5413,
    _5415, _5421, _5422, _5315,
    _5428, _5431, _5434, _5437,
    _5441, _5446, _5450, _5455,
    _5458, _5313
)
...
class AssemblyMultibodyDynamicsAnalysis(_5313.AbstractAssemblyMultibodyDynamicsAnalysis):
    """AssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def bearings(self) -> 'List[_5322.BearingMultibodyDynamicsAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5325.BeltDriveMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5328.BevelDifferentialGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5334.BoltedJointMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5335.BoltMultibodyDynamicsAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5357.CVTMultibodyDynamicsAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5338.ClutchMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5344.ConceptCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5347.ConceptGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def connections(self) -> 'List[_5386.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5359.CycloidalAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5361.CycloidalDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5365.CylindricalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5372.FEPartMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5371.FaceGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5373.FlexiblePinAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def gear_sets(self) -> 'List[_5377.GearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5381.HypoidGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5392.KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5395.KlingelnbergCycloPalloidSpiralBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5396.MassDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5400.MeasurementComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5402.OilSealMultibodyDynamicsAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5406.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5409.PlanetCarrierMultibodyDynamicsAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5410.PointLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5411.PowerLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5413.RingPinsMultibodyDynamicsAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5415.RollingRingAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5421.ShaftHubConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5422.ShaftMultibodyDynamicsAnalysis]':
    ...
    @property
    def shafts_and_housings(self) -> 'List[_5315.AbstractShaftOrHousingMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5428.SpiralBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5431.SpringDamperMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5434.StraightBevelDiffGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5437.StraightBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5441.SynchroniserMultibodyDynamicsAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5446.TorqueConverterMultibodyDynamicsAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5450.UnbalancedMassMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5455.WormGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5458.ZerolBevelGearSetMultibodyDynamicsAnalysis]':
