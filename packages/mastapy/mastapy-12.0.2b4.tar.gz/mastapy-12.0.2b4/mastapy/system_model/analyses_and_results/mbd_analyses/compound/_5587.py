...
class VirtualComponentCompoundMultibodyDynamicsAnalysis(_5542.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """VirtualComponentCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5451.VirtualComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5451.VirtualComponentMultibodyDynamicsAnalysis]':
