...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5433, _5432, _5333
...
class StraightBevelDiffGearSetMultibodyDynamicsAnalysis(_5333.BevelGearSetMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5433.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_multibody_dynamics_analysis(self) -> 'List[_5433.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_multibody_dynamics_analysis(self) -> 'List[_5432.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
