...
class UnbalancedMassCompoundMultibodyDynamicsAnalysis(_5587.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """UnbalancedMassCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5450.UnbalancedMassMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5450.UnbalancedMassMultibodyDynamicsAnalysis]':
