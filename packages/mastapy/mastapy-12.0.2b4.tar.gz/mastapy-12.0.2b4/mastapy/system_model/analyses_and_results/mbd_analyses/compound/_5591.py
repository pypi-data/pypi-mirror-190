...
class ZerolBevelGearCompoundMultibodyDynamicsAnalysis(_5481.BevelGearCompoundMultibodyDynamicsAnalysis):
    """ZerolBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5457.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5457.ZerolBevelGearMultibodyDynamicsAnalysis]':
