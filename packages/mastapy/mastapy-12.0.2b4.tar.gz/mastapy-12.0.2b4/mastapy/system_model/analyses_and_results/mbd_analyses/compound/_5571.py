...
class StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis(_5482.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5432.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5432.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
