...
class BeltDriveCompoundMultibodyDynamicsAnalysis(_5563.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """BeltDriveCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5325.BeltDriveMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5325.BeltDriveMultibodyDynamicsAnalysis]':
