...
class CVTBeltConnectionCompoundMultibodyDynamicsAnalysis(_5474.BeltConnectionCompoundMultibodyDynamicsAnalysis):
    """CVTBeltConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5356.CVTBeltConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5356.CVTBeltConnectionMultibodyDynamicsAnalysis]':
