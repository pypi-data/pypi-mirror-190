...
class SpiralBevelGearCompoundMultibodyDynamicsAnalysis(_5481.BevelGearCompoundMultibodyDynamicsAnalysis):
    """SpiralBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5427.SpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5427.SpiralBevelGearMultibodyDynamicsAnalysis]':
