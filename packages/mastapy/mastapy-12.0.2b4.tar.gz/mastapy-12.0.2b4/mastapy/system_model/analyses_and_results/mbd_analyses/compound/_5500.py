...
class ConnectionCompoundMultibodyDynamicsAnalysis(_7463.ConnectionCompoundAnalysis):
    """ConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5351.ConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5351.ConnectionMultibodyDynamicsAnalysis]':
