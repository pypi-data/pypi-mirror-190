...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5512, _5513, _5525
...
class CylindricalGearSetCompoundMultibodyDynamicsAnalysis(_5525.GearSetCompoundMultibodyDynamicsAnalysis):
    """CylindricalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5365.CylindricalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5512.CylindricalGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5513.CylindricalGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5365.CylindricalGearSetMultibodyDynamicsAnalysis]':
