...
class InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(_5500.ConnectionCompoundMultibodyDynamicsAnalysis):
    """InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5386.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5386.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
