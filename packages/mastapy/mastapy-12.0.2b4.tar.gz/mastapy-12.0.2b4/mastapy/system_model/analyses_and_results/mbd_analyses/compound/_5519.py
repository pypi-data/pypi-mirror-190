...
class FaceGearMeshCompoundMultibodyDynamicsAnalysis(_5524.GearMeshCompoundMultibodyDynamicsAnalysis):
    """FaceGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5369.FaceGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5369.FaceGearMeshMultibodyDynamicsAnalysis]':
