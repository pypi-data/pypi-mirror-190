...
class PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis(_5502.CouplingCompoundMultibodyDynamicsAnalysis):
    """PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5406.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5406.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
