...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5370, _5369, _5377
...
class FaceGearSetMultibodyDynamicsAnalysis(_5377.GearSetMultibodyDynamicsAnalysis):
    """FaceGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5370.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gears_multibody_dynamics_analysis(self) -> 'List[_5370.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_meshes_multibody_dynamics_analysis(self) -> 'List[_5369.FaceGearMeshMultibodyDynamicsAnalysis]':
