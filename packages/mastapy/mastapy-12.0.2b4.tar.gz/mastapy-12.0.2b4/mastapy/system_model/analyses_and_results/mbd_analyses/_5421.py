...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5461, _5463
...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5352.ConnectorMultibodyDynamicsAnalysis):
    """ShaftHubConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5461.DynamicForceVector3DResult':
    ...
    @property
    def peak_dynamic_force_angular(self) -> '_5463.DynamicTorqueVector3DResult':
