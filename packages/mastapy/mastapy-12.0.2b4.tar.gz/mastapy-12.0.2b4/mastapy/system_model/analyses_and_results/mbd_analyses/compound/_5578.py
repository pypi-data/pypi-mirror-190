...
class SynchroniserCompoundMultibodyDynamicsAnalysis(_5563.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """SynchroniserCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5441.SynchroniserMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5441.SynchroniserMultibodyDynamicsAnalysis]':
