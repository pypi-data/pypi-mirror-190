...
class BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis(_5482.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5326.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5326.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]':
