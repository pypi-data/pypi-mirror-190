...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5346, _5345, _5377
...
class ConceptGearSetMultibodyDynamicsAnalysis(_5377.GearSetMultibodyDynamicsAnalysis):
    """ConceptGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5346.ConceptGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gears_multibody_dynamics_analysis(self) -> 'List[_5346.ConceptGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_meshes_multibody_dynamics_analysis(self) -> 'List[_5345.ConceptGearMeshMultibodyDynamicsAnalysis]':
