...
class CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis(_5489.CoaxialConnectionCompoundMultibodyDynamicsAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5360.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5360.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis]':
