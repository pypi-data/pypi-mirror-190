...
class StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis(_5570.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5438.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5438.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
