...
class TorqueConverterTurbineCompoundMultibodyDynamicsAnalysis(_5504.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """TorqueConverterTurbineCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5449.TorqueConverterTurbineMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5449.TorqueConverterTurbineMultibodyDynamicsAnalysis]':
