...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5448, _5353
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5353.CouplingConnectionMultibodyDynamicsAnalysis):
    """TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5448.TorqueConverterStatus':
        ...
        return constructor.new_from_mastapy_type(_5448.TorqueConverterStatus)(value) if value is not None else None
    ...
    @property
    def connection_load_case(self) -> '_6898.TorqueConverterConnectionLoadCase':
