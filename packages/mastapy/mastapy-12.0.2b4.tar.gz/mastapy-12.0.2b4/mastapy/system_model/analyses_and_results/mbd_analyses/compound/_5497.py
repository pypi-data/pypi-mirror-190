...
class ConicalGearCompoundMultibodyDynamicsAnalysis(_5523.GearCompoundMultibodyDynamicsAnalysis):
    """ConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5349.ConicalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5349.ConicalGearMultibodyDynamicsAnalysis]':
