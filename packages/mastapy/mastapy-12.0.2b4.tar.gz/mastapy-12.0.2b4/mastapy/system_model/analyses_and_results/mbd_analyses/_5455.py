...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5454, _5453, _5377
...
class WormGearSetMultibodyDynamicsAnalysis(_5377.GearSetMultibodyDynamicsAnalysis):
    """WormGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5454.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gears_multibody_dynamics_analysis(self) -> 'List[_5454.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_meshes_multibody_dynamics_analysis(self) -> 'List[_5453.WormGearMeshMultibodyDynamicsAnalysis]':
