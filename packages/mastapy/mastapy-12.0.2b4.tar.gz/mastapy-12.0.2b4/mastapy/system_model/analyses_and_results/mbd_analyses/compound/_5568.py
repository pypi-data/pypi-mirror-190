...
class SpringDamperConnectionCompoundMultibodyDynamicsAnalysis(_5503.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """SpringDamperConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5429.SpringDamperConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5429.SpringDamperConnectionMultibodyDynamicsAnalysis]':
