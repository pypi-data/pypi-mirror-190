...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5376, _5374, _5425
...
class GearSetMultibodyDynamicsAnalysis(_5425.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    """GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5376.GearMultibodyDynamicsAnalysis]':
    ...
    @property
    def meshes(self) -> 'List[_5374.GearMeshMultibodyDynamicsAnalysis]':
