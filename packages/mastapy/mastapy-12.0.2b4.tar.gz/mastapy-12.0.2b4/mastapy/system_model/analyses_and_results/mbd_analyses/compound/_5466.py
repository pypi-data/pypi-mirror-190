...
class AbstractShaftCompoundMultibodyDynamicsAnalysis(_5467.AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis):
    """AbstractShaftCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5314.AbstractShaftMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5314.AbstractShaftMultibodyDynamicsAnalysis]':
