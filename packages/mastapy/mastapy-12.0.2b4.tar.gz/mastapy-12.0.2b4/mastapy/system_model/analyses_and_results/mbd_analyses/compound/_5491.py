...
class ConceptCouplingCompoundMultibodyDynamicsAnalysis(_5502.CouplingCompoundMultibodyDynamicsAnalysis):
    """ConceptCouplingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5344.ConceptCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5344.ConceptCouplingMultibodyDynamicsAnalysis]':
