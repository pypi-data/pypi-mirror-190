...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5494, _5495, _5525
...
class ConceptGearSetCompoundMultibodyDynamicsAnalysis(_5525.GearSetCompoundMultibodyDynamicsAnalysis):
    """ConceptGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5347.ConceptGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5494.ConceptGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5495.ConceptGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5347.ConceptGearSetMultibodyDynamicsAnalysis]':
