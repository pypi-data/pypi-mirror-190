...
class ConceptGearMeshCompoundMultibodyDynamicsAnalysis(_5524.GearMeshCompoundMultibodyDynamicsAnalysis):
    """ConceptGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5345.ConceptGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5345.ConceptGearMeshMultibodyDynamicsAnalysis]':
