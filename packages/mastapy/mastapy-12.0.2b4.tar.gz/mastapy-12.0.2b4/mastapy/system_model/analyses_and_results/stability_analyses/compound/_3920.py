...
class PartCompoundStabilityAnalysis(_7470.PartCompoundAnalysis):
    """PartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3789.PartStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3789.PartStabilityAnalysis]':
