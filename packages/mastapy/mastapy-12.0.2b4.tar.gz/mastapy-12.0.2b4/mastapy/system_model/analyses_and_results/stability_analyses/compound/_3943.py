...
class SpringDamperCompoundStabilityAnalysis(_3878.CouplingCompoundStabilityAnalysis):
    """SpringDamperCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3814.SpringDamperStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3814.SpringDamperStabilityAnalysis]':
