...
class CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis(_3865.CoaxialConnectionCompoundStabilityAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3754.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3754.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
