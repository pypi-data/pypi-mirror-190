...
class ClutchHalfCompoundStabilityAnalysis(_3880.CouplingHalfCompoundStabilityAnalysis):
    """ClutchHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3731.ClutchHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3731.ClutchHalfStabilityAnalysis]':
