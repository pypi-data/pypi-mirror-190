...
class StraightBevelDiffGearMeshCompoundStabilityAnalysis(_3858.BevelGearMeshCompoundStabilityAnalysis):
    """StraightBevelDiffGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3817.StraightBevelDiffGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3817.StraightBevelDiffGearMeshStabilityAnalysis]':
