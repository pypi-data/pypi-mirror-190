...
from mastapy.system_model.analyses_and_results.stability_analyses import _3740, _3738, _3769
...
class ConceptGearSetStabilityAnalysis(_3769.GearSetStabilityAnalysis):
    """ConceptGearSetStabilityAnalysis
    ...
    @property
    def concept_gears_stability_analysis(self) -> 'List[_3740.ConceptGearStabilityAnalysis]':
    ...
    @property
    def concept_meshes_stability_analysis(self) -> 'List[_3738.ConceptGearMeshStabilityAnalysis]':
