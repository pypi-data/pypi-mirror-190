...
class RingPinsToDiscConnectionCompoundStabilityAnalysis(_3906.InterMountableComponentConnectionCompoundStabilityAnalysis):
    """RingPinsToDiscConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3800.RingPinsToDiscConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3800.RingPinsToDiscConnectionStabilityAnalysis]':
