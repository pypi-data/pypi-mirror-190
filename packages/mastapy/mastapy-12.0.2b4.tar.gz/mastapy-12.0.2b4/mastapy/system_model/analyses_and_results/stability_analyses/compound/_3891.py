...
class CylindricalPlanetGearCompoundStabilityAnalysis(_3888.CylindricalGearCompoundStabilityAnalysis):
    """CylindricalPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3760.CylindricalPlanetGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3760.CylindricalPlanetGearStabilityAnalysis]':
