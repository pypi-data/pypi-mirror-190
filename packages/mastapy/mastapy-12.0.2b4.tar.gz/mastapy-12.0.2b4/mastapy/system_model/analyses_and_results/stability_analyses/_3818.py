...
from mastapy.system_model.analyses_and_results.stability_analyses import _3819, _3817, _3726
...
class StraightBevelDiffGearSetStabilityAnalysis(_3726.BevelGearSetStabilityAnalysis):
    """StraightBevelDiffGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_diff_gears_stability_analysis(self) -> 'List[_3819.StraightBevelDiffGearStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_stability_analysis(self) -> 'List[_3817.StraightBevelDiffGearMeshStabilityAnalysis]':
