...
class MountableComponentCompoundStabilityAnalysis(_3866.ComponentCompoundStabilityAnalysis):
    """MountableComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3787.MountableComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3787.MountableComponentStabilityAnalysis]':
