...
class PulleyCompoundStabilityAnalysis(_3880.CouplingHalfCompoundStabilityAnalysis):
    """PulleyCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3798.PulleyStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3798.PulleyStabilityAnalysis]':
