...
class GearSetCompoundStabilityAnalysis(_3939.SpecialisedAssemblyCompoundStabilityAnalysis):
    """GearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3769.GearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3769.GearSetStabilityAnalysis]':
