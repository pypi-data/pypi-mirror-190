...
class FlexiblePinAssemblyCompoundStabilityAnalysis(_3939.SpecialisedAssemblyCompoundStabilityAnalysis):
    """FlexiblePinAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3767.FlexiblePinAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3767.FlexiblePinAssemblyStabilityAnalysis]':
