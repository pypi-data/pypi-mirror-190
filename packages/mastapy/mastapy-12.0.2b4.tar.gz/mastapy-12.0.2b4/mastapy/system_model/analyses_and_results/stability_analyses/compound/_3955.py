...
class SynchroniserHalfCompoundStabilityAnalysis(_3956.SynchroniserPartCompoundStabilityAnalysis):
    """SynchroniserHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3825.SynchroniserHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3825.SynchroniserHalfStabilityAnalysis]':
