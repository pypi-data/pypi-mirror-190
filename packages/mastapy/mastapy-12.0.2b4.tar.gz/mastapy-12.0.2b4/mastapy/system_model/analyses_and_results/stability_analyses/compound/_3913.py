...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundStabilityAnalysis(_3907.KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3784.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3784.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
