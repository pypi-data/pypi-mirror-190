...
class ConicalGearSetCompoundStabilityAnalysis(_3901.GearSetCompoundStabilityAnalysis):
    """ConicalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3742.ConicalGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3742.ConicalGearSetStabilityAnalysis]':
