...
class StraightBevelPlanetGearCompoundStabilityAnalysis(_3946.StraightBevelDiffGearCompoundStabilityAnalysis):
    """StraightBevelPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3823.StraightBevelPlanetGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3823.StraightBevelPlanetGearStabilityAnalysis]':
