...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3888, _3889, _3901
...
class CylindricalGearSetCompoundStabilityAnalysis(_3901.GearSetCompoundStabilityAnalysis):
    """CylindricalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3758.CylindricalGearSetStabilityAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_stability_analysis(self) -> 'List[_3888.CylindricalGearCompoundStabilityAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_stability_analysis(self) -> 'List[_3889.CylindricalGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3758.CylindricalGearSetStabilityAnalysis]':
