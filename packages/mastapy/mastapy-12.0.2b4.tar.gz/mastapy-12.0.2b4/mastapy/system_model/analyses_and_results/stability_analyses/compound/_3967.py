...
class ZerolBevelGearCompoundStabilityAnalysis(_3857.BevelGearCompoundStabilityAnalysis):
    """ZerolBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3840.ZerolBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3840.ZerolBevelGearStabilityAnalysis]':
