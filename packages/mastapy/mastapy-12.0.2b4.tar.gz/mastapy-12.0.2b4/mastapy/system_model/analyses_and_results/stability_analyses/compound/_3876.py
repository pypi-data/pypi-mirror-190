...
class ConnectionCompoundStabilityAnalysis(_7463.ConnectionCompoundAnalysis):
    """ConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3744.ConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3744.ConnectionStabilityAnalysis]':
