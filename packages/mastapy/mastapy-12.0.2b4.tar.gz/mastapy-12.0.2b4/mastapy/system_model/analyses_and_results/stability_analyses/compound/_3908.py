...
class KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis(_3874.ConicalGearMeshCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3776.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3776.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis]':
