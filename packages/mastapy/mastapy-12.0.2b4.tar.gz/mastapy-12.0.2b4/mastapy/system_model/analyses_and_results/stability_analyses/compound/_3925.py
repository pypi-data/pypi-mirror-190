...
class PlanetaryGearSetCompoundStabilityAnalysis(_3890.CylindricalGearSetCompoundStabilityAnalysis):
    """PlanetaryGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3794.PlanetaryGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3794.PlanetaryGearSetStabilityAnalysis]':
