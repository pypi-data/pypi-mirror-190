...
class RollingRingAssemblyCompoundStabilityAnalysis(_3939.SpecialisedAssemblyCompoundStabilityAnalysis):
    """RollingRingAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3801.RollingRingAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3801.RollingRingAssemblyStabilityAnalysis]':
