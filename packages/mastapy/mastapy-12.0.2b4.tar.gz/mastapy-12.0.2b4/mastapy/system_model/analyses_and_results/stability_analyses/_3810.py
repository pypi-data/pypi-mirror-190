...
from mastapy.system_model.analyses_and_results.stability_analyses import _3811, _3809, _3726
...
class SpiralBevelGearSetStabilityAnalysis(_3726.BevelGearSetStabilityAnalysis):
    """SpiralBevelGearSetStabilityAnalysis
    ...
    @property
    def spiral_bevel_gears_stability_analysis(self) -> 'List[_3811.SpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_stability_analysis(self) -> 'List[_3809.SpiralBevelGearMeshStabilityAnalysis]':
