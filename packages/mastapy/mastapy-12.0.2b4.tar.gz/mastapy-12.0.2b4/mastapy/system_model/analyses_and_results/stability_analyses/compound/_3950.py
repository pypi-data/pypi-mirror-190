...
class StraightBevelGearMeshCompoundStabilityAnalysis(_3858.BevelGearMeshCompoundStabilityAnalysis):
    """StraightBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3820.StraightBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3820.StraightBevelGearMeshStabilityAnalysis]':
