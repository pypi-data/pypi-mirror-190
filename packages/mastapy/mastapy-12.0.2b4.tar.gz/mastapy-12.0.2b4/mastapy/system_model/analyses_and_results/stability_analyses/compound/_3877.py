...
class ConnectorCompoundStabilityAnalysis(_3918.MountableComponentCompoundStabilityAnalysis):
    """ConnectorCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3745.ConnectorStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3745.ConnectorStabilityAnalysis]':
