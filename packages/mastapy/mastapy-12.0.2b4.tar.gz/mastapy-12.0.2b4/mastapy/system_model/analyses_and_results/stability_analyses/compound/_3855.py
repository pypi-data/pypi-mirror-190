...
class BevelDifferentialPlanetGearCompoundStabilityAnalysis(_3852.BevelDifferentialGearCompoundStabilityAnalysis):
    """BevelDifferentialPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3723.BevelDifferentialPlanetGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3723.BevelDifferentialPlanetGearStabilityAnalysis]':
