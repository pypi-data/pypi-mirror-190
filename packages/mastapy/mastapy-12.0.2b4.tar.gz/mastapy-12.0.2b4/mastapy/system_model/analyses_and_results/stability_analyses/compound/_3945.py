...
class SpringDamperHalfCompoundStabilityAnalysis(_3880.CouplingHalfCompoundStabilityAnalysis):
    """SpringDamperHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3813.SpringDamperHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3813.SpringDamperHalfStabilityAnalysis]':
