...
class AbstractShaftCompoundStabilityAnalysis(_3843.AbstractShaftOrHousingCompoundStabilityAnalysis):
    """AbstractShaftCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3711.AbstractShaftStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3711.AbstractShaftStabilityAnalysis]':
