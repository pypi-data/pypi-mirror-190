...
class SynchroniserCompoundStabilityAnalysis(_3939.SpecialisedAssemblyCompoundStabilityAnalysis):
    """SynchroniserCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3828.SynchroniserStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3828.SynchroniserStabilityAnalysis]':
