...
class BoltCompoundStabilityAnalysis(_3866.ComponentCompoundStabilityAnalysis):
    """BoltCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3729.BoltStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3729.BoltStabilityAnalysis]':
