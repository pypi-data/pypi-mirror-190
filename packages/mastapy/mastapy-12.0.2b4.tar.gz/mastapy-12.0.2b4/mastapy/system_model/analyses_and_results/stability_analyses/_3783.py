...
from mastapy.system_model.analyses_and_results.stability_analyses import _3784, _3782, _3777
...
class KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis(_3777.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_stability_analysis(self) -> 'List[_3784.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_stability_analysis(self) -> 'List[_3782.KlingelnbergCycloPalloidSpiralBevelGearMeshStabilityAnalysis]':
