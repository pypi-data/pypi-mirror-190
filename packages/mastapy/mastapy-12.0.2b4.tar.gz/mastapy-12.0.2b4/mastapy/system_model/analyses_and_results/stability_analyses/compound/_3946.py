...
class StraightBevelDiffGearCompoundStabilityAnalysis(_3857.BevelGearCompoundStabilityAnalysis):
    """StraightBevelDiffGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3819.StraightBevelDiffGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3819.StraightBevelDiffGearStabilityAnalysis]':
