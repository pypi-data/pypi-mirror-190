...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3903, _3904, _3847
...
class HypoidGearSetCompoundStabilityAnalysis(_3847.AGMAGleasonConicalGearSetCompoundStabilityAnalysis):
    """HypoidGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3773.HypoidGearSetStabilityAnalysis]':
    ...
    @property
    def hypoid_gears_compound_stability_analysis(self) -> 'List[_3903.HypoidGearCompoundStabilityAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_stability_analysis(self) -> 'List[_3904.HypoidGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3773.HypoidGearSetStabilityAnalysis]':
