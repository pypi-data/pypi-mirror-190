...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3852, _3853, _3859
...
class BevelDifferentialGearSetCompoundStabilityAnalysis(_3859.BevelGearSetCompoundStabilityAnalysis):
    """BevelDifferentialGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3721.BevelDifferentialGearSetStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_stability_analysis(self) -> 'List[_3852.BevelDifferentialGearCompoundStabilityAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_stability_analysis(self) -> 'List[_3853.BevelDifferentialGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3721.BevelDifferentialGearSetStabilityAnalysis]':
