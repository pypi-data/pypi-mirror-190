...
class RootAssemblyCompoundStabilityAnalysis(_3848.AssemblyCompoundStabilityAnalysis):
    """RootAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3804.RootAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3804.RootAssemblyStabilityAnalysis]':
