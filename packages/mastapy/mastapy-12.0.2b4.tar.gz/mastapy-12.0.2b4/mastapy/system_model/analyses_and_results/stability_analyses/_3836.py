...
from mastapy.system_model.analyses_and_results.stability_analyses import _3837, _3835, _3769
...
class WormGearSetStabilityAnalysis(_3769.GearSetStabilityAnalysis):
    """WormGearSetStabilityAnalysis
    ...
    @property
    def worm_gears_stability_analysis(self) -> 'List[_3837.WormGearStabilityAnalysis]':
    ...
    @property
    def worm_meshes_stability_analysis(self) -> 'List[_3835.WormGearMeshStabilityAnalysis]':
