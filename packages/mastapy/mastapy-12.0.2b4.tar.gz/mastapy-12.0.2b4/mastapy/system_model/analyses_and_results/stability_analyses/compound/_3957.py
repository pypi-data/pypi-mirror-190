...
class SynchroniserSleeveCompoundStabilityAnalysis(_3956.SynchroniserPartCompoundStabilityAnalysis):
    """SynchroniserSleeveCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3827.SynchroniserSleeveStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3827.SynchroniserSleeveStabilityAnalysis]':
