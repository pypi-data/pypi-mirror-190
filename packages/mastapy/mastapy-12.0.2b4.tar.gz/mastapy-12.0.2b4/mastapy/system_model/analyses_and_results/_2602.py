...
from mastapy.utility.model_validation import _1759, _1758
...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def active_report_as_text(self) -> '_1719.CustomReport':
    ...
    @property
    def component_design(self) -> '_2159.DesignEntity':
    ...
    @property
    def component_design_of_type_connection(self) -> '_2224.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2420.Part':
    ...
    @property
    def all_status_errors(self) -> 'List[_1759.StatusItem]':
