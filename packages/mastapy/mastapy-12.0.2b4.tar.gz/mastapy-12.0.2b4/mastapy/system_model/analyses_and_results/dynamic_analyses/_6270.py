...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6268, _6269, _6211
...
class HypoidGearSetDynamicAnalysis(_6211.AGMAGleasonConicalGearSetDynamicAnalysis):
    """HypoidGearSetDynamicAnalysis
    ...
    @property
    def hypoid_gears_dynamic_analysis(self) -> 'List[_6268.HypoidGearDynamicAnalysis]':
    ...
    @property
    def hypoid_meshes_dynamic_analysis(self) -> 'List[_6269.HypoidGearMeshDynamicAnalysis]':
