...
class BevelDifferentialSunGearCompoundDynamicAnalysis(_6346.BevelDifferentialGearCompoundDynamicAnalysis):
    """BevelDifferentialSunGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6220.BevelDifferentialSunGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6220.BevelDifferentialSunGearDynamicAnalysis]':
