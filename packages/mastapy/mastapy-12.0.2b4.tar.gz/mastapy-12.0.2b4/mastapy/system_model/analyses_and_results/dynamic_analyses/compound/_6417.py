...
class PartToPartShearCouplingHalfCompoundDynamicAnalysis(_6374.CouplingHalfCompoundDynamicAnalysis):
    """PartToPartShearCouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6288.PartToPartShearCouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6288.PartToPartShearCouplingHalfDynamicAnalysis]':
