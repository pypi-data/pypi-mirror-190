...
class BoltCompoundDynamicAnalysis(_6360.ComponentCompoundDynamicAnalysis):
    """BoltCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6224.BoltDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6224.BoltDynamicAnalysis]':
