...
class CylindricalPlanetGearCompoundDynamicAnalysis(_6382.CylindricalGearCompoundDynamicAnalysis):
    """CylindricalPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6255.CylindricalPlanetGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6255.CylindricalPlanetGearDynamicAnalysis]':
