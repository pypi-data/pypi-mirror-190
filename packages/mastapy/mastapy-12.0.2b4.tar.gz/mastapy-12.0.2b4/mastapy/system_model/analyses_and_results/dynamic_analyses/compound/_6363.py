...
class ConceptCouplingHalfCompoundDynamicAnalysis(_6374.CouplingHalfCompoundDynamicAnalysis):
    """ConceptCouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6233.ConceptCouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6233.ConceptCouplingHalfDynamicAnalysis]':
