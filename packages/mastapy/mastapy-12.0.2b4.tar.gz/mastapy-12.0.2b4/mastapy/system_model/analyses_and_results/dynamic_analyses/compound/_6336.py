...
class AbstractShaftCompoundDynamicAnalysis(_6337.AbstractShaftOrHousingCompoundDynamicAnalysis):
    """AbstractShaftCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6206.AbstractShaftDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6206.AbstractShaftDynamicAnalysis]':
