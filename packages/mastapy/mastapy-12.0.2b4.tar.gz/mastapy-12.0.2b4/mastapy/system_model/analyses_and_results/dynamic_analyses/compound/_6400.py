...
class InterMountableComponentConnectionCompoundDynamicAnalysis(_6370.ConnectionCompoundDynamicAnalysis):
    """InterMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6271.InterMountableComponentConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6271.InterMountableComponentConnectionDynamicAnalysis]':
