...
class AbstractAssemblyCompoundDynamicAnalysis(_6414.PartCompoundDynamicAnalysis):
    """AbstractAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6205.AbstractAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6205.AbstractAssemblyDynamicAnalysis]':
