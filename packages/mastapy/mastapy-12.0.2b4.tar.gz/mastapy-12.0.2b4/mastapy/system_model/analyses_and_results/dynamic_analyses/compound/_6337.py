...
class AbstractShaftOrHousingCompoundDynamicAnalysis(_6360.ComponentCompoundDynamicAnalysis):
    """AbstractShaftOrHousingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6207.AbstractShaftOrHousingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6207.AbstractShaftOrHousingDynamicAnalysis]':
