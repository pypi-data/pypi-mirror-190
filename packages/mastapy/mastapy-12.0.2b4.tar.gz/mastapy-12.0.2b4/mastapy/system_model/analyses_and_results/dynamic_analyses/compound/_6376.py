...
class CVTCompoundDynamicAnalysis(_6345.BeltDriveCompoundDynamicAnalysis):
    """CVTCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6246.CVTDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6246.CVTDynamicAnalysis]':
