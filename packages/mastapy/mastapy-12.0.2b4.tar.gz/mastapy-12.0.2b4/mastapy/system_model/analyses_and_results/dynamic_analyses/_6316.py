...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6314, _6315, _6223
...
class StraightBevelGearSetDynamicAnalysis(_6223.BevelGearSetDynamicAnalysis):
    """StraightBevelGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_gears_dynamic_analysis(self) -> 'List[_6314.StraightBevelGearDynamicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_dynamic_analysis(self) -> 'List[_6315.StraightBevelGearMeshDynamicAnalysis]':
