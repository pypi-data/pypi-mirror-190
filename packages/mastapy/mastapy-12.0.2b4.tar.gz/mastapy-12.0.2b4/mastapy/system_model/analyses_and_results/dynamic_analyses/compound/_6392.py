...
class FlexiblePinAssemblyCompoundDynamicAnalysis(_6433.SpecialisedAssemblyCompoundDynamicAnalysis):
    """FlexiblePinAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6263.FlexiblePinAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6263.FlexiblePinAssemblyDynamicAnalysis]':
