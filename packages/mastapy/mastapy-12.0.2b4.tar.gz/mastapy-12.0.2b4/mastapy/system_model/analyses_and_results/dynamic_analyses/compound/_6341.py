...
class AGMAGleasonConicalGearSetCompoundDynamicAnalysis(_6369.ConicalGearSetCompoundDynamicAnalysis):
    """AGMAGleasonConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6211.AGMAGleasonConicalGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6211.AGMAGleasonConicalGearSetDynamicAnalysis]':
