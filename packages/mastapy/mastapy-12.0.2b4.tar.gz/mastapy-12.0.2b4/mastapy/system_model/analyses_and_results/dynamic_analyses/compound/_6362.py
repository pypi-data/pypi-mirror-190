...
class ConceptCouplingConnectionCompoundDynamicAnalysis(_6373.CouplingConnectionCompoundDynamicAnalysis):
    """ConceptCouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6231.ConceptCouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6231.ConceptCouplingConnectionDynamicAnalysis]':
