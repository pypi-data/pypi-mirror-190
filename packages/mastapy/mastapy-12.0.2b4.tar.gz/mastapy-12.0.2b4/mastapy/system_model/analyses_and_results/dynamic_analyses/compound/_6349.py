...
class BevelDifferentialPlanetGearCompoundDynamicAnalysis(_6346.BevelDifferentialGearCompoundDynamicAnalysis):
    """BevelDifferentialPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6219.BevelDifferentialPlanetGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6219.BevelDifferentialPlanetGearDynamicAnalysis]':
