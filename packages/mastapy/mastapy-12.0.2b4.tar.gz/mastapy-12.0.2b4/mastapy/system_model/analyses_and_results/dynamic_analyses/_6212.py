...
from mastapy.system_model.analyses_and_results.dynamic_analyses import (
    _6213, _6215, _6218, _6225,
    _6224, _6246, _6227, _6232,
    _6236, _6248, _6250, _6254,
    _6262, _6261, _6263, _6270,
    _6277, _6280, _6281, _6282,
    _6284, _6287, _6291, _6292,
    _6293, _6295, _6297, _6302,
    _6301, _6307, _6309, _6313,
    _6316, _6319, _6324, _6327,
    _6331, _6334, _6205
)
...
class AssemblyDynamicAnalysis(_6205.AbstractAssemblyDynamicAnalysis):
    """AssemblyDynamicAnalysis
    ...
    @property
    def bearings(self) -> 'List[_6213.BearingDynamicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6215.BeltDriveDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6218.BevelDifferentialGearSetDynamicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6225.BoltedJointDynamicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6224.BoltDynamicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6246.CVTDynamicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6227.ClutchDynamicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6232.ConceptCouplingDynamicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6236.ConceptGearSetDynamicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6248.CycloidalAssemblyDynamicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6250.CycloidalDiscDynamicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6254.CylindricalGearSetDynamicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6262.FEPartDynamicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6261.FaceGearSetDynamicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6263.FlexiblePinAssemblyDynamicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6270.HypoidGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6277.KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6280.KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6281.MassDiscDynamicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6282.MeasurementComponentDynamicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6284.OilSealDynamicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6287.PartToPartShearCouplingDynamicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6291.PlanetCarrierDynamicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6292.PointLoadDynamicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6293.PowerLoadDynamicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6295.RingPinsDynamicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6297.RollingRingAssemblyDynamicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6302.ShaftHubConnectionDynamicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6301.ShaftDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6307.SpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6309.SpringDamperDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6313.StraightBevelDiffGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6316.StraightBevelGearSetDynamicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6319.SynchroniserDynamicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6324.TorqueConverterDynamicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6327.UnbalancedMassDynamicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6331.WormGearSetDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6334.ZerolBevelGearSetDynamicAnalysis]':
