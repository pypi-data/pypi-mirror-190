...
class BevelDifferentialGearCompoundDynamicAnalysis(_6351.BevelGearCompoundDynamicAnalysis):
    """BevelDifferentialGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6216.BevelDifferentialGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6216.BevelDifferentialGearDynamicAnalysis]':
