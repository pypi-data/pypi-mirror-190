...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6275, _6276, _6274
...
class KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis(_6274.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_dynamic_analysis(self) -> 'List[_6275.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_dynamic_analysis(self) -> 'List[_6276.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis]':
