...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6216, _6217, _6223
...
class BevelDifferentialGearSetDynamicAnalysis(_6223.BevelGearSetDynamicAnalysis):
    """BevelDifferentialGearSetDynamicAnalysis
    ...
    @property
    def bevel_differential_gears_dynamic_analysis(self) -> 'List[_6216.BevelDifferentialGearDynamicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_dynamic_analysis(self) -> 'List[_6217.BevelDifferentialGearMeshDynamicAnalysis]':
