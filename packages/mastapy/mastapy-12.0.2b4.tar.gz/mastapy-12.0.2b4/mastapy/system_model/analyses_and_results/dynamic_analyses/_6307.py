...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6305, _6306, _6223
...
class SpiralBevelGearSetDynamicAnalysis(_6223.BevelGearSetDynamicAnalysis):
    """SpiralBevelGearSetDynamicAnalysis
    ...
    @property
    def spiral_bevel_gears_dynamic_analysis(self) -> 'List[_6305.SpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_6306.SpiralBevelGearMeshDynamicAnalysis]':
