...
class StraightBevelDiffGearCompoundDynamicAnalysis(_6351.BevelGearCompoundDynamicAnalysis):
    """StraightBevelDiffGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6311.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6311.StraightBevelDiffGearDynamicAnalysis]':
