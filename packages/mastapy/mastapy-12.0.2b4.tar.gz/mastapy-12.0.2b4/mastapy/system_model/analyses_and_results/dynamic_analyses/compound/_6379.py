...
class CycloidalDiscCentralBearingConnectionCompoundDynamicAnalysis(_6359.CoaxialConnectionCompoundDynamicAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6249.CycloidalDiscCentralBearingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6249.CycloidalDiscCentralBearingConnectionDynamicAnalysis]':
