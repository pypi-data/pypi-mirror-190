...
class ShaftToMountableComponentConnectionCompoundDynamicAnalysis(_6338.AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """ShaftToMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6303.ShaftToMountableComponentConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6303.ShaftToMountableComponentConnectionDynamicAnalysis]':
