...
class BevelDifferentialGearMeshCompoundDynamicAnalysis(_6352.BevelGearMeshCompoundDynamicAnalysis):
    """BevelDifferentialGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6217.BevelDifferentialGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6217.BevelDifferentialGearMeshDynamicAnalysis]':
