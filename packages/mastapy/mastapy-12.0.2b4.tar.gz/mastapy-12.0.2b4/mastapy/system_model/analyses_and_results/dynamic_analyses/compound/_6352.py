...
class BevelGearMeshCompoundDynamicAnalysis(_6340.AGMAGleasonConicalGearMeshCompoundDynamicAnalysis):
    """BevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6222.BevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6222.BevelGearMeshDynamicAnalysis]':
