...
from mastapy.bearings.bearing_designs.concept import _2151, _2153
...
class ConceptAxialClearanceBearing(_2153.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_2151.BearingNodePosition':
        ...
        return constructor.new_from_mastapy_type(_2151.BearingNodePosition)(value) if value is not None else None

    @node_position.setter
    def node_position(self, value: '_2151.BearingNodePosition'):
