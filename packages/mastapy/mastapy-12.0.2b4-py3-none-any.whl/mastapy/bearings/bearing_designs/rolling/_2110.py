...
from mastapy.bearings.bearing_designs.rolling import _2111, _2112
...
class GeometricConstants(_0.APIBase):
    ...
    @property
    def geometric_constants_for_rolling_frictional_moments(self) -> '_2111.GeometricConstantsForRollingFrictionalMoments':
    ...
    @property
    def geometric_constants_for_sliding_frictional_moments(self) -> '_2112.GeometricConstantsForSlidingFrictionalMoments':
