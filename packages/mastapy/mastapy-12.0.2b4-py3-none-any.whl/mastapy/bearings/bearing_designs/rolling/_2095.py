...
from mastapy.bearings.bearing_designs.rolling import _2096, _2120
...
class BallBearing(_2120.RollingBearing):
    """BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_2096.BallBearingShoulderDefinition]':
