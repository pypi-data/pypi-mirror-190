...
from mastapy.bearings.bearing_designs.rolling import _2118, _2119, _2117
...
class NonBarrelRollerBearing(_2117.RollerBearing):
    """NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_2118.RollerEndShape':
        ...
        return constructor.new_from_mastapy_type(_2118.RollerEndShape)(value) if value is not None else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_2118.RollerEndShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RollerEndShape = value

    @property
    def ribs(self) -> 'List[_2119.RollerRibDetail]':
