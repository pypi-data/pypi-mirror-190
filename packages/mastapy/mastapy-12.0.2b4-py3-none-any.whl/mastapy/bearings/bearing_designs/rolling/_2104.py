...
from mastapy.bearings.bearing_designs.rolling import _2116
...
class CylindricalRollerBearing(_2116.NonBarrelRollerBearing):
    """CylindricalRollerBearing
    ...
    @property
    def permissible_axial_load_default_calculation_method(self) -> '_1903.CylindricalRollerMaxAxialLoadMethod':
        ...
        return constructor.new_from_mastapy_type(_1903.CylindricalRollerMaxAxialLoadMethod)(value) if value is not None else None

    @permissible_axial_load_default_calculation_method.setter
    def permissible_axial_load_default_calculation_method(self, value: '_1903.CylindricalRollerMaxAxialLoadMethod'):
