...
from mastapy.bearings.bearing_designs.rolling import _2108, _2114
...
class FourPointContactBallBearing(_2114.MultiPointContactBallBearing):
    """FourPointContactBallBearing
    ...
    @property
    def contact_angle_and_internal_clearance_definition(self) -> '_2108.FourPointContactAngleDefinition':
        ...
        return constructor.new_from_mastapy_type(_2108.FourPointContactAngleDefinition)(value) if value is not None else None

    @contact_angle_and_internal_clearance_definition.setter
    def contact_angle_and_internal_clearance_definition(self, value: '_2108.FourPointContactAngleDefinition'):
