...
from mastapy.bearings.bearing_results.rolling import _2007, _1959
...
class LoadedThreePointContactBallBearingRow(_1959.LoadedBallBearingRow):
    """LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2007.LoadedThreePointContactBallBearingResults':
