...
from mastapy.bearings.bearing_results.rolling import _2010, _1959
...
class LoadedThrustBallBearingRow(_1959.LoadedBallBearingRow):
    """LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2010.LoadedThrustBallBearingResults':
