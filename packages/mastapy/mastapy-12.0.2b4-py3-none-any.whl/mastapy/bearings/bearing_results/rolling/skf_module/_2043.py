...
class GreaseLifeAndRelubricationInterval(_2052.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    @property
    def grease_quantity(self) -> '_2044.GreaseQuantity':
    ...
    @property
    def initial_fill(self) -> '_2045.InitialFill':
