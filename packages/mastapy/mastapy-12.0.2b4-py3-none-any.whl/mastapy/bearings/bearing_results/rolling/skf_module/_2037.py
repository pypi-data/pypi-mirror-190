...
from mastapy.bearings.bearing_results.rolling.skf_module import _2038, _2050, _2052
...
class Frequencies(_2052.SKFCalculationResult):
    """Frequencies
    ...
    @property
    def frequency_of_over_rolling(self) -> '_2038.FrequencyOfOverRolling':
    ...
    @property
    def rotational_frequency(self) -> '_2050.RotationalFrequency':
