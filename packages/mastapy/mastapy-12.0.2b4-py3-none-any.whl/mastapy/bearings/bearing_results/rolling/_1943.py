...
from mastapy.bearings.bearing_results.rolling import _1942, _1940
...
class LoadedAngularContactThrustBallBearingRow(_1940.LoadedAngularContactBallBearingRow):
    """LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1942.LoadedAngularContactThrustBallBearingResults':
