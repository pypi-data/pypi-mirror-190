...
from mastapy.bearings.bearing_results.rolling import _1977, _1966
...
class LoadedNeedleRollerBearingRow(_1966.LoadedCylindricalRollerBearingRow):
    """LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1977.LoadedNeedleRollerBearingResults':
