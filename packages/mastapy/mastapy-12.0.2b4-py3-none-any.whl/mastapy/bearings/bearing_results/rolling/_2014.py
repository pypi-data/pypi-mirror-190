...
from mastapy.bearings.bearing_results.rolling import _2013, _1986
...
class LoadedToroidalRollerBearingRow(_1986.LoadedRollerBearingRow):
    """LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2013.LoadedToroidalRollerBearingResults':
