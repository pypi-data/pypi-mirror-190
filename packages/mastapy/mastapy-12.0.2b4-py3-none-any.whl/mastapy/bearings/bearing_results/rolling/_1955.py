...
class LoadedBallBearingDutyCycle(_1919.LoadedRollingBearingDutyCycle):
    """LoadedBallBearingDutyCycle
    ...
    @property
    def track_truncation_inner_summary(self) -> '_1802.DutyCyclePropertySummaryPercentage[_1958.LoadedBallBearingResults]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1958.LoadedBallBearingResults](temp) if temp is not None else None

    @property
    def track_truncation_outer_summary(self) -> '_1802.DutyCyclePropertySummaryPercentage[_1958.LoadedBallBearingResults]':
