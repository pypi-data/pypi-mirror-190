...
class ISO14179Settings(_1792.NamedDatabaseItem):
    """ISO14179Settings
    ...
    @property
    def isotr141792001f1_specification_method(self) -> '_2021.PowerRatingF1EstimationMethod':
        ...
        return constructor.new_from_mastapy_type(_2021.PowerRatingF1EstimationMethod)(value) if value is not None else None

    @isotr141792001f1_specification_method.setter
    def isotr141792001f1_specification_method(self, value: '_2021.PowerRatingF1EstimationMethod'):
