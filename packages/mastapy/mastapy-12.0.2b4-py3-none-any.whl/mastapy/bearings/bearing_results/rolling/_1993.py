...
from mastapy.bearings.bearing_results.rolling import _1992, _1959
...
class LoadedSelfAligningBallBearingRow(_1959.LoadedBallBearingRow):
    """LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1992.LoadedSelfAligningBallBearingResults':
