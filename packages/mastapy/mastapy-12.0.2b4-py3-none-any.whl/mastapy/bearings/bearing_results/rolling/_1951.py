...
from mastapy.bearings.bearing_results.rolling import _1950, _1953, _1981
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1981.LoadedNonBarrelRollerBearingRow):
    """LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1950.LoadedAxialThrustCylindricalRollerBearingResults':
