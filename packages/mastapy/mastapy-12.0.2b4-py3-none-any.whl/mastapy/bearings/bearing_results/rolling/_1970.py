...
from mastapy.bearings.bearing_results.rolling import _1933, _2030, _2029
...
class LoadedElement(_0.APIBase):
    ...
    @property
    def operating_internal_clearance(self) -> '_1933.InternalClearance':
    ...
    @property
    def subsurface_shear_stress_distribution_inner(self) -> 'List[_2029.StressAtPosition]':
    ...
    @property
    def subsurface_shear_stress_distribution_outer(self) -> 'List[_2029.StressAtPosition]':
