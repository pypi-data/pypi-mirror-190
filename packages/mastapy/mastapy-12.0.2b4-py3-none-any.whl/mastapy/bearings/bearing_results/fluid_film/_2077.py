...
from mastapy.bearings.bearing_results.fluid_film import _2078, _2074
...
class LoadedPlainJournalBearingResults(_2074.LoadedFluidFilmBearingResults):
    """LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_2078.LoadedPlainJournalBearingRow]':
