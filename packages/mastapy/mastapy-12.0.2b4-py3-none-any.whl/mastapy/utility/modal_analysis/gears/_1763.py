...
from mastapy.utility.modal_analysis.gears import _1764, _1767, _1769
...
class GearOrderForTE(_1769.OrderWithRadius):
    """GearOrderForTE
    ...
    @property
    def position(self) -> '_1764.GearPositions':
        ...
        return constructor.new_from_mastapy_type(_1764.GearPositions)(value) if value is not None else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1767.OrderForTE]':
