...
from mastapy.utility.report import _1750, _1743
...
class UserTextRow(_1743.CustomRow):
    """UserTextRow
    ...
    @property
    def heading_size(self) -> '_1750.HeadingSize':
        ...
        return constructor.new_from_mastapy_type(_1750.HeadingSize)(value) if value is not None else None

    @heading_size.setter
    def heading_size(self, value: '_1750.HeadingSize'):
