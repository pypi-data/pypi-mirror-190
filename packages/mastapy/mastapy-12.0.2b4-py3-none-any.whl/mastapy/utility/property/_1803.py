...
from mastapy.utility.units_and_measurements.measurements import _1580
...
class DutyCyclePropertySummarySmallAngle(_1800.DutyCyclePropertySummary['_1580.AngleSmall', 'T'], Generic[T]):
    """DutyCyclePropertySummarySmallAngle
