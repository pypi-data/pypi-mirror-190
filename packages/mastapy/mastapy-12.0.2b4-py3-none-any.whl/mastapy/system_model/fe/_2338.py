...
from mastapy.system_model.fe import _2336, _2337
...
class FESubstructureNodeModeShapes(_0.APIBase):
    ...
    @property
    def condensation_node(self) -> '_2336.FESubstructureNode':
    ...
    @property
    def mode_shapes_at_condensation_node(self) -> 'List[_2337.FESubstructureNodeModeShape]':
