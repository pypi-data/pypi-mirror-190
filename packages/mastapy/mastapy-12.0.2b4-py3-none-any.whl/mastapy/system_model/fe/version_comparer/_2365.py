...
from mastapy.system_model.fe.version_comparer import _2367, _2363
...
class FESubstructureVersionComparer(_0.APIBase):
    ...
    @property
    def load_cases_to_run(self) -> '_2367.LoadCasesToRun':
        ...
        return constructor.new_from_mastapy_type(_2367.LoadCasesToRun)(value) if value is not None else None

    @load_cases_to_run.setter
    def load_cases_to_run(self, value: '_2367.LoadCasesToRun'):
    ...
    @property
    def design_results(self) -> 'List[_2363.DesignResults]':
