...
from mastapy.system_model.fe import _2338, _2341
...
class FESubstructureWithSelectionForModalAnalysis(_2341.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def full_fe_mode_shapes_at_condensation_nodes(self) -> 'List[_2338.FESubstructureNodeModeShapes]':
