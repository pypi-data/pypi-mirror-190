...
from mastapy.system_model.fe import _2323, _2324
...
class NodeBoundaryConditionStaticAnalysis(_0.APIBase):
    ...
    @property
    def boundary_conditions_angular(self) -> 'List[_2323.DegreeOfFreedomBoundaryConditionAngular]':
    ...
    @property
    def boundary_conditions_linear(self) -> 'List[_2324.DegreeOfFreedomBoundaryConditionLinear]':
