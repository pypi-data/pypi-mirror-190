...
from mastapy.system_model import _2163, _2167
...
class DutyCycleImporter(_0.APIBase):
    ...
    @property
    def design_state_destinations(self) -> 'List[_2163.DutyCycleImporterDesignEntityMatch[_5599.DesignState]]':
    ...
    @property
    def duty_cycles_to_import(self) -> 'List[_2167.IncludeDutyCycleOption]':
    ...
    @property
    def point_load_destinations(self) -> 'List[_2163.DutyCycleImporterDesignEntityMatch[_2423.PointLoad]]':
    ...
    @property
    def power_load_destinations(self) -> 'List[_2163.DutyCycleImporterDesignEntityMatch[_2424.PowerLoad]]':
