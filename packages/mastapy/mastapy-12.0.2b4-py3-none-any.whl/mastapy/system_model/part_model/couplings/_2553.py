...
from mastapy.system_model.part_model.couplings import _2557, _2555
...
class Synchroniser(_2428.SpecialisedAssembly):
    """Synchroniser
    ...
    @property
    def clutch_connection_left(self) -> '_2294.ClutchConnection':
    ...
    @property
    def clutch_connection_right(self) -> '_2294.ClutchConnection':
    ...
    @property
    def hub_and_sleeve(self) -> '_2557.SynchroniserSleeve':
    ...
    @property
    def left_cone(self) -> '_2555.SynchroniserHalf':
    ...
    @property
    def right_cone(self) -> '_2555.SynchroniserHalf':
