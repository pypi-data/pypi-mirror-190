...
from mastapy.system_model.part_model.couplings import _2528, _2541
...
class BeltDrive(_2428.SpecialisedAssembly):
    """BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2528.BeltDriveType':
        ...
        return constructor.new_from_mastapy_type(_2528.BeltDriveType)(value) if value is not None else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2528.BeltDriveType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfBelt = value

    @property
    def belt_connections(self) -> 'List[_2220.BeltConnection]':
    ...
    @property
    def pulleys(self) -> 'List[_2541.Pulley]':
