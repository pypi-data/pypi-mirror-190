...
from mastapy.system_model.part_model import _2396, _2420
...
class AbstractAssembly(_2420.Part):
    """AbstractAssembly
    ...
    @property
    def components_with_unknown_mass_properties(self) -> 'List[_2396.Component]':
    ...
    @property
    def components_with_zero_mass_properties(self) -> 'List[_2396.Component]':
