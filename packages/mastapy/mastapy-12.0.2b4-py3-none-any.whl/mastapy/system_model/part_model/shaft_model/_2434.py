...
class Shaft(_2388.AbstractShaft):
    """Shaft
    ...
    @property
    def guide_image(self) -> '_2408.GuideImage':
    ...
    @property
    def fe_substructure_replacing_this(self) -> '_2334.FESubstructure':
    ...
    def mount_component(self, component: '_2416.MountableComponent', offset: 'float'):
