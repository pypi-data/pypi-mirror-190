...
from mastapy.system_model.part_model.part_groups import _2439, _2441, _2438
...
class ParallelPartGroup(_2438.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2439.ConcentricPartGroup]':
    ...
    @property
    def design_measurements(self) -> 'List[_2441.DesignMeasurements]':
