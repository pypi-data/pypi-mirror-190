...
from mastapy.system_model.part_model.gears import _2485, _2465
...
class HypoidGearSet(_2465.AGMAGleasonConicalGearSet):
    """HypoidGearSet
    ...
    @property
    def hypoid_gears(self) -> 'List[_2485.HypoidGear]':
    ...
    @property
    def hypoid_meshes(self) -> 'List[_2267.HypoidGearMesh]':
