...
from mastapy.system_model.part_model.gears import _2498, _2471
...
class StraightBevelGearSet(_2471.BevelGearSet):
    """StraightBevelGearSet
    ...
    @property
    def straight_bevel_gears(self) -> 'List[_2498.StraightBevelGear]':
    ...
    @property
    def straight_bevel_meshes(self) -> 'List[_2279.StraightBevelGearMesh]':
