...
from mastapy.system_model.part_model.gears import _2491, _2488
...
class KlingelnbergCycloPalloidSpiralBevelGearSet(_2488.KlingelnbergCycloPalloidConicalGearSet):
    """KlingelnbergCycloPalloidSpiralBevelGearSet
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears(self) -> 'List[_2491.KlingelnbergCycloPalloidSpiralBevelGear]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes(self) -> 'List[_2272.KlingelnbergCycloPalloidSpiralBevelGearMesh]':
