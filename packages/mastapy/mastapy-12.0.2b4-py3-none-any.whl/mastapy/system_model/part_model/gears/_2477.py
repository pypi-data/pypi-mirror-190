...
from mastapy.system_model.part_model.gears import _2476, _2483
...
class CylindricalGearSet(_2483.GearSet):
    """CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2514.SuperchargerRotorSet':
    ...
    @property
    def cylindrical_meshes(self) -> 'List[_2261.CylindricalGearMesh]':
