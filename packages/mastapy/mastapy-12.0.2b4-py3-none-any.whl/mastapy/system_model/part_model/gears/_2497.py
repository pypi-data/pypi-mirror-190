...
from mastapy.system_model.part_model.gears import _2496, _2471
...
class StraightBevelDiffGearSet(_2471.BevelGearSet):
    """StraightBevelDiffGearSet
    ...
    @property
    def straight_bevel_diff_gears(self) -> 'List[_2496.StraightBevelDiffGear]':
    ...
    @property
    def straight_bevel_diff_meshes(self) -> 'List[_2277.StraightBevelDiffGearMesh]':
