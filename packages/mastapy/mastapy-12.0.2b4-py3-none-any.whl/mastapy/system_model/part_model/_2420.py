...
from mastapy.system_model.import_export import _2193
...
class Part(_2159.DesignEntity):
    ...
    @property
    def local_connections(self) -> 'List[_2224.Connection]':
    ...
    def connections_to(self, part: 'Part') -> 'List[_2224.Connection]':
    ...
    def copy_to(self, container: '_2386.Assembly') -> 'Part':
    ...
    def create_geometry_export_options(self) -> '_2193.GeometryExportOptions':
