...
from mastapy.system_model.drawing import _2207, _2203
...
class ContourDrawStyle(_302.DrawStyleBase):
    ...
    @property
    def contour(self) -> '_1784.ThreeDViewContourOption':
        ...
        return constructor.new_from_mastapy_type(_1784.ThreeDViewContourOption)(value) if value is not None else None

    @contour.setter
    def contour(self, value: '_1784.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_2207.ScalingDrawStyle':
    ...
    @property
    def model_view_options(self) -> '_2203.ModelViewOptionsDrawStyle':
