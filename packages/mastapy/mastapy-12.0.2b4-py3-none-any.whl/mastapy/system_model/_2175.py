...
T = TypeVar('T', bound='_2396.Component')
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def axial_offset(self) -> '_2176.RelativeOffsetOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2176.RelativeOffsetOption)(value) if value is not None else None

    @axial_offset.setter
    def axial_offset(self, value: '_2176.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
