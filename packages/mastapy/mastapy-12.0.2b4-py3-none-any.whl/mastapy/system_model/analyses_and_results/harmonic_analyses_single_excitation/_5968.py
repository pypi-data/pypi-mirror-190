...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5966, _5967, _5997
...
class ConceptGearSetHarmonicAnalysisOfSingleExcitation(_5997.GearSetHarmonicAnalysisOfSingleExcitation):
    """ConceptGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def concept_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5966.ConceptGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5967.ConceptGearMeshHarmonicAnalysisOfSingleExcitation]':
