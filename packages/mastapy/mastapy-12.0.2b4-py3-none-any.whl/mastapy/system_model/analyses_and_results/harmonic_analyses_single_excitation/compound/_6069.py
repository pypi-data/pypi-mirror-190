...
class AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation(_6092.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5939.AbstractShaftOrHousingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5939.AbstractShaftOrHousingHarmonicAnalysisOfSingleExcitation]':
