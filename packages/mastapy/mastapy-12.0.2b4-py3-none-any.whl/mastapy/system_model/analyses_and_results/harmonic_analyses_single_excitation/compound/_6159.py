...
class RollingRingCompoundHarmonicAnalysisOfSingleExcitation(_6106.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    """RollingRingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6031.RollingRingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6031.RollingRingHarmonicAnalysisOfSingleExcitation]':
