...
class CouplingCompoundHarmonicAnalysisOfSingleExcitation(_6165.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """CouplingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5976.CouplingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5976.CouplingHarmonicAnalysisOfSingleExcitation]':
