...
class AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation(_6069.AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation):
    """AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5938.AbstractShaftHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5938.AbstractShaftHarmonicAnalysisOfSingleExcitation]':
