...
class TorqueConverterPumpCompoundHarmonicAnalysisOfSingleExcitation(_6106.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    """TorqueConverterPumpCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6057.TorqueConverterPumpHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6057.TorqueConverterPumpHarmonicAnalysisOfSingleExcitation]':
