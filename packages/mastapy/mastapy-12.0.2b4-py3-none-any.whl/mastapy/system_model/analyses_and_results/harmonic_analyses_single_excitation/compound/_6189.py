...
class VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation(_6144.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6060.VirtualComponentHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6060.VirtualComponentHarmonicAnalysisOfSingleExcitation]':
