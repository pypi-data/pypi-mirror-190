...
class PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation(_6104.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    """PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6020.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6020.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]':
