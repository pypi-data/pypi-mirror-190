...
class ExternalCADModelCompoundHarmonicAnalysisOfSingleExcitation(_6092.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """ExternalCADModelCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5989.ExternalCADModelHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5989.ExternalCADModelHarmonicAnalysisOfSingleExcitation]':
