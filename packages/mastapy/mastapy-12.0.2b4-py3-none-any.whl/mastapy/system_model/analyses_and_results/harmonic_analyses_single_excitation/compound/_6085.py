...
class BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6073.AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5955.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5955.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
