...
class RingPinsCompoundHarmonicAnalysisOfSingleExcitation(_6144.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """RingPinsCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6027.RingPinsHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6027.RingPinsHarmonicAnalysisOfSingleExcitation]':
