...
class BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation(_6078.BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5952.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5952.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
