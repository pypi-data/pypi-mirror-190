...
class OilSealCompoundHarmonicAnalysisOfSingleExcitation(_6103.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    """OilSealCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6016.OilSealHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6016.OilSealHarmonicAnalysisOfSingleExcitation]':
