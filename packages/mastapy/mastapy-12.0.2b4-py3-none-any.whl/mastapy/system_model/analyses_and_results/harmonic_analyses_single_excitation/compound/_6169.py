...
class SpringDamperCompoundHarmonicAnalysisOfSingleExcitation(_6104.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    """SpringDamperCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6042.SpringDamperHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6042.SpringDamperHarmonicAnalysisOfSingleExcitation]':
