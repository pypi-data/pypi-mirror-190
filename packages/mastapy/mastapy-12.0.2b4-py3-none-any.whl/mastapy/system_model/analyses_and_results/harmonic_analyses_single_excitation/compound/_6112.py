...
class CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation(_6068.AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation):
    """CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5982.CycloidalDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5982.CycloidalDiscHarmonicAnalysisOfSingleExcitation]':
