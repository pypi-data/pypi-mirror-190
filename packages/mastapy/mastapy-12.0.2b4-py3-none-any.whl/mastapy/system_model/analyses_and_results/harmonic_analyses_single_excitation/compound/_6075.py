...
class BearingCompoundHarmonicAnalysisOfSingleExcitation(_6103.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    """BearingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5945.BearingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5945.BearingHarmonicAnalysisOfSingleExcitation]':
