...
class PlanetCarrierCompoundHarmonicAnalysisOfSingleExcitation(_6144.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """PlanetCarrierCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6023.PlanetCarrierHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6023.PlanetCarrierHarmonicAnalysisOfSingleExcitation]':
