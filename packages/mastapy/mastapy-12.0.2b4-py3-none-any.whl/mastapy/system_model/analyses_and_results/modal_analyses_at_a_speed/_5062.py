...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import (
    ...
    _5075, _5096, _5078, _5083,
    _5086, _5098, _5100, _5104,
    _5111, _5110, _5112, _5119,
    _5126, _5129, _5130, _5131,
    _5133, _5137, _5140, _5141,
    _5142, _5144, _5146, _5150,
    _5151, _5156, _5159, _5162,
    _5165, _5169, _5173, _5176,
    _5180, _5183, _5055
)
...
class AssemblyModalAnalysisAtASpeed(_5055.AbstractAssemblyModalAnalysisAtASpeed):
    """AssemblyModalAnalysisAtASpeed
    ...
    @property
    def bearings(self) -> 'List[_5063.BearingModalAnalysisAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_5065.BeltDriveModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5068.BevelDifferentialGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5074.BoltedJointModalAnalysisAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_5075.BoltModalAnalysisAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_5096.CVTModalAnalysisAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_5078.ClutchModalAnalysisAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5083.ConceptCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5086.ConceptGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5098.CycloidalAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5100.CycloidalDiscModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5104.CylindricalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_5111.FEPartModalAnalysisAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5110.FaceGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5112.FlexiblePinAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5119.HypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5126.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5129.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_5130.MassDiscModalAnalysisAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_5131.MeasurementComponentModalAnalysisAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_5133.OilSealModalAnalysisAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5137.PartToPartShearCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5140.PlanetCarrierModalAnalysisAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_5141.PointLoadModalAnalysisAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_5142.PowerLoadModalAnalysisAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_5144.RingPinsModalAnalysisAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5146.RollingRingAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5150.ShaftHubConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_5151.ShaftModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5156.SpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5159.SpringDamperModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5162.StraightBevelDiffGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5165.StraightBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_5169.SynchroniserModalAnalysisAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_5173.TorqueConverterModalAnalysisAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5176.UnbalancedMassModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5180.WormGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5183.ZerolBevelGearSetModalAnalysisAtASpeed]':
