...
class PulleyCompoundModalAnalysisAtASpeed(_5223.CouplingHalfCompoundModalAnalysisAtASpeed):
    """PulleyCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5143.PulleyModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5143.PulleyModalAnalysisAtASpeed]':
