...
class UnbalancedMassCompoundModalAnalysisAtASpeed(_5306.VirtualComponentCompoundModalAnalysisAtASpeed):
    """UnbalancedMassCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5176.UnbalancedMassModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5176.UnbalancedMassModalAnalysisAtASpeed]':
