...
class ExternalCADModelCompoundModalAnalysisAtASpeed(_5209.ComponentCompoundModalAnalysisAtASpeed):
    """ExternalCADModelCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5107.ExternalCADModelModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5107.ExternalCADModelModalAnalysisAtASpeed]':
