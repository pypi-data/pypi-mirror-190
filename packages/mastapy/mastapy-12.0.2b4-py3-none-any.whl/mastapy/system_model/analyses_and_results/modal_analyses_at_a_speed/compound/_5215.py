...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5213, _5214, _5244
...
class ConceptGearSetCompoundModalAnalysisAtASpeed(_5244.GearSetCompoundModalAnalysisAtASpeed):
    """ConceptGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5086.ConceptGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5213.ConceptGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5214.ConceptGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5086.ConceptGearSetModalAnalysisAtASpeed]':
