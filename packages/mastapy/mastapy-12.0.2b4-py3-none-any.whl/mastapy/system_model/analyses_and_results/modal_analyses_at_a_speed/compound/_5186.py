...
class AbstractShaftOrHousingCompoundModalAnalysisAtASpeed(_5209.ComponentCompoundModalAnalysisAtASpeed):
    """AbstractShaftOrHousingCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5057.AbstractShaftOrHousingModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5057.AbstractShaftOrHousingModalAnalysisAtASpeed]':
