...
class ShaftHubConnectionCompoundModalAnalysisAtASpeed(_5220.ConnectorCompoundModalAnalysisAtASpeed):
    """ShaftHubConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5150.ShaftHubConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5150.ShaftHubConnectionModalAnalysisAtASpeed]':
