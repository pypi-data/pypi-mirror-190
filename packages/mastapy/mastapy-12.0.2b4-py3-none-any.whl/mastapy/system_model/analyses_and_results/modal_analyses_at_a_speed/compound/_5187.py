...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed(_5219.ConnectionCompoundModalAnalysisAtASpeed):
    """AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5058.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5058.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
