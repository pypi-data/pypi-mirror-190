...
class MountableComponentCompoundModalAnalysisAtASpeed(_5209.ComponentCompoundModalAnalysisAtASpeed):
    """MountableComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5132.MountableComponentModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5132.MountableComponentModalAnalysisAtASpeed]':
