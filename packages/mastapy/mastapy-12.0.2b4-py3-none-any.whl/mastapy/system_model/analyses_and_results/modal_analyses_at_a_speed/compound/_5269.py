...
class PlanetCarrierCompoundModalAnalysisAtASpeed(_5261.MountableComponentCompoundModalAnalysisAtASpeed):
    """PlanetCarrierCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5140.PlanetCarrierModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5140.PlanetCarrierModalAnalysisAtASpeed]':
