...
class StraightBevelGearCompoundModalAnalysisAtASpeed(_5200.BevelGearCompoundModalAnalysisAtASpeed):
    """StraightBevelGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5164.StraightBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5164.StraightBevelGearModalAnalysisAtASpeed]':
