...
class PlanetaryGearSetCompoundModalAnalysisAtASpeed(_5233.CylindricalGearSetCompoundModalAnalysisAtASpeed):
    """PlanetaryGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5139.PlanetaryGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5139.PlanetaryGearSetModalAnalysisAtASpeed]':
