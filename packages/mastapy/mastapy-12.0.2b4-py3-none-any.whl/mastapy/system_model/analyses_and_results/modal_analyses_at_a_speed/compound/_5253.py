...
class KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysisAtASpeed(_5250.KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5125.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5125.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed]':
