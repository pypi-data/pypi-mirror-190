...
class SynchroniserHalfCompoundModalAnalysisAtASpeed(_5299.SynchroniserPartCompoundModalAnalysisAtASpeed):
    """SynchroniserHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5168.SynchroniserHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5168.SynchroniserHalfModalAnalysisAtASpeed]':
