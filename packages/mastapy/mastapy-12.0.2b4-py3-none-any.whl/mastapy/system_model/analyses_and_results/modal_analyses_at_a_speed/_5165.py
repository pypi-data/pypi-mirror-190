...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5164, _5163, _5073
...
class StraightBevelGearSetModalAnalysisAtASpeed(_5073.BevelGearSetModalAnalysisAtASpeed):
    """StraightBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_5164.StraightBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_5163.StraightBevelGearMeshModalAnalysisAtASpeed]':
