...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5125, _5124, _5123
...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed(_5123.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_modal_analysis_at_a_speed(self) -> 'List[_5125.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_modal_analysis_at_a_speed(self) -> 'List[_5124.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed]':
