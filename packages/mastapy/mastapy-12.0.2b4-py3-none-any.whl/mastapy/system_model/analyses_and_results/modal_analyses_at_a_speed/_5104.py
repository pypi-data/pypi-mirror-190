...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5103, _5102, _5115
...
class CylindricalGearSetModalAnalysisAtASpeed(_5115.GearSetModalAnalysisAtASpeed):
    """CylindricalGearSetModalAnalysisAtASpeed
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_speed(self) -> 'List[_5103.CylindricalGearModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_meshes_modal_analysis_at_a_speed(self) -> 'List[_5102.CylindricalGearMeshModalAnalysisAtASpeed]':
