...
class PartToPartShearCouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed(_3619.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    """PartToPartShearCouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3531.PartToPartShearCouplingHalfSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3531.PartToPartShearCouplingHalfSteadyStateSynchronousResponseAtASpeed]':
