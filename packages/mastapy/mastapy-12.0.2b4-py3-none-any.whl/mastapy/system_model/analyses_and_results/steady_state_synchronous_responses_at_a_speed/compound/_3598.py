...
class BevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3586.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """BevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3467.BevelGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3467.BevelGearSetSteadyStateSynchronousResponseAtASpeed]':
