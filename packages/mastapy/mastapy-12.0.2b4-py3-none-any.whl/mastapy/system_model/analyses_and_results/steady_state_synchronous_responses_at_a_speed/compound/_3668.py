...
class PulleyCompoundSteadyStateSynchronousResponseAtASpeed(_3619.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    """PulleyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3538.PulleySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3538.PulleySteadyStateSynchronousResponseAtASpeed]':
