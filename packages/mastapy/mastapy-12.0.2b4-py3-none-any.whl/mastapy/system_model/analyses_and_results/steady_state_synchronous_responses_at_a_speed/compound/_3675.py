...
class ShaftCompoundSteadyStateSynchronousResponseAtASpeed(_3581.AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed):
    """ShaftCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3546.ShaftSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3546.ShaftSteadyStateSynchronousResponseAtASpeed]':
