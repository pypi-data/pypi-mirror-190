...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import (
    _3588, _3590, _3593, _3600,
    _3599, _3621, _3601, _3606,
    _3611, _3623, _3625, _3629,
    _3636, _3635, _3637, _3644,
    _3651, _3654, _3655, _3656,
    _3658, _3660, _3665, _3666,
    _3667, _3669, _3671, _3676,
    _3675, _3681, _3682, _3687,
    _3690, _3693, _3697, _3701,
    _3705, _3708, _3580
)
...
class AssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3580.AbstractAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """AssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3457.AssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bearings(self) -> 'List[_3588.BearingCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_3590.BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3593.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3600.BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_3599.BoltCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_3621.CVTCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_3601.ClutchCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3606.ConceptCouplingCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3611.ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3623.CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3625.CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3629.CylindricalGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_3636.FEPartCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3635.FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3637.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3644.HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3651.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3654.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_3655.MassDiscCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_3656.MeasurementComponentCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_3658.OilSealCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3660.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3665.PlanetCarrierCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_3666.PointLoadCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_3667.PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_3669.RingPinsCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3671.RollingRingAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3676.ShaftHubConnectionCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_3675.ShaftCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3681.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3682.SpringDamperCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3687.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3690.StraightBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_3693.SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_3697.TorqueConverterCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3701.UnbalancedMassCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3705.WormGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3708.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3457.AssemblySteadyStateSynchronousResponseAtASpeed]':
