...
class RingPinsCompoundSteadyStateSynchronousResponseAtASpeed(_3657.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """RingPinsCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3539.RingPinsSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3539.RingPinsSteadyStateSynchronousResponseAtASpeed]':
