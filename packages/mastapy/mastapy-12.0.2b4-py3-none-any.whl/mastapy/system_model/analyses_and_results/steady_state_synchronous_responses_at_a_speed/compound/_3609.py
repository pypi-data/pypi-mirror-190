...
class ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed(_3638.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3481.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3481.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
