...
class ClutchConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3618.CouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """ClutchConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3471.ClutchConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3471.ClutchConnectionSteadyStateSynchronousResponseAtASpeed]':
