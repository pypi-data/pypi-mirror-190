...
class FaceGearCompoundSteadyStateSynchronousResponseAtASpeed(_3638.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """FaceGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3505.FaceGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3505.FaceGearSteadyStateSynchronousResponseAtASpeed]':
