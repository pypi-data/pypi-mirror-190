...
class PointLoadCompoundSteadyStateSynchronousResponseAtASpeed(_3702.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """PointLoadCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3536.PointLoadSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3536.PointLoadSteadyStateSynchronousResponseAtASpeed]':
