...
class CoaxialConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3677.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """CoaxialConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3474.CoaxialConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3474.CoaxialConnectionSteadyStateSynchronousResponseAtASpeed]':
