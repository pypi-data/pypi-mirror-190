...
class BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed(_3678.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3469.BoltedJointSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3469.BoltedJointSteadyStateSynchronousResponseAtASpeed]':
