...
class OilSealCompoundSteadyStateSynchronousResponseAtASpeed(_3616.ConnectorCompoundSteadyStateSynchronousResponseAtASpeed):
    """OilSealCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3528.OilSealSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3528.OilSealSteadyStateSynchronousResponseAtASpeed]':
