...
class PartCompoundSteadyStateSynchronousResponseAtASpeed(_7470.PartCompoundAnalysis):
    """PartCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3529.PartSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3529.PartSteadyStateSynchronousResponseAtASpeed]':
