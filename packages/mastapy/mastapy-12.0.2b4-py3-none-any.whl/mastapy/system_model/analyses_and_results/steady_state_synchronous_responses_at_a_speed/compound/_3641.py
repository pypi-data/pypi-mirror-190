...
class GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed(_3605.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3511.GuideDxfModelSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3511.GuideDxfModelSteadyStateSynchronousResponseAtASpeed]':
