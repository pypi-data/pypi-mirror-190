...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3481, _3479, _3509
...
class ConceptGearSetSteadyStateSynchronousResponseAtASpeed(_3509.GearSetSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def concept_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3481.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3479.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed]':
