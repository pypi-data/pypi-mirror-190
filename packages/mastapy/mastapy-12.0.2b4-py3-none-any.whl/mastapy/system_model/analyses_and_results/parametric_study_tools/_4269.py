...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4268, _4267, _4305
...
class ConceptGearSetParametricStudyTool(_4305.GearSetParametricStudyTool):
    """ConceptGearSetParametricStudyTool
    ...
    @property
    def concept_gears_parametric_study_tool(self) -> 'List[_4268.ConceptGearParametricStudyTool]':
    ...
    @property
    def concept_meshes_parametric_study_tool(self) -> 'List[_4267.ConceptGearMeshParametricStudyTool]':
