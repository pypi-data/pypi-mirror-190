...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4325, _4322, _4290
...
class ParametricStudyVariable(_2599.AnalysisCaseVariable):
    """ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4325.ParametricStudyDimension':
        ...
        return constructor.new_from_mastapy_type(_4325.ParametricStudyDimension)(value) if value is not None else None

    @dimension.setter
    def dimension(self, value: '_4325.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4322.MonteCarloDistribution':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_4322.MonteCarloDistribution)(value) if value is not None else None

    @distribution.setter
    def distribution(self, value: '_4322.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def doe_variable_setter(self) -> '_4290.DesignOfExperimentsVariableSetter':
