...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4365, _4364, _4256
...
class StraightBevelGearSetParametricStudyTool(_4256.BevelGearSetParametricStudyTool):
    """StraightBevelGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_gears_parametric_study_tool(self) -> 'List[_4365.StraightBevelGearParametricStudyTool]':
    ...
    @property
    def straight_bevel_meshes_parametric_study_tool(self) -> 'List[_4364.StraightBevelGearMeshParametricStudyTool]':
