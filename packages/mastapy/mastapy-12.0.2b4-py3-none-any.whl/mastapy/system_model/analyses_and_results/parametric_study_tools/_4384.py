...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4383, _4382, _4256
...
class ZerolBevelGearSetParametricStudyTool(_4256.BevelGearSetParametricStudyTool):
    """ZerolBevelGearSetParametricStudyTool
    ...
    @property
    def zerol_bevel_gears_parametric_study_tool(self) -> 'List[_4383.ZerolBevelGearParametricStudyTool]':
    ...
    @property
    def zerol_bevel_meshes_parametric_study_tool(self) -> 'List[_4382.ZerolBevelGearMeshParametricStudyTool]':
