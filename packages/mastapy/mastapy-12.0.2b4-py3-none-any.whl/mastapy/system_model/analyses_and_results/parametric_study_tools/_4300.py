...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4299, _4298, _4305
...
class FaceGearSetParametricStudyTool(_4305.GearSetParametricStudyTool):
    """FaceGearSetParametricStudyTool
    ...
    @property
    def face_gears_parametric_study_tool(self) -> 'List[_4299.FaceGearParametricStudyTool]':
    ...
    @property
    def face_meshes_parametric_study_tool(self) -> 'List[_4298.FaceGearMeshParametricStudyTool]':
