...
class BoltedJointCompoundParametricStudyTool(_4483.SpecialisedAssemblyCompoundParametricStudyTool):
    """BoltedJointCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4257.BoltedJointParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4257.BoltedJointParametricStudyTool]':
