...
class CVTCompoundParametricStudyTool(_4395.BeltDriveCompoundParametricStudyTool):
    """CVTCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4279.CVTParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4279.CVTParametricStudyTool]':
