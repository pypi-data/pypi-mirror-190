...
class BevelDifferentialGearCompoundParametricStudyTool(_4401.BevelGearCompoundParametricStudyTool):
    """BevelDifferentialGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4250.BevelDifferentialGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4250.BevelDifferentialGearParametricStudyTool]':
