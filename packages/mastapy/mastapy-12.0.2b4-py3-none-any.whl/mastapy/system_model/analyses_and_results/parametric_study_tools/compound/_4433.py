...
class CylindricalGearMeshCompoundParametricStudyTool(_4444.GearMeshCompoundParametricStudyTool):
    """CylindricalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4285.CylindricalGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4285.CylindricalGearMeshParametricStudyTool]':
