...
class SynchroniserPartCompoundParametricStudyTool(_4424.CouplingHalfCompoundParametricStudyTool):
    """SynchroniserPartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4371.SynchroniserPartParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4371.SynchroniserPartParametricStudyTool]':
