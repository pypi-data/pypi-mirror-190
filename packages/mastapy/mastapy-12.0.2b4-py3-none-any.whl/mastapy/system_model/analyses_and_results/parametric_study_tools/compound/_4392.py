...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4292, _4245
from mastapy._internal import constructor, conversion
from mastapy.system_model.part_model import _2386, _2426
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import (
    _4393, _4395, _4398, _4405,
    _4404, _4426, _4406, _4411,
    _4416, _4428, _4430, _4434,
    _4441, _4440, _4442, _4449,
    _4456, _4459, _4460, _4461,
    _4463, _4465, _4470, _4471,
    _4472, _4474, _4476, _4481,
    _4480, _4486, _4487, _4492,
    _4495, _4498, _4502, _4506,
    _4510, _4513, _4385
)
...
class AssemblyCompoundParametricStudyTool(_4385.AbstractAssemblyCompoundParametricStudyTool):
    """AssemblyCompoundParametricStudyTool
    ...
    @property
    def all_duty_cycle_results(self) -> '_4292.DutyCycleResultsForAllComponents':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4245.AssemblyParametricStudyTool]':
    ...
    @property
    def bearings(self) -> 'List[_4393.BearingCompoundParametricStudyTool]':
    ...
    @property
    def belt_drives(self) -> 'List[_4395.BeltDriveCompoundParametricStudyTool]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4398.BevelDifferentialGearSetCompoundParametricStudyTool]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4405.BoltedJointCompoundParametricStudyTool]':
    ...
    @property
    def bolts(self) -> 'List[_4404.BoltCompoundParametricStudyTool]':
    ...
    @property
    def cv_ts(self) -> 'List[_4426.CVTCompoundParametricStudyTool]':
    ...
    @property
    def clutches(self) -> 'List[_4406.ClutchCompoundParametricStudyTool]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4411.ConceptCouplingCompoundParametricStudyTool]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4416.ConceptGearSetCompoundParametricStudyTool]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4428.CycloidalAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4430.CycloidalDiscCompoundParametricStudyTool]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4434.CylindricalGearSetCompoundParametricStudyTool]':
    ...
    @property
    def fe_parts(self) -> 'List[_4441.FEPartCompoundParametricStudyTool]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4440.FaceGearSetCompoundParametricStudyTool]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4442.FlexiblePinAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4449.HypoidGearSetCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4456.KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4459.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def mass_discs(self) -> 'List[_4460.MassDiscCompoundParametricStudyTool]':
    ...
    @property
    def measurement_components(self) -> 'List[_4461.MeasurementComponentCompoundParametricStudyTool]':
    ...
    @property
    def oil_seals(self) -> 'List[_4463.OilSealCompoundParametricStudyTool]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4465.PartToPartShearCouplingCompoundParametricStudyTool]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4470.PlanetCarrierCompoundParametricStudyTool]':
    ...
    @property
    def point_loads(self) -> 'List[_4471.PointLoadCompoundParametricStudyTool]':
    ...
    @property
    def power_loads(self) -> 'List[_4472.PowerLoadCompoundParametricStudyTool]':
    ...
    @property
    def ring_pins(self) -> 'List[_4474.RingPinsCompoundParametricStudyTool]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4476.RollingRingAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4481.ShaftHubConnectionCompoundParametricStudyTool]':
    ...
    @property
    def shafts(self) -> 'List[_4480.ShaftCompoundParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4486.SpiralBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4487.SpringDamperCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4492.StraightBevelDiffGearSetCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4495.StraightBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def synchronisers(self) -> 'List[_4498.SynchroniserCompoundParametricStudyTool]':
    ...
    @property
    def torque_converters(self) -> 'List[_4502.TorqueConverterCompoundParametricStudyTool]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4506.UnbalancedMassCompoundParametricStudyTool]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4510.WormGearSetCompoundParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4513.ZerolBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4245.AssemblyParametricStudyTool]':
