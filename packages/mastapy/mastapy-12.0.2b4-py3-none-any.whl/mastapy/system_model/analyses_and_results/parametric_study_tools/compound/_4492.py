...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4490, _4491, _4403
...
class StraightBevelDiffGearSetCompoundParametricStudyTool(_4403.BevelGearSetCompoundParametricStudyTool):
    """StraightBevelDiffGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4363.StraightBevelDiffGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gears_compound_parametric_study_tool(self) -> 'List[_4490.StraightBevelDiffGearCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_parametric_study_tool(self) -> 'List[_4491.StraightBevelDiffGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4363.StraightBevelDiffGearSetParametricStudyTool]':
