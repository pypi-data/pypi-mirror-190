...
class StraightBevelSunGearCompoundParametricStudyTool(_4490.StraightBevelDiffGearCompoundParametricStudyTool):
    """StraightBevelSunGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4368.StraightBevelSunGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4368.StraightBevelSunGearParametricStudyTool]':
