...
class ShaftToMountableComponentConnectionCompoundParametricStudyTool(_4388.AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """ShaftToMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4353.ShaftToMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4353.ShaftToMountableComponentConnectionParametricStudyTool]':
