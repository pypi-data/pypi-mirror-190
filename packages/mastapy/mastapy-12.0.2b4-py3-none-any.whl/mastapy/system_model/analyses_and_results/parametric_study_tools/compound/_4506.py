...
class UnbalancedMassCompoundParametricStudyTool(_4507.VirtualComponentCompoundParametricStudyTool):
    """UnbalancedMassCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4377.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4377.UnbalancedMassParametricStudyTool]':
