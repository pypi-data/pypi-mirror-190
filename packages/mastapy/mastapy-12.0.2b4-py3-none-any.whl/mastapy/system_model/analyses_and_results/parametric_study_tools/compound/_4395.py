...
class BeltDriveCompoundParametricStudyTool(_4483.SpecialisedAssemblyCompoundParametricStudyTool):
    """BeltDriveCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4248.BeltDriveParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4248.BeltDriveParametricStudyTool]':
