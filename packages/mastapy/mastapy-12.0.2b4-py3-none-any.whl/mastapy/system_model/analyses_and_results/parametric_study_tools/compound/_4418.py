...
class ConicalGearMeshCompoundParametricStudyTool(_4444.GearMeshCompoundParametricStudyTool):
    """ConicalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4270.ConicalGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4270.ConicalGearMeshParametricStudyTool]':
