...
class SpringDamperConnectionCompoundParametricStudyTool(_4423.CouplingConnectionCompoundParametricStudyTool):
    """SpringDamperConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4358.SpringDamperConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4358.SpringDamperConnectionParametricStudyTool]':
