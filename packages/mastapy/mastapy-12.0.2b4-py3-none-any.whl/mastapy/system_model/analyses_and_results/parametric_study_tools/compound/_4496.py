...
class StraightBevelPlanetGearCompoundParametricStudyTool(_4490.StraightBevelDiffGearCompoundParametricStudyTool):
    """StraightBevelPlanetGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4367.StraightBevelPlanetGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4367.StraightBevelPlanetGearParametricStudyTool]':
