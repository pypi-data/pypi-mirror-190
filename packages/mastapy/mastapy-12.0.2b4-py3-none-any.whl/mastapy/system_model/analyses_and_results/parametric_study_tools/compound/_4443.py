...
class GearCompoundParametricStudyTool(_4462.MountableComponentCompoundParametricStudyTool):
    """GearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4304.GearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4304.GearParametricStudyTool]':
