...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4447, _4448, _4391
...
class HypoidGearSetCompoundParametricStudyTool(_4391.AGMAGleasonConicalGearSetCompoundParametricStudyTool):
    """HypoidGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4309.HypoidGearSetParametricStudyTool]':
    ...
    @property
    def hypoid_gears_compound_parametric_study_tool(self) -> 'List[_4447.HypoidGearCompoundParametricStudyTool]':
    ...
    @property
    def hypoid_meshes_compound_parametric_study_tool(self) -> 'List[_4448.HypoidGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4309.HypoidGearSetParametricStudyTool]':
