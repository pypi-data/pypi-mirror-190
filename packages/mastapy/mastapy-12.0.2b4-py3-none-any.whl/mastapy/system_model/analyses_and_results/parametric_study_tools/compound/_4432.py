...
class CylindricalGearCompoundParametricStudyTool(_4443.GearCompoundParametricStudyTool):
    """CylindricalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4286.CylindricalGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4286.CylindricalGearParametricStudyTool]':
