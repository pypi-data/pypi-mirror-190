...
class MeasurementComponentCompoundParametricStudyTool(_4507.VirtualComponentCompoundParametricStudyTool):
    """MeasurementComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4321.MeasurementComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4321.MeasurementComponentParametricStudyTool]':
