...
class FEPartCompoundParametricStudyTool(_4387.AbstractShaftOrHousingCompoundParametricStudyTool):
    """FEPartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4301.FEPartParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4301.FEPartParametricStudyTool]':
