...
class FlexiblePinAssemblyCompoundParametricStudyTool(_4483.SpecialisedAssemblyCompoundParametricStudyTool):
    """FlexiblePinAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4302.FlexiblePinAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4302.FlexiblePinAssemblyParametricStudyTool]':
