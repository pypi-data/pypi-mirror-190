...
class ConceptCouplingHalfCompoundParametricStudyTool(_4424.CouplingHalfCompoundParametricStudyTool):
    """ConceptCouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4265.ConceptCouplingHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4265.ConceptCouplingHalfParametricStudyTool]':
