...
class ZerolBevelGearCompoundParametricStudyTool(_4401.BevelGearCompoundParametricStudyTool):
    """ZerolBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4383.ZerolBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4383.ZerolBevelGearParametricStudyTool]':
