...
class DatumCompoundParametricStudyTool(_4410.ComponentCompoundParametricStudyTool):
    """DatumCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4289.DatumParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4289.DatumParametricStudyTool]':
