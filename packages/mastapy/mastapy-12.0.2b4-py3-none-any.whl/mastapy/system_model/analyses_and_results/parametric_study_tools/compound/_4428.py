...
class CycloidalAssemblyCompoundParametricStudyTool(_4483.SpecialisedAssemblyCompoundParametricStudyTool):
    """CycloidalAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4281.CycloidalAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4281.CycloidalAssemblyParametricStudyTool]':
