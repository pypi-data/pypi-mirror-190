...
class PlanetaryGearSetCompoundParametricStudyTool(_4434.CylindricalGearSetCompoundParametricStudyTool):
    """PlanetaryGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4340.PlanetaryGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4340.PlanetaryGearSetParametricStudyTool]':
