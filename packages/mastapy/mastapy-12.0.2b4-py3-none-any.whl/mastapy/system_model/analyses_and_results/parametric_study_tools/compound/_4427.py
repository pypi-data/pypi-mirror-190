...
class CVTPulleyCompoundParametricStudyTool(_4473.PulleyCompoundParametricStudyTool):
    """CVTPulleyCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4280.CVTPulleyParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4280.CVTPulleyParametricStudyTool]':
