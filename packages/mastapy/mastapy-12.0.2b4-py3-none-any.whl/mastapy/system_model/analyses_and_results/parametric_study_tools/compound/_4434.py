...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4432, _4433, _4445
...
class CylindricalGearSetCompoundParametricStudyTool(_4445.GearSetCompoundParametricStudyTool):
    """CylindricalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4287.CylindricalGearSetParametricStudyTool]':
    ...
    @property
    def cylindrical_gears_compound_parametric_study_tool(self) -> 'List[_4432.CylindricalGearCompoundParametricStudyTool]':
    ...
    @property
    def cylindrical_meshes_compound_parametric_study_tool(self) -> 'List[_4433.CylindricalGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4287.CylindricalGearSetParametricStudyTool]':
