...
class VirtualComponentCompoundParametricStudyTool(_4462.MountableComponentCompoundParametricStudyTool):
    """VirtualComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4378.VirtualComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4378.VirtualComponentParametricStudyTool]':
