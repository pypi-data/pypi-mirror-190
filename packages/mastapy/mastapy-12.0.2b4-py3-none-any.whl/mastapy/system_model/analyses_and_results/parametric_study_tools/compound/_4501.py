...
class SynchroniserSleeveCompoundParametricStudyTool(_4500.SynchroniserPartCompoundParametricStudyTool):
    """SynchroniserSleeveCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4372.SynchroniserSleeveParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4372.SynchroniserSleeveParametricStudyTool]':
