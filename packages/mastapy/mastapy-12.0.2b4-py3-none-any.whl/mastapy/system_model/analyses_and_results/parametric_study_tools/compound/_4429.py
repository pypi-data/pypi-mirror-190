...
class CycloidalDiscCentralBearingConnectionCompoundParametricStudyTool(_4409.CoaxialConnectionCompoundParametricStudyTool):
    """CycloidalDiscCentralBearingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4282.CycloidalDiscCentralBearingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4282.CycloidalDiscCentralBearingConnectionParametricStudyTool]':
