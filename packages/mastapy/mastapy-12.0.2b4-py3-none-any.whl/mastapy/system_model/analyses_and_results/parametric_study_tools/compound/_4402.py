...
class BevelGearMeshCompoundParametricStudyTool(_4390.AGMAGleasonConicalGearMeshCompoundParametricStudyTool):
    """BevelGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4254.BevelGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4254.BevelGearMeshParametricStudyTool]':
