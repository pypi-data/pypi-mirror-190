...
class TorqueConverterPumpCompoundParametricStudyTool(_4424.CouplingHalfCompoundParametricStudyTool):
    """TorqueConverterPumpCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4375.TorqueConverterPumpParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4375.TorqueConverterPumpParametricStudyTool]':
