...
class TorqueConverterCompoundParametricStudyTool(_4422.CouplingCompoundParametricStudyTool):
    """TorqueConverterCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4374.TorqueConverterParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4374.TorqueConverterParametricStudyTool]':
