...
class SpiralBevelGearMeshCompoundParametricStudyTool(_4402.BevelGearMeshCompoundParametricStudyTool):
    """SpiralBevelGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4355.SpiralBevelGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4355.SpiralBevelGearMeshParametricStudyTool]':
