...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4508, _4509, _4445
...
class WormGearSetCompoundParametricStudyTool(_4445.GearSetCompoundParametricStudyTool):
    """WormGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4381.WormGearSetParametricStudyTool]':
    ...
    @property
    def worm_gears_compound_parametric_study_tool(self) -> 'List[_4508.WormGearCompoundParametricStudyTool]':
    ...
    @property
    def worm_meshes_compound_parametric_study_tool(self) -> 'List[_4509.WormGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4381.WormGearSetParametricStudyTool]':
