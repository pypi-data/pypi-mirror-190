...
class AbstractShaftCompoundParametricStudyTool(_4387.AbstractShaftOrHousingCompoundParametricStudyTool):
    """AbstractShaftCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4240.AbstractShaftParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4240.AbstractShaftParametricStudyTool]':
