...
class TorqueConverterConnectionCompoundParametricStudyTool(_4423.CouplingConnectionCompoundParametricStudyTool):
    """TorqueConverterConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4373.TorqueConverterConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4373.TorqueConverterConnectionParametricStudyTool]':
