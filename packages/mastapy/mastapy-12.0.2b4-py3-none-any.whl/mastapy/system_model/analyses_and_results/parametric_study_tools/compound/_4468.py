...
class PlanetaryConnectionCompoundParametricStudyTool(_4482.ShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """PlanetaryConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4339.PlanetaryConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4339.PlanetaryConnectionParametricStudyTool]':
