...
class BevelDifferentialSunGearCompoundParametricStudyTool(_4396.BevelDifferentialGearCompoundParametricStudyTool):
    """BevelDifferentialSunGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4253.BevelDifferentialSunGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4253.BevelDifferentialSunGearParametricStudyTool]':
