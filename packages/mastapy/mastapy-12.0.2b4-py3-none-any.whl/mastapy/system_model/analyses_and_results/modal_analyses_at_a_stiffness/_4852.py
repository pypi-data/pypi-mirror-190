...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4851, _4850, _4857
...
class FaceGearSetModalAnalysisAtAStiffness(_4857.GearSetModalAnalysisAtAStiffness):
    """FaceGearSetModalAnalysisAtAStiffness
    ...
    @property
    def face_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4851.FaceGearModalAnalysisAtAStiffness]':
    ...
    @property
    def face_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4850.FaceGearMeshModalAnalysisAtAStiffness]':
