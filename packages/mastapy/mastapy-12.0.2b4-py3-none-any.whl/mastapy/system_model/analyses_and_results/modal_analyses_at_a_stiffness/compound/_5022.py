...
class ShaftHubConnectionCompoundModalAnalysisAtAStiffness(_4962.ConnectorCompoundModalAnalysisAtAStiffness):
    """ShaftHubConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4892.ShaftHubConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4892.ShaftHubConnectionModalAnalysisAtAStiffness]':
