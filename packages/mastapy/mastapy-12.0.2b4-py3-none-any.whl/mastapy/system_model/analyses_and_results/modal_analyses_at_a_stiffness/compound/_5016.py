...
class RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness(_4991.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4887.RingPinsToDiscConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4887.RingPinsToDiscConnectionModalAnalysisAtAStiffness]':
