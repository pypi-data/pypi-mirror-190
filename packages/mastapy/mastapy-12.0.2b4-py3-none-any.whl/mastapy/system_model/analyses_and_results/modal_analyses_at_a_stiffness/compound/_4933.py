...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import (
    _4934, _4936, _4939, _4946,
    _4945, _4967, _4947, _4952,
    _4957, _4969, _4971, _4975,
    _4982, _4981, _4983, _4990,
    _4997, _5000, _5001, _5002,
    _5004, _5006, _5011, _5012,
    _5013, _5015, _5017, _5022,
    _5021, _5027, _5028, _5033,
    _5036, _5039, _5043, _5047,
    _5051, _5054, _4926
)
...
class AssemblyCompoundModalAnalysisAtAStiffness(_4926.AbstractAssemblyCompoundModalAnalysisAtAStiffness):
    """AssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4803.AssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def bearings(self) -> 'List[_4934.BearingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def belt_drives(self) -> 'List[_4936.BeltDriveCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4939.BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4946.BoltedJointCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bolts(self) -> 'List[_4945.BoltCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cv_ts(self) -> 'List[_4967.CVTCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def clutches(self) -> 'List[_4947.ClutchCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4952.ConceptCouplingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4957.ConceptGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4969.CycloidalAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4971.CycloidalDiscCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4975.CylindricalGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def fe_parts(self) -> 'List[_4982.FEPartCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4981.FaceGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4983.FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4990.HypoidGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4997.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5000.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def mass_discs(self) -> 'List[_5001.MassDiscCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def measurement_components(self) -> 'List[_5002.MeasurementComponentCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def oil_seals(self) -> 'List[_5004.OilSealCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5006.PartToPartShearCouplingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5011.PlanetCarrierCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def point_loads(self) -> 'List[_5012.PointLoadCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def power_loads(self) -> 'List[_5013.PowerLoadCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def ring_pins(self) -> 'List[_5015.RingPinsCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5017.RollingRingAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5022.ShaftHubConnectionCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def shafts(self) -> 'List[_5021.ShaftCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5027.SpiralBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5028.SpringDamperCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5033.StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5036.StraightBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def synchronisers(self) -> 'List[_5039.SynchroniserCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def torque_converters(self) -> 'List[_5043.TorqueConverterCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5047.UnbalancedMassCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5051.WormGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5054.ZerolBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4803.AssemblyModalAnalysisAtAStiffness]':
