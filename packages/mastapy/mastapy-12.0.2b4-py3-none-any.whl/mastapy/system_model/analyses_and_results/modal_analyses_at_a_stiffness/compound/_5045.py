...
class TorqueConverterPumpCompoundModalAnalysisAtAStiffness(_4965.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """TorqueConverterPumpCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4916.TorqueConverterPumpModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4916.TorqueConverterPumpModalAnalysisAtAStiffness]':
