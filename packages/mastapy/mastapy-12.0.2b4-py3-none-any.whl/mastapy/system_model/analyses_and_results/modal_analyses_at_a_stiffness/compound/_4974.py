...
class CylindricalGearMeshCompoundModalAnalysisAtAStiffness(_4985.GearMeshCompoundModalAnalysisAtAStiffness):
    """CylindricalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4843.CylindricalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4843.CylindricalGearMeshModalAnalysisAtAStiffness]':
