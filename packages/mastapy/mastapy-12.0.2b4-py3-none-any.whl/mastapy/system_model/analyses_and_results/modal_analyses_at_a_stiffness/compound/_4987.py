...
class GuideDxfModelCompoundModalAnalysisAtAStiffness(_4951.ComponentCompoundModalAnalysisAtAStiffness):
    """GuideDxfModelCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4858.GuideDxfModelModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4858.GuideDxfModelModalAnalysisAtAStiffness]':
