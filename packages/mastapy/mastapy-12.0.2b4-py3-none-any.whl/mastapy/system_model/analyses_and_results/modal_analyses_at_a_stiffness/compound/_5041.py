...
class SynchroniserPartCompoundModalAnalysisAtAStiffness(_4965.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """SynchroniserPartCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4912.SynchroniserPartModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4912.SynchroniserPartModalAnalysisAtAStiffness]':
