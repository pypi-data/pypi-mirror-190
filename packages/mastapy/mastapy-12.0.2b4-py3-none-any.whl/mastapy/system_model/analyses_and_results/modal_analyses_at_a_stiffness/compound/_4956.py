...
class ConceptGearMeshCompoundModalAnalysisAtAStiffness(_4985.GearMeshCompoundModalAnalysisAtAStiffness):
    """ConceptGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4825.ConceptGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4825.ConceptGearMeshModalAnalysisAtAStiffness]':
