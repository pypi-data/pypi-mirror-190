...
class StraightBevelGearCompoundModalAnalysisAtAStiffness(_4942.BevelGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4906.StraightBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4906.StraightBevelGearModalAnalysisAtAStiffness]':
