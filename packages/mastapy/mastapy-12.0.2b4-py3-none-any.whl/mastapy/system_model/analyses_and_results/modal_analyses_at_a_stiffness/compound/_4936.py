...
class BeltDriveCompoundModalAnalysisAtAStiffness(_5024.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """BeltDriveCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4806.BeltDriveModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4806.BeltDriveModalAnalysisAtAStiffness]':
