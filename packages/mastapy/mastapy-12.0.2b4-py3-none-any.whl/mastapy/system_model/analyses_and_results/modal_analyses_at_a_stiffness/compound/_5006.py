...
class PartToPartShearCouplingCompoundModalAnalysisAtAStiffness(_4963.CouplingCompoundModalAnalysisAtAStiffness):
    """PartToPartShearCouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4879.PartToPartShearCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4879.PartToPartShearCouplingModalAnalysisAtAStiffness]':
