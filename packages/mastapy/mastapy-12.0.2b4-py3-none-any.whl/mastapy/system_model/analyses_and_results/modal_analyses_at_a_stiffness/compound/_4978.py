...
class ExternalCADModelCompoundModalAnalysisAtAStiffness(_4951.ComponentCompoundModalAnalysisAtAStiffness):
    """ExternalCADModelCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4849.ExternalCADModelModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4849.ExternalCADModelModalAnalysisAtAStiffness]':
