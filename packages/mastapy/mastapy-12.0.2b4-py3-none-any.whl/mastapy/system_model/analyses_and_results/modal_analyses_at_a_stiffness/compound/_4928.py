...
class AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness(_4951.ComponentCompoundModalAnalysisAtAStiffness):
    """AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4798.AbstractShaftOrHousingModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4798.AbstractShaftOrHousingModalAnalysisAtAStiffness]':
