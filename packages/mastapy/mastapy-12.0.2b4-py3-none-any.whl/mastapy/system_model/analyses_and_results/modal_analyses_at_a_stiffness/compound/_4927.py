...
class AbstractShaftCompoundModalAnalysisAtAStiffness(_4928.AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness):
    """AbstractShaftCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4797.AbstractShaftModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4797.AbstractShaftModalAnalysisAtAStiffness]':
