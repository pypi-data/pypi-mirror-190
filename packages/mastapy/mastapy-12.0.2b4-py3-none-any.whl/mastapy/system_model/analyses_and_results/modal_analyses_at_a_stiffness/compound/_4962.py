...
class ConnectorCompoundModalAnalysisAtAStiffness(_5003.MountableComponentCompoundModalAnalysisAtAStiffness):
    """ConnectorCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4832.ConnectorModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4832.ConnectorModalAnalysisAtAStiffness]':
