...
class SpringDamperConnectionCompoundModalAnalysisAtAStiffness(_4964.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """SpringDamperConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4899.SpringDamperConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4899.SpringDamperConnectionModalAnalysisAtAStiffness]':
