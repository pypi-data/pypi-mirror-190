...
class PlanetCarrierCompoundModalAnalysisAtAStiffness(_5003.MountableComponentCompoundModalAnalysisAtAStiffness):
    """PlanetCarrierCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4882.PlanetCarrierModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4882.PlanetCarrierModalAnalysisAtAStiffness]':
