...
class CVTBeltConnectionCompoundModalAnalysisAtAStiffness(_4935.BeltConnectionCompoundModalAnalysisAtAStiffness):
    """CVTBeltConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4836.CVTBeltConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4836.CVTBeltConnectionModalAnalysisAtAStiffness]':
