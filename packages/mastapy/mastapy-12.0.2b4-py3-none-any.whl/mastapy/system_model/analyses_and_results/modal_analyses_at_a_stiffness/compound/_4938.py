...
class BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness(_4943.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4807.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4807.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
