...
class PlanetaryGearSetCompoundModalAnalysisAtAStiffness(_4975.CylindricalGearSetCompoundModalAnalysisAtAStiffness):
    """PlanetaryGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4881.PlanetaryGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4881.PlanetaryGearSetModalAnalysisAtAStiffness]':
