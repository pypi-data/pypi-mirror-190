...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5034, _5035, _4944
...
class StraightBevelGearSetCompoundModalAnalysisAtAStiffness(_4944.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """StraightBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4907.StraightBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5034.StraightBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5035.StraightBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4907.StraightBevelGearSetModalAnalysisAtAStiffness]':
