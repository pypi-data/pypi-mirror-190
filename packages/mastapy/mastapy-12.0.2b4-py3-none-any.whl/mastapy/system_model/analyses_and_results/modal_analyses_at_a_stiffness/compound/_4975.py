...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4973, _4974, _4986
...
class CylindricalGearSetCompoundModalAnalysisAtAStiffness(_4986.GearSetCompoundModalAnalysisAtAStiffness):
    """CylindricalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4845.CylindricalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4973.CylindricalGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4974.CylindricalGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4845.CylindricalGearSetModalAnalysisAtAStiffness]':
