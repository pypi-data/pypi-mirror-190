...
class SpiralBevelGearCompoundModalAnalysisAtAStiffness(_4942.BevelGearCompoundModalAnalysisAtAStiffness):
    """SpiralBevelGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4897.SpiralBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4897.SpiralBevelGearModalAnalysisAtAStiffness]':
