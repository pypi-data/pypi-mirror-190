...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4924, _4923, _4814
...
class ZerolBevelGearSetModalAnalysisAtAStiffness(_4814.BevelGearSetModalAnalysisAtAStiffness):
    """ZerolBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def zerol_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4924.ZerolBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4923.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
