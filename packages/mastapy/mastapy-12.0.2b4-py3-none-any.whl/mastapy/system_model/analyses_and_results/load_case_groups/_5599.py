...
from mastapy.system_model.analyses_and_results.load_case_groups import _5597, _5598, _5594
from mastapy._internal import constructor, conversion
from mastapy.system_model.connections_and_sockets.couplings import _2294
...
class DesignState(_5594.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    def clutches(self) -> 'List[_5597.ClutchEngagementStatus]':
    ...
    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5598.ConceptSynchroGearEngagementStatus]':
    ...
    def clutch_engagement_status_for(self, clutch_connection: '_2294.ClutchConnection') -> '_5597.ClutchEngagementStatus':
    ...
    def concept_synchro_gear_engagement_status_for(self, gear: '_2476.CylindricalGear') -> '_5598.ConceptSynchroGearEngagementStatus':
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6731.StaticLoadCase':
