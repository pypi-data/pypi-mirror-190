...
from mastapy.system_model.analyses_and_results.load_case_groups import _5603, _5596
...
class DutyCycle(_5596.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_5603.SubGroupInSingleDesignState]':
    ...
    @property
    def time_series_importer(self) -> '_6927.TimeSeriesImporter':
    ...
    def add_static_load(self, static_load: '_6731.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_5603.SubGroupInSingleDesignState'):
    ...
    def remove_static_load(self, static_load: '_6731.StaticLoadCase'):
