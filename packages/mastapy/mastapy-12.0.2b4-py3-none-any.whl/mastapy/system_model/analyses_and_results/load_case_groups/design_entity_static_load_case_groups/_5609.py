...
TReal = TypeVar('TReal', bound='_2396.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6763.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5613.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    """ComponentStaticLoadCaseGroup
