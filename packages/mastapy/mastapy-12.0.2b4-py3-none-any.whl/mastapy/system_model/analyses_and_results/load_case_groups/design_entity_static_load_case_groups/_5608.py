...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5613
...
TAssembly = TypeVar('TAssembly', bound='_2387.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6733.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5613.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    """AbstractAssemblyStaticLoadCaseGroup
