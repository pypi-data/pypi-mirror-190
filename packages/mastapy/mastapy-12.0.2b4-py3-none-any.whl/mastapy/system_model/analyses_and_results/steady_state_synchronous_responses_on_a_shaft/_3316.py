...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3317, _3315, _3250
...
class WormGearSetSteadyStateSynchronousResponseOnAShaft(_3250.GearSetSteadyStateSynchronousResponseOnAShaft):
    """WormGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def worm_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3317.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3315.WormGearMeshSteadyStateSynchronousResponseOnAShaft]':
