...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3240, _3238, _3250
...
class CylindricalGearSetSteadyStateSynchronousResponseOnAShaft(_3250.GearSetSteadyStateSynchronousResponseOnAShaft):
    """CylindricalGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3240.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3238.CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft]':
