...
class CoaxialConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3418.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """CoaxialConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3215.CoaxialConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3215.CoaxialConnectionSteadyStateSynchronousResponseOnAShaft]':
