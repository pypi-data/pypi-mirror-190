...
class BoltCompoundSteadyStateSynchronousResponseOnAShaft(_3346.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """BoltCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3211.BoltSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3211.BoltSteadyStateSynchronousResponseOnAShaft]':
