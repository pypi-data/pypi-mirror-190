...
class GearSetCompoundSteadyStateSynchronousResponseOnAShaft(_3419.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    """GearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3250.GearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3250.GearSetSteadyStateSynchronousResponseOnAShaft]':
