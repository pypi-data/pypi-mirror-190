...
class ConicalGearCompoundSteadyStateSynchronousResponseOnAShaft(_3379.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """ConicalGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3225.ConicalGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3225.ConicalGearSteadyStateSynchronousResponseOnAShaft]':
