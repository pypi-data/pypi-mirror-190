...
class BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3386.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3200.BeltConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3200.BeltConnectionSteadyStateSynchronousResponseOnAShaft]':
