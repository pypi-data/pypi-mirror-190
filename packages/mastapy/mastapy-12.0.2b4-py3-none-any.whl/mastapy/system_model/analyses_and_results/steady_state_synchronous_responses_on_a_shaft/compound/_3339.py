...
class BevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft(_3327.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponseOnAShaft):
    """BevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3208.BevelGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3208.BevelGearSetSteadyStateSynchronousResponseOnAShaft]':
