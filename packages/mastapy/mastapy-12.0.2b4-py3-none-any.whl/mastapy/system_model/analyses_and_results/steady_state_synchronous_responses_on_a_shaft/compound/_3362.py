...
class CVTCompoundSteadyStateSynchronousResponseOnAShaft(_3331.BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft):
    """CVTCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3233.CVTSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3233.CVTSteadyStateSynchronousResponseOnAShaft]':
