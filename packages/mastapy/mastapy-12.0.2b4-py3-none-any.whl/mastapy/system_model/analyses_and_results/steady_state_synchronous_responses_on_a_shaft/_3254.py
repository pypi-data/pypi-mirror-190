...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3255, _3253, _3196
...
class HypoidGearSetSteadyStateSynchronousResponseOnAShaft(_3196.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseOnAShaft):
    """HypoidGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3255.HypoidGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def hypoid_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3253.HypoidGearMeshSteadyStateSynchronousResponseOnAShaft]':
