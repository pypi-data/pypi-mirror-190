...
class PlanetCarrierSystemDeflection(_2728.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4062.PlanetCarrierPowerFlow':
    ...
    @property
    def windup(self) -> 'List[_2792.PlanetCarrierWindup]':
