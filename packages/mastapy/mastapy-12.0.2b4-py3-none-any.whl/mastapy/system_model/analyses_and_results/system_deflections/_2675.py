...
class CouplingConnectionSystemDeflection(_2713.InterMountableComponentConnectionSystemDeflection):
    """CouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4013.CouplingConnectionPowerFlow':
        ...
        if _4013.CouplingConnectionPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_clutch_connection_power_flow(self) -> '_3997.ClutchConnectionPowerFlow':
        ...
        if _3997.ClutchConnectionPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_concept_coupling_connection_power_flow(self) -> '_4002.ConceptCouplingConnectionPowerFlow':
        ...
        if _4002.ConceptCouplingConnectionPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_part_to_part_shear_coupling_connection_power_flow(self) -> '_4057.PartToPartShearCouplingConnectionPowerFlow':
        ...
        if _4057.PartToPartShearCouplingConnectionPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_spring_damper_connection_power_flow(self) -> '_4081.SpringDamperConnectionPowerFlow':
        ...
        if _4081.SpringDamperConnectionPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_torque_converter_connection_power_flow(self) -> '_4097.TorqueConverterConnectionPowerFlow':
        ...
        if _4097.TorqueConverterConnectionPowerFlow.TYPE not in temp.__class__.__mro__:
