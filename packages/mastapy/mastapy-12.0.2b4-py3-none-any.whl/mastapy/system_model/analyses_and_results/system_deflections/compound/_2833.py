...
class ConnectorCompoundSystemDeflection(_2875.MountableComponentCompoundSystemDeflection):
    """ConnectorCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2674.ConnectorSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2674.ConnectorSystemDeflection]':
