...
class AbstractShaftToMountableComponentConnectionCompoundSystemDeflection(_2832.ConnectionCompoundSystemDeflection):
    """AbstractShaftToMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2639.AbstractShaftToMountableComponentConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2639.AbstractShaftToMountableComponentConnectionSystemDeflection]':
