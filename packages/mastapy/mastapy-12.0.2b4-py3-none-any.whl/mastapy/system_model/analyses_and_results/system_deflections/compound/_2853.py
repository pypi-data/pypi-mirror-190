...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2851, _2852, _2858
...
class FaceGearSetCompoundSystemDeflection(_2858.GearSetCompoundSystemDeflection):
    """FaceGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2701.FaceGearSetSystemDeflection]':
    ...
    @property
    def face_gears_compound_system_deflection(self) -> 'List[_2851.FaceGearCompoundSystemDeflection]':
    ...
    @property
    def face_meshes_compound_system_deflection(self) -> 'List[_2852.FaceGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2701.FaceGearSetSystemDeflection]':
