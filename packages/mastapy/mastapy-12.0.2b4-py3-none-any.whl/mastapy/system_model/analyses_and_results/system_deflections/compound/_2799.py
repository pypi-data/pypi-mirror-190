...
class AbstractShaftOrHousingCompoundSystemDeflection(_2822.ComponentCompoundSystemDeflection):
    """AbstractShaftOrHousingCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2637.AbstractShaftOrHousingSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2637.AbstractShaftOrHousingSystemDeflection]':
