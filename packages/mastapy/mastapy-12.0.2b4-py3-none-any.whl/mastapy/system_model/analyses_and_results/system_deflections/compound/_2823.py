...
class ConceptCouplingCompoundSystemDeflection(_2834.CouplingCompoundSystemDeflection):
    """ConceptCouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2665.ConceptCouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2665.ConceptCouplingSystemDeflection]':
