...
class FaceGearCompoundSystemDeflection(_2856.GearCompoundSystemDeflection):
    """FaceGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2702.FaceGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2702.FaceGearSystemDeflection]':
