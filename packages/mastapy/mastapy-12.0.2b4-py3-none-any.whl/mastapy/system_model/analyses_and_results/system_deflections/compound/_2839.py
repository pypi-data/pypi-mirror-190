...
class CVTPulleyCompoundSystemDeflection(_2886.PulleyCompoundSystemDeflection):
    """CVTPulleyCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2679.CVTPulleySystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2679.CVTPulleySystemDeflection]':
