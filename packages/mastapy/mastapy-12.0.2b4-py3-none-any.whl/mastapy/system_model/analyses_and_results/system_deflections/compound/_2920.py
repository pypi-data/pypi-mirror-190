...
class UnbalancedMassCompoundSystemDeflection(_2921.VirtualComponentCompoundSystemDeflection):
    """UnbalancedMassCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2780.UnbalancedMassSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2780.UnbalancedMassSystemDeflection]':
