...
class AGMAGleasonConicalGearMeshCompoundSystemDeflection(_2830.ConicalGearMeshCompoundSystemDeflection):
    """AGMAGleasonConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2640.AGMAGleasonConicalGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2640.AGMAGleasonConicalGearMeshSystemDeflection]':
