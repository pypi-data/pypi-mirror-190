...
class FEPartCompoundSystemDeflection(_2799.AbstractShaftOrHousingCompoundSystemDeflection):
    """FEPartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2703.FEPartSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2703.FEPartSystemDeflection]':
