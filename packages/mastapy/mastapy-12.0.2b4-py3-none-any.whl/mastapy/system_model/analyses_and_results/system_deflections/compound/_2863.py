...
class InterMountableComponentConnectionCompoundSystemDeflection(_2832.ConnectionCompoundSystemDeflection):
    """InterMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2713.InterMountableComponentConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2713.InterMountableComponentConnectionSystemDeflection]':
