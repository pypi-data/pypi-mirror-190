...
class ZerolBevelGearCompoundSystemDeflection(_2813.BevelGearCompoundSystemDeflection):
    """ZerolBevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2787.ZerolBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2787.ZerolBevelGearSystemDeflection]':
