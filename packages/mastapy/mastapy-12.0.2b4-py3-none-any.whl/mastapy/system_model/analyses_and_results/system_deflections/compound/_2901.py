...
class SpringDamperCompoundSystemDeflection(_2834.CouplingCompoundSystemDeflection):
    """SpringDamperCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2758.SpringDamperSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2758.SpringDamperSystemDeflection]':
