...
class CouplingCompoundSystemDeflection(_2897.SpecialisedAssemblyCompoundSystemDeflection):
    """CouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2677.CouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2677.CouplingSystemDeflection]':
