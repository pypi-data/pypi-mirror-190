...
class CylindricalPlanetGearCompoundSystemDeflection(_2844.CylindricalGearCompoundSystemDeflection):
    """CylindricalPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2696.CylindricalPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2696.CylindricalPlanetGearSystemDeflection]':
