...
class ConceptCouplingConnectionCompoundSystemDeflection(_2835.CouplingConnectionCompoundSystemDeflection):
    """ConceptCouplingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2663.ConceptCouplingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2663.ConceptCouplingConnectionSystemDeflection]':
