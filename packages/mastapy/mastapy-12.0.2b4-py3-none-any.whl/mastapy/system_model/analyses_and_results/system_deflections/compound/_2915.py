...
class SynchroniserSleeveCompoundSystemDeflection(_2914.SynchroniserPartCompoundSystemDeflection):
    """SynchroniserSleeveCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2769.SynchroniserSleeveSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2769.SynchroniserSleeveSystemDeflection]':
