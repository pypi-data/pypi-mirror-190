...
class RollingRingConnectionCompoundSystemDeflection(_2863.InterMountableComponentConnectionCompoundSystemDeflection):
    """RollingRingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2744.RollingRingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2744.RollingRingConnectionSystemDeflection]':
