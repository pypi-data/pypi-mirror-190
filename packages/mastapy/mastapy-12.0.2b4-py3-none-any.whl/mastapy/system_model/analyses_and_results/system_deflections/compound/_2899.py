...
class SpiralBevelGearMeshCompoundSystemDeflection(_2814.BevelGearMeshCompoundSystemDeflection):
    """SpiralBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2753.SpiralBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2753.SpiralBevelGearMeshSystemDeflection]':
