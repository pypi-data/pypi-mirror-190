...
class GearSetCompoundSystemDeflection(_2897.SpecialisedAssemblyCompoundSystemDeflection):
    """GearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2706.GearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2706.GearSetSystemDeflection]':
