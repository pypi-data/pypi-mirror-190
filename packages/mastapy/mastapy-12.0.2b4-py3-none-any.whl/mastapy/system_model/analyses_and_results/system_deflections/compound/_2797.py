...
class AbstractAssemblyCompoundSystemDeflection(_2877.PartCompoundSystemDeflection):
    """AbstractAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2636.AbstractAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2636.AbstractAssemblySystemDeflection]':
