...
class CylindricalGearMeshCompoundSystemDeflection(_2857.GearMeshCompoundSystemDeflection):
    """CylindricalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2687.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2687.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
