...
class MountableComponentCompoundSystemDeflection(_2822.ComponentCompoundSystemDeflection):
    """MountableComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2728.MountableComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2728.MountableComponentSystemDeflection]':
