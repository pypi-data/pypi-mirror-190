...
class BevelDifferentialPlanetGearCompoundSystemDeflection(_2808.BevelDifferentialGearCompoundSystemDeflection):
    """BevelDifferentialPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2650.BevelDifferentialPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2650.BevelDifferentialPlanetGearSystemDeflection]':
