...
class CycloidalAssemblyCompoundSystemDeflection(_2897.SpecialisedAssemblyCompoundSystemDeflection):
    """CycloidalAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2681.CycloidalAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2681.CycloidalAssemblySystemDeflection]':
