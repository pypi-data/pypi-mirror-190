...
class DatumCompoundSystemDeflection(_2822.ComponentCompoundSystemDeflection):
    """DatumCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2697.DatumSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2697.DatumSystemDeflection]':
