...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2808, _2809, _2815
...
class BevelDifferentialGearSetCompoundSystemDeflection(_2815.BevelGearSetCompoundSystemDeflection):
    """BevelDifferentialGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2648.BevelDifferentialGearSetSystemDeflection]':
    ...
    @property
    def bevel_differential_gears_compound_system_deflection(self) -> 'List[_2808.BevelDifferentialGearCompoundSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_compound_system_deflection(self) -> 'List[_2809.BevelDifferentialGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2648.BevelDifferentialGearSetSystemDeflection]':
