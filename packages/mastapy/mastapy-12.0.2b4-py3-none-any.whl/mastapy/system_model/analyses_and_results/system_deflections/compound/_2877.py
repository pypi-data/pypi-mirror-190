...
class PartCompoundSystemDeflection(_7470.PartCompoundAnalysis):
    """PartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2731.PartSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2731.PartSystemDeflection]':
