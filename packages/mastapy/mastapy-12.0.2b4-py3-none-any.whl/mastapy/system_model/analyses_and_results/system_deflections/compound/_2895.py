...
class ShaftHubConnectionCompoundSystemDeflection(_2833.ConnectorCompoundSystemDeflection):
    """ShaftHubConnectionCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2747.ShaftHubConnectionSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2747.ShaftHubConnectionSystemDeflection]':
