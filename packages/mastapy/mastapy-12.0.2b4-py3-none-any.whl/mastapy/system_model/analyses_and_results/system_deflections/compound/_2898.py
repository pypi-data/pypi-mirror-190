...
class SpiralBevelGearCompoundSystemDeflection(_2813.BevelGearCompoundSystemDeflection):
    """SpiralBevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2755.SpiralBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2755.SpiralBevelGearSystemDeflection]':
