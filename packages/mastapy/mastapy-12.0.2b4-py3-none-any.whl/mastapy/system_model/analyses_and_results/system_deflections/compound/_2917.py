...
class TorqueConverterConnectionCompoundSystemDeflection(_2835.CouplingConnectionCompoundSystemDeflection):
    """TorqueConverterConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2774.TorqueConverterConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2774.TorqueConverterConnectionSystemDeflection]':
