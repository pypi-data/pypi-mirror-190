...
class StraightBevelSunGearCompoundSystemDeflection(_2904.StraightBevelDiffGearCompoundSystemDeflection):
    """StraightBevelSunGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2766.StraightBevelSunGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2766.StraightBevelSunGearSystemDeflection]':
