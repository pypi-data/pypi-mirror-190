...
class FlexiblePinAssemblyCompoundSystemDeflection(_2897.SpecialisedAssemblyCompoundSystemDeflection):
    """FlexiblePinAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2704.FlexiblePinAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2704.FlexiblePinAssemblySystemDeflection]':
