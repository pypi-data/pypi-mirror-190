...
class ComponentCompoundSystemDeflection(_2877.PartCompoundSystemDeflection):
    """ComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2661.ComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2661.ComponentSystemDeflection]':
