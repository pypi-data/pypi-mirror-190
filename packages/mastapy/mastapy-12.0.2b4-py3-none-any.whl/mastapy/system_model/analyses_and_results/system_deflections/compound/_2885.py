...
class PowerLoadCompoundSystemDeflection(_2921.VirtualComponentCompoundSystemDeflection):
    """PowerLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2738.PowerLoadSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2738.PowerLoadSystemDeflection]':
