...
class AGMAGleasonConicalGearCompoundSystemDeflection(_2829.ConicalGearCompoundSystemDeflection):
    """AGMAGleasonConicalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2642.AGMAGleasonConicalGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2642.AGMAGleasonConicalGearSystemDeflection]':
