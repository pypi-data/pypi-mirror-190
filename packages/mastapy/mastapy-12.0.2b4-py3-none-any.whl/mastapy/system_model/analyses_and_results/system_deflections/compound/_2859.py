...
class GuideDxfModelCompoundSystemDeflection(_2822.ComponentCompoundSystemDeflection):
    """GuideDxfModelCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2708.GuideDxfModelSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2708.GuideDxfModelSystemDeflection]':
