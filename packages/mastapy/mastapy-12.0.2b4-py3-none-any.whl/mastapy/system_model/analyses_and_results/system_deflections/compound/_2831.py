...
class ConicalGearSetCompoundSystemDeflection(_2858.GearSetCompoundSystemDeflection):
    """ConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2671.ConicalGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2671.ConicalGearSetSystemDeflection]':
