...
class GearCompoundSystemDeflection(_2875.MountableComponentCompoundSystemDeflection):
    """GearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2707.GearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2707.GearSystemDeflection]':
