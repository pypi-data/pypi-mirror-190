...
class SynchroniserPartCompoundSystemDeflection(_2836.CouplingHalfCompoundSystemDeflection):
    """SynchroniserPartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2768.SynchroniserPartSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2768.SynchroniserPartSystemDeflection]':
