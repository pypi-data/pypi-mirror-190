...
class KlingelnbergCycloPalloidHypoidGearCompoundSystemDeflection(_2864.KlingelnbergCycloPalloidConicalGearCompoundSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2719.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2719.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
