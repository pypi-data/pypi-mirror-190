...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2844, _2845, _2858
...
class CylindricalGearSetCompoundSystemDeflection(_2858.GearSetCompoundSystemDeflection):
    """CylindricalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2690.CylindricalGearSetSystemDeflectionWithLTCAResults]':
    ...
    @property
    def cylindrical_gears_compound_system_deflection(self) -> 'List[_2844.CylindricalGearCompoundSystemDeflection]':
    ...
    @property
    def cylindrical_meshes_compound_system_deflection(self) -> 'List[_2845.CylindricalGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2690.CylindricalGearSetSystemDeflectionWithLTCAResults]':
