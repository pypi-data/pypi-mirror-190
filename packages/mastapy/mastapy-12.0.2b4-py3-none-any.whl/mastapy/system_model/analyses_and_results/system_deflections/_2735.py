...
class PlanetaryConnectionSystemDeflection(_2751.ShaftToMountableComponentConnectionSystemDeflection):
    """PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4060.PlanetaryConnectionPowerFlow':
