...
class ShaftSystemDeflectionSectionsReport(_1721.CustomReportChart):
    """ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1783.TableAndChartOptions':
        ...
        return constructor.new_from_mastapy_type(_1783.TableAndChartOptions)(value) if value is not None else None

    @display.setter
    def display(self, value: '_1783.TableAndChartOptions'):
