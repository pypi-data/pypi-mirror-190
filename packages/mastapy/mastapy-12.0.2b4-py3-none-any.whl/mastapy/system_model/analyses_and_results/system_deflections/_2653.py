...
class BevelGearSetSystemDeflection(_2641.AGMAGleasonConicalGearSetSystemDeflection):
    """BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3994.BevelGearSetPowerFlow':
