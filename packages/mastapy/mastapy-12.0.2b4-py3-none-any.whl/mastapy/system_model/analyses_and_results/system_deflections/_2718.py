...
from mastapy.system_model.analyses_and_results.system_deflections import _2719, _2717, _2715
...
class KlingelnbergCycloPalloidHypoidGearSetSystemDeflection(_2715.KlingelnbergCycloPalloidConicalGearSetSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4048.KlingelnbergCycloPalloidHypoidGearSetPowerFlow':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_system_deflection(self) -> 'List[_2719.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_system_deflection(self) -> 'List[_2717.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
