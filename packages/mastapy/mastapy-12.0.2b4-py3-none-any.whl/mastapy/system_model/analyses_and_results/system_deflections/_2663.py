...
class ConceptCouplingConnectionSystemDeflection(_2675.CouplingConnectionSystemDeflection):
    """ConceptCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4002.ConceptCouplingConnectionPowerFlow':
