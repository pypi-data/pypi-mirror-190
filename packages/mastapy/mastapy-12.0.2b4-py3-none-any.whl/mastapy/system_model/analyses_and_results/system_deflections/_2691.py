...
from mastapy.system_model.analyses_and_results.power_flows import _4025, _4027
from mastapy.system_model.analyses_and_results.system_deflections import _2695, _2707
...
class CylindricalGearSystemDeflection(_2707.GearSystemDeflection):
    """CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4025.CylindricalGearPowerFlow':
        ...
        if _4025.CylindricalGearPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_system_deflections_in_meshes(self) -> 'List[_2695.CylindricalMeshedGearSystemDeflection]':
