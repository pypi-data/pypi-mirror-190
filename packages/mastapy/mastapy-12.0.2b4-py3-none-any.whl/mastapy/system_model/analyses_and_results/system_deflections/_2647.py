...
class BevelDifferentialGearMeshSystemDeflection(_2652.BevelGearMeshSystemDeflection):
    """BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3987.BevelDifferentialGearMeshPowerFlow':
