...
class RollingRingConnectionSystemDeflection(_2713.InterMountableComponentConnectionSystemDeflection):
    """RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4071.RollingRingConnectionPowerFlow':
