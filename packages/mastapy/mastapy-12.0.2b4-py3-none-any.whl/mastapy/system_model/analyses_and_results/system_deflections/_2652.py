...
class BevelGearMeshSystemDeflection(_2640.AGMAGleasonConicalGearMeshSystemDeflection):
    """BevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3992.BevelGearMeshPowerFlow':
