...
class ShaftHubConnectionAdvancedSystemDeflection(_7233.ConnectorAdvancedSystemDeflection):
    """ShaftHubConnectionAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2747.ShaftHubConnectionSystemDeflection]':
