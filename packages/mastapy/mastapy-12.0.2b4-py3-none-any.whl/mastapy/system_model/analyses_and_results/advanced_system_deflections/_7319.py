...
class TorqueConverterPumpAdvancedSystemDeflection(_7237.CouplingHalfAdvancedSystemDeflection):
    """TorqueConverterPumpAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2775.TorqueConverterPumpSystemDeflection]':
