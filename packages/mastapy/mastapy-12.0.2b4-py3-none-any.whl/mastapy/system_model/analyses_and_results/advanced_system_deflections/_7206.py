...
class BeltConnectionAdvancedSystemDeflection(_7264.InterMountableComponentConnectionAdvancedSystemDeflection):
    """BeltConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2645.BeltConnectionSystemDeflection]':
