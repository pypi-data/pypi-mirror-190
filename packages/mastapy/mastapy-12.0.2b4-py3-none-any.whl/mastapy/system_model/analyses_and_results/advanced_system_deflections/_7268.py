...
class KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection(_7265.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2719.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
