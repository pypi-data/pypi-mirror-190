...
class MeasurementComponentAdvancedSystemDeflection(_7323.VirtualComponentAdvancedSystemDeflection):
    """MeasurementComponentAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2726.MeasurementComponentSystemDeflection]':
