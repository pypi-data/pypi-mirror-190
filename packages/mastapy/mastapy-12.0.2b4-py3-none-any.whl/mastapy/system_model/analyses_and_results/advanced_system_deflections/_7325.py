...
class WormGearMeshAdvancedSystemDeflection(_7258.GearMeshAdvancedSystemDeflection):
    """WormGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2782.WormGearMeshSystemDeflection]':
