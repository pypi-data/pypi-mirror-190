...
class ConceptGearMeshAdvancedSystemDeflection(_7258.GearMeshAdvancedSystemDeflection):
    """ConceptGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2666.ConceptGearMeshSystemDeflection]':
