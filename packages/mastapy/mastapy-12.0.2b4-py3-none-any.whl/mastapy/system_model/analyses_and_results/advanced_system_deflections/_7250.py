...
class DatumAdvancedSystemDeflection(_7222.ComponentAdvancedSystemDeflection):
    """DatumAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2697.DatumSystemDeflection]':
