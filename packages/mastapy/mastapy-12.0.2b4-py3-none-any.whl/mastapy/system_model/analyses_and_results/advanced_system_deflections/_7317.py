...
class TorqueConverterAdvancedSystemDeflection(_7235.CouplingAdvancedSystemDeflection):
    """TorqueConverterAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2776.TorqueConverterSystemDeflection]':
