...
class InterMountableComponentConnectionCompoundAdvancedSystemDeflection(_7365.ConnectionCompoundAdvancedSystemDeflection):
    """InterMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7264.InterMountableComponentConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7264.InterMountableComponentConnectionAdvancedSystemDeflection]':
