...
class FaceGearCompoundAdvancedSystemDeflection(_7388.GearCompoundAdvancedSystemDeflection):
    """FaceGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7252.FaceGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7252.FaceGearAdvancedSystemDeflection]':
