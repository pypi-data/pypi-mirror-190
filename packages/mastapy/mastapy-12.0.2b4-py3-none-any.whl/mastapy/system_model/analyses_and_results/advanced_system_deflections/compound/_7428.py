...
class SpecialisedAssemblyCompoundAdvancedSystemDeflection(_7330.AbstractAssemblyCompoundAdvancedSystemDeflection):
    """SpecialisedAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7298.SpecialisedAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7298.SpecialisedAssemblyAdvancedSystemDeflection]':
