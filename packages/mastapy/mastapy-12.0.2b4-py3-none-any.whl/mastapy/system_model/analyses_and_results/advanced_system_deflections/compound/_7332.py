...
class AbstractShaftOrHousingCompoundAdvancedSystemDeflection(_7355.ComponentCompoundAdvancedSystemDeflection):
    """AbstractShaftOrHousingCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7196.AbstractShaftOrHousingAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7196.AbstractShaftOrHousingAdvancedSystemDeflection]':
