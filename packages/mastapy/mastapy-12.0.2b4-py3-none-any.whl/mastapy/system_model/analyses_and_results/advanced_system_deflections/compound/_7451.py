...
class UnbalancedMassCompoundAdvancedSystemDeflection(_7452.VirtualComponentCompoundAdvancedSystemDeflection):
    """UnbalancedMassCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7322.UnbalancedMassAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7322.UnbalancedMassAdvancedSystemDeflection]':
