...
class SpiralBevelGearCompoundAdvancedSystemDeflection(_7346.BevelGearCompoundAdvancedSystemDeflection):
    """SpiralBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7299.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7299.SpiralBevelGearAdvancedSystemDeflection]':
