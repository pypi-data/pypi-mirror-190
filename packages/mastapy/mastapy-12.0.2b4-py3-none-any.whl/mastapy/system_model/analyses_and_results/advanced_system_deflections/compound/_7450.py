...
class TorqueConverterTurbineCompoundAdvancedSystemDeflection(_7369.CouplingHalfCompoundAdvancedSystemDeflection):
    """TorqueConverterTurbineCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7320.TorqueConverterTurbineAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7320.TorqueConverterTurbineAdvancedSystemDeflection]':
