...
class TorqueConverterPumpCompoundAdvancedSystemDeflection(_7369.CouplingHalfCompoundAdvancedSystemDeflection):
    """TorqueConverterPumpCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7319.TorqueConverterPumpAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7319.TorqueConverterPumpAdvancedSystemDeflection]':
