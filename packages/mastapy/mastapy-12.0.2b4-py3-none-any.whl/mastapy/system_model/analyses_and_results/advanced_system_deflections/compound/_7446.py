...
class SynchroniserSleeveCompoundAdvancedSystemDeflection(_7445.SynchroniserPartCompoundAdvancedSystemDeflection):
    """SynchroniserSleeveCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7316.SynchroniserSleeveAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7316.SynchroniserSleeveAdvancedSystemDeflection]':
