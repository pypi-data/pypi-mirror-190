...
class ShaftHubConnectionCompoundAdvancedSystemDeflection(_7366.ConnectorCompoundAdvancedSystemDeflection):
    """ShaftHubConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7296.ShaftHubConnectionAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7296.ShaftHubConnectionAdvancedSystemDeflection]':
