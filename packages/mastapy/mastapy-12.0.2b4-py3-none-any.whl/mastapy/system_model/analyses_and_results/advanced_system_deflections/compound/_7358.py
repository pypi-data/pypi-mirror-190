...
class ConceptCouplingHalfCompoundAdvancedSystemDeflection(_7369.CouplingHalfCompoundAdvancedSystemDeflection):
    """ConceptCouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7225.ConceptCouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7225.ConceptCouplingHalfAdvancedSystemDeflection]':
