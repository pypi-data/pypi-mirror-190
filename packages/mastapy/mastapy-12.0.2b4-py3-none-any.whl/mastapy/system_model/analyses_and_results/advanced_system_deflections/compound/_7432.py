...
class SpringDamperCompoundAdvancedSystemDeflection(_7367.CouplingCompoundAdvancedSystemDeflection):
    """SpringDamperCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7302.SpringDamperAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7302.SpringDamperAdvancedSystemDeflection]':
