...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7377, _7378, _7390
...
class CylindricalGearSetCompoundAdvancedSystemDeflection(_7390.GearSetCompoundAdvancedSystemDeflection):
    """CylindricalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7247.CylindricalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gears_compound_advanced_system_deflection(self) -> 'List[_7377.CylindricalGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_meshes_compound_advanced_system_deflection(self) -> 'List[_7378.CylindricalGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7247.CylindricalGearSetAdvancedSystemDeflection]':
