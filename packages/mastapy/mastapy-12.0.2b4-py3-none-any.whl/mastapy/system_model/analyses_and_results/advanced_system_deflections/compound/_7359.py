...
class ConceptGearCompoundAdvancedSystemDeflection(_7388.GearCompoundAdvancedSystemDeflection):
    """ConceptGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7226.ConceptGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7226.ConceptGearAdvancedSystemDeflection]':
