...
class ConnectionCompoundAdvancedSystemDeflection(_7463.ConnectionCompoundAnalysis):
    """ConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7232.ConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7232.ConnectionAdvancedSystemDeflection]':
