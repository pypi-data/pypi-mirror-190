...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7246, _7248, _7257
...
class CylindricalGearAdvancedSystemDeflection(_7257.GearAdvancedSystemDeflection):
    """CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_7246.CylindricalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_7248.CylindricalMeshedGearAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_7248.CylindricalMeshedGearAdvancedSystemDeflection]':
