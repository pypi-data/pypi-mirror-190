...
class StraightBevelGearAdvancedSystemDeflection(_7213.BevelGearAdvancedSystemDeflection):
    """StraightBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2764.StraightBevelGearSystemDeflection]':
