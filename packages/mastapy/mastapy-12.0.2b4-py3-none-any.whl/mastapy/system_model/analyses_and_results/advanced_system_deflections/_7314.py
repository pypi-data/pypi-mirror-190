...
class SynchroniserHalfAdvancedSystemDeflection(_7315.SynchroniserPartAdvancedSystemDeflection):
    """SynchroniserHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2767.SynchroniserHalfSystemDeflection]':
