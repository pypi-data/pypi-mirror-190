...
class PointLoadAdvancedSystemDeflection(_7323.VirtualComponentAdvancedSystemDeflection):
    """PointLoadAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2737.PointLoadSystemDeflection]':
