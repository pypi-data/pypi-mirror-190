...
from mastapy.system_model.analyses_and_results.system_deflections import _2704, _2724, _2747
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7295, _7245, _7298
...
class FlexiblePinAssemblyAdvancedSystemDeflection(_7298.SpecialisedAssemblyAdvancedSystemDeflection):
    """FlexiblePinAssemblyAdvancedSystemDeflection
    ...
    @property
    def pin_advanced_analyses(self) -> 'List[_7295.ShaftAdvancedSystemDeflection]':
    ...
    @property
    def pin_spindle_fit_advanced_analyses(self) -> 'List[_2747.ShaftHubConnectionSystemDeflection]':
    ...
    @property
    def planet_gear_analyses(self) -> 'List[_7245.CylindricalGearAdvancedSystemDeflection]':
    ...
    @property
    def spindle_advanced_analyses(self) -> 'List[_7295.ShaftAdvancedSystemDeflection]':
