...
class PlanetCarrierAdvancedSystemDeflection(_7277.MountableComponentAdvancedSystemDeflection):
    """PlanetCarrierAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2736.PlanetCarrierSystemDeflection]':
