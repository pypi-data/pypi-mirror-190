...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7327, _7328, _7215
...
class ZerolBevelGearSetAdvancedSystemDeflection(_7215.BevelGearSetAdvancedSystemDeflection):
    """ZerolBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2786.ZerolBevelGearSetSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_advanced_system_deflection(self) -> 'List[_7327.ZerolBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_advanced_system_deflection(self) -> 'List[_7328.ZerolBevelGearMeshAdvancedSystemDeflection]':
