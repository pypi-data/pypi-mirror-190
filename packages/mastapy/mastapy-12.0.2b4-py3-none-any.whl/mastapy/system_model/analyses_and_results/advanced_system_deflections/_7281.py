...
class PartToPartShearCouplingConnectionAdvancedSystemDeflection(_7236.CouplingConnectionAdvancedSystemDeflection):
    """PartToPartShearCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2732.PartToPartShearCouplingConnectionSystemDeflection]':
