...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7305, _7306, _7215
...
class StraightBevelDiffGearSetAdvancedSystemDeflection(_7215.BevelGearSetAdvancedSystemDeflection):
    """StraightBevelDiffGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2760.StraightBevelDiffGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gears_advanced_system_deflection(self) -> 'List[_7305.StraightBevelDiffGearAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_meshes_advanced_system_deflection(self) -> 'List[_7306.StraightBevelDiffGearMeshAdvancedSystemDeflection]':
