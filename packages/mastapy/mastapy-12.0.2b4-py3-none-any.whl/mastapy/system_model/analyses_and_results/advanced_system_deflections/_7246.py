...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7245, _7234, _7258
...
class CylindricalGearMeshAdvancedSystemDeflection(_7258.GearMeshAdvancedSystemDeflection):
    """CylindricalGearMeshAdvancedSystemDeflection
    ...
    @property
    def cylindrical_gear_advanced_analyses(self) -> 'List[_7245.CylindricalGearAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_results(self) -> 'List[_2686.CylindricalGearMeshSystemDeflectionTimestep]':
    ...
    @property
    def max_pressure_contact_chart_for_each_tooth_pass_for_gear_a(self) -> 'List[_7234.ContactChartPerToothPass]':
