...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7299, _7300, _7215
...
class SpiralBevelGearSetAdvancedSystemDeflection(_7215.BevelGearSetAdvancedSystemDeflection):
    """SpiralBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2754.SpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_advanced_system_deflection(self) -> 'List[_7299.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_advanced_system_deflection(self) -> 'List[_7300.SpiralBevelGearMeshAdvancedSystemDeflection]':
