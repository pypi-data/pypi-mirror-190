...
class RollingRingAdvancedSystemDeflection(_7237.CouplingHalfAdvancedSystemDeflection):
    """RollingRingAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2745.RollingRingSystemDeflection]':
