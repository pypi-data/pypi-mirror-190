...
class ClutchConnectionAdvancedSystemDeflection(_7236.CouplingConnectionAdvancedSystemDeflection):
    """ClutchConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2657.ClutchConnectionSystemDeflection]':
