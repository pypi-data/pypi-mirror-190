...
class FaceGearMeshAdvancedSystemDeflection(_7258.GearMeshAdvancedSystemDeflection):
    """FaceGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2700.FaceGearMeshSystemDeflection]':
