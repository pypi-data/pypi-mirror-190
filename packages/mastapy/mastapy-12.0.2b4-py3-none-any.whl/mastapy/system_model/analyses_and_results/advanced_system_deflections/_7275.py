...
class MassDiscAdvancedSystemDeflection(_7323.VirtualComponentAdvancedSystemDeflection):
    """MassDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2725.MassDiscSystemDeflection]':
