...
class ConceptCouplingConnectionAdvancedSystemDeflection(_7236.CouplingConnectionAdvancedSystemDeflection):
    """ConceptCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2663.ConceptCouplingConnectionSystemDeflection]':
