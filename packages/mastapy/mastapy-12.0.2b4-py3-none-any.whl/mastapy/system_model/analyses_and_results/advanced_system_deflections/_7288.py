...
class PulleyAdvancedSystemDeflection(_7237.CouplingHalfAdvancedSystemDeflection):
    """PulleyAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2739.PulleySystemDeflection]':
