...
class ConceptCouplingHalfAdvancedSystemDeflection(_7237.CouplingHalfAdvancedSystemDeflection):
    """ConceptCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2664.ConceptCouplingHalfSystemDeflection]':
