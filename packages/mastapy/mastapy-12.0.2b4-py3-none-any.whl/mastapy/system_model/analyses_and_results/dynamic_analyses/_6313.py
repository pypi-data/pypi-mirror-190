...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6311, _6312, _6223
...
class StraightBevelDiffGearSetDynamicAnalysis(_6223.BevelGearSetDynamicAnalysis):
    """StraightBevelDiffGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_diff_gears_dynamic_analysis(self) -> 'List[_6311.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_dynamic_analysis(self) -> 'List[_6312.StraightBevelDiffGearMeshDynamicAnalysis]':
