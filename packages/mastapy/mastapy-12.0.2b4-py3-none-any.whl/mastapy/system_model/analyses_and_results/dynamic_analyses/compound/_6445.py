...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6443, _6444, _6353
...
class StraightBevelGearSetCompoundDynamicAnalysis(_6353.BevelGearSetCompoundDynamicAnalysis):
    """StraightBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6316.StraightBevelGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6443.StraightBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6444.StraightBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6316.StraightBevelGearSetDynamicAnalysis]':
