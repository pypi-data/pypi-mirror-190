...
class SynchroniserHalfCompoundDynamicAnalysis(_6450.SynchroniserPartCompoundDynamicAnalysis):
    """SynchroniserHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6320.SynchroniserHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6320.SynchroniserHalfDynamicAnalysis]':
