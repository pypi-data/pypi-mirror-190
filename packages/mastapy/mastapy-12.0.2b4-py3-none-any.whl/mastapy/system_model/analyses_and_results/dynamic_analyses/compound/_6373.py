...
class CouplingConnectionCompoundDynamicAnalysis(_6400.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """CouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6242.CouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6242.CouplingConnectionDynamicAnalysis]':
