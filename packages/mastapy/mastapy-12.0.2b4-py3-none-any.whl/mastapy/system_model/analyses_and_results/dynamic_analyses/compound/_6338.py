...
class AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis(_6370.ConnectionCompoundDynamicAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6208.AbstractShaftToMountableComponentConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6208.AbstractShaftToMountableComponentConnectionDynamicAnalysis]':
