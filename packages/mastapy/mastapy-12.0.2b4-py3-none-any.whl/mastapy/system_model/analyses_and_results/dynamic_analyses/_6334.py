...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6332, _6333, _6223
...
class ZerolBevelGearSetDynamicAnalysis(_6223.BevelGearSetDynamicAnalysis):
    """ZerolBevelGearSetDynamicAnalysis
    ...
    @property
    def zerol_bevel_gears_dynamic_analysis(self) -> 'List[_6332.ZerolBevelGearDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_dynamic_analysis(self) -> 'List[_6333.ZerolBevelGearMeshDynamicAnalysis]':
