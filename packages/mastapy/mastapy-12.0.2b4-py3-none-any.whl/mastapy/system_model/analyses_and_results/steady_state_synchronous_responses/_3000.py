...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3001, _2999, _2997
...
class KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse(_2997.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_steady_state_synchronous_response(self) -> 'List[_3001.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_steady_state_synchronous_response(self) -> 'List[_2999.KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse]':
