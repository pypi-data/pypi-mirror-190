...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3043, _3041, _2946
...
class StraightBevelGearSetSteadyStateSynchronousResponse(_2946.BevelGearSetSteadyStateSynchronousResponse):
    """StraightBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def straight_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3043.StraightBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3041.StraightBevelGearMeshSteadyStateSynchronousResponse]':
