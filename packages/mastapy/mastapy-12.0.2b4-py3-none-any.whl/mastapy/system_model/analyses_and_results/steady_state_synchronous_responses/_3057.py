...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3058, _3056, _2989
...
class WormGearSetSteadyStateSynchronousResponse(_2989.GearSetSteadyStateSynchronousResponse):
    """WormGearSetSteadyStateSynchronousResponse
    ...
    @property
    def worm_gears_steady_state_synchronous_response(self) -> 'List[_3058.WormGearSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_meshes_steady_state_synchronous_response(self) -> 'List[_3056.WormGearMeshSteadyStateSynchronousResponse]':
