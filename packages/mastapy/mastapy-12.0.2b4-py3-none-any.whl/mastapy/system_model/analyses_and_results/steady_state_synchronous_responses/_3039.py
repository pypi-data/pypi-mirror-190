...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3040, _3038, _2946
...
class StraightBevelDiffGearSetSteadyStateSynchronousResponse(_2946.BevelGearSetSteadyStateSynchronousResponse):
    """StraightBevelDiffGearSetSteadyStateSynchronousResponse
    ...
    @property
    def straight_bevel_diff_gears_steady_state_synchronous_response(self) -> 'List[_3040.StraightBevelDiffGearSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_meshes_steady_state_synchronous_response(self) -> 'List[_3038.StraightBevelDiffGearMeshSteadyStateSynchronousResponse]':
