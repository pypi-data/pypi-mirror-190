...
class AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse(_3096.ConicalGearSetCompoundSteadyStateSynchronousResponse):
    """AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2934.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2934.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse]':
