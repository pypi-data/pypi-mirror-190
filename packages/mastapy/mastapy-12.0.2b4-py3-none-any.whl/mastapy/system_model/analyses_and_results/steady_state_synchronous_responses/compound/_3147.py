...
class PlanetCarrierCompoundSteadyStateSynchronousResponse(_3139.MountableComponentCompoundSteadyStateSynchronousResponse):
    """PlanetCarrierCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3015.PlanetCarrierSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3015.PlanetCarrierSteadyStateSynchronousResponse]':
