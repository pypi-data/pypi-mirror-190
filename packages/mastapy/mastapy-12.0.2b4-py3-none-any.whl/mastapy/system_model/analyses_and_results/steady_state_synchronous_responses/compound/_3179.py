...
class TorqueConverterCompoundSteadyStateSynchronousResponse(_3099.CouplingCompoundSteadyStateSynchronousResponse):
    """TorqueConverterCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3052.TorqueConverterSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3052.TorqueConverterSteadyStateSynchronousResponse]':
