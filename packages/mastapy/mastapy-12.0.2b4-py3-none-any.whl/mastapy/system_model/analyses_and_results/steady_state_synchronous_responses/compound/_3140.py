...
class OilSealCompoundSteadyStateSynchronousResponse(_3098.ConnectorCompoundSteadyStateSynchronousResponse):
    """OilSealCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3008.OilSealSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3008.OilSealSteadyStateSynchronousResponse]':
