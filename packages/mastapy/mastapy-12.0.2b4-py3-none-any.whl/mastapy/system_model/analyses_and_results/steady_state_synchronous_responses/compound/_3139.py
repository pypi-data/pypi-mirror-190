...
class MountableComponentCompoundSteadyStateSynchronousResponse(_3087.ComponentCompoundSteadyStateSynchronousResponse):
    """MountableComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3007.MountableComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3007.MountableComponentSteadyStateSynchronousResponse]':
