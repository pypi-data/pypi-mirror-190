...
class BoltCompoundSteadyStateSynchronousResponse(_3087.ComponentCompoundSteadyStateSynchronousResponse):
    """BoltCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2949.BoltSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2949.BoltSteadyStateSynchronousResponse]':
