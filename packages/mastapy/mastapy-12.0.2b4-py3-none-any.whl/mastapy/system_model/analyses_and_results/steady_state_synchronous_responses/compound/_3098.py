...
class ConnectorCompoundSteadyStateSynchronousResponse(_3139.MountableComponentCompoundSteadyStateSynchronousResponse):
    """ConnectorCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2965.ConnectorSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2965.ConnectorSteadyStateSynchronousResponse]':
