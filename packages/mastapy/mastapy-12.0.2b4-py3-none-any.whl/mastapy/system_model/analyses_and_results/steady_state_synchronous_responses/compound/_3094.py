...
class ConicalGearCompoundSteadyStateSynchronousResponse(_3120.GearCompoundSteadyStateSynchronousResponse):
    """ConicalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2963.ConicalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2963.ConicalGearSteadyStateSynchronousResponse]':
