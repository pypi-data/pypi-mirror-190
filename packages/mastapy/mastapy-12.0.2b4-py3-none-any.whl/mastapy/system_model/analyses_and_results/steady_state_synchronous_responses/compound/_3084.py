...
class ClutchConnectionCompoundSteadyStateSynchronousResponse(_3100.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """ClutchConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2950.ClutchConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2950.ClutchConnectionSteadyStateSynchronousResponse]':
