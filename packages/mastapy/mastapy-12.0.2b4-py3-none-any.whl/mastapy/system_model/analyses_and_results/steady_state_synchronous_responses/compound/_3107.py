...
class CycloidalDiscCompoundSteadyStateSynchronousResponse(_3063.AbstractShaftCompoundSteadyStateSynchronousResponse):
    """CycloidalDiscCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2975.CycloidalDiscSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2975.CycloidalDiscSteadyStateSynchronousResponse]':
