...
class VirtualComponentCompoundSteadyStateSynchronousResponse(_3139.MountableComponentCompoundSteadyStateSynchronousResponse):
    """VirtualComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3055.VirtualComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3055.VirtualComponentSteadyStateSynchronousResponse]':
