...
class SpringDamperCompoundSteadyStateSynchronousResponse(_3099.CouplingCompoundSteadyStateSynchronousResponse):
    """SpringDamperCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3034.SpringDamperSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3034.SpringDamperSteadyStateSynchronousResponse]':
