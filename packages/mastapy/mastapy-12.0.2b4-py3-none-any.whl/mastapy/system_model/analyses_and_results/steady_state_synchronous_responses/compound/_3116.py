...
class FaceGearMeshCompoundSteadyStateSynchronousResponse(_3121.GearMeshCompoundSteadyStateSynchronousResponse):
    """FaceGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2983.FaceGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2983.FaceGearMeshSteadyStateSynchronousResponse]':
