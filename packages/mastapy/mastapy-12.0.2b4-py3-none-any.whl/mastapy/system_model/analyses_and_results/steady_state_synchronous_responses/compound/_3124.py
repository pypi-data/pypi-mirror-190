...
class HypoidGearCompoundSteadyStateSynchronousResponse(_3066.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse):
    """HypoidGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2994.HypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2994.HypoidGearSteadyStateSynchronousResponse]':
