...
class ZerolBevelGearCompoundSteadyStateSynchronousResponse(_3078.BevelGearCompoundSteadyStateSynchronousResponse):
    """ZerolBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3061.ZerolBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3061.ZerolBevelGearSteadyStateSynchronousResponse]':
