...
class GuideDxfModelCompoundSteadyStateSynchronousResponse(_3087.ComponentCompoundSteadyStateSynchronousResponse):
    """GuideDxfModelCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2991.GuideDxfModelSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2991.GuideDxfModelSteadyStateSynchronousResponse]':
