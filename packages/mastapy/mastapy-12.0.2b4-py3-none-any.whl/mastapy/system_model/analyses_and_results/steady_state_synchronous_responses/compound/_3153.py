...
class RollingRingAssemblyCompoundSteadyStateSynchronousResponse(_3160.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """RollingRingAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3021.RollingRingAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3021.RollingRingAssemblySteadyStateSynchronousResponse]':
