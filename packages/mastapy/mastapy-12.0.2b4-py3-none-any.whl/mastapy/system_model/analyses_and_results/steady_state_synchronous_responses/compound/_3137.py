...
class MassDiscCompoundSteadyStateSynchronousResponse(_3184.VirtualComponentCompoundSteadyStateSynchronousResponse):
    """MassDiscCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3005.MassDiscSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3005.MassDiscSteadyStateSynchronousResponse]':
