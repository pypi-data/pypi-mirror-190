...
class ConnectionSteadyStateSynchronousResponse(_7465.ConnectionStaticLoadAnalysisCase):
    """ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3035.SteadyStateSynchronousResponse':
