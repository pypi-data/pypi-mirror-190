...
class PlanetaryGearSetLoadCase(_6791.CylindricalGearSetLoadCase):
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1554.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1554.LoadCaseOverrideOption'):
