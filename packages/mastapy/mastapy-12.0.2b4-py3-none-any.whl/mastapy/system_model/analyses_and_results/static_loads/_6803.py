...
from mastapy.system_model.analyses_and_results.static_loads import _6797, _6806
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_6797.ElectricMachineHarmonicLoadData, Generic[T]):
    """ElectricMachineHarmonicLoadDataFromMotorPackages
