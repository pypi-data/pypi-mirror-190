...
from mastapy.system_model.analyses_and_results.static_loads import _6782, _6748
...
class CVTLoadCase(_6748.BeltDriveLoadCase):
    """CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6782.CVTPulleyLoadCase]':
