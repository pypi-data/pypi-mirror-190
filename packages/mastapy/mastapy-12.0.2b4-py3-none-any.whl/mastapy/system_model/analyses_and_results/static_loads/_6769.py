...
from mastapy.system_model.analyses_and_results.static_loads import _6767, _6768, _6821
...
class ConceptGearSetLoadCase(_6821.GearSetLoadCase):
    """ConceptGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6767.ConceptGearLoadCase]':
    ...
    @property
    def concept_gears_load_case(self) -> 'List[_6767.ConceptGearLoadCase]':
    ...
    @property
    def concept_meshes_load_case(self) -> 'List[_6768.ConceptGearMeshLoadCase]':
