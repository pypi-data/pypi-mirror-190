...
from mastapy.system_model.analyses_and_results.static_loads import _6794, _6828, _6806
...
T = TypeVar('T', bound='_6806.ElectricMachineHarmonicLoadImportOptionsBase')


class HarmonicLoadDataCSVImport(_6828.HarmonicLoadDataImportFromMotorPackages['T'], Generic[T]):
    """HarmonicLoadDataCSVImport
    ...
    @property
    def electric_machine_data_per_speed(self) -> 'List[_6794.DataFromMotorPackagePerSpeed]':
