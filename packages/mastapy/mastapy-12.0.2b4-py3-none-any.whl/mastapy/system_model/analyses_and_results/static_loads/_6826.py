...
from mastapy.system_model.analyses_and_results.static_loads import _6836, _6824, _6805
...
class HarmonicLoadDataFluxImport(_6824.HarmonicLoadDataCSVImport['_6805.ElectricMachineHarmonicLoadFluxImportOptions']):
    """HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6836.InnerDiameterReference':
        ...
        return constructor.new_from_mastapy_type(_6836.InnerDiameterReference)(value) if value is not None else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6836.InnerDiameterReference'):
