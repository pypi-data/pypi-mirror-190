...
from mastapy.system_model.analyses_and_results.static_loads import _6844, _6845, _6840
...
class KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase(_6840.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    """KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6844.KlingelnbergCycloPalloidSpiralBevelGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_load_case(self) -> 'List[_6844.KlingelnbergCycloPalloidSpiralBevelGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_load_case(self) -> 'List[_6845.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase]':
