...
class ConceptCouplingLoadCase(_6779.CouplingLoadCase):
    """ConceptCouplingLoadCase
    ...
    @property
    def speed_ratio_specification_method(self) -> '_2158.ConceptCouplingSpeedRatioSpecificationMethod':
        ...
        return constructor.new_from_mastapy_type(_2158.ConceptCouplingSpeedRatioSpecificationMethod)(value) if value is not None else None

    @speed_ratio_specification_method.setter
    def speed_ratio_specification_method(self, value: '_2158.ConceptCouplingSpeedRatioSpecificationMethod'):
