...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6930, _6924
...
class TorqueInputOptions(_6924.PowerLoadInputOptions):
    """TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6930.TorqueValuesObtainedFrom':
        ...
        return constructor.new_from_mastapy_type(_6930.TorqueValuesObtainedFrom)(value) if value is not None else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6930.TorqueValuesObtainedFrom'):
