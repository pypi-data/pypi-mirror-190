...
from mastapy.system_model.analyses_and_results.static_loads import _6888, _6889, _6756
...
class StraightBevelGearSetLoadCase(_6756.BevelGearSetLoadCase):
    """StraightBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6888.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6888.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6889.StraightBevelGearMeshLoadCase]':
