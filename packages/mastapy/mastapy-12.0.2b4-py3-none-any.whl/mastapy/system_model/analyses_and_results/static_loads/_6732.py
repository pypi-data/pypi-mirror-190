...
from mastapy.system_model.analyses_and_results import _2590, _2571
...
class TimeSeriesLoadCase(_6730.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5398.MBDAnalysisOptions':
    ...
    @property
    def time_series_load_case_group(self) -> '_5607.TimeSeriesLoadCaseGroup':
    ...
    def duplicate(self, new_load_case_group: '_5607.TimeSeriesLoadCaseGroup', name: Optional['str'] = 'None') -> 'TimeSeriesLoadCase':
