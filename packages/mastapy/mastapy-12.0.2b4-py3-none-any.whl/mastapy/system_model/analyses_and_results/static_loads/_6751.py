...
from mastapy.system_model.analyses_and_results.static_loads import _6749, _6750, _6756
...
class BevelDifferentialGearSetLoadCase(_6756.BevelGearSetLoadCase):
    """BevelDifferentialGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6749.BevelDifferentialGearLoadCase]':
    ...
    @property
    def bevel_differential_gears_load_case(self) -> 'List[_6749.BevelDifferentialGearLoadCase]':
    ...
    @property
    def bevel_differential_meshes_load_case(self) -> 'List[_6750.BevelDifferentialGearMeshLoadCase]':
