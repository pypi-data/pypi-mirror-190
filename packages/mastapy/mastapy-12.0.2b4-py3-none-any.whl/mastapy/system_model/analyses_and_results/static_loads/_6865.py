...
from mastapy.system_model import _2171, _2173, _2172
from mastapy.math_utility.measured_data import _1530
from mastapy.system_model.fe import _2325
from mastapy.system_model.analyses_and_results.static_loads import _6903, _6797, _6907
...
class PowerLoadLoadCase(_6907.VirtualComponentLoadCase):
    """PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_2171.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new_from_mastapy_type(_2171.PowerLoadDragTorqueSpecificationMethod)(value) if value is not None else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_2171.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def target_speed_input_type(self) -> '_2173.PowerLoadPIDControlSpeedInputType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2173.PowerLoadPIDControlSpeedInputType)(value) if value is not None else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_2173.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def wheel_slip_model(self) -> '_5452.WheelSlipType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5452.WheelSlipType)(value) if value is not None else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5452.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def component_design(self) -> '_2424.PowerLoad':
    ...
    def get_harmonic_load_data_for_import(self) -> '_6797.ElectricMachineHarmonicLoadData':
