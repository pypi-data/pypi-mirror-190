...
from mastapy.system_model.fe import _2311, _2334
...
class FEPartLoadCase(_6735.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2311.AngleSource':
        ...
        return constructor.new_from_mastapy_type(_2311.AngleSource)(value) if value is not None else None
