...
from mastapy.system_model.analyses_and_results.static_loads import _6771, _6816
...
class ConicalGearLoadCase(_6816.GearLoadCase):
    """ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6771.ConicalGearManufactureError':
