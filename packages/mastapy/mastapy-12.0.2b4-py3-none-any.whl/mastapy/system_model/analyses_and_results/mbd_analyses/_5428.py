...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5427, _5426, _5333
...
class SpiralBevelGearSetMultibodyDynamicsAnalysis(_5333.BevelGearSetMultibodyDynamicsAnalysis):
    """SpiralBevelGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5427.SpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5427.SpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5426.SpiralBevelGearMeshMultibodyDynamicsAnalysis]':
