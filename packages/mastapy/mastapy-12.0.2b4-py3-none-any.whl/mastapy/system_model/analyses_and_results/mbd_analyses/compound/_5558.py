...
class RollingRingConnectionCompoundMultibodyDynamicsAnalysis(_5530.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """RollingRingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5416.RollingRingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5416.RollingRingConnectionMultibodyDynamicsAnalysis]':
