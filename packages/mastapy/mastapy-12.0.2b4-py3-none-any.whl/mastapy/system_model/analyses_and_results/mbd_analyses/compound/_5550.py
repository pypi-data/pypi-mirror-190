...
class PlanetCarrierCompoundMultibodyDynamicsAnalysis(_5542.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """PlanetCarrierCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5409.PlanetCarrierMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5409.PlanetCarrierMultibodyDynamicsAnalysis]':
