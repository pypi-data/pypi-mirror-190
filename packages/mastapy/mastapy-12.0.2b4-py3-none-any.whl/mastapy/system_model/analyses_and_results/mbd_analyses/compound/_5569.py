...
class SpringDamperHalfCompoundMultibodyDynamicsAnalysis(_5504.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """SpringDamperHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5430.SpringDamperHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5430.SpringDamperHalfMultibodyDynamicsAnalysis]':
