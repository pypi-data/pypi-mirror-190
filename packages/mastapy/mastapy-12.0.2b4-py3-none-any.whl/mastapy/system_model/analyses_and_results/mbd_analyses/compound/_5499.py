...
class ConicalGearSetCompoundMultibodyDynamicsAnalysis(_5525.GearSetCompoundMultibodyDynamicsAnalysis):
    """ConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5350.ConicalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5350.ConicalGearSetMultibodyDynamicsAnalysis]':
