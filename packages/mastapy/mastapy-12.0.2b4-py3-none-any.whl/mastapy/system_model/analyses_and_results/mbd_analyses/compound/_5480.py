...
class BevelDifferentialSunGearCompoundMultibodyDynamicsAnalysis(_5476.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialSunGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5330.BevelDifferentialSunGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5330.BevelDifferentialSunGearMultibodyDynamicsAnalysis]':
