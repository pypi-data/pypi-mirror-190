...
class ExternalCADModelCompoundMultibodyDynamicsAnalysis(_5490.ComponentCompoundMultibodyDynamicsAnalysis):
    """ExternalCADModelCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5368.ExternalCADModelMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5368.ExternalCADModelMultibodyDynamicsAnalysis]':
