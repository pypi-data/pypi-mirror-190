...
class CylindricalGearCompoundMultibodyDynamicsAnalysis(_5523.GearCompoundMultibodyDynamicsAnalysis):
    """CylindricalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5364.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5364.CylindricalGearMultibodyDynamicsAnalysis]':
