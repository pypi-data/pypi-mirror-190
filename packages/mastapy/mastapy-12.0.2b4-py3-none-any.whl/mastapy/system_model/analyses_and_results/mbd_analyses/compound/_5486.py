...
class ClutchCompoundMultibodyDynamicsAnalysis(_5502.CouplingCompoundMultibodyDynamicsAnalysis):
    """ClutchCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5338.ClutchMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5338.ClutchMultibodyDynamicsAnalysis]':
