...
class TorqueConverterCompoundMultibodyDynamicsAnalysis(_5502.CouplingCompoundMultibodyDynamicsAnalysis):
    """TorqueConverterCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5446.TorqueConverterMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5446.TorqueConverterMultibodyDynamicsAnalysis]':
