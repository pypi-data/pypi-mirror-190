...
class ShaftHubConnectionCompoundMultibodyDynamicsAnalysis(_5501.ConnectorCompoundMultibodyDynamicsAnalysis):
    """ShaftHubConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5421.ShaftHubConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5421.ShaftHubConnectionMultibodyDynamicsAnalysis]':
