...
class PartCompoundMultibodyDynamicsAnalysis(_7470.PartCompoundAnalysis):
    """PartCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5403.PartMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5403.PartMultibodyDynamicsAnalysis]':
