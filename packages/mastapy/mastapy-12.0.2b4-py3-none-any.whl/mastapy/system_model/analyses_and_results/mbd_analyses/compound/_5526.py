...
class GuideDxfModelCompoundMultibodyDynamicsAnalysis(_5490.ComponentCompoundMultibodyDynamicsAnalysis):
    """GuideDxfModelCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5378.GuideDxfModelMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5378.GuideDxfModelMultibodyDynamicsAnalysis]':
