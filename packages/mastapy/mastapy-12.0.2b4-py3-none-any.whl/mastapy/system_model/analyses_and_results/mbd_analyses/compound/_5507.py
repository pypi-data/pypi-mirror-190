...
class CVTPulleyCompoundMultibodyDynamicsAnalysis(_5553.PulleyCompoundMultibodyDynamicsAnalysis):
    """CVTPulleyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5358.CVTPulleyMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5358.CVTPulleyMultibodyDynamicsAnalysis]':
