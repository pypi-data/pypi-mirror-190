...
class CylindricalPlanetGearCompoundMultibodyDynamicsAnalysis(_5512.CylindricalGearCompoundMultibodyDynamicsAnalysis):
    """CylindricalPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5366.CylindricalPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5366.CylindricalPlanetGearMultibodyDynamicsAnalysis]':
