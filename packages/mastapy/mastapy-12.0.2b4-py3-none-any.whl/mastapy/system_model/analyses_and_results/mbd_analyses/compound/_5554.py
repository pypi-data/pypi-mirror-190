...
class RingPinsCompoundMultibodyDynamicsAnalysis(_5542.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """RingPinsCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5413.RingPinsMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5413.RingPinsMultibodyDynamicsAnalysis]':
