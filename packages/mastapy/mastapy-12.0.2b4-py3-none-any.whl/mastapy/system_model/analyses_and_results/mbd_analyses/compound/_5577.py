...
class StraightBevelSunGearCompoundMultibodyDynamicsAnalysis(_5570.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelSunGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5439.StraightBevelSunGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5439.StraightBevelSunGearMultibodyDynamicsAnalysis]':
