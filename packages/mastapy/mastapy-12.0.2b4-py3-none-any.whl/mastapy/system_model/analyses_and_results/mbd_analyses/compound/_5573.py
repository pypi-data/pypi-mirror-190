...
class StraightBevelGearCompoundMultibodyDynamicsAnalysis(_5481.BevelGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5436.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5436.StraightBevelGearMultibodyDynamicsAnalysis]':
