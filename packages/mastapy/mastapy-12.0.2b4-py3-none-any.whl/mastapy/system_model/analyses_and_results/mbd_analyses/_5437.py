...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5436, _5435, _5333
...
class StraightBevelGearSetMultibodyDynamicsAnalysis(_5333.BevelGearSetMultibodyDynamicsAnalysis):
    """StraightBevelGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5436.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5436.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5435.StraightBevelGearMeshMultibodyDynamicsAnalysis]':
