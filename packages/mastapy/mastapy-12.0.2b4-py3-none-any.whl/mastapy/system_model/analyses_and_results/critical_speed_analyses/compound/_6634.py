...
class ConicalGearMeshCompoundCriticalSpeedAnalysis(_6660.GearMeshCompoundCriticalSpeedAnalysis):
    """ConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6503.ConicalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6503.ConicalGearMeshCriticalSpeedAnalysis]':
