...
class ConnectorCompoundCriticalSpeedAnalysis(_6678.MountableComponentCompoundCriticalSpeedAnalysis):
    """ConnectorCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6506.ConnectorCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6506.ConnectorCriticalSpeedAnalysis]':
