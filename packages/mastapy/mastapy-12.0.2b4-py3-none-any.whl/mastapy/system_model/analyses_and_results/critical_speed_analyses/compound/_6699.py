...
class SpecialisedAssemblyCompoundCriticalSpeedAnalysis(_6601.AbstractAssemblyCompoundCriticalSpeedAnalysis):
    """SpecialisedAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6570.SpecialisedAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6570.SpecialisedAssemblyCriticalSpeedAnalysis]':
