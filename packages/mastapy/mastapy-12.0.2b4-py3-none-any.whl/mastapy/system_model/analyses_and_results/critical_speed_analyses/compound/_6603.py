...
class AbstractShaftOrHousingCompoundCriticalSpeedAnalysis(_6626.ComponentCompoundCriticalSpeedAnalysis):
    """AbstractShaftOrHousingCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6472.AbstractShaftOrHousingCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6472.AbstractShaftOrHousingCriticalSpeedAnalysis]':
