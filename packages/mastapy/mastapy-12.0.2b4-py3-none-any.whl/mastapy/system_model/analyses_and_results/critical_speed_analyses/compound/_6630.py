...
class ConceptGearCompoundCriticalSpeedAnalysis(_6659.GearCompoundCriticalSpeedAnalysis):
    """ConceptGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6499.ConceptGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6499.ConceptGearCriticalSpeedAnalysis]':
