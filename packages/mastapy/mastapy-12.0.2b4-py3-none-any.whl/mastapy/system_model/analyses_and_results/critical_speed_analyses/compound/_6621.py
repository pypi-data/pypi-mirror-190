...
class BoltedJointCompoundCriticalSpeedAnalysis(_6699.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """BoltedJointCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6490.BoltedJointCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6490.BoltedJointCriticalSpeedAnalysis]':
