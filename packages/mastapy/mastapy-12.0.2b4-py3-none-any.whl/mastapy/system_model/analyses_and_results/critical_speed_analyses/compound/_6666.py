...
class InterMountableComponentConnectionCompoundCriticalSpeedAnalysis(_6636.ConnectionCompoundCriticalSpeedAnalysis):
    """InterMountableComponentConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6537.InterMountableComponentConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6537.InterMountableComponentConnectionCriticalSpeedAnalysis]':
