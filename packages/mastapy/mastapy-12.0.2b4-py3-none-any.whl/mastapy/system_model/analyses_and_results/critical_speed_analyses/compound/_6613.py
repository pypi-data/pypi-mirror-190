...
class BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis(_6618.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6482.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6482.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
