...
class StraightBevelSunGearCompoundCriticalSpeedAnalysis(_6706.StraightBevelDiffGearCompoundCriticalSpeedAnalysis):
    """StraightBevelSunGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6584.StraightBevelSunGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6584.StraightBevelSunGearCriticalSpeedAnalysis]':
