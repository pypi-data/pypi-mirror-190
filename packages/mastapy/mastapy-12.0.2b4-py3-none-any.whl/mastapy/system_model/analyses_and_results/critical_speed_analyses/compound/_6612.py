...
class BevelDifferentialGearCompoundCriticalSpeedAnalysis(_6617.BevelGearCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6481.BevelDifferentialGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6481.BevelDifferentialGearCriticalSpeedAnalysis]':
