...
class CVTBeltConnectionCompoundCriticalSpeedAnalysis(_6610.BeltConnectionCompoundCriticalSpeedAnalysis):
    """CVTBeltConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6512.CVTBeltConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6512.CVTBeltConnectionCriticalSpeedAnalysis]':
