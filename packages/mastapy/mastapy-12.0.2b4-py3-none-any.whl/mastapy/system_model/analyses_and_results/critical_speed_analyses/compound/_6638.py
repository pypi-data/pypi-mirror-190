...
class CouplingCompoundCriticalSpeedAnalysis(_6699.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """CouplingCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6508.CouplingCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6508.CouplingCriticalSpeedAnalysis]':
