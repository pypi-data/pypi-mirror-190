...
class RollingRingCompoundCriticalSpeedAnalysis(_6640.CouplingHalfCompoundCriticalSpeedAnalysis):
    """RollingRingCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6565.RollingRingCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6565.RollingRingCriticalSpeedAnalysis]':
