...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6499, _6500, _6532
...
class ConceptGearSetCriticalSpeedAnalysis(_6532.GearSetCriticalSpeedAnalysis):
    """ConceptGearSetCriticalSpeedAnalysis
    ...
    @property
    def concept_gears_critical_speed_analysis(self) -> 'List[_6499.ConceptGearCriticalSpeedAnalysis]':
    ...
    @property
    def concept_meshes_critical_speed_analysis(self) -> 'List[_6500.ConceptGearMeshCriticalSpeedAnalysis]':
