...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6481, _6482, _6488
...
class BevelDifferentialGearSetCriticalSpeedAnalysis(_6488.BevelGearSetCriticalSpeedAnalysis):
    """BevelDifferentialGearSetCriticalSpeedAnalysis
    ...
    @property
    def bevel_differential_gears_critical_speed_analysis(self) -> 'List[_6481.BevelDifferentialGearCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_meshes_critical_speed_analysis(self) -> 'List[_6482.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
