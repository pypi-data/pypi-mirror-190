...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6598, _6599, _6488
...
class ZerolBevelGearSetCriticalSpeedAnalysis(_6488.BevelGearSetCriticalSpeedAnalysis):
    """ZerolBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def zerol_bevel_gears_critical_speed_analysis(self) -> 'List[_6598.ZerolBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_critical_speed_analysis(self) -> 'List[_6599.ZerolBevelGearMeshCriticalSpeedAnalysis]':
