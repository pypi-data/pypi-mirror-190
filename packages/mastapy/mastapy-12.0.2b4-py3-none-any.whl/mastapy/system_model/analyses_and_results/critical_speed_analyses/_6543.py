...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6541, _6542, _6540
...
class KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis(_6540.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_critical_speed_analysis(self) -> 'List[_6541.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_critical_speed_analysis(self) -> 'List[_6542.KlingelnbergCycloPalloidHypoidGearMeshCriticalSpeedAnalysis]':
