...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6534, _6535, _6476
...
class HypoidGearSetCriticalSpeedAnalysis(_6476.AGMAGleasonConicalGearSetCriticalSpeedAnalysis):
    """HypoidGearSetCriticalSpeedAnalysis
    ...
    @property
    def hypoid_gears_critical_speed_analysis(self) -> 'List[_6534.HypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_meshes_critical_speed_analysis(self) -> 'List[_6535.HypoidGearMeshCriticalSpeedAnalysis]':
