...
class BoltedJointCompoundPowerFlow(_4207.SpecialisedAssemblyCompoundPowerFlow):
    """BoltedJointCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3995.BoltedJointPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3995.BoltedJointPowerFlow]':
