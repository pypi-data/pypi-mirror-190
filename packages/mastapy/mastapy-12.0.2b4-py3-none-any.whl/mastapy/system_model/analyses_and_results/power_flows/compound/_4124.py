...
class BevelDifferentialSunGearCompoundPowerFlow(_4120.BevelDifferentialGearCompoundPowerFlow):
    """BevelDifferentialSunGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3991.BevelDifferentialSunGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3991.BevelDifferentialSunGearPowerFlow]':
