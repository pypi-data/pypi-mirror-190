...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4232, _4233, _4169
...
class WormGearSetCompoundPowerFlow(_4169.GearSetCompoundPowerFlow):
    """WormGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4105.WormGearSetPowerFlow]':
    ...
    @property
    def worm_gears_compound_power_flow(self) -> 'List[_4232.WormGearCompoundPowerFlow]':
    ...
    @property
    def worm_meshes_compound_power_flow(self) -> 'List[_4233.WormGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4105.WormGearSetPowerFlow]':
