...
class AGMAGleasonConicalGearSetCompoundPowerFlow(_4143.ConicalGearSetCompoundPowerFlow):
    """AGMAGleasonConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3982.AGMAGleasonConicalGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3982.AGMAGleasonConicalGearSetPowerFlow]':
