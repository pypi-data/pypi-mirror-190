...
class ConnectorCompoundPowerFlow(_4186.MountableComponentCompoundPowerFlow):
    """ConnectorCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4012.ConnectorPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4012.ConnectorPowerFlow]':
