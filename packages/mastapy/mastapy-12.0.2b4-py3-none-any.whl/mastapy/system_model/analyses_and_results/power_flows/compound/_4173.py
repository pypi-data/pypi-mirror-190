...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4171, _4172, _4115
...
class HypoidGearSetCompoundPowerFlow(_4115.AGMAGleasonConicalGearSetCompoundPowerFlow):
    """HypoidGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4041.HypoidGearSetPowerFlow]':
    ...
    @property
    def hypoid_gears_compound_power_flow(self) -> 'List[_4171.HypoidGearCompoundPowerFlow]':
    ...
    @property
    def hypoid_meshes_compound_power_flow(self) -> 'List[_4172.HypoidGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4041.HypoidGearSetPowerFlow]':
