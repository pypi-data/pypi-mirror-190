...
class OilSealCompoundPowerFlow(_4145.ConnectorCompoundPowerFlow):
    """OilSealCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4055.OilSealPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4055.OilSealPowerFlow]':
