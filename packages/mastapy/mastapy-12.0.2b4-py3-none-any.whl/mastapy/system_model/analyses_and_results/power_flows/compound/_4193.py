...
class PlanetaryGearSetCompoundPowerFlow(_4158.CylindricalGearSetCompoundPowerFlow):
    """PlanetaryGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4061.PlanetaryGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4061.PlanetaryGearSetPowerFlow]':
