...
class ClutchHalfCompoundPowerFlow(_4148.CouplingHalfCompoundPowerFlow):
    """ClutchHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3998.ClutchHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3998.ClutchHalfPowerFlow]':
