...
class ClutchConnectionCompoundPowerFlow(_4147.CouplingConnectionCompoundPowerFlow):
    """ClutchConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3997.ClutchConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3997.ClutchConnectionPowerFlow]':
