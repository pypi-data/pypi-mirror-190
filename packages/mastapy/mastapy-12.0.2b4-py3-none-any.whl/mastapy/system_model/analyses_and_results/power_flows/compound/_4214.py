...
class StraightBevelDiffGearCompoundPowerFlow(_4125.BevelGearCompoundPowerFlow):
    """StraightBevelDiffGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4085.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4085.StraightBevelDiffGearPowerFlow]':
