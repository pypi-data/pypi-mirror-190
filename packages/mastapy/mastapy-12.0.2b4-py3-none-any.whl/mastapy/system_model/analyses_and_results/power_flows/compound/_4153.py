...
class CycloidalDiscCentralBearingConnectionCompoundPowerFlow(_4133.CoaxialConnectionCompoundPowerFlow):
    """CycloidalDiscCentralBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4020.CycloidalDiscCentralBearingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4020.CycloidalDiscCentralBearingConnectionPowerFlow]':
