...
class MountableComponentCompoundPowerFlow(_4134.ComponentCompoundPowerFlow):
    """MountableComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4054.MountableComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4054.MountableComponentPowerFlow]':
