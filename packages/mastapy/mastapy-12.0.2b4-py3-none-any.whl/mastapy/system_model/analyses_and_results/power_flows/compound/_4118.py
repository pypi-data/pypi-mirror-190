...
class BeltConnectionCompoundPowerFlow(_4174.InterMountableComponentConnectionCompoundPowerFlow):
    """BeltConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3985.BeltConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3985.BeltConnectionPowerFlow]':
