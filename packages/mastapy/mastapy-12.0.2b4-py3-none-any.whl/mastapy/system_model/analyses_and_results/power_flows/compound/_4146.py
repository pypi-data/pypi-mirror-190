...
class CouplingCompoundPowerFlow(_4207.SpecialisedAssemblyCompoundPowerFlow):
    """CouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4015.CouplingPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4015.CouplingPowerFlow]':
