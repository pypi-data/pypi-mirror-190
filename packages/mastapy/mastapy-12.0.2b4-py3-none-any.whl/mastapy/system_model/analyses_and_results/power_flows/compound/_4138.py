...
class ConceptGearCompoundPowerFlow(_4167.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4006.ConceptGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4006.ConceptGearPowerFlow]':
