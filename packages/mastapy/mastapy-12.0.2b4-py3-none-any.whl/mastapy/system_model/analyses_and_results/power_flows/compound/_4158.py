...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4156, _4157, _4169
...
class CylindricalGearSetCompoundPowerFlow(_4169.GearSetCompoundPowerFlow):
    """CylindricalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4026.CylindricalGearSetPowerFlow]':
    ...
    @property
    def cylindrical_gears_compound_power_flow(self) -> 'List[_4156.CylindricalGearCompoundPowerFlow]':
    ...
    @property
    def cylindrical_meshes_compound_power_flow(self) -> 'List[_4157.CylindricalGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4026.CylindricalGearSetPowerFlow]':
