...
class SpecialisedAssemblyCompoundPowerFlow(_4109.AbstractAssemblyCompoundPowerFlow):
    """SpecialisedAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4077.SpecialisedAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4077.SpecialisedAssemblyPowerFlow]':
