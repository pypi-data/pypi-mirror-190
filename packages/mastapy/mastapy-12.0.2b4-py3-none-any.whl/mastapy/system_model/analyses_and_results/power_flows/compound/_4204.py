...
class ShaftCompoundPowerFlow(_4110.AbstractShaftCompoundPowerFlow):
    """ShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4075.ShaftPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4075.ShaftPowerFlow]':
