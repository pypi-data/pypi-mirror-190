...
class SpringDamperConnectionCompoundPowerFlow(_4147.CouplingConnectionCompoundPowerFlow):
    """SpringDamperConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4081.SpringDamperConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4081.SpringDamperConnectionPowerFlow]':
