...
class RollingRingCompoundPowerFlow(_4148.CouplingHalfCompoundPowerFlow):
    """RollingRingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4072.RollingRingPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4072.RollingRingPowerFlow]':
