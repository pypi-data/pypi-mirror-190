...
class SpiralBevelGearMeshCompoundPowerFlow(_4126.BevelGearMeshCompoundPowerFlow):
    """SpiralBevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4078.SpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4078.SpiralBevelGearMeshPowerFlow]':
