...
class WormGearCompoundPowerFlow(_4167.GearCompoundPowerFlow):
    """WormGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4104.WormGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4104.WormGearPowerFlow]':
