...
class ConicalGearCompoundPowerFlow(_4167.GearCompoundPowerFlow):
    """ConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4009.ConicalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4009.ConicalGearPowerFlow]':
