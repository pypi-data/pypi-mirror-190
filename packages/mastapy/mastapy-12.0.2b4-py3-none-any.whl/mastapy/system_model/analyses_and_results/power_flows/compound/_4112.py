...
class AbstractShaftToMountableComponentConnectionCompoundPowerFlow(_4144.ConnectionCompoundPowerFlow):
    """AbstractShaftToMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3979.AbstractShaftToMountableComponentConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3979.AbstractShaftToMountableComponentConnectionPowerFlow]':
