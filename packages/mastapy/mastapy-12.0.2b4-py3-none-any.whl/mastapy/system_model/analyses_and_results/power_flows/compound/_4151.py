...
class CVTPulleyCompoundPowerFlow(_4197.PulleyCompoundPowerFlow):
    """CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4018.CVTPulleyPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4018.CVTPulleyPowerFlow]':
