...
class SynchroniserSleeveCompoundPowerFlow(_4224.SynchroniserPartCompoundPowerFlow):
    """SynchroniserSleeveCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4095.SynchroniserSleevePowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4095.SynchroniserSleevePowerFlow]':
