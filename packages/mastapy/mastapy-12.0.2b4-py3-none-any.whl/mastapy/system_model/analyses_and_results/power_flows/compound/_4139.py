...
class ConceptGearMeshCompoundPowerFlow(_4168.GearMeshCompoundPowerFlow):
    """ConceptGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4005.ConceptGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4005.ConceptGearMeshPowerFlow]':
