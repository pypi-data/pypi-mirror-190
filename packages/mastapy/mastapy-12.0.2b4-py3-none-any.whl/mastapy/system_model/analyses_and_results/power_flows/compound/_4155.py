...
class CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow(_4112.AbstractShaftToMountableComponentConnectionCompoundPowerFlow):
    """CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4021.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4021.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
