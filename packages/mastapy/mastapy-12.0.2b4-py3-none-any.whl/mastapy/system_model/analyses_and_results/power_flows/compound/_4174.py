...
class InterMountableComponentConnectionCompoundPowerFlow(_4144.ConnectionCompoundPowerFlow):
    """InterMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4042.InterMountableComponentConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4042.InterMountableComponentConnectionPowerFlow]':
