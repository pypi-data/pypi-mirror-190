...
class BoltCompoundPowerFlow(_4134.ComponentCompoundPowerFlow):
    """BoltCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3996.BoltPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3996.BoltPowerFlow]':
