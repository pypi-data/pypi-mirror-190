...
from mastapy.system_model.analyses_and_results.power_flows import _4092, _4077
...
class SynchroniserPowerFlow(_4077.SpecialisedAssemblyPowerFlow):
    """SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_4092.SynchroniserHalfPowerFlow]':
