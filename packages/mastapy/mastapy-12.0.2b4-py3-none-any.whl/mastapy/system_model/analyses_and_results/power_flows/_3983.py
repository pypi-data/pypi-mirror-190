...
from mastapy.system_model.analyses_and_results.power_flows import (
    _3984, _3986, _3989, _3995,
    _3996, _4017, _3999, _4004,
    _4007, _4019, _4022, _4026,
    _4033, _4032, _4034, _4041,
    _4048, _4051, _4037, _4052,
    _4053, _4055, _4059, _4062,
    _4063, _4066, _4068, _4070,
    _4074, _4075, _4080, _4083,
    _4086, _4089, _4094, _4098,
    _4101, _4105, _4108, _3976
)
...
class AssemblyPowerFlow(_3976.AbstractAssemblyPowerFlow):
    """AssemblyPowerFlow
    ...
    @property
    def bearings(self) -> 'List[_3984.BearingPowerFlow]':
    ...
    @property
    def belt_drives(self) -> 'List[_3986.BeltDrivePowerFlow]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3989.BevelDifferentialGearSetPowerFlow]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3995.BoltedJointPowerFlow]':
    ...
    @property
    def bolts(self) -> 'List[_3996.BoltPowerFlow]':
    ...
    @property
    def cv_ts(self) -> 'List[_4017.CVTPowerFlow]':
    ...
    @property
    def clutches(self) -> 'List[_3999.ClutchPowerFlow]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4004.ConceptCouplingPowerFlow]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4007.ConceptGearSetPowerFlow]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4019.CycloidalAssemblyPowerFlow]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4022.CycloidalDiscPowerFlow]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4026.CylindricalGearSetPowerFlow]':
    ...
    @property
    def fe_parts(self) -> 'List[_4033.FEPartPowerFlow]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4032.FaceGearSetPowerFlow]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4034.FlexiblePinAssemblyPowerFlow]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4041.HypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4048.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4051.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_4037.GearSetPowerFlow]':
    ...
    @property
    def mass_discs(self) -> 'List[_4052.MassDiscPowerFlow]':
    ...
    @property
    def measurement_components(self) -> 'List[_4053.MeasurementComponentPowerFlow]':
    ...
    @property
    def oil_seals(self) -> 'List[_4055.OilSealPowerFlow]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4059.PartToPartShearCouplingPowerFlow]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4062.PlanetCarrierPowerFlow]':
    ...
    @property
    def point_loads(self) -> 'List[_4063.PointLoadPowerFlow]':
    ...
    @property
    def power_loads(self) -> 'List[_4066.PowerLoadPowerFlow]':
    ...
    @property
    def ring_pins(self) -> 'List[_4068.RingPinsPowerFlow]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4070.RollingRingAssemblyPowerFlow]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4074.ShaftHubConnectionPowerFlow]':
    ...
    @property
    def shafts(self) -> 'List[_4075.ShaftPowerFlow]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4080.SpiralBevelGearSetPowerFlow]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4083.SpringDamperPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4086.StraightBevelDiffGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4089.StraightBevelGearSetPowerFlow]':
    ...
    @property
    def synchronisers(self) -> 'List[_4094.SynchroniserPowerFlow]':
    ...
    @property
    def torque_converters(self) -> 'List[_4098.TorqueConverterPowerFlow]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4101.UnbalancedMassPowerFlow]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4105.WormGearSetPowerFlow]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4108.ZerolBevelGearSetPowerFlow]':
