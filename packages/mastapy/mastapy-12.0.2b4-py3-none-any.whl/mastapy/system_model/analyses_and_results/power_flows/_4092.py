...
from mastapy.system_model.analyses_and_results.power_flows import _3997, _4093
...
class SynchroniserHalfPowerFlow(_4093.SynchroniserPartPowerFlow):
    """SynchroniserHalfPowerFlow
    ...
    @property
    def clutch_connection(self) -> '_3997.ClutchConnectionPowerFlow':
