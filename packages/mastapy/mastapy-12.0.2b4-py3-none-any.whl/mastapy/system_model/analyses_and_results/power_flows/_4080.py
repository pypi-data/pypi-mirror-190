...
from mastapy.system_model.analyses_and_results.power_flows import _4079, _4078, _3994
...
class SpiralBevelGearSetPowerFlow(_3994.BevelGearSetPowerFlow):
    """SpiralBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4079.SpiralBevelGearPowerFlow]':
    ...
    @property
    def spiral_bevel_gears_power_flow(self) -> 'List[_4079.SpiralBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4078.SpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def spiral_bevel_meshes_power_flow(self) -> 'List[_4078.SpiralBevelGearMeshPowerFlow]':
