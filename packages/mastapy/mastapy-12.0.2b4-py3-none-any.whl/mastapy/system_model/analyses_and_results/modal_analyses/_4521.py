...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4522, _4524, _4527, _4533,
    _4534, _4556, _4537, _4542,
    _4545, _4558, _4560, _4564,
    _4573, _4572, _4574, _4582,
    _4589, _4592, _4593, _4594,
    _4599, _4604, _4607, _4608,
    _4609, _4611, _4613, _4617,
    _4618, _4624, _4627, _4630,
    _4633, _4637, _4641, _4644,
    _4651, _4654, _4514
)
...
class AssemblyModalAnalysis(_4514.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def bearings(self) -> 'List[_4522.BearingModalAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_4524.BeltDriveModalAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4527.BevelDifferentialGearSetModalAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4533.BoltedJointModalAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_4534.BoltModalAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_4556.CVTModalAnalysis]':
    ...
    @property
    def calculate_full_fe_results_by_mode(self) -> 'List[_4655.CalculateFullFEResultsForMode]':
    ...
    @property
    def clutches(self) -> 'List[_4537.ClutchModalAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4542.ConceptCouplingModalAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4545.ConceptGearSetModalAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4558.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4560.CycloidalDiscModalAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4564.CylindricalGearSetModalAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_4573.FEPartModalAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4572.FaceGearSetModalAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4574.FlexiblePinAssemblyModalAnalysis]':
    ...
    @property
    def full_fe_meshes_for_calculating_modes(self) -> 'List[_4573.FEPartModalAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4582.HypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4589.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4592.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_4593.MassDiscModalAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_4594.MeasurementComponentModalAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_4599.OilSealModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4604.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4607.PlanetCarrierModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4608.PointLoadModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4609.PowerLoadModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4611.RingPinsModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4613.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4617.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4618.ShaftModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4624.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4627.SpringDamperModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4630.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4633.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4637.SynchroniserModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4641.TorqueConverterModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4644.UnbalancedMassModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4651.WormGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4654.ZerolBevelGearSetModalAnalysis]':
