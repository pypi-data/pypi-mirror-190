...
from mastapy.system_model.analyses_and_results.modal_analyses import _4653, _4652, _4532
...
class ZerolBevelGearSetModalAnalysis(_4532.BevelGearSetModalAnalysis):
    """ZerolBevelGearSetModalAnalysis
    ...
    @property
    def zerol_bevel_gears_modal_analysis(self) -> 'List[_4653.ZerolBevelGearModalAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis(self) -> 'List[_4652.ZerolBevelGearMeshModalAnalysis]':
