...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def chart_type(self) -> '_4567.DynamicsResponse3DChartType':
        ...
        return constructor.new_from_mastapy_type(_4567.DynamicsResponse3DChartType)(value) if value is not None else None

    @chart_type.setter
    def chart_type(self, value: '_4567.DynamicsResponse3DChartType'):
    ...
    @property
    def connected_component_type(self) -> '_5773.ConnectedComponentType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5773.ConnectedComponentType)(value) if value is not None else None

    @connected_component_type.setter
    def connected_component_type(self, value: '_5773.ConnectedComponentType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ConnectedComponentType = value

    @property
    def coordinate_system(self) -> '_4551.CoordinateSystemForWhine':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_4551.CoordinateSystemForWhine)(value) if value is not None else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4551.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def whine_waterfall_export_option(self) -> '_4647.WhineWaterfallExportOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_4647.WhineWaterfallExportOption)(value) if value is not None else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4647.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def frequency_options(self) -> '_5686.FrequencyOptionsForHarmonicAnalysisResults':
    ...
    @property
    def modal_contribution_view_options(self) -> '_2215.ModalContributionViewOptions':
    ...
    @property
    def mode_view_options(self) -> '_2213.AdvancedTimeSteppingAnalysisForModulationModeViewOptions':
    ...
    @property
    def order_cuts_chart_settings(self) -> '_4600.OrderCutsChartSettings':
    ...
    @property
    def reference_speed_options(self) -> '_5741.SpeedOptionsForHarmonicAnalysisResults':
    ...
    @property
    def result_location_selection_groups(self) -> '_5781.ResultLocationSelectionGroups':
    ...
    @property
    def selected_excitations(self) -> '_5776.ExcitationSourceSelectionGroup':
    ...
    @property
    def waterfall_chart_settings(self) -> '_4646.WaterfallChartSettings':
    ...
    @property
    def active_result_locations(self) -> 'List[_5782.ResultNodeSelection]':
    ...
    @property
    def degrees_of_freedom(self) -> 'List[_1805.EnumWithBool[_1490.ResultOptionsFor3DVector]]':
