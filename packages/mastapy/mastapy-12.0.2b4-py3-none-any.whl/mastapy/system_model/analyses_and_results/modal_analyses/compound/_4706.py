...
class CouplingHalfCompoundModalAnalysis(_4744.MountableComponentCompoundModalAnalysis):
    """CouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4553.CouplingHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4553.CouplingHalfModalAnalysis]':
