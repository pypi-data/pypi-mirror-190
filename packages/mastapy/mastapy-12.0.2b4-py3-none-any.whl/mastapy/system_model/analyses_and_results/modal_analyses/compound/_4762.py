...
class ShaftCompoundModalAnalysis(_4668.AbstractShaftCompoundModalAnalysis):
    """ShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4618.ShaftModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4618.ShaftModalAnalysis]':
