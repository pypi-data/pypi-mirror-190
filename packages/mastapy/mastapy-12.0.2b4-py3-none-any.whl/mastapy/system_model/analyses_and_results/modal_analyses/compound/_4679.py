...
class BevelDifferentialGearMeshCompoundModalAnalysis(_4684.BevelGearMeshCompoundModalAnalysis):
    """BevelDifferentialGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4525.BevelDifferentialGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4525.BevelDifferentialGearMeshModalAnalysis]':
