...
class CylindricalPlanetGearCompoundModalAnalysis(_4714.CylindricalGearCompoundModalAnalysis):
    """CylindricalPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4565.CylindricalPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4565.CylindricalPlanetGearModalAnalysis]':
