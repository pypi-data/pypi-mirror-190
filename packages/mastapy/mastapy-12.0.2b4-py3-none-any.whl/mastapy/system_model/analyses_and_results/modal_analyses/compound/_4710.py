...
class CycloidalAssemblyCompoundModalAnalysis(_4765.SpecialisedAssemblyCompoundModalAnalysis):
    """CycloidalAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4558.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4558.CycloidalAssemblyModalAnalysis]':
