...
class AbstractAssemblyCompoundModalAnalysis(_4746.PartCompoundModalAnalysis):
    """AbstractAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4514.AbstractAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4514.AbstractAssemblyModalAnalysis]':
