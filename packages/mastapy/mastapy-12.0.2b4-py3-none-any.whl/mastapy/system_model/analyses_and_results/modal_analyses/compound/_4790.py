...
class WormGearCompoundModalAnalysis(_4725.GearCompoundModalAnalysis):
    """WormGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4650.WormGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4650.WormGearModalAnalysis]':
