...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis(_4734.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4590.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4590.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
