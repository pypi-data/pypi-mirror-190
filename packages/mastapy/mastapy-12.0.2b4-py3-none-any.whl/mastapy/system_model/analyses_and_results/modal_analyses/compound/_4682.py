...
class BevelDifferentialSunGearCompoundModalAnalysis(_4678.BevelDifferentialGearCompoundModalAnalysis):
    """BevelDifferentialSunGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4529.BevelDifferentialSunGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4529.BevelDifferentialSunGearModalAnalysis]':
