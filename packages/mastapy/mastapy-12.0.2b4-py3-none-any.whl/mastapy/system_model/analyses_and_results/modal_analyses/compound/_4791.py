...
class WormGearMeshCompoundModalAnalysis(_4726.GearMeshCompoundModalAnalysis):
    """WormGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4649.WormGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4649.WormGearMeshModalAnalysis]':
