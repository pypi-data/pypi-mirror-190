...
class CylindricalGearMeshCompoundModalAnalysis(_4726.GearMeshCompoundModalAnalysis):
    """CylindricalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4562.CylindricalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4562.CylindricalGearMeshModalAnalysis]':
