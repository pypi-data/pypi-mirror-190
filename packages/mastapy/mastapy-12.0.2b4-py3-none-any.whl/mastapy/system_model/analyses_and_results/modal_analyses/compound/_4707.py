...
class CVTBeltConnectionCompoundModalAnalysis(_4676.BeltConnectionCompoundModalAnalysis):
    """CVTBeltConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4555.CVTBeltConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4555.CVTBeltConnectionModalAnalysis]':
