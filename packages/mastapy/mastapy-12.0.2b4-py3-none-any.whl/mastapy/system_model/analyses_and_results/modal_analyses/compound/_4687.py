...
class BoltedJointCompoundModalAnalysis(_4765.SpecialisedAssemblyCompoundModalAnalysis):
    """BoltedJointCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4533.BoltedJointModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4533.BoltedJointModalAnalysis]':
