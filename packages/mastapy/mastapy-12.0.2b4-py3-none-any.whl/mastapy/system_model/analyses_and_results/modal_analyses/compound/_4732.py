...
class InterMountableComponentConnectionCompoundModalAnalysis(_4702.ConnectionCompoundModalAnalysis):
    """InterMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4583.InterMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4583.InterMountableComponentConnectionModalAnalysis]':
