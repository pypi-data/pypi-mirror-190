...
class CVTPulleyCompoundModalAnalysis(_4755.PulleyCompoundModalAnalysis):
    """CVTPulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4557.CVTPulleyModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4557.CVTPulleyModalAnalysis]':
