...
class KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis(_4699.ConicalGearCompoundModalAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4585.KlingelnbergCycloPalloidConicalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4585.KlingelnbergCycloPalloidConicalGearModalAnalysis]':
