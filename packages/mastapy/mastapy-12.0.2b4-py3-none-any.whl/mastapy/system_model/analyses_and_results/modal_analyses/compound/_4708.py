...
class CVTCompoundModalAnalysis(_4677.BeltDriveCompoundModalAnalysis):
    """CVTCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4556.CVTModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4556.CVTModalAnalysis]':
