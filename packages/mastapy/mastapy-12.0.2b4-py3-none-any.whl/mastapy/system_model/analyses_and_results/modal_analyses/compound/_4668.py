...
class AbstractShaftCompoundModalAnalysis(_4669.AbstractShaftOrHousingCompoundModalAnalysis):
    """AbstractShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4515.AbstractShaftModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4515.AbstractShaftModalAnalysis]':
