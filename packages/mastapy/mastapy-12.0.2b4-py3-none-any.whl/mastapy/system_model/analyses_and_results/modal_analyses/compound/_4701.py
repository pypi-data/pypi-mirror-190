...
class ConicalGearSetCompoundModalAnalysis(_4727.GearSetCompoundModalAnalysis):
    """ConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4548.ConicalGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4548.ConicalGearSetModalAnalysis]':
