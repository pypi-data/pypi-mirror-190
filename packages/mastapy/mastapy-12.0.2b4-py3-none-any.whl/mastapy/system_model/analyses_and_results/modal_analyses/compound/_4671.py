...
class AGMAGleasonConicalGearCompoundModalAnalysis(_4699.ConicalGearCompoundModalAnalysis):
    """AGMAGleasonConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4519.AGMAGleasonConicalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4519.AGMAGleasonConicalGearModalAnalysis]':
