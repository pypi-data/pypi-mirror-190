...
class ConnectionCompoundModalAnalysis(_7463.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4549.ConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4549.ConnectionModalAnalysis]':
