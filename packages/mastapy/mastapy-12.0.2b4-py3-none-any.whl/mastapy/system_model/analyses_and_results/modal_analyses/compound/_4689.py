...
class ClutchConnectionCompoundModalAnalysis(_4705.CouplingConnectionCompoundModalAnalysis):
    """ClutchConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4535.ClutchConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4535.ClutchConnectionModalAnalysis]':
