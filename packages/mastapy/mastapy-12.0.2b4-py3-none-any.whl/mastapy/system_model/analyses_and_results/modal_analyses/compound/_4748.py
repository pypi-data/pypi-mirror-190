...
class PartToPartShearCouplingConnectionCompoundModalAnalysis(_4705.CouplingConnectionCompoundModalAnalysis):
    """PartToPartShearCouplingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4602.PartToPartShearCouplingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4602.PartToPartShearCouplingConnectionModalAnalysis]':
