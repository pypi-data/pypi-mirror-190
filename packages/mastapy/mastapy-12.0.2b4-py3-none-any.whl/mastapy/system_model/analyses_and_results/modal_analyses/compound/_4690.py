...
class ClutchHalfCompoundModalAnalysis(_4706.CouplingHalfCompoundModalAnalysis):
    """ClutchHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4536.ClutchHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4536.ClutchHalfModalAnalysis]':
