...
class GuideDxfModelCompoundModalAnalysis(_4692.ComponentCompoundModalAnalysis):
    """GuideDxfModelCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4579.GuideDxfModelModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4579.GuideDxfModelModalAnalysis]':
