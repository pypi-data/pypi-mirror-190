...
class GearCompoundModalAnalysis(_4744.MountableComponentCompoundModalAnalysis):
    """GearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4577.GearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4577.GearModalAnalysis]':
