...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4678, _4679, _4685
...
class BevelDifferentialGearSetCompoundModalAnalysis(_4685.BevelGearSetCompoundModalAnalysis):
    """BevelDifferentialGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4527.BevelDifferentialGearSetModalAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis(self) -> 'List[_4678.BevelDifferentialGearCompoundModalAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis(self) -> 'List[_4679.BevelDifferentialGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4527.BevelDifferentialGearSetModalAnalysis]':
