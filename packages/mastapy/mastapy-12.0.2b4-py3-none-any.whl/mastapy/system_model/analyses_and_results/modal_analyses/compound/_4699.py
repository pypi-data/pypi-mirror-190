...
class ConicalGearCompoundModalAnalysis(_4725.GearCompoundModalAnalysis):
    """ConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4547.ConicalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4547.ConicalGearModalAnalysis]':
