...
class CouplingCompoundModalAnalysis(_4765.SpecialisedAssemblyCompoundModalAnalysis):
    """CouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4554.CouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4554.CouplingModalAnalysis]':
