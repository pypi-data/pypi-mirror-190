...
from mastapy.system_model.analyses_and_results.modal_analyses import _4526, _4525, _4532
...
class BevelDifferentialGearSetModalAnalysis(_4532.BevelGearSetModalAnalysis):
    """BevelDifferentialGearSetModalAnalysis
    ...
    @property
    def bevel_differential_gears_modal_analysis(self) -> 'List[_4526.BevelDifferentialGearModalAnalysis]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis(self) -> 'List[_4525.BevelDifferentialGearMeshModalAnalysis]':
