...
from mastapy.system_model.analyses_and_results.modal_analyses import _4632, _4631, _4532
...
class StraightBevelGearSetModalAnalysis(_4532.BevelGearSetModalAnalysis):
    """StraightBevelGearSetModalAnalysis
    ...
    @property
    def straight_bevel_gears_modal_analysis(self) -> 'List[_4632.StraightBevelGearModalAnalysis]':
    ...
    @property
    def straight_bevel_meshes_modal_analysis(self) -> 'List[_4631.StraightBevelGearMeshModalAnalysis]':
