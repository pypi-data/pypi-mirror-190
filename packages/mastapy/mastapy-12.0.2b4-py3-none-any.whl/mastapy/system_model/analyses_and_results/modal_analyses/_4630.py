...
from mastapy.system_model.analyses_and_results.modal_analyses import _4629, _4628, _4532
...
class StraightBevelDiffGearSetModalAnalysis(_4532.BevelGearSetModalAnalysis):
    """StraightBevelDiffGearSetModalAnalysis
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis(self) -> 'List[_4629.StraightBevelDiffGearModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_modal_analysis(self) -> 'List[_4628.StraightBevelDiffGearMeshModalAnalysis]':
