...
class TorqueConverterPumpCompoundStabilityAnalysis(_3880.CouplingHalfCompoundStabilityAnalysis):
    """TorqueConverterPumpCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3830.TorqueConverterPumpStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3830.TorqueConverterPumpStabilityAnalysis]':
