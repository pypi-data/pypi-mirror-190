...
class PointLoadCompoundStabilityAnalysis(_3963.VirtualComponentCompoundStabilityAnalysis):
    """PointLoadCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3796.PointLoadStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3796.PointLoadStabilityAnalysis]':
