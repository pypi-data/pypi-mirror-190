...
class PowerLoadCompoundStabilityAnalysis(_3963.VirtualComponentCompoundStabilityAnalysis):
    """PowerLoadCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3797.PowerLoadStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3797.PowerLoadStabilityAnalysis]':
