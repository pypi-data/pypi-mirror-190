...
class ConceptCouplingConnectionCompoundStabilityAnalysis(_3879.CouplingConnectionCompoundStabilityAnalysis):
    """ConceptCouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3735.ConceptCouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3735.ConceptCouplingConnectionStabilityAnalysis]':
