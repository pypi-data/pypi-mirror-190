...
class CycloidalDiscCompoundStabilityAnalysis(_3842.AbstractShaftCompoundStabilityAnalysis):
    """CycloidalDiscCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3756.CycloidalDiscStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3756.CycloidalDiscStabilityAnalysis]':
