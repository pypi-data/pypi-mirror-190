...
class RollingRingCompoundStabilityAnalysis(_3880.CouplingHalfCompoundStabilityAnalysis):
    """RollingRingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3803.RollingRingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3803.RollingRingStabilityAnalysis]':
