...
class HypoidGearCompoundStabilityAnalysis(_3845.AGMAGleasonConicalGearCompoundStabilityAnalysis):
    """HypoidGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3774.HypoidGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3774.HypoidGearStabilityAnalysis]':
