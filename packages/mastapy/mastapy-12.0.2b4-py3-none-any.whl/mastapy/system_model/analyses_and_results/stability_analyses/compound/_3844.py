...
class AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis(_3876.ConnectionCompoundStabilityAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3712.AbstractShaftToMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3712.AbstractShaftToMountableComponentConnectionStabilityAnalysis]':
