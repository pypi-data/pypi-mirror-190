...
class GearCompoundStabilityAnalysis(_3918.MountableComponentCompoundStabilityAnalysis):
    """GearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3770.GearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3770.GearStabilityAnalysis]':
