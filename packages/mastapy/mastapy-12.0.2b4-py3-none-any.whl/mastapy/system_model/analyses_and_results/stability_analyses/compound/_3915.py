...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3913, _3914, _3909
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundStabilityAnalysis(_3909.KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3783.KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_stability_analysis(self) -> 'List[_3913.KlingelnbergCycloPalloidSpiralBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_stability_analysis(self) -> 'List[_3914.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3783.KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis]':
