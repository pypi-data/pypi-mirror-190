...
class ClutchConnectionCompoundStabilityAnalysis(_3879.CouplingConnectionCompoundStabilityAnalysis):
    """ClutchConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3730.ClutchConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3730.ClutchConnectionStabilityAnalysis]':
