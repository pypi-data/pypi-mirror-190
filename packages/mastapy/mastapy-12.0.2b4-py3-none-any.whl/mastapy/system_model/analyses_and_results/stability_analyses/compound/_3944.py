...
class SpringDamperConnectionCompoundStabilityAnalysis(_3879.CouplingConnectionCompoundStabilityAnalysis):
    """SpringDamperConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3812.SpringDamperConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3812.SpringDamperConnectionStabilityAnalysis]':
