...
class GuideDxfModelCompoundStabilityAnalysis(_3866.ComponentCompoundStabilityAnalysis):
    """GuideDxfModelCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3771.GuideDxfModelStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3771.GuideDxfModelStabilityAnalysis]':
