...
class VirtualComponentCompoundStabilityAnalysis(_3918.MountableComponentCompoundStabilityAnalysis):
    """VirtualComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3834.VirtualComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3834.VirtualComponentStabilityAnalysis]':
