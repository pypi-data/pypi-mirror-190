...
class HypoidGearMeshCompoundStabilityAnalysis(_3846.AGMAGleasonConicalGearMeshCompoundStabilityAnalysis):
    """HypoidGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3772.HypoidGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3772.HypoidGearMeshStabilityAnalysis]':
