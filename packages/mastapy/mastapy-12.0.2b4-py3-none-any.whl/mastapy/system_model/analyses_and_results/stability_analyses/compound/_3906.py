...
class InterMountableComponentConnectionCompoundStabilityAnalysis(_3876.ConnectionCompoundStabilityAnalysis):
    """InterMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3775.InterMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3775.InterMountableComponentConnectionStabilityAnalysis]':
