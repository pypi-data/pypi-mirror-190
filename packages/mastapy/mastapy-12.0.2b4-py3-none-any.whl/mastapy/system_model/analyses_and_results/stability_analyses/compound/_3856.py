...
class BevelDifferentialSunGearCompoundStabilityAnalysis(_3852.BevelDifferentialGearCompoundStabilityAnalysis):
    """BevelDifferentialSunGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3724.BevelDifferentialSunGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3724.BevelDifferentialSunGearStabilityAnalysis]':
