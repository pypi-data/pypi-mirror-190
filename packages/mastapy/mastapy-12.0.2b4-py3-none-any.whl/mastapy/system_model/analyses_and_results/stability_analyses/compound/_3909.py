...
class KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis(_3875.ConicalGearSetCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3777.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3777.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis]':
