...
class SynchroniserPartCompoundStabilityAnalysis(_3880.CouplingHalfCompoundStabilityAnalysis):
    """SynchroniserPartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3826.SynchroniserPartStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3826.SynchroniserPartStabilityAnalysis]':
