...
class ConicalGearCompoundStabilityAnalysis(_3899.GearCompoundStabilityAnalysis):
    """ConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3743.ConicalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3743.ConicalGearStabilityAnalysis]':
