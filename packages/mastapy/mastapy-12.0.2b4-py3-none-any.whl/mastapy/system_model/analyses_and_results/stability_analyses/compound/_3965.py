...
class WormGearMeshCompoundStabilityAnalysis(_3900.GearMeshCompoundStabilityAnalysis):
    """WormGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3835.WormGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3835.WormGearMeshStabilityAnalysis]':
