...
class AbstractAssemblyCompoundStabilityAnalysis(_3920.PartCompoundStabilityAnalysis):
    """AbstractAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3709.AbstractAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3709.AbstractAssemblyStabilityAnalysis]':
