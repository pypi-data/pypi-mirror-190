...
class BevelDifferentialGearCompoundStabilityAnalysis(_3857.BevelGearCompoundStabilityAnalysis):
    """BevelDifferentialGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3722.BevelDifferentialGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3722.BevelDifferentialGearStabilityAnalysis]':
