...
class TorqueConverterCompoundStabilityAnalysis(_3878.CouplingCompoundStabilityAnalysis):
    """TorqueConverterCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3831.TorqueConverterStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3831.TorqueConverterStabilityAnalysis]':
