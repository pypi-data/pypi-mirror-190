...
class RingPinsCompoundStabilityAnalysis(_3918.MountableComponentCompoundStabilityAnalysis):
    """RingPinsCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3799.RingPinsStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3799.RingPinsStabilityAnalysis]':
