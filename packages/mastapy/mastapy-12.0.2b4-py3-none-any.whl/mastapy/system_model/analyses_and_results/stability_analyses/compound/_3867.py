...
class ConceptCouplingCompoundStabilityAnalysis(_3878.CouplingCompoundStabilityAnalysis):
    """ConceptCouplingCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3737.ConceptCouplingStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3737.ConceptCouplingStabilityAnalysis]':
