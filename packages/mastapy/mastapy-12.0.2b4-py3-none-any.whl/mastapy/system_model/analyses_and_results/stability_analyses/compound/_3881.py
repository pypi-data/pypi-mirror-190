...
class CVTBeltConnectionCompoundStabilityAnalysis(_3850.BeltConnectionCompoundStabilityAnalysis):
    """CVTBeltConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3750.CVTBeltConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3750.CVTBeltConnectionStabilityAnalysis]':
