...
class ShaftToMountableComponentConnectionCompoundStabilityAnalysis(_3844.AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """ShaftToMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3807.ShaftToMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3807.ShaftToMountableComponentConnectionStabilityAnalysis]':
