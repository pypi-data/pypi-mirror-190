...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import (
    _3849, _3851, _3854, _3861,
    _3860, _3882, _3862, _3867,
    _3872, _3884, _3886, _3890,
    _3897, _3896, _3898, _3905,
    _3912, _3915, _3916, _3917,
    _3919, _3921, _3926, _3927,
    _3928, _3930, _3932, _3937,
    _3936, _3942, _3943, _3948,
    _3951, _3954, _3958, _3962,
    _3966, _3969, _3841
)
...
class AssemblyCompoundStabilityAnalysis(_3841.AbstractAssemblyCompoundStabilityAnalysis):
    """AssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3716.AssemblyStabilityAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_3849.BearingCompoundStabilityAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_3851.BeltDriveCompoundStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3854.BevelDifferentialGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3861.BoltedJointCompoundStabilityAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_3860.BoltCompoundStabilityAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_3882.CVTCompoundStabilityAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_3862.ClutchCompoundStabilityAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3867.ConceptCouplingCompoundStabilityAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3872.ConceptGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3884.CycloidalAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3886.CycloidalDiscCompoundStabilityAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3890.CylindricalGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_3897.FEPartCompoundStabilityAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3896.FaceGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3898.FlexiblePinAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3905.HypoidGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3912.KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3915.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_3916.MassDiscCompoundStabilityAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_3917.MeasurementComponentCompoundStabilityAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_3919.OilSealCompoundStabilityAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3921.PartToPartShearCouplingCompoundStabilityAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3926.PlanetCarrierCompoundStabilityAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_3927.PointLoadCompoundStabilityAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_3928.PowerLoadCompoundStabilityAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_3930.RingPinsCompoundStabilityAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3932.RollingRingAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3937.ShaftHubConnectionCompoundStabilityAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_3936.ShaftCompoundStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3942.SpiralBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3943.SpringDamperCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3948.StraightBevelDiffGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3951.StraightBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_3954.SynchroniserCompoundStabilityAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_3958.TorqueConverterCompoundStabilityAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3962.UnbalancedMassCompoundStabilityAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3966.WormGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3969.ZerolBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3716.AssemblyStabilityAnalysis]':
