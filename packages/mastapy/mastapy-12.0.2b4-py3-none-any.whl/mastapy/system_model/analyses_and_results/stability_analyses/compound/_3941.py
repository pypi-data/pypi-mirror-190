...
class SpiralBevelGearMeshCompoundStabilityAnalysis(_3858.BevelGearMeshCompoundStabilityAnalysis):
    """SpiralBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3809.SpiralBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3809.SpiralBevelGearMeshStabilityAnalysis]':
