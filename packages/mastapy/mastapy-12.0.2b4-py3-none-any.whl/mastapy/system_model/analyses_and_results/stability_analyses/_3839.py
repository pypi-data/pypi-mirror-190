...
from mastapy.system_model.analyses_and_results.stability_analyses import _3840, _3838, _3726
...
class ZerolBevelGearSetStabilityAnalysis(_3726.BevelGearSetStabilityAnalysis):
    """ZerolBevelGearSetStabilityAnalysis
    ...
    @property
    def zerol_bevel_gears_stability_analysis(self) -> 'List[_3840.ZerolBevelGearStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_stability_analysis(self) -> 'List[_3838.ZerolBevelGearMeshStabilityAnalysis]':
