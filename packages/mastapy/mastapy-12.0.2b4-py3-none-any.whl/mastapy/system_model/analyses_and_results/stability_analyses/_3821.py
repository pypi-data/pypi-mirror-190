...
from mastapy.system_model.analyses_and_results.stability_analyses import _3822, _3820, _3726
...
class StraightBevelGearSetStabilityAnalysis(_3726.BevelGearSetStabilityAnalysis):
    """StraightBevelGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_gears_stability_analysis(self) -> 'List[_3822.StraightBevelGearStabilityAnalysis]':
    ...
    @property
    def straight_bevel_meshes_stability_analysis(self) -> 'List[_3820.StraightBevelGearMeshStabilityAnalysis]':
