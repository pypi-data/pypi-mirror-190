...
from mastapy.system_model.analyses_and_results.stability_analyses import _3749, _3711
...
class ShaftStabilityAnalysis(_3711.AbstractShaftStabilityAnalysis):
    """ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self) -> 'List[_3749.CriticalSpeed]':
