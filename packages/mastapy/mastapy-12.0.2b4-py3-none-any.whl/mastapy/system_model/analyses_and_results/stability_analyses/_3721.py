...
from mastapy.system_model.analyses_and_results.stability_analyses import _3722, _3720, _3726
...
class BevelDifferentialGearSetStabilityAnalysis(_3726.BevelGearSetStabilityAnalysis):
    """BevelDifferentialGearSetStabilityAnalysis
    ...
    @property
    def bevel_differential_gears_stability_analysis(self) -> 'List[_3722.BevelDifferentialGearStabilityAnalysis]':
    ...
    @property
    def bevel_differential_meshes_stability_analysis(self) -> 'List[_3720.BevelDifferentialGearMeshStabilityAnalysis]':
