...
from mastapy.system_model.analyses_and_results.stability_analyses import _3781, _3779, _3777
...
class KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis(_3777.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_stability_analysis(self) -> 'List[_3781.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_stability_analysis(self) -> 'List[_3779.KlingelnbergCycloPalloidHypoidGearMeshStabilityAnalysis]':
