...
class PartToPartShearCouplingHalfAdvancedTimeSteppingAnalysisForModulation(_6974.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """PartToPartShearCouplingHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2733.PartToPartShearCouplingHalfSystemDeflection':
