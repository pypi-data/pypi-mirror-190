...
from mastapy.system_model.analyses_and_results.static_loads import (
    _6739, _6731, _6821, _6742,
    _6751, _6756, _6769, _6774,
    _6791, _6812, _6833, _6840,
    _6843, _6846, _6859, _6881,
    _6887, _6890, _6910, _6913
)
...
class AdvancedTimeSteppingAnalysisForModulationOptions(_0.APIBase):
    ...
    @property
    def advanced_time_stepping_analysis_method(self) -> '_6739.AdvancedTimeSteppingAnalysisForModulationType':
        ...
        return constructor.new_from_mastapy_type(_6739.AdvancedTimeSteppingAnalysisForModulationType)(value) if value is not None else None

    @advanced_time_stepping_analysis_method.setter
    def advanced_time_stepping_analysis_method(self, value: '_6739.AdvancedTimeSteppingAnalysisForModulationType'):
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation(self) -> '_6821.GearSetLoadCase':
        ...
        if _6821.GearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_agma_gleason_conical_gear_set_load_case(self) -> '_6742.AGMAGleasonConicalGearSetLoadCase':
        ...
        if _6742.AGMAGleasonConicalGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_bevel_differential_gear_set_load_case(self) -> '_6751.BevelDifferentialGearSetLoadCase':
        ...
        if _6751.BevelDifferentialGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_bevel_gear_set_load_case(self) -> '_6756.BevelGearSetLoadCase':
        ...
        if _6756.BevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_concept_gear_set_load_case(self) -> '_6769.ConceptGearSetLoadCase':
        ...
        if _6769.ConceptGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_conical_gear_set_load_case(self) -> '_6774.ConicalGearSetLoadCase':
        ...
        if _6774.ConicalGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_cylindrical_gear_set_load_case(self) -> '_6791.CylindricalGearSetLoadCase':
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_face_gear_set_load_case(self) -> '_6812.FaceGearSetLoadCase':
        ...
        if _6812.FaceGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_hypoid_gear_set_load_case(self) -> '_6833.HypoidGearSetLoadCase':
        ...
        if _6833.HypoidGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_klingelnberg_cyclo_palloid_conical_gear_set_load_case(self) -> '_6840.KlingelnbergCycloPalloidConicalGearSetLoadCase':
        ...
        if _6840.KlingelnbergCycloPalloidConicalGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_load_case(self) -> '_6843.KlingelnbergCycloPalloidHypoidGearSetLoadCase':
        ...
        if _6843.KlingelnbergCycloPalloidHypoidGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_load_case(self) -> '_6846.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase':
        ...
        if _6846.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_planetary_gear_set_load_case(self) -> '_6859.PlanetaryGearSetLoadCase':
        ...
        if _6859.PlanetaryGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_spiral_bevel_gear_set_load_case(self) -> '_6881.SpiralBevelGearSetLoadCase':
        ...
        if _6881.SpiralBevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_straight_bevel_diff_gear_set_load_case(self) -> '_6887.StraightBevelDiffGearSetLoadCase':
        ...
        if _6887.StraightBevelDiffGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_straight_bevel_gear_set_load_case(self) -> '_6890.StraightBevelGearSetLoadCase':
        ...
        if _6890.StraightBevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_worm_gear_set_load_case(self) -> '_6910.WormGearSetLoadCase':
        ...
        if _6910.WormGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_zerol_bevel_gear_set_load_case(self) -> '_6913.ZerolBevelGearSetLoadCase':
        ...
        if _6913.ZerolBevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def time_options(self) -> '_2635.TimeOptions':
