...
class StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation(_6952.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6886.StraightBevelDiffGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2759.StraightBevelDiffGearMeshSystemDeflection':
