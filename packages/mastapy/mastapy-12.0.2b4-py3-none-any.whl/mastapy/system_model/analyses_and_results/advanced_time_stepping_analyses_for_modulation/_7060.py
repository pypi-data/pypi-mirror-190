...
class WormGearMeshAdvancedTimeSteppingAnalysisForModulation(_6994.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    """WormGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6909.WormGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2782.WormGearMeshSystemDeflection':
