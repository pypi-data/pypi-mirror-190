...
class SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation(_7051.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2767.SynchroniserHalfSystemDeflection':
