...
class TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation(_6974.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6901.TorqueConverterTurbineLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2777.TorqueConverterTurbineSystemDeflection':
