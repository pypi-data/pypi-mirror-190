...
class SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation(_6973.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2756.SpringDamperConnectionSystemDeflection':
