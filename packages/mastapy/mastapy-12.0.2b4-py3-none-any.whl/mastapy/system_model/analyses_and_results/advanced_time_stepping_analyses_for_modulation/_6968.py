...
class ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation(_6994.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    """ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2670.ConicalGearMeshSystemDeflection':
