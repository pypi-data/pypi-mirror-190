...
class BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation(_6952.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2647.BevelDifferentialGearMeshSystemDeflection':
