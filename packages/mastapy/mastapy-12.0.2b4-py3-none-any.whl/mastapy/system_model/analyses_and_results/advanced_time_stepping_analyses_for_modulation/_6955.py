...
class BoltedJointAdvancedTimeSteppingAnalysisForModulation(_7034.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """BoltedJointAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6757.BoltedJointLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2655.BoltedJointSystemDeflection':
