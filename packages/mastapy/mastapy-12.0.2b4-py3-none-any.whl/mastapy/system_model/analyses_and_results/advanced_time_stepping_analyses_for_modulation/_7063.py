...
class ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6952.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6912.ZerolBevelGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2785.ZerolBevelGearMeshSystemDeflection':
