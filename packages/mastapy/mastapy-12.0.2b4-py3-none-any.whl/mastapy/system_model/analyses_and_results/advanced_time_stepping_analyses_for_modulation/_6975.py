...
class CVTAdvancedTimeSteppingAnalysisForModulation(_6945.BeltDriveAdvancedTimeSteppingAnalysisForModulation):
    """CVTAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_design(self) -> '_2537.CVT':
    ...
    @property
    def system_deflection_results(self) -> '_2680.CVTSystemDeflection':
