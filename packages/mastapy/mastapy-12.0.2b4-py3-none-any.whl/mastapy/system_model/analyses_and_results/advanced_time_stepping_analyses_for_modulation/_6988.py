...
class FaceGearAdvancedTimeSteppingAnalysisForModulation(_6993.GearAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2702.FaceGearSystemDeflection':
