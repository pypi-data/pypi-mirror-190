...
class SynchroniserSleeveCompoundAdvancedTimeSteppingAnalysisForModulation(_7180.SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserSleeveCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7052.SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7052.SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation]':
