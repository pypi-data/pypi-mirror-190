...
class CycloidalAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_7163.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2519.CycloidalAssembly':
    ...
    @property
    def assembly_design(self) -> '_2519.CycloidalAssembly':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6978.CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6978.CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation]':
