...
class TorqueConverterConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7103.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2304.TorqueConverterConnection':
    ...
    @property
    def connection_design(self) -> '_2304.TorqueConverterConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7054.TorqueConverterConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7054.TorqueConverterConnectionAdvancedTimeSteppingAnalysisForModulation]':
