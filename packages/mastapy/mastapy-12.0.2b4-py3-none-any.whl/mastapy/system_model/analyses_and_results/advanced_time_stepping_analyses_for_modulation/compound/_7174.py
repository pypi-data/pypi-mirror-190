...
class StraightBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7082.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2279.StraightBevelGearMesh':
    ...
    @property
    def connection_design(self) -> '_2279.StraightBevelGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7045.StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7045.StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
