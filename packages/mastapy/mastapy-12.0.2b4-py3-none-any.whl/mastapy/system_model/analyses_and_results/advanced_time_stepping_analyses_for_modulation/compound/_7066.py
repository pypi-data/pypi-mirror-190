...
class AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation(_7067.AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6932.AbstractShaftAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6932.AbstractShaftAdvancedTimeSteppingAnalysisForModulation]':
