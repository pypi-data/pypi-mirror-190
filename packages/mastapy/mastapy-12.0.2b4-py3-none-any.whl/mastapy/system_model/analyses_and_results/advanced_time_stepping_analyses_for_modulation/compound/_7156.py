...
class RollingRingAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_7163.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2548.RollingRingAssembly':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7028.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7028.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]':
