...
class MeasurementComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7187.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """MeasurementComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2415.MeasurementComponent':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7012.MeasurementComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7012.MeasurementComponentAdvancedTimeSteppingAnalysisForModulation]':
