...
class BoltedJointCompoundAdvancedTimeSteppingAnalysisForModulation(_7163.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BoltedJointCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2395.BoltedJoint':
    ...
    @property
    def assembly_design(self) -> '_2395.BoltedJoint':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6955.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6955.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
