...
class BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation(_7163.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2527.BeltDrive':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6945.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6945.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
