...
class ClutchCompoundAdvancedTimeSteppingAnalysisForModulation(_7102.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ClutchCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2529.Clutch':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6956.ClutchAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6956.ClutchAdvancedTimeSteppingAnalysisForModulation]':
