...
class ConceptCouplingCompoundAdvancedTimeSteppingAnalysisForModulation(_7102.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2532.ConceptCoupling':
    ...
    @property
    def assembly_design(self) -> '_2532.ConceptCoupling':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6961.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6961.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
