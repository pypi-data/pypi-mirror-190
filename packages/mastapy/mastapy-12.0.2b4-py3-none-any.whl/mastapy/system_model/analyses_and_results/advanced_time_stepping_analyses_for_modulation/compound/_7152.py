...
class PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation(_7187.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7023.PowerLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7023.PowerLoadAdvancedTimeSteppingAnalysisForModulation]':
