...
class BeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7130.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2220.BeltConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6944.BeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6944.BeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
