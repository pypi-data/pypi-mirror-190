...
from mastapy.system_model.connections_and_sockets.couplings import _2296
...
class ConceptCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7103.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2296.ConceptCouplingConnection':
    ...
    @property
    def connection_design(self) -> '_2296.ConceptCouplingConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6962.ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6962.ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation]':
