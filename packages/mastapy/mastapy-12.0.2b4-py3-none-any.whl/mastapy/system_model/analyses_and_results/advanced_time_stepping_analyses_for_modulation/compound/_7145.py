...
class PartToPartShearCouplingCompoundAdvancedTimeSteppingAnalysisForModulation(_7102.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PartToPartShearCouplingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2539.PartToPartShearCoupling':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7016.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7016.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
