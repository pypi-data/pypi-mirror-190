...
class PartCompoundAdvancedTimeSteppingAnalysisForModulation(_7470.PartCompoundAnalysis):
    """PartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7015.PartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7015.PartAdvancedTimeSteppingAnalysisForModulation]':
