...
class CycloidalDiscAdvancedTimeSteppingAnalysisForModulation(_6932.AbstractShaftAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6785.CycloidalDiscLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2684.CycloidalDiscSystemDeflection':
