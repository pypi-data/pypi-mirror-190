...
class ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation(_6971.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    """ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2747.ShaftHubConnectionSystemDeflection':
