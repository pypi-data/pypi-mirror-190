...
class StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation(_7041.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2501.StraightBevelSunGear':
    ...
    @property
    def system_deflection_results(self) -> '_2766.StraightBevelSunGearSystemDeflection':
