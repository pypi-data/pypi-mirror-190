...
class BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation(_6946.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2651.BevelDifferentialSunGearSystemDeflection':
