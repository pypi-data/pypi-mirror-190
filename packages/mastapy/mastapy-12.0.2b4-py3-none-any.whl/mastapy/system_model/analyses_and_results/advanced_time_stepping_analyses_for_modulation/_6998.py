...
class HypoidGearAdvancedTimeSteppingAnalysisForModulation(_6938.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6831.HypoidGearLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2711.HypoidGearSystemDeflection':
