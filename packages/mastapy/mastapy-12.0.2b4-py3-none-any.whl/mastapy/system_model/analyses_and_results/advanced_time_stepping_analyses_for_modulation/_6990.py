...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6988, _6989, _6995
...
class FaceGearSetAdvancedTimeSteppingAnalysisForModulation(_6995.GearSetAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2701.FaceGearSetSystemDeflection':
    ...
    @property
    def face_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6988.FaceGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6989.FaceGearMeshAdvancedTimeSteppingAnalysisForModulation]':
