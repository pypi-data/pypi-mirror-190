...
class ExternalCADModelAdvancedTimeSteppingAnalysisForModulation(_6960.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """ExternalCADModelAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6809.ExternalCADModelLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2698.ExternalCADModelSystemDeflection':
