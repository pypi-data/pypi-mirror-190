...
class CycloidalDiscPlanetaryBearingConnectionAdvancedTimeSteppingAnalysisForModulation(_6934.AbstractShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscPlanetaryBearingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6786.CycloidalDiscPlanetaryBearingConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2683.CycloidalDiscPlanetaryBearingConnectionSystemDeflection':
