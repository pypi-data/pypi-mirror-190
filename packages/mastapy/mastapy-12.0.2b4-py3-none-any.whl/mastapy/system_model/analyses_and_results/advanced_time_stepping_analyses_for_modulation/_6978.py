...
class CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation(_7034.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2681.CycloidalAssemblySystemDeflection':
