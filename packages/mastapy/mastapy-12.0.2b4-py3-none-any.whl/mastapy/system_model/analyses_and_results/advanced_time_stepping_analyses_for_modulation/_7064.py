...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7062, _7063, _6953
...
class ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6953.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2786.ZerolBevelGearSetSystemDeflection':
    ...
    @property
    def zerol_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7062.ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def zerol_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7063.ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
