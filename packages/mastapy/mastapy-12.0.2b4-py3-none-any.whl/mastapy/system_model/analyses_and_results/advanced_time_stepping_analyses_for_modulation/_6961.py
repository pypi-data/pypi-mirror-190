...
class ConceptCouplingAdvancedTimeSteppingAnalysisForModulation(_6972.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6766.ConceptCouplingLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2665.ConceptCouplingSystemDeflection':
