...
class ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation(_6994.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    """ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6768.ConceptGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2666.ConceptGearMeshSystemDeflection':
