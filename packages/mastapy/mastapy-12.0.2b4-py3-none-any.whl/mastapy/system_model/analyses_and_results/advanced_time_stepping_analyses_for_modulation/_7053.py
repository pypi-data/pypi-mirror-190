...
class TorqueConverterAdvancedTimeSteppingAnalysisForModulation(_6972.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6899.TorqueConverterLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2776.TorqueConverterSystemDeflection':
