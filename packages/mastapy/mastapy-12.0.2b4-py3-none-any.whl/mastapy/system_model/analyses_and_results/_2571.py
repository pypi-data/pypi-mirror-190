...
from mastapy import _7483, _7477
...
class SingleAnalysis(_7477.MarshalByRefObjectPermanent):
    """SingleAnalysis
    ...
    def perform_analysis_with_progress(self, task_progress: '_7483.TaskProgress'):
        """ 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_2159.DesignEntity') -> '_2602.DesignEntityAnalysis':
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2602.DesignEntityAnalysis') -> '_2602.DesignEntityAnalysis':
        """ 'ResultsFor' is the original name of this method.
