...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5748, _5749, _5633
...
class StraightBevelDiffGearSetHarmonicAnalysis(_5633.BevelGearSetHarmonicAnalysis):
    """StraightBevelDiffGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5748.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_harmonic_analysis(self) -> 'List[_5748.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5749.StraightBevelDiffGearMeshHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_harmonic_analysis(self) -> 'List[_5749.StraightBevelDiffGearMeshHarmonicAnalysis]':
