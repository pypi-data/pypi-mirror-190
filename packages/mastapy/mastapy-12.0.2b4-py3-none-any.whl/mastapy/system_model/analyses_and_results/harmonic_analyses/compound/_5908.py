...
class SpiralBevelGearMeshCompoundHarmonicAnalysis(_5825.BevelGearMeshCompoundHarmonicAnalysis):
    """SpiralBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5743.SpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5743.SpiralBevelGearMeshHarmonicAnalysis]':
