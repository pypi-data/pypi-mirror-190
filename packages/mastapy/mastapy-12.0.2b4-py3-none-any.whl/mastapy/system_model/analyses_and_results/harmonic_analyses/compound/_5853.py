...
class CycloidalDiscCompoundHarmonicAnalysis(_5809.AbstractShaftCompoundHarmonicAnalysis):
    """CycloidalDiscCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5661.CycloidalDiscHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5661.CycloidalDiscHarmonicAnalysis]':
