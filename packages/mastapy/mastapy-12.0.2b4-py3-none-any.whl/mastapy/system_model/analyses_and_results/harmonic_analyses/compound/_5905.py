...
class ShaftToMountableComponentConnectionCompoundHarmonicAnalysis(_5811.AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """ShaftToMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5738.ShaftToMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5738.ShaftToMountableComponentConnectionHarmonicAnalysis]':
