...
class StraightBevelGearMeshCompoundHarmonicAnalysis(_5825.BevelGearMeshCompoundHarmonicAnalysis):
    """StraightBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5752.StraightBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5752.StraightBevelGearMeshHarmonicAnalysis]':
