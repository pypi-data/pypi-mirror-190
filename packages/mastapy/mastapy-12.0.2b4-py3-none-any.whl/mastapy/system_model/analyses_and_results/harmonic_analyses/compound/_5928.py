...
class TorqueConverterTurbineCompoundHarmonicAnalysis(_5847.CouplingHalfCompoundHarmonicAnalysis):
    """TorqueConverterTurbineCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5763.TorqueConverterTurbineHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5763.TorqueConverterTurbineHarmonicAnalysis]':
