...
class BevelDifferentialGearCompoundHarmonicAnalysis(_5824.BevelGearCompoundHarmonicAnalysis):
    """BevelDifferentialGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5626.BevelDifferentialGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5626.BevelDifferentialGearHarmonicAnalysis]':
