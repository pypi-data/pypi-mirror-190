...
class InterMountableComponentConnectionCompoundHarmonicAnalysis(_5843.ConnectionCompoundHarmonicAnalysis):
    """InterMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5704.InterMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5704.InterMountableComponentConnectionHarmonicAnalysis]':
