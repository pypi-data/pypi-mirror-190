...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import (
    _5816, _5818, _5821, _5828,
    _5827, _5849, _5829, _5834,
    _5839, _5851, _5853, _5857,
    _5864, _5863, _5865, _5872,
    _5879, _5882, _5883, _5884,
    _5886, _5888, _5893, _5894,
    _5895, _5897, _5899, _5904,
    _5903, _5909, _5910, _5915,
    _5918, _5921, _5925, _5929,
    _5933, _5936, _5808
)
...
class AssemblyCompoundHarmonicAnalysis(_5808.AbstractAssemblyCompoundHarmonicAnalysis):
    """AssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5622.AssemblyHarmonicAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_5816.BearingCompoundHarmonicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5818.BeltDriveCompoundHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5821.BevelDifferentialGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5828.BoltedJointCompoundHarmonicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5827.BoltCompoundHarmonicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5849.CVTCompoundHarmonicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5829.ClutchCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5834.ConceptCouplingCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5839.ConceptGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5851.CycloidalAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5853.CycloidalDiscCompoundHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5857.CylindricalGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5864.FEPartCompoundHarmonicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5863.FaceGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5865.FlexiblePinAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5872.HypoidGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5879.KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5882.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5883.MassDiscCompoundHarmonicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5884.MeasurementComponentCompoundHarmonicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5886.OilSealCompoundHarmonicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5888.PartToPartShearCouplingCompoundHarmonicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5893.PlanetCarrierCompoundHarmonicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5894.PointLoadCompoundHarmonicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5895.PowerLoadCompoundHarmonicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5897.RingPinsCompoundHarmonicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5899.RollingRingAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5904.ShaftHubConnectionCompoundHarmonicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5903.ShaftCompoundHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5909.SpiralBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5910.SpringDamperCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5915.StraightBevelDiffGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5918.StraightBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5921.SynchroniserCompoundHarmonicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5925.TorqueConverterCompoundHarmonicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5929.UnbalancedMassCompoundHarmonicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5933.WormGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5936.ZerolBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5622.AssemblyHarmonicAnalysis]':
