...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5934, _5935, _5826
...
class ZerolBevelGearSetCompoundHarmonicAnalysis(_5826.BevelGearSetCompoundHarmonicAnalysis):
    """ZerolBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5772.ZerolBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5934.ZerolBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5935.ZerolBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5772.ZerolBevelGearSetHarmonicAnalysis]':
