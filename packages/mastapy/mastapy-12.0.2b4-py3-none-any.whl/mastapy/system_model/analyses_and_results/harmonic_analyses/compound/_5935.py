...
class ZerolBevelGearMeshCompoundHarmonicAnalysis(_5825.BevelGearMeshCompoundHarmonicAnalysis):
    """ZerolBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5771.ZerolBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5771.ZerolBevelGearMeshHarmonicAnalysis]':
