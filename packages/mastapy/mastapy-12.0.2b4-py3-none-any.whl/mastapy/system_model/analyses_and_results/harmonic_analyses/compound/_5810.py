...
class AbstractShaftOrHousingCompoundHarmonicAnalysis(_5833.ComponentCompoundHarmonicAnalysis):
    """AbstractShaftOrHousingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5617.AbstractShaftOrHousingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5617.AbstractShaftOrHousingHarmonicAnalysis]':
