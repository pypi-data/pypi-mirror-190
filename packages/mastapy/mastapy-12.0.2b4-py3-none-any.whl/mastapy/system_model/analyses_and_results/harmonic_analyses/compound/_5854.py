...
class CycloidalDiscPlanetaryBearingConnectionCompoundHarmonicAnalysis(_5811.AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5662.CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5662.CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis]':
