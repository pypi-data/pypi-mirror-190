...
class PartToPartShearCouplingHalfCompoundHarmonicAnalysis(_5847.CouplingHalfCompoundHarmonicAnalysis):
    """PartToPartShearCouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5720.PartToPartShearCouplingHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5720.PartToPartShearCouplingHalfHarmonicAnalysis]':
