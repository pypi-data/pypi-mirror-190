...
class ConceptCouplingConnectionCompoundHarmonicAnalysis(_5846.CouplingConnectionCompoundHarmonicAnalysis):
    """ConceptCouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5642.ConceptCouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5642.ConceptCouplingConnectionHarmonicAnalysis]':
