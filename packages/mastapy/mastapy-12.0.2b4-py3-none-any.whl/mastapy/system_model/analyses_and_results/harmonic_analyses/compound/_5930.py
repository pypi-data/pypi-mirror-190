...
class VirtualComponentCompoundHarmonicAnalysis(_5885.MountableComponentCompoundHarmonicAnalysis):
    """VirtualComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5766.VirtualComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5766.VirtualComponentHarmonicAnalysis]':
