...
class WormGearMeshCompoundHarmonicAnalysis(_5867.GearMeshCompoundHarmonicAnalysis):
    """WormGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5768.WormGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5768.WormGearMeshHarmonicAnalysis]':
