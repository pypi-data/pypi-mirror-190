...
from mastapy.system_model.analyses_and_results.harmonic_analyses import (
    _5623, _5625, _5628, _5634,
    _5635, _5657, _5638, _5644,
    _5647, _5659, _5661, _5665,
    _5684, _5683, _5685, _5703,
    _5710, _5713, _5692, _5714,
    _5715, _5717, _5721, _5725,
    _5726, _5727, _5730, _5732,
    _5737, _5736, _5744, _5747,
    _5750, _5753, _5757, _5761,
    _5765, _5769, _5772, _5614
)
...
class AssemblyHarmonicAnalysis(_5614.AbstractAssemblyHarmonicAnalysis):
    """AssemblyHarmonicAnalysis
    ...
    @property
    def bearings(self) -> 'List[_5623.BearingHarmonicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5625.BeltDriveHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5628.BevelDifferentialGearSetHarmonicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5634.BoltedJointHarmonicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5635.BoltHarmonicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5657.CVTHarmonicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5638.ClutchHarmonicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5644.ConceptCouplingHarmonicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5647.ConceptGearSetHarmonicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5659.CycloidalAssemblyHarmonicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5661.CycloidalDiscHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5665.CylindricalGearSetHarmonicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5684.FEPartHarmonicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5683.FaceGearSetHarmonicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5685.FlexiblePinAssemblyHarmonicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5703.HypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5710.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5713.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_5692.GearSetHarmonicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5714.MassDiscHarmonicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5715.MeasurementComponentHarmonicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5717.OilSealHarmonicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5721.PartToPartShearCouplingHarmonicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5725.PlanetCarrierHarmonicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5726.PointLoadHarmonicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5727.PowerLoadHarmonicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5730.RingPinsHarmonicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5732.RollingRingAssemblyHarmonicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5737.ShaftHubConnectionHarmonicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5736.ShaftHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5744.SpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5747.SpringDamperHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5750.StraightBevelDiffGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5753.StraightBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5757.SynchroniserHarmonicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5761.TorqueConverterHarmonicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5765.UnbalancedMassHarmonicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5769.WormGearSetHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5772.ZerolBevelGearSetHarmonicAnalysis]':
