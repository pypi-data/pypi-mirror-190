...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5800, _5783
...
class SingleWhineAnalysisResultsPropertyAccessor(_5783.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    """SingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5800.ResultsForOrderIncludingNodes]':
