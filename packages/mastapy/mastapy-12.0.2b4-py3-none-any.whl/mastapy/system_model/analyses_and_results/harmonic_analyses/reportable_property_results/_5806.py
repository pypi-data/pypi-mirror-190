...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5799, _5783
...
class RootAssemblySingleWhineAnalysisResultsPropertyAccessor(_5783.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    """RootAssemblySingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5799.ResultsForOrderIncludingGroups]':
