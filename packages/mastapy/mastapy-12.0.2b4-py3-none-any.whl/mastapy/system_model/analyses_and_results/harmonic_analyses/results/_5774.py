...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5777, _5775
...
class ExcitationSourceSelection(_5775.ExcitationSourceSelectionBase):
    """ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5777.HarmonicSelection]':
