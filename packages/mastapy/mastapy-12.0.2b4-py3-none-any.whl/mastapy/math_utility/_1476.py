...
class FourierSeries(_0.APIBase):
    ...
    def harmonic(self, index: 'int') -> '_1479.HarmonicValue':
    ...
    def harmonics_above_cut_off(self) -> 'List[_1479.HarmonicValue]':
    ...
    def harmonics_with_zeros_truncated(self) -> 'List[_1479.HarmonicValue]':
