...
from mastapy.math_utility.measured_data import _1531
...
class OnedimensionalFunctionLookupTable(_1531.LookupTableBase['OnedimensionalFunctionLookupTable']):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self) -> '_1498.Vector2DListAccessor':
    ...
    @lookup_table.setter
    def lookup_table(self, value: '_1498.Vector2DListAccessor'):
