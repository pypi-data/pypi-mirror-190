...
from mastapy.math_utility.measured_data import _1530, _1531
...
class TwodimensionalFunctionLookupTable(_1531.LookupTableBase['TwodimensionalFunctionLookupTable']):
    """TwodimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self) -> '_1530.GriddedSurfaceAccessor':
    ...
    @lookup_table.setter
    def lookup_table(self, value: '_1530.GriddedSurfaceAccessor'):
