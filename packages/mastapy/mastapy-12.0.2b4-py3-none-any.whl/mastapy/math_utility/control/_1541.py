...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def differential_gain_vs_time_and_error(self) -> '_1530.GriddedSurfaceAccessor':
    ...
    def differential_gain_vs_time_and_error(self, value: '_1530.GriddedSurfaceAccessor'):
    ...
    @property
    def integral_gain_vs_time_and_error(self) -> '_1530.GriddedSurfaceAccessor':
    ...
    def integral_gain_vs_time_and_error(self, value: '_1530.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def proportional_gain_vs_time_and_error(self) -> '_1530.GriddedSurfaceAccessor':
    ...
    def proportional_gain_vs_time_and_error(self, value: '_1530.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def update_method(self) -> '_1486.PIDControlUpdateMethod':
        ...
        return constructor.new_from_mastapy_type(_1486.PIDControlUpdateMethod)(value) if value is not None else None

    @update_method.setter
    def update_method(self, value: '_1486.PIDControlUpdateMethod'):
