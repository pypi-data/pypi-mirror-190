...
class OptimisationHistory(_0.APIBase):
    ...
    @property
    def input_history(self) -> 'List[_1509.OptimizationVariable]':
    ...
    @property
    def target_history(self) -> 'List[_1509.OptimizationVariable]':
    ...
    def add_input_history(self, value: '_1509.OptimizationVariable'):
    ...
    def add_target_history(self, value: '_1509.OptimizationVariable'):
