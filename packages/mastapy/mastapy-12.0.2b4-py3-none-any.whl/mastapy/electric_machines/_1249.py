...
class ElectricMachineDetail(_0.APIBase):
    ...
    def generate_design_without_non_linear_dq_model(self) -> '_1556.MethodOutcomeWithResult[ElectricMachineDetail]':
    ...
    def try_generate_non_linear_dq_model(self) -> '_1556.MethodOutcomeWithResult[ElectricMachineDetail]':
    ...
    def try_generate_non_linear_dq_model_with_task_progress(self, progress: '_7483.TaskProgress') -> '_1556.MethodOutcomeWithResult[ElectricMachineDetail]':
