...
class CycloidalDiscModificationsSpecification(_0.APIBase):
    ...
    @property
    def direction_of_measured_modifications(self) -> '_1424.DirectionOfMeasuredModifications':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1424.DirectionOfMeasuredModifications)(value) if value is not None else None

    @direction_of_measured_modifications.setter
    def direction_of_measured_modifications(self, value: '_1424.DirectionOfMeasuredModifications'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def measured_profile_modification(self) -> '_1498.Vector2DListAccessor':
    ...
    def measured_profile_modification(self, value: '_1498.Vector2DListAccessor'):
