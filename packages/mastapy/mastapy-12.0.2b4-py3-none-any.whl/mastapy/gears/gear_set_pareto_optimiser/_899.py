...
from mastapy.math_utility.optimisation import _1513, _1510, _1504
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1513.ParetoOptimisationStrategy':
    ...
    @property
    def filters(self) -> 'List[_1510.ParetoOptimisationFilter]':
    ...
    @property
    def input_setters(self) -> 'List[_1504.InputSetter[TAnalysis]]':
