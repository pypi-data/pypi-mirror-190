...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def clamped_parts(self) -> 'List[_1439.ClampedSection]':
    ...
    def clamped_parts(self, value: 'List[_1439.ClampedSection]'):
    ...
    @property
    def joint_geometry(self) -> '_1444.JointGeometries':
        ...
        return constructor.new_from_mastapy_type(_1444.JointGeometries)(value) if value is not None else None

    @joint_geometry.setter
    def joint_geometry(self, value: '_1444.JointGeometries'):
        value = value if value else None
    ...
    @property
    def rolled_before_or_after_heat_treatment(self) -> '_1447.RolledBeforeOrAfterHeatTreament':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1447.RolledBeforeOrAfterHeatTreament)(value) if value is not None else None

    @rolled_before_or_after_heat_treatment.setter
    def rolled_before_or_after_heat_treatment(self, value: '_1447.RolledBeforeOrAfterHeatTreament'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def bolt_geometry(self) -> '_1432.BoltGeometry':
    ...
    @property
    def material_of_bolt(self) -> '_1434.BoltMaterial':
    ...
    @property
    def material_of_nut(self) -> '_1430.BoltedJointMaterial':
        ...
        if _1430.BoltedJointMaterial.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def material_of_tapped_thread(self) -> '_1430.BoltedJointMaterial':
    ...
    @property
    def clamped_sections(self) -> 'List[_1439.ClampedSection]':
