...
from mastapy.bolts import _1449, _1430
...
class BoltMaterial(_1430.BoltedJointMaterial):
    """BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1449.StrengthGrades':
        ...
        return constructor.new_from_mastapy_type(_1449.StrengthGrades)(value) if value is not None else None

    @strength_grade.setter
    def strength_grade(self, value: '_1449.StrengthGrades'):
