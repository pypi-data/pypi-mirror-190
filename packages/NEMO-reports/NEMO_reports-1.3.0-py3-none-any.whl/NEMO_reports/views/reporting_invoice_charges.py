...
def invoice_charges(request):
    ...
    if split_by_month:
        ...
        for month in get_monthly_rule(start, end):
            ...
            add_summary_info(summary, monthly_start or month_start, month_end, month_key)
    else:
        summary.add_header(("value", "Value"))
        add_summary_info(summary, start, end)
...
def add_summary_info(summary: SummaryDisplayTable, start, end, summary_key=None):
