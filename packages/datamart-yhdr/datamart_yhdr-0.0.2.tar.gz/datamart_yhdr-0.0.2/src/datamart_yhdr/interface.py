...
class DMInterface:
    ...
    def submit_command(self, command: str, data: list):
        ...
        for item in data:
            ...
            sub = requests.post(const.COMMAND_URL, headers={'Authorization': self.token}, json=command_params).json()
...
if __name__ == '__main__':
    dm = DMInterface("admin", "YHDR@20221206")
    dm.submit_command("ETL_ETLTask_Start", [{"TaskDefId": "T1008", "TaskType": "ETL", "BatchId": "2023-02-08"}])
