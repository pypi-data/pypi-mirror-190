...
from meili_ros_lib.maths import quaternion_to_euler, euler_to_quaternion, convert_meili_angle_to_yaw
...
def goal_setup(data):
    ...
    try:
        ...
        rotation = 0
    yaw = convert_meili_angle_to_yaw(rotation)
    rotation_quaternion = rotation_setup(yaw)
