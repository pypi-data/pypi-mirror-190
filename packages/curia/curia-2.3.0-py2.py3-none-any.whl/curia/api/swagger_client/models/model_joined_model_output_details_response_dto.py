...
class ModelJoinedModelOutputDetailsResponseDto(object):
    ...
    attribute_map = {
        ...
        'ate': 'ate',
        'ate_se': 'ateSe',
        'top_impact_quartile_ate': 'topImpactQuartileAte',
    ...
    def __init__(self, model_id=None, model_job_output_id=None, model_job_id=None, att=None, att_se=None, ate=None, ate_se=None, top_impact_quartile_ate=None, top_impact_quartile_se=None, treated_records=None, total_records=None, n_features=None, average_outcome=None, spearman_stability=None, r2=None, auc=None, n_records=None, risk_average_outcome=None):  # noqa: E501
    ...
    @property
    def att(self):
        """Gets the att of this ModelJoinedModelOutputDetailsResponseDto.  # noqa: E501


        :return: The att of this ModelJoinedModelOutputDetailsResponseDto.  # noqa: E501
        :rtype: str
        """
        return self._att
    ...
    @att.setter
    def att(self, att):
        """Sets the att of this ModelJoinedModelOutputDetailsResponseDto.


        :param att: The att of this ModelJoinedModelOutputDetailsResponseDto.  # noqa: E501
        :type: str
        """
        if att is None:
            raise ValueError("Invalid value for `att`, must not be `None`")  # noqa: E501
    ...
    @property
    def ate(self):
        """Gets the ate of this ModelJoinedModelOutputDetailsResponseDto.  # noqa: E501


        :return: The ate of this ModelJoinedModelOutputDetailsResponseDto.  # noqa: E501
        :rtype: str
        """
        return self._ate
    ...
    @ate.setter
    def ate(self, ate):
        """Sets the ate of this ModelJoinedModelOutputDetailsResponseDto.


        :param ate: The ate of this ModelJoinedModelOutputDetailsResponseDto.  # noqa: E501
        :type: str
        """
        if ate is None:
            raise ValueError("Invalid value for `ate`, must not be `None`")  # noqa: E501
    ...
    @property
    def top_impact_quartile_ate(self):
        """Gets the top_impact_quartile_ate of this ModelJoinedModelOutputDetailsResponseDto.  # noqa: E501


        :return: The top_impact_quartile_ate of this ModelJoinedModelOutputDetailsResponseDto.  # noqa: E501
        :rtype: str
        """
        return self._top_impact_quartile_ate

    @top_impact_quartile_ate.setter
    def top_impact_quartile_ate(self, top_impact_quartile_ate):
        """Sets the top_impact_quartile_ate of this ModelJoinedModelOutputDetailsResponseDto.


        :param top_impact_quartile_ate: The top_impact_quartile_ate of this ModelJoinedModelOutputDetailsResponseDto.  # noqa: E501
        :type: str
        """
        if top_impact_quartile_ate is None:
            raise ValueError("Invalid value for `top_impact_quartile_ate`, must not be `None`")  # noqa: E501

        self._top_impact_quartile_ate = top_impact_quartile_ate
    ...
    def average_outcome(self):
        """Gets the average_outcome of this ModelJoinedModelOutputDetailsResponseDto.  # noqa: E501


        :return: The average_outcome of this ModelJoinedModelOutputDetailsResponseDto.  # noqa: E501
        :rtype: str
        """
        return self._average_outcome

    @average_outcome.setter
    def average_outcome(self, average_outcome):
        """Sets the average_outcome of this ModelJoinedModelOutputDetailsResponseDto.


        :param average_outcome: The average_outcome of this ModelJoinedModelOutputDetailsResponseDto.  # noqa: E501
        :type: str
        """
        if average_outcome is None:
            raise ValueError("Invalid value for `average_outcome`, must not be `None`")  # noqa: E501

        self._average_outcome = average_outcome
