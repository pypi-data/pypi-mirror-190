...
class ModelJobConfig(object):
    ...
    def cohort_window_count(self, cohort_window_count):
        ...
        :type: float
        """
        if cohort_window_count is None:
            raise ValueError("Invalid value for `cohort_window_count`, must not be `None`")  # noqa: E501
    ...
    def train_model_job_id(self, train_model_job_id):
        ...
        :type: str
        """
        if train_model_job_id is None:
            raise ValueError("Invalid value for `train_model_job_id`, must not be `None`")  # noqa: E501
