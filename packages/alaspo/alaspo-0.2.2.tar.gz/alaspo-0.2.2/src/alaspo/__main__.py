...
def main():
    ...
    parser.add_argument('-v', '--verbosity', type=int, choices=[0, 1, 2],
                        ...
                        help='the level of verbosity in the output: 0 for only errors and warnings, 1 for updates about the incumbent cost, 2 for debugging information')
    ...
    def signal_handler(sig, frame):
        ...
        if lns_solver.best_solution is not None:
            print("Best found solution:")
            print_model(lns_solver.best_solution.model.shown)
            print("Costs: " + str(lns_solver.best_solution.cost))
        else:
    ...
    solution = lns_solver.solve(args.time_limit)
