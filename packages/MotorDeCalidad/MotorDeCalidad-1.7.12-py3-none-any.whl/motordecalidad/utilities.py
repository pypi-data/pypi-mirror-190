...
def send_email(registerAmount,rulesNumber,outputPath,receiver_email = "operacionestelefonicabi.hispam@outlook.com"):
    import smtplib
    from email.message import EmailMessage
    sslPort = 587  # For SSL
    smtp_server = "smtp-mail.outlook.com"
    sender_email = "enzo.ipanaque.pineda@ms-peru.com"
    password = "Fidito_0005"
