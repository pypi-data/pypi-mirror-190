...
def send_email(registerAmount,rulesNumber,output,receiver_email = "operacionestelefonicabi.hispam@outlook.com"):
    import smtplib
    ...
    Se pueden consultar los resultados en {output.get[JsonParts.Path]} """
