...
We probably need to make users aware of the classes, but we generally want to discourage them from using them directly, because it's easier to just use the convenience functions.
