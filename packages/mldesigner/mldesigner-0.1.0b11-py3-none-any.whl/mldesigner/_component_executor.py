...
class ExecutorBase:
    ...
    def _parse_with_mapping(self, args, arg_mapping):
        ...
        for name, param in arg_mapping.items():
            ...
            if val is None:
                self._validate_unprovided_params(type_name=type_name, param=param, param_name=name)
            ...
            if type_name == "Input" and param._is_primitive_type:
                try:
                    ...
                    raise UserErrorException(
                        f"Parameter transition for {name!r} failed: "
    ...
    @classmethod
    def _update_environment(cls, environment_dict: dict, return_annotation: dict, force_inject_deps: bool):
