...
#
# Copyright (C) 2020  Astrid Bracher (AWI Bremerhaven, abracher@awi.de), Mariana Soppa (AWI Bremerhaven, msoppa@awi.de),
# and Brenner Silva (AWI Bremerhaven, bsilva@awi.de)
#
# This software was developed at the Alfred-Wegener-Institute (AWI, Bremerhaven)
# supported by the DLR Space Administration
# with funds of the German Federal Ministry of Economic Affairs and Energy
# (on the basis of a decision by the German Bundestag:50 EE 1529) and contributions from GFZ.
#
