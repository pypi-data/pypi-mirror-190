...
class Browser(DynamicCore):
    ...
    def get_console_log(self, assertion_operator: typing.Optional[assertionengine.assertion_engine.AssertionOperator] = None, assertion_expected: typing.Optional[typing.Any] = None, message: typing.Optional[str] = None, *_, full: bool = False, last: typing.Union[int, datetime.timedelta, None] = None): ...
    ...
    def get_page_errors(self, assertion_operator: typing.Optional[assertionengine.assertion_engine.AssertionOperator] = None, assertion_expected: typing.Optional[typing.Any] = None, message: typing.Optional[str] = None, *_, full: bool = False, last: typing.Union[int, datetime.timedelta, None] = None): ...
