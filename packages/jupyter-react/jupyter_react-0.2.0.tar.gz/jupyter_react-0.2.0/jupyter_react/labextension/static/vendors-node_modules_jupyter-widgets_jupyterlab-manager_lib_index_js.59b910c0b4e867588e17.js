...
/* harmony import */ var _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @jupyter-widgets/base */ "webpack/sharing/consume/default/@jupyter-widgets/base/@jupyter-widgets/base?0ccd");
    ...
    for (const cell of nb.widgets) {
        if (cell.model.type === 'code') {
            for (const codecell of cell.outputArea.widgets) {
                for (const output of (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_5__.toArray)(codecell.children())) {
...
function* outputViews(app, path) {
    ...
    for (const view of (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_5__.toArray)(linkedViews)) {
        for (const outputs of (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_5__.toArray)(view.children())) {
            for (const output of (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_5__.toArray)(outputs.children())) {
                if (output instanceof _renderer__WEBPACK_IMPORTED_MODULE_14__.WidgetRenderer) {
                    yield output;
                }
            }
            ...
            exports: () => {
                return new Promise((resolve, reject) => {
                    Promise.all(/*! require.ensure | @jupyter-widgets/controls */[__webpack_require__.e("webpack_sharing_consume_default_jupyter-widgets_controls_jupyter-widgets_controls"), __webpack_require__.e("@jupyter-widgets/controls")]).then(((require) => {
                        ...
                        resolve(__webpack_require__(/*! @jupyter-widgets/controls */ "webpack/sharing/consume/default/@jupyter-widgets/controls/@jupyter-widgets/controls?e815"));
...
//# sourceMappingURL=vendors-node_modules_jupyter-widgets_jupyterlab-manager_lib_index_js.59b910c0b4e867588e17.js.map