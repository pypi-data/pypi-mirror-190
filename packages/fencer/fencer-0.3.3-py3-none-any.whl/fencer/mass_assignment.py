...
class MassAssignmentTestCaseRunner:
...
class TestMassAssignment:
    ...
    def test_mass_assignment(self):
        ...
        for endpoint in self.api_spec.authorized_endpoints:
            ...
            self.mass_assignment_tests += 1
            test_case = MassAssignmentTestCaseRunner(
                test_case=TestCase(
                    category=AttackStrategy.UNAUTHORIZED_ACCESS,
                    test_target="mass_assignment__",
