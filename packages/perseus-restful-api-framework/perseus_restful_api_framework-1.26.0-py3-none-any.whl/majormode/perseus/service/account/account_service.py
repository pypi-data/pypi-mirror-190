...
class AccountService(BaseRdbmsService):
            ...
            cursor = connection.execute(
                ...
                INSERT INTO account_picture (
                  ...
                  VALUES (
                    %(app_id)s,
                    %(account_id)s,
                    MIN(%(capture_time)s, current_timestamp),
    ...
    def __get_picture(
        ...
        @return: An object containing the following attributes:
            ...
            - `creation_time: ISO8601DateTime or None` (required): The time when
              this picture has been registered to the platform.

            - `image_file_checksum: str` (required): The message digest of the
              binary data of the user's original image file.
            ...
            - `submitter_account_id: uuid.UUID` (required): The identification of
              the account of the user who submitted this picture.

            - `team_id: uuid or None` (required): The identification of the
              organization of the user who submitted this picture.
        ...
        with self.acquire_rdbms_connection(connection=connection) as connection:
            ...
            picture.picture_url = self.build_picture_url(picture_id)
    ...
    def get_account(
        ...
        with self.acquire_rdbms_connection(auto_commit=False, connection=connection) as connection:
            ...
            if account.picture_id:
                account.picture = self.__get_picture(account.picture_id, connection=connection)
    ...
    def upload_picture(
            ...
            account_id: uuid.UUID,
            submitter_account_id: uuid.UUID,
            uploaded_file: HttpRequest.HttpRequestUploadedFile,
            capture_time: ISO8601DateTime,
            connection: RdbmsConnection = None,
            is_review_required: bool = False,
