import setuptools
from pilotme import __version__

with open('README.md', 'r', encoding='utf-8') as fh:
    long_description = fh.read()

setuptools.setup(
    name='pilot-by-warjiang',
    version=__version__,
    author='warjiang',
    author_email='warjiangyes@gmail.com',
    ...
    # package_dir={'': 'pilot'},
    # packages=setuptools.find_packages(where='pilot'),
    packages=['pilotme'],
    classifiers=[
...
# print(setuptools.find_packages(where='pilot'))