...
def main(notebook_path: str = typer.Argument(..., help="notebook file name or complete path"),
         ...
         hide_from_feed:bool=typer.Option(True,  "--hide", help="Hide this article from Hashnode and display it only on your blog"),
         delete_files:bool=typer.Option(True,  "--delete", "-d", help="Delete all files after creating the publication story"),
         upload:bool=typer.Option(True, "--upload", "-u", help="Upload the publication story to the Hashnode server"),
