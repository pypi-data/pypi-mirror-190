...
class Task(ApiObject):
    ...
    def start_automl(self, run_time: int = 60, max_algos: int = 10, server_cost: float = 0.2, max_algo_fee: float = 5, algos: list[Algo] = []) -> None:
        """
        ...
        Args:
            ...
            algos: explicitly provide algos to use.
        ...
        if algos:
            ...
            payload['algo_ids'] = [x.algo_id for x in algos]
        else:
