...
class ClusterCreationRequest(abc.ABC):
    ...
    Args:
        ...
        propertySets (typing.List[ClusterPropertySetCreationRequest]): A data field.
    ...
    name: ClusterName
    propertySets: typing.List[ClusterPropertySetCreationRequest]
    ...
    def json_schema(cls) -> dict:
        ...
        return {
            ...
            "properties": {
                ...
                "propertySets": {
                    "type": "array",
                    "item": ClusterPropertySetCreationRequest.json_schema()
                }
            },
            "required": [
                "adt_type",
    ...
    def from_json(cls, data: dict) -> LocalClusterCreationRequest:
        ...
        try:
            ...
            return LocalClusterCreationRequest(
                ...
                propertySets=[ClusterPropertySetCreationRequest.from_json(v) for v in data["propertySets"]],
            )
        except jsonschema.exceptions.ValidationError as ex:
            logging.debug(
