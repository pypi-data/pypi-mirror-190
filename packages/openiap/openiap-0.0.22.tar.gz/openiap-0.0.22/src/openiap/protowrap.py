...
class protowrap():
    ...
    def __grpc_connect_and_listen(client, itr):
        try:
            ...
            stub = grpcServiceStub(client.chan)
    ...
    async def DownloadFile(client, Id:str=None, Filename:str=None):
        ...
        result:base_pb2.downloadreply = await protowrap.RPC(client, request, rid)
