...
def run_ecppack(argv):
    return yowasp_runtime.run_wasm(__package__, "ecppack.wasm", 
...
def run_ecpunpack(argv):
    return yowasp_runtime.run_wasm(__package__, "ecpunpack.wasm", 
...
def run_nextpnr_ecp5(argv):
    return yowasp_runtime.run_wasm(__package__, "nextpnr-ecp5.wasm", 
