...
def _PD_delete(
    ...
    try:
        ...
        if(exists == True):
            ...
            if DEBUG :
                print("> main.scripts._add | query:: ", query)
...
def _PD_add_multiple(
    ...
    try:
        ...
        if DEBUG :
            print("> main.scripts._add_multiple | validatedata:: ", validatedata)
        if(validatedata['valid'] == True):
            exist = _PD_exists(
                query = queryReadWrite,
                _kit = { 'readModel': Dataframe },
            ...
            if DEBUG :
                print("> main.scripts._add_multiple | exist:: ", exist)
            if(exist == True):
                return {
                    'type': responsesPossibles['data_exists']['type'],
                    'code': responsesPossibles['data_exists']['code'],
