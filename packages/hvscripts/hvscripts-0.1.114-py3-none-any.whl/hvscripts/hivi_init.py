...
class Manager():
    ...
    def checkInvalidModules(self, moduleNames: list, sendError = True):
        ...
        try:
            ...
            validModulesDatas = list(
                map(
                    lambda module: os.path.exists(createDir(
                        module,
                        "conf".replace('.', '/') + ".xml"
                    )),
                    moduleNames,
            ...
            print("> hvscripts.hivi_init.py | checkInvalidModules - allModulesDIR:: ", allModulesDIR)
            print("> hvscripts.hivi_init.py | checkInvalidModules - validModulesDatas:: ", validModulesDatas)
            invalidModules = list(
                filter(
            ...
            for index, (key, conf) in enumerate(allConf.items()):
                if(
                    ...
                    urlConf[key] = {
                        ...
                        'urlname': conf["DEFAULT"]["urlname"] if "urlname" in conf["DEFAULT"].keys() else "__init__",
                    }
