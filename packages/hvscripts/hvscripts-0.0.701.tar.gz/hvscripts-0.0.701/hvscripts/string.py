...
from hvscripts.config import tabNumerique, tabAlphabetique, tabAlphanumerique, tabAlphabetiqueInsensitive, tabAlphanumeriqueInsensitive
from hvscripts.utils import getLang
