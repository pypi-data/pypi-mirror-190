...
class MPS(Generic[T]):
    ...
    def __init__(self, fn: T | str = None, name='', version='', proto='grpc', codec='json', asyncable=True,
...
def mps(fn: T | str = None, *, name='', version='', proto='grpc', codec='json', asyncable=True, timeout=10000,
        encrypt=False) -> T:
    """
