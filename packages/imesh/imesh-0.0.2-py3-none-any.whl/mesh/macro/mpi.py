...
class MPI:
    ...
    def __init__(self, fn: Callable[..., T] | str | T = None, name='', version='', proto='grpc', codec='json',
    ...
    def __call__(self, *args, **kwargs):
        ...
        if self.declared_kind or inspect.isabstract(self.declared_kind):
            ...
            self.__proxy__ = ServiceLoader.load(MProxy).get_default().proxy(signature.return_annotation)
...
def mpi(fn: Callable[..., T] | str | T = None, *, name='', version='', proto='grpc', codec='json', asyncable=True,
