...
class TestDtaSelectFilter(unittest.TestCase):
    ...
    def test_dtafilter_filter(self):
        peptides_lines = [
            PeptideLine(file_name='file.1.1.2', sequence='PEPTIDE', conf=.9),
            PeptideLine(file_name='file.1.1.2', sequence='PEPTIDE', conf=.8),
            PeptideLine(file_name='file.1.1.4', sequence='PEPTIDE', conf=.7),
            PeptideLine(file_name='file.1.1.4', sequence='PEPTIDES', conf=.7),
