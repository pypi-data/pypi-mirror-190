...
from spotdl_romanized_lyrics.providers.lyrics import Genius, MusixMatch, AzLyrics, Lyricstranslate
...
class Downloader:
    ...
    def __init__(
        ...
        if lyrics_providers is None:
            lyrics_providers = ["genius", "lyricstranslate"]
    ...
    def translate(self, song: Song) -> Optional[str]:
        translate = self.lyrics_providers[1].get_lyrics(song.name, song.artists, romanized=False)
        if translate:
            return translate
        return None
