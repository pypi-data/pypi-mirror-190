...
def main():
    parser = ArgumentParser("face test CLI tool", usage="evaluation <command> [<args>]")
    commands_parser = parser.add_subparsers(help="face test - evaluation command-line helpers")
