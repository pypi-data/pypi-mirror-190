...
@LastEditTime: 2023-02-09 18:22:59
...
class FrameBaseHandler(BaseApiHandler):
    ...
    def get_http_log_extra_dict(self):
        ...
        """
        dict_param = {}
        if config.get_value("plat_type", 1) != 4: #平台类型：1淘宝2微信3抖音4web5京东 如果是web站点，从cookie取
    ...
    def _request_source_type(self):
        ...
        :last_editors: HuangJianYi
        """
        plat_type = config.get_value("plat_type", 1) # 平台类型
        if plat_type == 4:
            return 1
    ...
    def get_act_id(self):
        ...
        if env and env != 'online' and app_id:
            ...
            if act_info_dict:
                ...
                return act_id
        act_id = config.get_value("act_id", 1)
        return act_id
    ...
    def create_operation_log(self, operation_type=1, model_name="", handler_name="", old_detail=None, update_detail=None, operate_user_id="", operate_user_name="", operate_role_id="", title="", operation_desc=""):
        ...
        :last_editors: HuangJianYi
        """
        plat_type = config.get_value("plat_type", 1)
        if plat_type == 1:
