...
['fast_tmp',
 ...
 'fast_tmp.utils',
 'fast_tmp_cli',
 'fast_tmp_cli.tpl.project.src',
 'fast_tmp_cli.tpl.project.src.tests',
 'fast_tmp_cli.tpl.project.src.{{cookiecutter.project_slug}}']

package_data = \
{'': ['*'],
 'fast_tmp.admin': ['templates/*'],
 'fast_tmp_cli': ['tpl/project/*', 'tpl/static/*', 'tpl/static/static/*'],
 'fast_tmp_cli.tpl.project.src': ['static/*',
                                  'static/css/*',
                                  'static/img/*',
                                  'static/js/*']}
