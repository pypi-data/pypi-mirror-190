...
class TasksListResponsedata(object):
    """TasksListResponsedata - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.blackout.TasksListResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in TasksListResponsedata.discriminator_value_class_map.values():
            return list(TasksListResponsedata.discriminator_value_class_map.keys())[list(TasksListResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(TasksListResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TasksListResponsedata):
            return False
