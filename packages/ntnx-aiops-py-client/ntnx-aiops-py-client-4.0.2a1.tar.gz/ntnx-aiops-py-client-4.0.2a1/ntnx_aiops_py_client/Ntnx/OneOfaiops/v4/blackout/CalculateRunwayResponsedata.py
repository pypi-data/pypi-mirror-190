...
class CalculateRunwayResponsedata(object):
    """CalculateRunwayResponsedata - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.blackout.CalculateRunwayResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CalculateRunwayResponsedata.discriminator_value_class_map.values():
            return list(CalculateRunwayResponsedata.discriminator_value_class_map.keys())[list(CalculateRunwayResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CalculateRunwayResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CalculateRunwayResponsedata):
            return False
