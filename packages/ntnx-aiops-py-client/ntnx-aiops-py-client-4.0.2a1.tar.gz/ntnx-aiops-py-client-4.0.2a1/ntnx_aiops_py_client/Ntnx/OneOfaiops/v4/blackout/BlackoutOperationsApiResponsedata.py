...
class BlackoutOperationsApiResponsedata(object):
    """BlackoutOperationsApiResponsedata - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    discriminator_value_class_map = {
        'EMPTY_LIST': 'list[str]',
        'List<aiops.v4.blackout.BlackoutOperation>': 'list[aiops.v4.blackout.BlackoutOperation]',
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.blackout.BlackoutOperationsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in BlackoutOperationsApiResponsedata.discriminator_value_class_map.values():
            return list(BlackoutOperationsApiResponsedata.discriminator_value_class_map.keys())[list(BlackoutOperationsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BlackoutOperationsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BlackoutOperationsApiResponsedata):
            return False
