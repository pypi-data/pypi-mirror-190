...
from ntnx_aiops_py_client.Ntnx.OneOfaiops.v4.blackout.CalculateRunwayResponsedata import CalculateRunwayResponsedata  # noqa: F401,E501
...
class CalculateRunwayResponse(object):
    """CalculateRunwayResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    swagger_types = {
        ...
        'data': 'OneOfaiops.v4.blackout.CalculateRunwayResponsedata',
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.blackout.CalculateRunwayResponse'

    def _initialize_fq_object_type(self):
        return 'aiops.v4.r0.a1.blackout.CalculateRunwayResponse'
    ...
    @property
    def data(self):
        """`{ prism.v4.config.TaskReference | aiops.v4.error.ErrorResponse }`
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CalculateRunwayResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CalculateRunwayResponse):
            return False
