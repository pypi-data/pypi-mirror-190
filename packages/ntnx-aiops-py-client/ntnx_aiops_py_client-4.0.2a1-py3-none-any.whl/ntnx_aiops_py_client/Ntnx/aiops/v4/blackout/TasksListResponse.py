...
from ntnx_aiops_py_client.Ntnx.OneOfaiops.v4.blackout.TasksListResponsedata import TasksListResponsedata  # noqa: F401,E501
...
class TasksListResponse(object):
    """TasksListResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    swagger_types = {
        ...
        'data': 'OneOfaiops.v4.blackout.TasksListResponsedata',
    ...
    def _initialize_object_type(self):
        return 'aiops.v4.blackout.TasksListResponse'

    def _initialize_fq_object_type(self):
        return 'aiops.v4.r0.a1.blackout.TasksListResponse'
    ...
    @property
    def data(self):
        """`{ list[str] | aiops.v4.error.ErrorResponse }`
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(TasksListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TasksListResponse):
            return False
