...
class ApiClient:
    ...
    def _get_api_endpoint(self) -> str:
        ...
        def _walrus_wrapper_api_endpoint_0a1b2ce594d24dc1a2b011724e9d971c(expr):
            """Wrapper function for assignment expression."""
            nonlocal api_endpoint
            api_endpoint = expr
            return api_endpoint

        if (_walrus_wrapper_api_endpoint_0a1b2ce594d24dc1a2b011724e9d971c(get_value(OPTION_API_ENDPOINT))):
            return api_endpoint
