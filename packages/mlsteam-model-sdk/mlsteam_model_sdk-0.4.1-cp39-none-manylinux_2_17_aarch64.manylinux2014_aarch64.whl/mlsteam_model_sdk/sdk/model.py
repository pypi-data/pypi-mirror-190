...
class Model:
    ...
    def __init_default_puuid(self,
        ...
        def _walrus_wrapper_default_project_name_fe1bbc30c5824ef4a87d1ad8ed0c8b66(expr):
            """Wrapper function for assignment expression."""
            nonlocal default_project_name
            default_project_name = expr
            return default_project_name

        def _walrus_wrapper_default_puuid_6f1a161c38cf4e43bfeff386ee2d9e58(expr):
            """Wrapper function for assignment expression."""
        ...
        elif (_walrus_wrapper_default_puuid_6f1a161c38cf4e43bfeff386ee2d9e58(config.get_value(config.OPTION_DEFAULT_PUUID))):
            self.default_puuid = default_puuid
        elif (_walrus_wrapper_default_project_name_fe1bbc30c5824ef4a87d1ad8ed0c8b66(config.get_value(config.OPTION_DEFAULT_PROJECT_NAME))):
            self.default_puuid = self.to_puuid(default_project_name)
        else:
    ...
    def __init_default_muuid(self,
        ...
        def _walrus_wrapper_default_model_name_c5b5c30a966d4422b43d26c72599268f(expr):
            """Wrapper function for assignment expression."""
            nonlocal default_model_name
            default_model_name = expr
            return default_model_name

        def _walrus_wrapper_default_muuid_395301a9de81442aaa314a27be6f2260(expr):
            """Wrapper function for assignment expression."""
        ...
        elif (_walrus_wrapper_default_muuid_395301a9de81442aaa314a27be6f2260(config.get_value(config.OPTION_DEFAULT_MUUID))):
            self.default_muuid = default_muuid
        elif (_walrus_wrapper_default_model_name_c5b5c30a966d4422b43d26c72599268f(config.get_value(config.OPTION_DEFAULT_MODEL_NAME))):
            self.default_muuid = self.to_muuid(default_model_name, puuid=self.default_puuid)
        else:
    ...
    def _update_sys_paths_modules(self, abs_syspath: Path, abs_pkgbase: Path):
        ...
        def _walrus_wrapper_abs_syspath_str_33b8863094b040bab9d8c0daa3530d78(expr):
            """Wrapper function for assignment expression."""
            nonlocal abs_syspath_str
            abs_syspath_str = expr
            return abs_syspath_str

        if (_walrus_wrapper_abs_syspath_str_33b8863094b040bab9d8c0daa3530d78(str(abs_syspath))) not in sys.path:
