...
class ApiClient:
    ...
    def _get_api_endpoint(self) -> str:
        ...
        def _walrus_wrapper_api_endpoint_d4801021f9184da5a7a39404c2361e1f(expr):
            """Wrapper function for assignment expression."""
            nonlocal api_endpoint
            api_endpoint = expr
            return api_endpoint

        if (_walrus_wrapper_api_endpoint_d4801021f9184da5a7a39404c2361e1f(get_value(OPTION_API_ENDPOINT))):
            return api_endpoint
