...
def get_config_path(check: bool = False) -> Optional[Path]:
    ...
    def _walrus_wrapper_curr_file_09cd703d094f4a25b53ccf566b86d108(expr):
        """Wrapper function for assignment expression."""
        nonlocal curr_file
        curr_file = expr
        return curr_file

    if (_walrus_wrapper_curr_file_09cd703d094f4a25b53ccf566b86d108(curr_dir / CFG_DIR / CFG_FILE)).is_file():
        return curr_file
    ...
    with contextlib.suppress(RuntimeError):
        ...
        def _walrus_wrapper_curr_file_c24ece2a6641421fa50f54d0bb9db85e(expr):
            """Wrapper function for assignment expression."""
            nonlocal curr_file
            curr_file = expr
            return curr_file

        if (_walrus_wrapper_curr_file_c24ece2a6641421fa50f54d0bb9db85e(Path.home() / CFG_DIR / CFG_FILE)).is_file():
            return curr_file
    ...
    for _dir in curr_dir.parents:
        ...
        def _walrus_wrapper_curr_file_280aabe342e3429a9156b5cc7dfe6b81(expr):
            """Wrapper function for assignment expression."""
            nonlocal curr_file
            curr_file = expr
            return curr_file

        if (_walrus_wrapper_curr_file_280aabe342e3429a9156b5cc7dfe6b81(_dir / CFG_DIR / CFG_FILE)).is_file():
            return curr_file
