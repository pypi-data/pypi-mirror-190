...
class FrequentialSolver:
    ...
    def resonance_peaks(self, k=5):
        ...
        if(self.compute_method=='modal'):
            ...
            return tools.resonance_peaks_from_phase(self.frequencies, self.impedance, k)
    ...
    def antiresonance_peaks(self, k=5):
        ...
        """
        return tools.antiresonance_peaks_from_phase(self.frequencies, self.impedance, k)
