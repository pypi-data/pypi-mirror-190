...
def resonance_frequencies(frequencies, impedance, k=5):
    ...
    return resonance_peaks_from_phase(frequencies, impedance, k)[0]


def resonance_peaks_from_phase(frequencies, impedance, k=5):
    r"""
...
def antiresonance_peaks_from_phase(frequencies, impedance, k=5):
    """
    ...
    f_antires, Q, Y_antires = resonance_peaks_from_phase(frequencies, 1/impedance, k)
