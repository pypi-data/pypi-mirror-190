...
find_package(projectq
             ...
             NO_DEFAULT_PATH
             PATHS
             "${MQ_PACKAGE_PREFIX_DIR}/lib64/mindquantum/third_party/projectq_0.5.1_760f5553671716a4926d9f15d33a75e5"
             REQUIRED)
...
find_package(Eigen3
             ...
             NO_DEFAULT_PATH
             PATHS
             "${MQ_PACKAGE_PREFIX_DIR}/lib64/mindquantum/third_party/Eigen3_3.4.0_6dbb9a87731ef41d52675990761f1cdf"
             REQUIRED)
...
find_package(fmt
             ...
             NO_DEFAULT_PATH
             PATHS
             "${MQ_PACKAGE_PREFIX_DIR}/lib64/mindquantum/third_party/fmt_9.1.0_ce1e5972bbad28ae64a914cfe5a0383f"
             REQUIRED)
...
find_package(nlohmann_json
             ...
             NO_DEFAULT_PATH
             PATHS
             "${MQ_PACKAGE_PREFIX_DIR}/lib64/mindquantum/third_party/nlohmann_json_3.11.2_a07c0cb38cd14d69714533545cfd6ef9"
             REQUIRED)
...
find_package(Boost
             ...
             NO_DEFAULT_PATH
             PATHS
             "${MQ_PACKAGE_PREFIX_DIR}/lib64/mindquantum/third_party/Boost_1.78.0_b83bc72656f2b93f56a8b5d600a1f7e0"
             COMPONENTS
             serialization
             filesystem
             system
...
find_package(lru_cache
             ...
             NO_DEFAULT_PATH
             PATHS
             "${MQ_PACKAGE_PREFIX_DIR}/lib64/mindquantum/third_party/lru_cache_0.0.1_b7c8a26ad81d97e287ce8e2fc3c4a5f9"
             REQUIRED)
