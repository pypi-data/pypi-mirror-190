...
class Logger:
    ...
    def get_file_handler(self):
        ...
        Returns:
            logging handler object : the console handler
        """
        file_handler = handlers.RotatingFileHandler(self.log_file, maxBytes=5000, backupCount=1)
        # file_handler = handlers.TimedRotatingFileHandler(self.log_file, when="m", interval=1, backupCount=1, delay=True) # noqa E501
    ...
    def get_logger(self, logger_name: str):
        ...
        self.add_handlers(logger, [console_handler])
