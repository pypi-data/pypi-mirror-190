...
from operbot import Command, Default, Handler, Message, Object, Storage
from operbot import elapsed, format, keys, fntime, last, locked, save, update
from operbot import launch
...
class Config(Default):
    ...
    password = ""
    port = 6667
    realname = "OPERBOT is a contribution back to society, placed in the Public Domain."
    sasl = False
    server = "localhost"
    servermodes = ""
    sleep = 60
