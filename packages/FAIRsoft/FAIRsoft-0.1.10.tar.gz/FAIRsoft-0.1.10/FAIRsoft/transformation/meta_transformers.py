...
class repositoryToolsGenerator(toolGenerator):
    ...
    def import_bioconda_dict(self):
        ...
        '''
        path = '/Users/evabsc/projects/FAIRsoft/FAIRsoft_ETL/FAIRsoft/FAIRsoft/transformation/bioconda_types.json'
...
class bioconda_conda_ToolsGenerator(toolGenerator):
    ...
    def import_bioconda_dict(self):
            with open('/Users/evabsc/projects/FAIRsoft/FAIRsoft_ETL/FAIRsoft/FAIRsoft/transformation/bioconda_types.json', 'r') as infile:
                self.bioconda_types = json.load(infile)
