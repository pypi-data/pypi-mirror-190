    ...
    def style_excel(self, excel_name: str, sheet_name: str):
        ...
        for i in range(1, max_column + 1):
            ...
            for j in range(1, max_row + 1):
                ...
                # 全部居中
                sheet.cell(row=j, column=i).alignment = openpyxl.styles.Alignment(horizontal='center', vertical='center')
        ...
        for key, value in max_column_dict.items():
            sheet.column_dimensions[num_str_dict[key]].width = max(value+1,5)
        # 保存
        wb.save(excel_name)
