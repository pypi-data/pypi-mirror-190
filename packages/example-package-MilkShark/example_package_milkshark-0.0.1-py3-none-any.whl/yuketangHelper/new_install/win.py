...
class BaseWindow:
    def __init__(self,parent):
        ...
        self.exam_id = None
        self.exam = None
        self.user_anwser = None # 0表示A,1表示B，2表示C，3表示D，-1为未选择
    ...
    def main_left(self, parent):
        ...
        if self.exam_id:
            ...
            s = "无"
        label(f1, s).pack(side=tk.LEFT, anchor=tk.W, padx=30, pady=5)
    ...
    #win_random设置。可以随意更改选项，btn颜色为灰色，不给正确答案。
