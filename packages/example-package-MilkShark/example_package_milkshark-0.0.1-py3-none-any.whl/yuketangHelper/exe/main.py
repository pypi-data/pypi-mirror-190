...
class App:
	...
	def body(self):
		...
		tk.Button(canvas, text="模拟考试", bg="cadetblue", command=self.show_random, font=ft2, height=2, fg="white", width=12)\
			.pack(side=tk.LEFT, expand=tk.YES, anchor=tk.CENTER, padx=5)
		tk.Button(canvas, text="顺序做题", bg="cadetblue", command=self.show_order, font=ft2, height=2, fg="white", width=12)\
			.pack(side=tk.LEFT, expand=tk.YES, anchor=tk.CENTER, padx=5)
