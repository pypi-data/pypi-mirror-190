...
def get_exame_and_done(exam_path,exam_done_path,i):
...
class Window:
    def __init__(self,parent,i):
        ...
        self.exam_id = i
        self.user_anwser, self.exam, self.score=get_exame_and_done(r"data\data.json","data\exam.json",int(i))
    ...
    def main_left(self, parent):
        ...
        label(f1, str(self.exam_id)).pack(side=tk.LEFT, anchor=tk.W, padx=30, pady=5)
    ...
    def main_right(self, parent):
        ...
        self.frame_ti.refresh(1,self.exam[0],self.score_label)
        return frame_ti
