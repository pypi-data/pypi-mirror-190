    ...
    def main_left_tihao(self, parent):
        ...
        def last_btn_click(i):
            if i == 0:
                ...
                refresh__yema_tihao((i-1)*10,i*10)
        ...
        def next_btn_click(i):
            ...
            if i+1 == totol_ye:
                ...
                refresh__yema_tihao((i+1)*10,len(btn_frames))
            else:
                refresh__yema_tihao((i+1)*10,(i+2)*10)
        ...
        refresh__yema_tihao(0,min(10,len(btn_frames)))
