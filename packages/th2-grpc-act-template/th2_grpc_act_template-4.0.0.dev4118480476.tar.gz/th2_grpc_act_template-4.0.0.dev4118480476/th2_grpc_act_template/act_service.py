...
class ActService(object):
    ...
    def placeOrderCancelRequest(self, request, timeout=None):
        return self.connector.create_request('placeOrderCancelRequest', request, timeout)

    def placeOrderCancelReplaceRequest(self, request, timeout=None):
        return self.connector.create_request('placeOrderCancelReplaceRequest', request, timeout)
