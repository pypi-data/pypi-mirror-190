...
version = importlib.metadata.version("microformats")
...
class Parser(object):
    ...
    ua_desc = "python-microformats"
    ua_url = "https://ragt.ag/code/python-microformats"
    useragent = f"{ua_desc} - version {version} - {ua_url}"
