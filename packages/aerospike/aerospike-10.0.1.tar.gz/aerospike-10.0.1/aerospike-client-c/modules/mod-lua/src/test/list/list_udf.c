...
TEST(list_udf_1, "create a list")
{
    ...
    int rc = as_module_apply_record(&mod_lua, &ctx, "lists", "create", rec,
                                    (as_list *)&arglist, res);
...
TEST(list_udf_2, "get the size of a list")
{
    ...
    int rc = as_module_apply_record(&mod_lua, &ctx, "lists", "size", rec,
                                    (as_list *)&arglist, res);
...
TEST(list_udf_3, "iterate over a list")
{
    ...
    int rc = as_module_apply_record(&mod_lua, &ctx, "lists", "iterate", rec,
                                    (as_list *)&arglist, res);
    ...
    as_list *rlist =
        (as_list *)
            res->value; // returned list should look just like the input one
    assert_int_eq(as_list_size(rlist), 5);
    assert_int_eq(as_list_get_int64(rlist, 0), 1);
    assert_int_eq(as_list_get_int64(rlist, 1), 2);
    assert_int_eq(as_list_get_int64(rlist, 2), 3);
...
TEST(list_udf_4, "insert an element into a list")
{
    ...
    int rc = as_module_apply_record(&mod_lua, &ctx, "lists", "insert", rec,
                                    (as_list *)&arglist, res);
...
TEST(list_udf_5, "append an element to a list")
{
    ...
    int rc = as_module_apply_record(&mod_lua, &ctx, "lists", "append", rec,
                                    (as_list *)&arglist, res);
...
TEST(list_udf_6, "prepend an element to a list")
{
    ...
    int rc = as_module_apply_record(&mod_lua, &ctx, "lists", "prepend", rec,
                                    (as_list *)&arglist, res);
...
TEST(list_udf_7, "select the first 2 elements of a list")
{
    ...
    int rc = as_module_apply_record(&mod_lua, &ctx, "lists", "take", rec,
                                    (as_list *)&arglist, res);
...
TEST(list_udf_8, "remove an element from a list")
{
    ...
    int rc = as_module_apply_record(&mod_lua, &ctx, "lists", "remove", rec,
                                    (as_list *)&arglist, res);
...
TEST(list_udf_9, "drop the first 3 elements of a list")
{
    ...
    int rc = as_module_apply_record(&mod_lua, &ctx, "lists", "drop", rec,
                                    (as_list *)&arglist, res);
...
TEST(list_udf_10, "trim a list")
{
    ...
    int rc = as_module_apply_record(&mod_lua, &ctx, "lists", "trim", rec,
                                    (as_list *)&arglist, res);
...
TEST(list_udf_11, "clone a list")
{
    ...
    int rc = as_module_apply_record(&mod_lua, &ctx, "lists", "clone", rec,
                                    (as_list *)&arglist, res);
...
TEST(list_udf_12, "concatenate two lists")
{
    ...
    int rc = as_module_apply_record(&mod_lua, &ctx, "lists", "concat", rec,
                                    (as_list *)&arglist, res);
...
TEST(list_udf_13, "merge two lists")
{
    ...
    int rc = as_module_apply_record(&mod_lua, &ctx, "lists", "merge", rec,
                                    (as_list *)&arglist, res);
