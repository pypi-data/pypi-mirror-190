...
static const luaL_reg object_table[] = {{"has_next", mod_lua_iterator_has_next},
                                        {"next", mod_lua_iterator_next},
                                        {0, 0}};

static const luaL_reg object_metatable[] = {{"__call", mod_lua_iterator_next},
                                            {0, 0}};
...
static const luaL_reg class_table[] = {{"has_next", mod_lua_iterator_has_next},
                                       {"next", mod_lua_iterator_next},
                                       {0, 0}};

static const luaL_reg class_metatable[] = {{"__gc", mod_lua_iterator_gc},
                                           {0, 0}};
