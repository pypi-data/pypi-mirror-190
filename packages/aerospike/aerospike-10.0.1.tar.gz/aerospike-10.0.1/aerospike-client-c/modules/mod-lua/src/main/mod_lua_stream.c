...
{
    mod_lua_box *box =
        mod_lua_pushbox(l, MOD_LUA_SCOPE_HOST, stream, CLASS_NAME);
    return (as_stream *)mod_lua_box_value(box);
}
...
static const luaL_reg object_table[] = {{"read", mod_lua_stream_read},
...
static const luaL_reg object_metatable[] = {{0, 0}};
