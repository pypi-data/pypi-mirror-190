...
TEST(types_hashmap_iterator, "as_hashmap w/ as_iterator ops")
{
    ...
    as_hashmap_set(m, (as_val *)as_string_new_strdup("R"),
                   (as_val *)as_integer_new(1));
    as_hashmap_set(m, (as_val *)as_string_new_strdup("a"),
                   (as_val *)as_integer_new(2));
    as_hashmap_set(m, (as_val *)as_string_new_strdup("N"),
                   (as_val *)as_integer_new(3));
    as_hashmap_set(m, (as_val *)as_string_new_strdup("d"),
                   (as_val *)as_integer_new(4));
    as_hashmap_set(m, (as_val *)as_string_new_strdup("o"),
                   (as_val *)as_integer_new(5));
    as_hashmap_set(m, (as_val *)as_string_new_strdup("M"),
                   (as_val *)as_integer_new(6));
...
bool types_hashmap_foreach_callback(const as_val *key, const as_val *val,
                                    void *udata)
{
    int *sum = (int *)udata;
...
TEST(types_hashmap_types, "as_hashmap types")
{
    ...
    as_map_set(map_data, (as_val *)as_integer_new(10),
               (as_val *)as_integer_new(20));
    as_map_set(m, (as_val *)as_string_new_strdup("map_data"),
               (as_val *)map_data);

    // Setting a list
    as_list *list_data = (as_list *)as_arraylist_new(1, 1);
    as_arraylist_set_int64((as_arraylist *)list_data, 0, 20000);
    as_map_set(m, (as_val *)as_string_new_strdup("list_data"),
               (as_val *)list_data);

    // Setting a string
    as_map_set(m, (as_val *)as_string_new_strdup("string_data"),
               (as_val *)as_string_new_strdup("my string data"));

    // Setting an integer
    as_map_set(m, (as_val *)as_string_new_strdup("integer_data"),
               (as_val *)as_integer_new(10000));

    // Setting a double
    as_map_set(m, (as_val *)as_string_new_strdup("double_data"),
               (as_val *)as_double_new(1013.4454));
    ...
    as_map_set(m, (as_val *)as_string_new_strdup("byte_data"),
               (as_val *)byte_data);
