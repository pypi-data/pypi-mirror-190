...
const as_boolean as_true = {
    ._ = {.type = AS_BOOLEAN, .free = false, .count = 0}, .value = true};

const as_boolean as_false = {
    ._.type = AS_BOOLEAN, ._.free = false, ._.count = 0, .value = false};

/******************************************************************************
 *	INSTANCE FUNCTIONS
 ******************************************************************************/

static inline as_boolean *as_boolean_cons(as_boolean *boolean, bool free,
                                          bool value)
{
    if (!boolean)
        return boolean;
