...
as_serializer *as_serializer_cons(as_serializer *serializer, bool free,
...
as_serializer *as_serializer_init(as_serializer *serializer,
                                  const as_serializer_hooks *hooks)
{
...
{
    as_serializer *serializer =
        (as_serializer *)cf_malloc(sizeof(as_serializer));
