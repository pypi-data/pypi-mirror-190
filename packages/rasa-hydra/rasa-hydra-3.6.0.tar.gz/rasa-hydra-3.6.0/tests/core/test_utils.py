...
from rasa.constants import ENV_SANIC_WORKERS, SANIC_WORKERS
...
def test_get_number_of_sanic_workers(
    ...
    if env_value is not None:
        os.environ[SANIC_WORKERS] = str(env_value)
    ...
    os.environ.pop(SANIC_WORKERS, None)

    if pre_test_value is not None:
        os.environ[SANIC_WORKERS] = pre_test_value
