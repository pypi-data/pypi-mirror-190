...
{'bigquery': ['pyarrow>=8.0.0'],
 'bigquery:python_version < "3.11"': ['grpcio>=1.50.0',
                                      'google-cloud-bigquery>=2.26.0',
                                      'google-cloud-bigquery-storage>2.13.0'],
 'dbt': ['dbt-core>=1.3.0,<1.4.0', 'dbt-redshift>=1.3.0,<1.4.0'],
 'dbt:python_version < "3.11"': ['dbt-bigquery>=1.3.0,<1.4.0',
                                 'dbt-duckdb>=1.3.0,<1.4.0'],
 'duckdb': ['duckdb>=0.5.0'],
 'gcp': ['pyarrow>=8.0.0'],
 'gcp:python_version < "3.11"': ['grpcio>=1.50.0',
                                 'google-cloud-bigquery>=2.26.0',
                                 'google-cloud-bigquery-storage>2.13.0'],
