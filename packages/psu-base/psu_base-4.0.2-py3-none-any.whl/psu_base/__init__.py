...
_DEFAULTS = {
    ...
    'PSU_BASE_ADMIN_LINKS': [
        ...
        {'url': "psu:errors", 'label': "Error Log", 'icon': "fa-exclamation-triangle", 'authorities': "~SuperUser"},
        {'url': "psu:emails", 'label': "Email Log", 'icon': "fa-envelope-o"},
        {'url': "psu:features", 'label': "Feature Toggles", 'icon': "fa-plug", 'authorities': "~SuperUser+features"},
        {'url': "psu:audit", 'label': "Audit Events", 'icon': "fa-id-card-o", 'authorities': "~SecurityOfficer"},
        {'url': "psu:audit_xss", 'label': "XSS Attempts", 'icon': "fa-user-secret", 'authorities': "~SecurityOfficer"},
        ...
        {'url': "psu:scripts", 'label': "Admin Script", 'icon': "fa-code", 'authorities': "~SuperUser+scriptor", 'feature': 'admin_script'},
        {'url': "psu:export", 'label': "Database Export", 'icon': "fa-database", 'authorities': "developer", 'feature': 'database_export'},
        {'url': "psu:downtimes", 'label': "Downtimes", 'icon': "fa-bed", 'authorities': "developer"},
    ]
}
