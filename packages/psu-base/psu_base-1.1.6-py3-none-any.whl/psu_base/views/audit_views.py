...
log = Log()
allowable_role_list = DynamicRole().security_officer()
...
def audit_list(request):
    ...
    sortby, page = utility_service.pagination_sort_info(request, "date_created", 'desc')
    audits = audits.order_by(sortby)

    paginator = Paginator(audits, 1)
