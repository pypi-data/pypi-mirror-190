...
SUB_APPS = {
    'EMERGENCY': 'Emergency Management Demo',
    'DIPLOMA': 'Diploma Order Demo',
    'ARRANGEMENT': 'By-Arrangement Demo',
}
...
FLASH_MESSAGE_POSITION = 'ANIMATE'   # TOP, BOTTOM, ANIMATE
