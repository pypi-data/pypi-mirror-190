...
from psu_base.services import downtime_service, message_service, utility_service
...
def downtime_list(request):
    ...
    active_base_downtime = False
    for dt in downtimes:
        if dt.is_active():
            active_base_downtime = True

    # Include Banner downtimes
    banner_downtimes = downtime_service.get_banner_downtimes()
    ...
    return render(
        ...
        {
            "downtimes": downtimes,
            "active_base_downtime": active_base_downtime,
            "banner_downtimes": banner_downtimes,
            "downtime_json_path": downtime_service.downtime_path,
        },
    )
