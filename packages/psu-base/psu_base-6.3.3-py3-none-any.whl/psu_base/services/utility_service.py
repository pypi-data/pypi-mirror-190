...
def allow_id_lookups(set_status=None):
    var_name = "psu_base-allow_id_lookup"

    # If status is specified, remember it for duration of session
    if set_status is not None:
        set_session_var(var_name, set_status)

    # Return the previously-set status, or None
    return get_session_var(var_name)
