...
def export_all(request):
    ...
    include_audits = request.GET.get("include_audits", "N") == "Y"

    for aa in installed_apps:
        # Only export data from specified app
        if target_app and aa != target_app:
            continue
    ...
    for app_name, model_list in app_models.items():
        for model_name in model_list:
            if app_name == "psu_base" and model_name == "Audit" and not include_audits:
                continue
