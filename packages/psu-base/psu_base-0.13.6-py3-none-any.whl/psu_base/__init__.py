...
_DEFAULTS = {
    ...
    'PSU_BASE_ADMIN_LINKS': [
        ...
        {'url': "psu:audit", 'label': "Audit Events", 'icon': "fa-id-card-o", 'authorities': "DynamicPowerUser"},
        {'url': "psu:audit_xss", 'label': "XSS Attempts", 'icon': "fa-user-secret", 'authorities': "DynamicSecurityOfficer"},
        {'url': "psu:finti", 'label': "Finti Interface", 'icon': "fa-laptop", 'authorities': "developer", 'feature': "finti_console"},
