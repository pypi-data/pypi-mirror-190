...
class Run():
    ...
    def __init__(self, name: str = None, project: str = None, read_only: bool = False, path: str = None, generate_name: bool = False):
        """Initiate a new run
        ...
        assert name or path or generate_name, "Please specify `name` or `path`, or set `generate_name` to True."
        if generate_name:
            assert name==None, "The `name` cannot be specified if generate_name is True."
            assert path==None, "The `name` cannot be specified if generate_name is True."
