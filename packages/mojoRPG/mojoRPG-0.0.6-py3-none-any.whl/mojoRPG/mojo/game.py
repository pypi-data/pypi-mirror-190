...
def fight(
    ...
    while player1.hp > 0 and player2.hp > 0:
      ...
      print(f"  Initiative: {queue[0][0].initiative}      {queue[0][0].name} (hp:{queue[0][0].hp} mojo:{queue[0][0].mojo}) ")
      print(f"  Initiative: {queue[1][0].initiative}      {queue[1][0].name} (hp:{queue[1][0].hp} mojo:{queue[1][0].mojo})" )
      for o, d in queue:
        if o.mojo <= 0:
