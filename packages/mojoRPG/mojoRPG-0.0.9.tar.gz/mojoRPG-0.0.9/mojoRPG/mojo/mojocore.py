...
class Mojo(object):
    ...
    def actionMelleAttack(
        self, mojo, toHit, armor, ddcount, ddsides, dbonus, proficiency=100
    ):
        action = {"type": "attack"}
        ...
        print(
            f'Attack: roll: {action["attack"]["roll"]}({action["attack"]["value"]}) ToHit: {action["attack"]["overHit"]} DamageHit: {action["attack"]["overDamage"]} Damage:{action["damage"]["roll"]} ({action["damage"]["value"]})'
        )
        return action
        ...
        while not winner:
            ...
            for i in range(len(players)):
                ...
                if o.mojo <= 0:
                    ...
                    while o.mojo > 0:
                        print(
                            f"It is {o.name}'s turn. {o.name} has {o.mojo} mojo. Enter offensive mojo to use:",
                            end=" ",
                        )
                        if auto:
                        ...
                        print(
                            f"{d.name} is defending. {d.name} has {d.mojo} mojo. Enter deffensive mojo to use:",
                            end=" ",
                        )
                        if auto:
